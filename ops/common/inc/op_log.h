...
#define GE_OP_LOGEVT(opname, ...) GE_D_OP_LOGEVT(opname, __VA_ARGS__)
...
#define GE_D_OP_LOGEVT(opname, fmt, ...) DlogSub(GE, OPPROTO_SUBMOD_NAME, DLOG_EVENT, " %s:%d OpName:[%s] "#fmt, __FUNCTION__, __LINE__, opname, ##__VA_ARGS__)
