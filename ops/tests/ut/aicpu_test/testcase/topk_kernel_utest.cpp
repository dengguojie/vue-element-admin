...
class TEST_TOPK_UTest : public testing::Test {
protected:
    virtual void SetUp()
    {
    }
...
//TEST_DT_FLOAT16
TEST_F(TEST_TOPK_UTest, TEST_DT_FLOAT16)
{
...
//TEST_DT_FLOAT
TEST_F(TEST_TOPK_UTest, TEST_DT_FLOAT)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("TopK");
    //set x
...
//TEST_DT_DOUBLE
TEST_F(TEST_TOPK_UTest, TEST_DT_DOUBLE)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("TopK");
    //set x
...
//TEST_DT_UINT8
TEST_F(TEST_TOPK_UTest, TEST_DT_UINT8)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("TopK");
    //set x
...
//TEST_DT_INT8
TEST_F(TEST_TOPK_UTest, TEST_DT_INT8)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("TopK");
    //set x
...
//TEST_DT_UINT16
TEST_F(TEST_TOPK_UTest, TEST_DT_UINT16)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("TopK");
    //set x
...
//TEST_DT_INT16
TEST_F(TEST_TOPK_UTest, TEST_DT_INT16)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("TopK");
    //set x
...
//TEST_DT_UINT32
TEST_F(TEST_TOPK_UTest, TEST_DT_UINT32)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("TopK");
    //set x
...
//TEST_DT_INT32
TEST_F(TEST_TOPK_UTest, TEST_DT_INT32)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("TopK");
    //set x
...
//TEST_DT_UINT64
TEST_F(TEST_TOPK_UTest, TEST_DT_UINT64)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("TopK");
    //set x
...
//TEST_DT_INT64
TEST_F(TEST_TOPK_UTest, TEST_DT_INT64)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("TopK");
    //set x
