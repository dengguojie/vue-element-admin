...
class TEST_RANDOM_UNIFORM_KERNEL_UTest : public testing::Test {
  protected:
    virtual void SetUp() {}
...
TEST_F(TEST_RANDOM_UNIFORM_KERNEL_UTest, float16_with_seed) {
...
TEST_F(TEST_RANDOM_UNIFORM_KERNEL_UTest, float_with_seed_2) {
    cout<<"Test Kernel Begin."<<endl;
    int64_t input[2] = {2, 2};
    float output[4] = {0};
...
TEST_F(TEST_RANDOM_UNIFORM_KERNEL_UTest, double_with_no_seed) {
    cout<<"Test Kernel Begin."<<endl;
    int64_t input[2] = {2, 2};
    double output[4] = {0};
...
TEST_F(TEST_RANDOM_UNIFORM_KERNEL_UTest, data_type_not_match) {
    cout<<"Test Kernel Begin."<<endl;
    int64_t input[2] = {2, 2};
    double output[4] = {0};
...
TEST_F(TEST_RANDOM_UNIFORM_KERNEL_UTest, data_type_not_support) {
    cout<<"Test Kernel Begin."<<endl;
    int64_t input[2] = {2, 2};
    int64_t output[4] = {0};
