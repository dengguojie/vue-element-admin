...
class acos : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "acos Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "acos Proto Test TearDown" << std::endl;
  }
};

TEST_F(acos, acos_infershape_diff_test){
  ge::op::Acos op;
...
TEST_F(acos, acos_infershape_same_test){
  ge::op::Acos op;
