...
ut_case = OpUT("UnsortedSegmentProdD")

def calc_expect_func(x, segment_ids, y, num_segments):
    output = tf.math.unsorted_segment_prod(x['value'],
                                          segment_ids['value'],
                                          num_segments,
                                          name="output")
...
case_small_shape_scalar_fp32 = {
    ...
    "case_name": 'test_unsorted_segment_prod_d_small_shape_scalar_fp32',
    "expect": "success"
}
...
case_small_shape_fp32 = {
    ...
    "case_name": 'test_unsorted_segment_prod_d_small_shape_fp32',
    "expect": "success"
}
