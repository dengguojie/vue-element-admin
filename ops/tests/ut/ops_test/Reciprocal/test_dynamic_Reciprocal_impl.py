...
ut_case = OpUT("Reciprocal", "impl.dynamic.reciprocal", "reciprocal")
...
case1 = {"params": [
    ...
    {"shape": (-1, -1, 2), "ori_shape": (2, 10, 5), "range": ((1, None), (1, None), (2, 2)), "format": "NHWC",
     "ori_format": "NHWC", 'dtype': "float32"}],
         "case_name": "reciprocal_dynamic_1",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
...
case2 = {"params": [{"shape": (-1,), "ori_shape": (100,), "range": ((1, None),), "format": "NHWC", "ori_format": "NHWC",
                    ...
                    {"shape": (1,), "ori_shape": (1,), "range": ((1, 1),), "format": "NHWC", "ori_format": "NHWC",
                     'dtype': "float32"}],
         "case_name": "reciprocal_dynamic_2",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
...
case3 = {"params": [
    ...
    {"shape": (-1, 5), "ori_shape": (200, 5), "range": ((1, 100), (1, 5)), "format": "ND", "ori_format": "ND",
     'dtype': "float16"}],
         "case_name": "reciprocal_dynamic_3",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
...
case4 = {"params": [
    ...
    {"shape": (-1, 5), "ori_shape": (200, 5), "range": ((1, 100), (1, 5)), "format": "ND", "ori_format": "ND",
     'dtype': "float32"}],
         "case_name": "reciprocal_dynamic_4",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
...
case5 = {"params": [
    ...
    {"shape": (-1, -1), "ori_shape": (2, 5), "range": ((1, None), (1, None)), "format": "NHWC", "ori_format": "NHWC",
     'dtype': "float16"}],
         "case_name": "reciprocal_dynamic_5",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
...
case6 = {"params": [
    ...
    {"shape": (-1, -1), "ori_shape": (2, 2), "range": ((2, 2), (2, 2)), "format": "NHWC", "ori_format": "NHWC",
     'dtype': "float16"}],
         "case_name": "reciprocal_dynamic_6",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
