...
ut_case = ElementwiseOpUT("Sqrt", None, None)
...
precision_case4 = {"params": [{"shape": (16,2,4,32), "dtype": "float16", "format": "ND", "ori_shape": (16,2,4,32),"ori_format": "ND","param_type":"input"},
                              {"shape": (16,2,4,32), "dtype": "float16", "format": "ND", "ori_shape": (16,2,4,32),"ori_format": "ND","param_type":"output"}],
                   "expect": "success",
                   "calc_expect_func": calc_expect_func,
                   "precision_standard": precision_info.PrecisionStandard(0.005, 0.005)}
precision_case5 = {"params": [{"shape": (11,33), "dtype": "float16", "format": "ND", "ori_shape": (11,33),"ori_format": "ND","param_type":"input"},
