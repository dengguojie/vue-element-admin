...
FakeQuantWithMinMaxVarsPerChannelGradient ut case
"""
from op_test_frame.ut import OpUT
ut_case = OpUT("FakeQuantWithMinMaxVarsPerChannelGradient", None, None)
...
case1 = {"params": [{"shape": (2, 2, 2), "dtype": "float32", "format": "ND", "ori_shape": (2, 2, 2),"ori_format": "ND"}, #x
                    ...
                    {"shape": (2, 2, 2), "dtype": "float32", "format": "ND", "ori_shape": (2, 2, 2),"ori_format": "ND"},
                    {"shape": (2,), "dtype": "float32", "format": "ND", "ori_shape": (2,),"ori_format": "ND"},
                    {"shape": (2, 2), "dtype": "float32", "format": "ND", "ori_shape": (2, 2),"ori_format": "ND"},
                    2,True,
                    ],
         "case_name": "FakeQuantWithMinMaxVarsPerChannelGradient_1",
         "expect": "success",
         "support_expect": True}
...
case2 = {"params": [{"shape": (2, 2, 2), "dtype": "float32", "format": "ND", "ori_shape": (2, 2, 2),"ori_format": "ND"}, #x
         ...
         "case_name": "FakeQuantWithMinMaxVarsPerChannelGradient_2",
         "expect": "success",
         "support_expect": True}
