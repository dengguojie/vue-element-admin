...
ut_case = OpUT("ScatterMul", None, None)
...
case6 = {"params": [{"shape": (255, 33), "dtype": "int32", "format": "ND", "ori_shape": (255, 33),"ori_format": "ND"},
                    ...
                    False],
         "case_name": "scatter_mul_6",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
case7 = {"params": [{"shape": (31, 2, 2), "dtype": "float16", "format": "ND", "ori_shape": (31, 2, 2),"ori_format": "ND"},
                    ...
                    {"shape": (31, 2, 2), "dtype": "float16", "format": "ND", "ori_shape": (31, 2, 2),"ori_format": "ND"},
                    False],
         "case_name": "scatter_mul_7",
         "expect": RuntimeError,
         "format_expect": [],
         "support_expect": True}
