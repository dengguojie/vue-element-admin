...
TEST_F(mul, mul_infershape_diff_test_4) {
  ge::op::Mul op;
...
TEST_F(mul, mul_infershape_diff_test_5) {
  ge::op::Mul op;
...
TEST_F(mul, mul_infershape_diff_test_6) {
  ge::op::Mul op;
...
TEST_F(mul, mul_infershape_diff_test_7) {
  ge::op::Mul op;
...
TEST_F(mul, mul_infershape_diff_test_8) {
  ge::op::Mul op;
...
TEST_F(mul, mul_infershape_diff_test_9) {
  ge::op::Mul op;
...
TEST_F(mul, mul_infershape_diff_test_10) {
  ge::op::Mul op;
  op.UpdateInputDesc("x1", create_desc_shape_range({-1}, ge::DT_INT32, ge::FORMAT_ND, {-1}, ge::FORMAT_ND, {{1,55}}));
