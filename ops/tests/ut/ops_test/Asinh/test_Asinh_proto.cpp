...
class asinh : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "asinh Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "asinh Proto Test TearDown" << std::endl;
  }
};

TEST_F(asinh, asinh_infershape_diff_test){
  ge::op::Asinh op;
...
TEST_F(asinh, asinh_infershape_same_test){
  ge::op::Asinh op;
