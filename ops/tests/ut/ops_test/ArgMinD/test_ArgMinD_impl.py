...
ut_case = OpUT("ArgMinD", None, None)
...
def calc_expect_func(x, y, dimension):
    ...
    output_data=np.argmin(x_value,axis = dimension)
...
#                                               {"shape": (1, 3, 10, 16), "dtype": "int32", "format": "ND", "ori_shape": (1, 3, 10, 16),"ori_format": "ND", "param_type": "output"},
#                                               2,
#                                               ],
#                                    "calc_expect_func": calc_expect_func,
#                                    "precision_standard": precision_info.PrecisionStandard(0.001, 0.001)
