...
class atanh : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "atanh Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "atanh Proto Test TearDown" << std::endl;
  }
};

TEST_F(atanh, atanh_infershape_diff_test){
  ge::op::Atanh op;
...
TEST_F(atanh, atanh_infershape_same_test){
  ge::op::Atanh op;
