...
ut_case.add_elewise_case_simple(["Hi3796CV300ES"], ["float16"], (1024,))
ut_case.add_elewise_case_simple(["Hi3796CV300ES"], ["float16"], (256,256))
ut_case.add_elewise_case_simple(["Hi3796CV300ES"], ["float16"], (1, 2, 608, 608, 16))
ut_case.add_elewise_case_simple(["Hi3796CV300ES"], ["float16"], (1, 4, 304, 304, 16))
ut_case.add_elewise_case_simple(["Hi3796CV300ES"], ["float16"], (1, 4, 152, 152, 16))
ut_case.add_elewise_case_simple(["Hi3796CV300ES"], ["float16"], (1, 8, 76, 76, 16))
ut_case.add_elewise_case_simple(["Hi3796CV300ES"], ["float16"], (1, 16, 38, 38, 16))
ut_case.add_elewise_case_simple(["Hi3796CV300ES"], ["float16"], (1, 32, 38, 38, 16))
ut_case.add_elewise_case_simple(["Hi3796CV300ES"], ["float16"], (1, 64, 19, 19, 16))
