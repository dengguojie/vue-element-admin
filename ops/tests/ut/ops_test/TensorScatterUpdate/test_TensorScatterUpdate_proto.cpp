...
class tensor_scatter_update : public testing::Test {
protected:
...
// normal cases
TEST_F(tensor_scatter_update, tensor_scatter_update_infershape_test) {
    ge::op::TensorScatterUpdate op;
...
TEST_F(tensor_scatter_update, tensor_scatter_update_verify_test) {
    ge::op::TensorScatterUpdate op;
    op.UpdateInputDesc("x", create_desc_with_ori({33, 5}, ge::DT_FLOAT16, ge::FORMAT_ND, {33, 5}, ge::FORMAT_ND));
    op.UpdateInputDesc("indices", create_desc_with_ori({33, 25, 1}, ge::DT_INT32, ge::FORMAT_ND, {33, 25, 1}, ge::FORMAT_ND));
    op.UpdateInputDesc("updates", create_desc_with_ori({33, 25, 5}, ge::DT_FLOAT16, ge::FORMAT_ND, {33, 25, 5}, ge::FORMAT_ND));
...
// exception cases
TEST_F(tensor_scatter_update, tensor_scatter_update_verify_invalid_test) {
    ge::op::TensorScatterUpdate op;
