...
def test_tiling_query(test_arg):
    ...
    # { { 8, 1, 48, 48, 4, 16, 7, 7, 16, 2, 2, 2, 2, 2, 3, 3, 1, 1, 1, 1, 1, 0, 0 },
    # { 65535, 2, 65535, 1, 78, 1, 16, 16, 1, 4, 16, 16, 4, 78, 16, 16, 2, 78, 16, 16, 0, 0, 2, 0, 1, 1, 1, 1, 1, 1, 1 } },
    # the shape in repository
    a_shape = [8, 1, 48, 48, 16]
    b_shape = [64, 1, 7, 7, 16]
    c_shape=None
    a_dtype='float16'
    b_dtype='float16'
    c_dtype='float16'
    mad_dtype='float16'
    padl, padr, padu, padd= 2, 2, 3, 3
    strideh, stridew = 1, 1
    strideh_expand, stridew_expand = 1, 1
    dilationh, dilationw = 1, 1
    group = 1
    fused_double_operand_num = 0
    bias_flag_repo = 0

    tiling_repo = {'block_dim': [2, 2, 1], 'CUB_matrix': [4, 64, 16, 16, 1], 'cout_bef_batch_flag': 0,
        'BL1_shape': [], 'B_overhead_opt_flag': 0, 'BUB_shape': None, 'BL0_matrix': [1, 4, 16, 16, 1],
        'AL0_matrix': [64, 1, 16, 16, 1], 'AUB_shape': None, 'manual_pingpong_buffer': {'AL1_pbuffer': 2,
        'AUB_pbuffer': 1, 'CUB_pbuffer': 1, 'BL1_pbuffer': 2, 'CL0_pbuffer': 2, 'BL0_pbuffer': 2,
        'AL0_pbuffer': 2, 'BUB_pbuffer': 1, 'UBG_pbuffer': 2}, 'CL0_matrix': [4, 64, 16, 16, 1],
        'AL1_shape': [784, 1, 1], 'A_overhead_opt_flag': 0}

    tiling_res_repo = tiling_query(a_shape, b_shape, c_shape,
                                    a_dtype=a_dtype, b_dtype=b_dtype, c_dtype=c_dtype, mad_dtype=mad_dtype,
                                    padl=padl, padr=padr, padu=padu, padd=padd, strideh=strideh, stridew=stridew,
                                    strideh_expand=strideh_expand, stridew_expand=stridew_expand, dilationh=dilationh, dilationw=dilationw,
                                    group=group, fused_double_operand_num=fused_double_operand_num,
                                    );

    # .assertEquals(tiling_res_repo, tiling_repo)
    print(tiling_res_repo)
    print("test_tiling_repository_query_001\n")
    ...
    tiling_predict = {'AUB_shape': None, 'BUB_shape': None, 'B_overhead_opt_flag': 0,
        'AL0_matrix': [64, 1, 16, 16, 1], 'A_overhead_opt_flag': 0, 'CL0_matrix': [4, 64, 16, 16, 1],
        'AL1_shape': [784, 1, 1], 'CUB_matrix': [4, 64, 16, 16, 1], 'BL1_shape': [], 'block_dim': [2, 2, 1],
        'BL0_matrix': [1, 4, 16, 16, 1], 'cout_bef_batch_flag': 0, 'manual_pingpong_buffer':
        {'UBG_pbuffer': 2, 'CL0_pbuffer': 2, 'AL0_pbuffer': 2, 'AUB_pbuffer': 1, 'BL0_pbuffer': 2,
        'BUB_pbuffer': 1, 'CUB_pbuffer': 1, 'AL1_pbuffer': 2, 'BL1_pbuffer': 2}}
    ...
    print("test_tiling_repository_query_002\n")
    ...
    print(tiling_res_predict)
    # .assertEquals(tiling_res_predict, tiling_predict)
    print("test_tiling_repository_query_004\n")
    ...
    tiling_predict =  {'BUB_shape': None, 'block_dim': [2, 2, 1], 'AL0_matrix': [64, 1, 16, 16, 1],
        'CUB_matrix': [2, 64, 16, 16, 1], 'BL0_matrix': [1, 2, 16, 16, 1], 'CL0_matrix': [2, 64, 16, 16, 1],
        'AUB_shape': None, 'manual_pingpong_buffer': {'AL0_pbuffer': 2, 'BL1_pbuffer': 2, 'CUB_pbuffer': 2,
        'BL0_pbuffer': 2, 'AL1_pbuffer': 2, 'AUB_pbuffer': 1, 'BUB_pbuffer': 1, 'UBG_pbuffer': 2,
        'CL0_pbuffer': 2}, 'B_overhead_opt_flag': 0, 'cout_bef_batch_flag': 0,
        'A_overhead_opt_flag': 0, 'BL1_shape': [], 'AL1_shape': [784, 1, 1]}
    ...
    print(tiling_res_predict)
    # .assertEquals(tiling_res_predict, tiling_predict)
    print("test_tiling_cost_model_query_001\n")

    # convolution_002
    # the shape not in repository
    img_shape_predict = [8, 1, 2, 1, 16]
    filter_shape_predict = [13, 1, 1, 1, 16]
    out_shape_repo = None
    img_dtype_predict = 'float16'
    filter_dtype_predict = 'float16'
    ...
    tiling_predict = {'BUB_shape': None, 'block_dim': [2, 2, 1], 'AL0_matrix': [1, 1, 16, 16, 1],
        'CUB_matrix': [1, 1, 16, 16, 1], 'BL0_matrix': [1, 1, 16, 16, 1], 'CL0_matrix': [1, 1, 16, 16, 1],
        'AUB_shape': None, 'manual_pingpong_buffer': {'AL0_pbuffer': 2, 'BL1_pbuffer': 2, 'CUB_pbuffer': 2,
        'BL0_pbuffer': 2, 'AL1_pbuffer': 2, 'AUB_pbuffer': 1, 'BUB_pbuffer': 1, 'UBG_pbuffer': 2,
        'CL0_pbuffer': 2}, 'B_overhead_opt_flag': 1, 'cout_bef_batch_flag': 0,
        'A_overhead_opt_flag': 0, 'BL1_shape': [], 'AL1_shape': []}
    ...
    print(tiling_res_predict)
    # .assertEquals(tiling_res_predict, tiling_predict)
    print("test_tiling_cost_model_query_002\n")

    # convolution_003
    # the shape not in repository
    img_shape_predict = [2, 1, 2, 1, 16]
    filter_shape_predict = [53, 1, 1, 1, 16]
    out_shape_repo = None
    img_dtype_predict = 'float16'
    filter_dtype_predict = 'float16'
    res_dtype_predict = 'float16'
    ...
    tiling_predict = {'BUB_shape': None, 'block_dim': [2, 2, 1], 'AL0_matrix': [1, 1, 16, 32, 1],
        'CUB_matrix': [4, 1, 16, 16, 1], 'BL0_matrix': [1, 4, 16, 32, 1], 'CL0_matrix': [4, 1, 16, 16, 1],
        'AUB_shape': None, 'manual_pingpong_buffer': {'AL0_pbuffer': 2, 'BL1_pbuffer': 2,
        'CUB_pbuffer': 2, 'BL0_pbuffer': 2, 'AL1_pbuffer': 2, 'AUB_pbuffer': 1, 'BUB_pbuffer': 1,
        'UBG_pbuffer': 2, 'CL0_pbuffer': 2}, 'B_overhead_opt_flag': 1, 'cout_bef_batch_flag': 0,
        'A_overhead_opt_flag': 0, 'BL1_shape': [], 'AL1_shape': []}
    ...
    print(tiling_res_predict)
    # .assertEquals(tiling_res_predict, tiling_predict)
    print("test_tiling_cost_model_query_003\n")
    ...
    tiling_predict = {'BUB_shape': None, 'block_dim': [2, 2, 1], 'AL0_matrix': [63, 1, 16, 16, 1],
        'CUB_matrix': [2, 63, 16, 16, 1], 'BL0_matrix': [1, 2, 16, 16, 1], 'CL0_matrix': [2, 63, 16, 16, 1],
        'AUB_shape': None, 'manual_pingpong_buffer': {'AL0_pbuffer': 2, 'BL1_pbuffer': 2, 'CUB_pbuffer': 2,
        'BL0_pbuffer': 2, 'AL1_pbuffer': 2, 'AUB_pbuffer': 1, 'BUB_pbuffer': 1, 'UBG_pbuffer': 2,
        'CL0_pbuffer': 2}, 'B_overhead_opt_flag': 0, 'cout_bef_batch_flag': 0, 'A_overhead_opt_flag': 0,
        'BL1_shape': [], 'AL1_shape': [16, 1, 1]}
