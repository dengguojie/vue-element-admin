...
class atan : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "atan Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "atan Proto Test TearDown" << std::endl;
  }
};

TEST_F(atan, atan_infershape_diff_test){
  ge::op::Atan op;
...
TEST_F(atan, atan_infershape_same_test){
  ge::op::Atan op;
