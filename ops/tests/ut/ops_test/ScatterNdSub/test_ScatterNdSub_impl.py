...
ut_case = OpUT("ScatterNdSub", "impl.scatter_nd_sub", "scatter_nd_sub")


def gen_scatter_nd_sub_case(x_shape, indices_shape, updates_shape,
...
ut_case.add_case("all",
                 gen_scatter_nd_sub_case((33,5), (33,25,1), (33,25,5),
                                          "float32", "valid_fp32", "success"))

ut_case.add_case("all",
                 gen_scatter_nd_sub_case((128,14,16), (10,2,1), (10,2,14,16),
                                          "float16", "valid_fp16", "success"))

ut_case.add_case("all",
                 gen_scatter_nd_sub_case((8, 427), (2,3,1), (2,3,427),
                                          "int32", "valid_int32", "success"))

ut_case.add_case("all",
                 gen_scatter_nd_sub_case((128,512,7,7), (128,1), (128,512,7,7),
                                          "int8", "valid_int8", "success"))

ut_case.add_case("all",
                 gen_scatter_nd_sub_case((128,32), (128,1), (128,32),
