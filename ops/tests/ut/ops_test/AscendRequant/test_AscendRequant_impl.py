...
case4 = {"params": [{"shape": (1,1,16,16), "dtype": "int32", "format": "FRACTAL_NZ", "ori_shape": (2,4),"ori_format": "ND"},
                    {"shape": (1,1,2,2,16), "dtype": "uint64", "format": "NC1HWC0", "ori_shape": (1,),"ori_format": "ND"},
                    {"shape": (1,1,16,32), "dtype": "int8", "format": "FRACTAL_NZ", "ori_shape": (2,4),"ori_format": "NC1HWC0"},
                    False],
...
ut_case.add_case(["Ascend615", "Ascend710", "Ascend610", "Ascend910"], case3)
ut_case.add_case(["Ascend615", "Ascend710", "Ascend610", "Ascend910"], case4)
ut_case.add_case(["Ascend615", "Ascend710", "Ascend610", "Ascend910"], case5)
