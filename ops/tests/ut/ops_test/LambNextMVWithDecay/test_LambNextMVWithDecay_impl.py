...
ut_case = OpUT("LambNextMVWithDecay", None, None)
...
case1 = {"params": [{"shape": (1, ), "dtype": "float32", "format": "ND", "ori_shape": (1, ),"ori_format": "ND"},
                    ...
                    {"shape": (1, ), "dtype": "float32", "format": "ND", "ori_shape": (1, ),"ori_format": "ND"},
                    {"shape": (1, ), "dtype": "float32", "format": "ND", "ori_shape": (1, ),"ori_format": "ND"}],
         "case_name": "lamb_next_m_v_with_decay_1",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
case2 = {"params": [{"shape": (1, ), "dtype": "float16", "format": "ND", "ori_shape": (1, ),"ori_format": "ND"},
                    ...
                    {"shape": (1, ), "dtype": "float16", "format": "ND", "ori_shape": (1, ),"ori_format": "ND"},
                    {"shape": (1, ), "dtype": "float16", "format": "ND", "ori_shape": (1, ),"ori_format": "ND"}],
         "case_name": "lamb_next_m_v_with_decay_2",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
...
def calc_expect_func(input_mul3, input_mul2, input_realdiv1, input_mul1,
    ...
    # add_5
    add_5_result = mul_4_result+truediv_4_result
