...
LambApplyOptimizerAssign ut case
"""
from op_test_frame.ut import OpUT
ut_case = OpUT("LambApplyOptimizerAssign", None, None)
...
case1 = {"params": [{"shape": (1,), "dtype": "float32", "format": "ND", "ori_shape": (1,),"ori_format": "ND"},
         ...
         "case_name": "LambApplyOptimizerAssign_1",
         "expect": "success",
         "support_expect": True}
...
case2 = {"params": [{"shape": (1,), "dtype": "float16", "format": "ND", "ori_shape": (1,),"ori_format": "ND"},
         ...
         "case_name": "LambApplyOptimizerAssign_2",
         "expect": "success",
         "support_expect": True}
