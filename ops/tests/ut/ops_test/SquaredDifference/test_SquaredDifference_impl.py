...
ut_case = BroadcastOpUT("SquaredDifference", None, None)
...
def calc_expect_func(x1, x2, y):
    ...
    data_sub = x1_value-x2_value
    res = data_sub*data_sub
    return res
...
ut_case.add_precision_case("all", {"params": [{"shape": (2, 16, 32), "dtype": "int32", "format": "ND", "ori_shape": (2, 16, 32),"ori_format": "ND", "param_type": "input"},
                                              {"shape": (2, 16, 32), "dtype": "int32", "format": "ND", "ori_shape": (2, 16, 32),"ori_format": "ND", "param_type": "input"},
