...
TEST_F(batch_to_space_nd_fusion_test, batch_to_space_nd_fusion_test_1) {
    ge::Graph graph("batch_to_space_nd_fusion_test_1");
    ...
    *(crops_data + 3) = 0;
    ...
    auto batch_op = op::BatchToSpaceND("batch_op")
                        .set_input_x(data0)
    ...
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_1_before");
    fe::FusionPassTestUtils::RunGraphFusionPass("ConstToAttrBatchToSpaceNdFusion", fe::BUILT_IN_GRAPH_PASS, *compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_1_after");
...
TEST_F(batch_to_space_nd_fusion_test, batch_to_space_nd_fusion_test_2) {
    ...
    *(crops_data + 5) = 0;
    ...
    ge::ComputeGraphPtr compute_graph_ptr = ge::GraphUtils::GetComputeGraph(graph);
    fe::FusionPassTestUtils::InferShapeAndType(compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_2_before");
    fe::FusionPassTestUtils::RunGraphFusionPass("ConstToAttrBatchToSpaceNdFusion", fe::BUILT_IN_GRAPH_PASS, *compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_2_after");
...
TEST_F(batch_to_space_nd_fusion_test, batch_to_space_nd_fusion_test_3) {
    ...
    *(crops_data + 3) = 0;
    ...
    ge::ComputeGraphPtr compute_graph_ptr = ge::GraphUtils::GetComputeGraph(graph);
    //fe::FusionPassTestUtils::InferShapeAndType(compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_3_before");
    fe::FusionPassTestUtils::RunGraphFusionPass("ConstToAttrBatchToSpaceNdFusion", fe::BUILT_IN_GRAPH_PASS, *compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_3_after");
...
TEST_F(batch_to_space_nd_fusion_test, batch_to_space_nd_fusion_test_4) {
    ...
    *(crops_data + 3) = 0;
    ...
    ge::ComputeGraphPtr compute_graph_ptr = ge::GraphUtils::GetComputeGraph(graph);
    //fe::FusionPassTestUtils::InferShapeAndType(compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_4_before");
    fe::FusionPassTestUtils::RunGraphFusionPass("ConstToAttrBatchToSpaceNdFusion", fe::BUILT_IN_GRAPH_PASS, *compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_4_after");
...
TEST_F(batch_to_space_nd_fusion_test, batch_to_space_nd_fusion_test_6) {
    ge::Graph graph("batch_to_space_nd_fusion_test_6");
    ...
    *(crops_data + 5) = 0;
    ...
    ge::ComputeGraphPtr compute_graph_ptr = ge::GraphUtils::GetComputeGraph(graph);
    //fe::FusionPassTestUtils::InferShapeAndType(compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_6_before");
    fe::FusionPassTestUtils::RunGraphFusionPass("ConstToAttrBatchToSpaceNdFusion", fe::BUILT_IN_GRAPH_PASS, *compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_6_after");
...
TEST_F(batch_to_space_nd_fusion_test, batch_to_space_nd_fusion_test_7) {
    ge::Graph graph("batch_to_space_nd_fusion_test_7");
    ...
    *(crops_data + 3) = 0;
    ...
    ge::ComputeGraphPtr compute_graph_ptr = ge::GraphUtils::GetComputeGraph(graph);
    //fe::FusionPassTestUtils::InferShapeAndType(compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_7_before");
    fe::FusionPassTestUtils::RunGraphFusionPass("ConstToAttrBatchToSpaceNdFusion", fe::BUILT_IN_GRAPH_PASS, *compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_7_after");
...
TEST_F(batch_to_space_nd_fusion_test, batch_to_space_nd_fusion_test_8) {
    ge::Graph graph("batch_to_space_nd_fusion_test_8");
    ...
    *(crops_data + 5) = 0;
    ...
    ge::ComputeGraphPtr compute_graph_ptr = ge::GraphUtils::GetComputeGraph(graph);
    //fe::FusionPassTestUtils::InferShapeAndType(compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_8_before");
    fe::FusionPassTestUtils::RunGraphFusionPass("ConstToAttrBatchToSpaceNdFusion", fe::BUILT_IN_GRAPH_PASS, *compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_8_after");
...
TEST_F(batch_to_space_nd_fusion_test, batch_to_space_nd_fusion_test_9) {
    ge::Graph graph("batch_to_space_nd_fusion_test_9");
    ...
    *(crops_data + 5) = 0;
    ...
    ge::ComputeGraphPtr compute_graph_ptr = ge::GraphUtils::GetComputeGraph(graph);
    //fe::FusionPassTestUtils::InferShapeAndType(compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_9_before");
    fe::FusionPassTestUtils::RunGraphFusionPass("ConstToAttrBatchToSpaceNdFusion", fe::BUILT_IN_GRAPH_PASS, *compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "batch_to_space_nd_fusion_test_9_after");
