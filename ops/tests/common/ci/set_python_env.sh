...
cp $cur_dir/llt/tensor_engine/ut/testcase/auto_tiling/cost_model.bin $cur_dir/out/${product}/llt/$test_type/obj/data/tiling/ascend610/built-in/cost_model_Ascend610_conv2d_bp_filter.bin
...
#PYTHONPATH
export PYTHONPATH=$cur_dir/tensor_engine/python:$cur_dir/tensor_engine/topi/python:$cur_dir/ops/built-in/tbe:$cur_dir/toolchain/tensor_utils/op_test_frame/python:$PYTHONPATH
