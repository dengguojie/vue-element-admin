...
class GraphOptimizer {
 public:
  explicit GraphOptimizer(ge::ComputeGraphPtr graph, FrameworkType type = TENSORFLOW)
  ...
  Status InsertHWCK2FZ(ge::OutDataAnchorPtr src_anchor, ge::InDataAnchorPtr dst_anchor, enum ge::Format srcOutFormat,
                       enum ge::DataType srcOutDatatype, enum ge::Format dstInFormat, enum ge::DataType dstInDatatype);

  Status Insert4DTo5DTransOp(ge::OutDataAnchorPtr src_anchor, ge::InDataAnchorPtr dst_anchor,
  ...
  Status InsertFZ2HWCK(ge::OutDataAnchorPtr src_anchor, ge::InDataAnchorPtr dst_anchor, enum ge::Format srcOutFormat,
                       enum ge::DataType srcOutDatatype, enum ge::Format dstInFormat, enum ge::DataType dstInDatatype);

  Status Insert5DTo4DTransOp(ge::OutDataAnchorPtr src_anchor, ge::InDataAnchorPtr dst_anchor,
                             enum ge::Format src_out_format, enum ge::DataType src_out_data_type,
                             enum ge::Format dst_in_format, enum ge::DataType dst_in_data_type);
  ...
  Status NewNodeAddEdges(ge::OutDataAnchorPtr src_anchor, ge::InDataAnchorPtr dst_anchor, ge::NodePtr first,
                         ge::NodePtr second, ge::NodePtr third);

  Status InsertVar5DTo4D(ge::OutDataAnchorPtr src_anchor, ge::InDataAnchorPtr dst_anchor, enum ge::Format srcOutFormat,
                         enum ge::DataType srcOutDatatype, enum ge::Format dstInFormat,
                         enum ge::DataType dstInDatatype);
 ...
 private:
  ...
  Status FindFmkNodeCluser(unordered_map<string, vector<ge::NodePtr>> &node_cluser_Map);

  Status MarkForFusion(unordered_map<string, vector<ge::NodePtr>> &node_cluser_Map);

  Status UpdateGraph(vector<ge::NodePtr> &nodes);

  Status InsertNode(ge::ComputeGraphPtr sub_graph, vector<ge::NodePtr> &nodes,
  ...
  Status LinkInnerAnchor(unordered_map<string, ge::NodePtr> &node_map);

  Status RebuildOutputAnchors(vector<ge::OutDataAnchorPtr> &output_anchors, ge::OpDescPtr fusion_op_desc);

  Status RebuildInputAnchors(vector<ge::InDataAnchorPtr> &input_anchors, ge::OpDescPtr fusion_op_desc);

  Status RebuildFusionNode(vector<ge::InDataAnchorPtr> &input_anchors, vector<ge::OutDataAnchorPtr> &output_anchors,
                           map<ge::OutDataAnchorPtr, vector<ge::InDataAnchorPtr>> &output_in_map,
                           vector<ge::InControlAnchorPtr> &input_control_anchors,
                           vector<ge::OutControlAnchorPtr> &output_control_anchors, ge::NodePtr fusion_node);

  Status MakeTfProtoDef();
};
}  // namespace domi
