...
// register DropOutGenMaskV3 op to GE
REGISTER_CUSTOM_OP("DropOutGenMaskV3")
    .FrameworkType(TENSORFLOW)
    .OriginOpType("DropOutGenMaskV3")
    .ParseParamsFn(AutoMappingFn)
    .ImplyType(ImplyType::AI_CPU);
...
// register MatrixSetDiagV3 op to GE
REGISTER_CUSTOM_OP("MatrixSetDiagV3")
    .FrameworkType(TENSORFLOW)
    .OriginOpType("MatrixSetDiagV3")
    .ParseParamsFn(AutoMappingFn)
    .ImplyType(ImplyType::AI_CPU);
...
// register StatelessRandomUniformV2 op to GE
REGISTER_CUSTOM_OP("StatelessRandomUniformV2")
    .FrameworkType(TENSORFLOW)
