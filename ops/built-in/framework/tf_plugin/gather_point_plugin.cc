...
Status ParseParamsGatherPoint(const Message *op_src, ge::Operator &op_dest)  {
  ...
  OP_LOGI(op_dest.GetName().c_str(), "ParseParamsGatherPoint input_size = %d", n);
...
REGISTER_CUSTOM_OP("PartitionedCall")
    ...
    .ParseParamsFn(ParseParamsGatherPoint)
