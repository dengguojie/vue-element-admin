    ...
    Status RpnProposalsParams(const std::vector<const google::protobuf::Message *> insideNodes, ge::Operator &op) {
        ...
        for (auto node : insideNodes) {
            ...
            if (node_def->op() == kScoreTthresholdOp) {
                ...
                float param = 0.0;
                if (node_def->name() == "task_0/generate_rpn_proposals/filtered_boxes" or node_def->name() == "task_1/generate_rpn_proposals/filtered_boxes" or
                node_def->name() == "task_2/generate_rpn_proposals/filtered_boxes" or node_def->name() == "task_3/generate_rpn_proposals/filtered_boxes" or
                node_def->name() == "task_4/generate_rpn_proposals/filtered_boxes" or node_def->name() == "task_5/generate_rpn_proposals/filtered_boxes" or
                node_def->name() == "task_6/generate_rpn_proposals/filtered_boxes" or node_def->name() == "task_7/generate_rpn_proposals/filtered_boxes" or
            ...
            if (node_def->op() == kKOp) {
                ...
                int param = 0;
                if (node_def->name() == "task_0/generate_rpn_proposals/Minimum" or node_def->name() == "task_1/generate_rpn_proposals/Minimum" or
                node_def->name() == "task_2/generate_rpn_proposals/Minimum" or node_def->name() == "task_3/generate_rpn_proposals/Minimum" or
                node_def->name() == "task_4/generate_rpn_proposals/Minimum" or node_def->name() == "task_5/generate_rpn_proposals/Minimum" or
                node_def->name() == "task_6/generate_rpn_proposals/Minimum" or node_def->name() == "task_7/generate_rpn_proposals/Minimum" or
            ...
            if (node_def->op() == kMinSizeOp) {
                ...
                float param = 0.0;
                if (node_def->name() == "task_0/generate_rpn_proposals/Greater" or node_def->name() == "task_1/generate_rpn_proposals/Greater" or
                node_def->name() == "task_2/generate_rpn_proposals/Greater" or node_def->name() == "task_3/generate_rpn_proposals/Greater" or
                node_def->name() == "task_4/generate_rpn_proposals/Greater" or node_def->name() == "task_5/generate_rpn_proposals/Greater" or
                node_def->name() == "task_6/generate_rpn_proposals/Greater" or node_def->name() == "task_7/generate_rpn_proposals/Greater" or
