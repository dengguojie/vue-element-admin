...
/*!
 * \file dilation2d_backprop_input_plugin.cc
 * \brief
 */
...
namespace domi {
Status ParseDilation2DBackpropInput(const Message* op_src, ge::Operator& op) {
...
// register Dilation2DBackpropInput op to GE
REGISTER_CUSTOM_OP("Dilation2DBackpropInput")
    .FrameworkType(TENSORFLOW)
    .OriginOpType("Dilation2DBackpropInput")
    .ParseParamsFn(ParseDilation2DBackpropInput)
