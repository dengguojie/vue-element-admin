...
/*!
 * \file resize_bicubic_plugin.cpp
 * \brief
 */
...
namespace domi {
Status ParseResizeBicubic(const Message* op_src, ge::Operator& op) {
...
// register ResizeBicubic op to GE
REGISTER_CUSTOM_OP("ResizeBicubic")
    .FrameworkType(TENSORFLOW)
    .OriginOpType("ResizeBicubic")
    .ParseParamsFn(ParseResizeBicubic)
