...
/*!
 * \file extract_glimpse_plugin.cpp
 * \brief
 */
...
namespace domi {
Status ParseExtractGlimpse(const Message* op_src, ge::Operator& op) {
...
// register ExtractGlimpse op to GE
REGISTER_CUSTOM_OP("ExtractGlimpse")
    .FrameworkType(TENSORFLOW)
    .OriginOpType("ExtractGlimpse")
    .ParseParamsFn(ParseExtractGlimpse)
