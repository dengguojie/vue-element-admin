...
/*!
 * \file draw_bounding_boxes_plugin.cpp
 * \brief
 */
...
namespace domi {
Status ParseDrawBoundingBoxes(const Message* op_src, ge::Operator& op) {
...
// register DrawBoundingBoxes op to GE
REGISTER_CUSTOM_OP("DrawBoundingBoxes")
    .FrameworkType(TENSORFLOW)
    .OriginOpType("DrawBoundingBoxes")
    .ParseParamsFn(ParseDrawBoundingBoxes)
