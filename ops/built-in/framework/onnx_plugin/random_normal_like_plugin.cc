...
Status ParseOpToGraphRandomNormalLike(const ge::Operator &op, ge::Graph &graph) {
  ...
  auto random_op = op::RandomStandardNormal(ori_name + "_random_standard_normal").set_input_shape(shape_op)
...
REGISTER_CUSTOM_OP("PartitionedCall")
    ...
    .OriginOpType({"ai.onnx::8::RandomNormalLike",
                   ...
                   "ai.onnx::14::RandomNormalLike",
                   "ai.onnx::15::RandomNormalLike"})
