...
std::string ScopeClipBoxesPass::PassName() { return std::string("ScopeClipBoxesPass"); }
...
void ScopeClipBoxesPass::GenScopePatterns(ScopeFusionPatterns &patterns) {
  ...
  clipBoxesPattern->AddNodeOpTypeFeature(NodeOpTypeFeature("decode_bbox_target", -1, 0));    // decode_bbox_target num is -1
