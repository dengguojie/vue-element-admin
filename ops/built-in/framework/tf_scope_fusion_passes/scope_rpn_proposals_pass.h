...
#ifndef PARSER_TENSORFLOW_SCOPE_RPN_PROPOSALS_PASS_H_
#define PARSER_TENSORFLOW_SCOPE_RPN_PROPOSALS_PASS_H_
...
namespace ge {
    ...
    #endif  // PARSER_TENSORFLOW_SCOPE_PRN_PROPOSALS_PASS_H_