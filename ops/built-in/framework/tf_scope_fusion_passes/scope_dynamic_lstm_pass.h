...
#ifndef PARSER_TENSORFLOW_SCOPE_SCOPE_DYNAMICLSTM_PASS_H_
#define PARSER_TENSORFLOW_SCOPE_SCOPE_DYNAMICLSTM_H_
...
#endif  // PARSER_TENSORFLOW_SCOPE_SCOPE_DYNAMICLSTM_H_
