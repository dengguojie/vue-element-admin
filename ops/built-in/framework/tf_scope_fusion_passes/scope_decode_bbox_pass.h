...
/*!
 * \file scope_decode_bbox_pass.h
 * \brief
 */
#ifndef OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_DECODE_BBOX_PASS_H_
#define OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_DECODE_BBOX_PASS_H_
...
/**
 * @ingroup domi_omg
 * @brief ScopeDecodeBboxPass
 */
class ScopeDecodeBboxPass : public ScopeBasePass {
 protected:
...
#endif  // OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_DECODE_BBOX_PASS_H_
