...
#ifndef OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_DYNAMIC_GRU_PASS_H_
#define OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_DYNAMIC_GRU_PASS_H_
...
namespace ge {
class ScopeDynamicGRUPass : public ScopeBasePass {
 protected:
  std::vector<ScopeFusionPatterns> DefinePatterns() override;
  std::string PassName() override;

  /**
   * @brief ScopeDynamicGRUPass multi scope
   */
...
#endif  // OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_DYNAMIC_GRU_PASS_H_
