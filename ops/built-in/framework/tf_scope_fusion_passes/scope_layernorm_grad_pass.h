...
#ifndef PARSER_TENSORFLOW_SCOPE_SCOPE_LAYERNORM_GRAD_PASS_H_
#define PARSER_TENSORFLOW_SCOPE_SCOPE_LAYERNORM_GRAD_PASS_H_
...
class ScopeLayerNormGradPass : public ScopeBasePass {
 ...
 private:
  std::vector<ge::OperatorPtr> FindOutNodesShouldInScope(const Scope *scope,
...
#endif  // PARSER_TENSORFLOW_SCOPE_SCOPE_LAYERNORM_GRAD_PASS_H_
