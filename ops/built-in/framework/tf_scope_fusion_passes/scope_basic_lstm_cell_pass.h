...
/*!
 * \file scope_basic_lstm_cell_pass.h
 * \brief
 */
#ifndef OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_BASIC_LSTM_CELL_PASS_H_
#define OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_BASIC_LSTM_CELL_PASS_H_
...
namespace ge {
class ScopeBasicLSTMCellPass : public ScopeBasePass {
 protected:
...
#endif  // OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_BASIC_LSTM_CELL_PASS_H_
