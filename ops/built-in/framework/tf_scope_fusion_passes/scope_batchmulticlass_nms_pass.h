...
#ifndef PARSER_TENSORFLOW_SCOPE_SCOPE__BATCHMULTICLASSNMS_PASS_H_
#define PARSER_TENSORFLOW_SCOPE_SCOPE_BATCHMULTICLASSNMS_PASS_H_
...
#endif  // PARSER_TENSORFLOW_SCOPE_SCOPE_BATCHMULTICLASSNMS_PASS_H_
