...
/*!
 * \file scope_roi_align_pass.h
 * \brief
 */
#ifndef OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_ROI_ALIGN_PASS_H_
#define OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_ROI_ALIGN_PASS_H_
...
namespace ge {
class ScopeROIAlignPass : public ScopeBasePass {
 protected:
...
#endif  // OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_ROI_ALIGN_PASS_H_
