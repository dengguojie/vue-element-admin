...
std::string ScopeROIAlignPass::PassName() { return std::string("ScopeROIAlignPass"); }
...
void ScopeROIAlignPass::GenScopePatterns(ScopeFusionPatterns &patterns)
{
    ...
    roiAlignPattern->AddNodeOpTypeFeature(
        NodeOpTypeFeature("AvgPool", 1, 0));
    roiAlignPattern->AddNodeOpTypeFeature(
        NodeOpTypeFeature("Merge", -1, 0));
    roiAlignPattern->AddNodeOpTypeFeature(
        NodeOpTypeFeature("CropAndResize", 1, 0));
