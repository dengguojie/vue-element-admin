...
const char *const kScopeTypeSSDBatchMultiClassNonMaxSuppression = "BatchSSDhMultiClassNonMaxSuppression";
 ...
 */
Status ScopeBatchMultiClassNonMaxSuppressionPass::LastMatchScopesAndOPs(std::shared_ptr<ScopeGraph> &scope_graph, std::vector<ScopesResult> &results) {
  ...
  for (auto &scope : scopes) {
    ...
    if (scope->SubType() == kScopeTypeSSDBatchMultiClassNonMaxSuppression ){
        OP_LOGI(kOpType, "SSDBatchMultiClassNonMaxSuppression LastMatchScopesAndOPs match SubType.");
        ScopesResult result;
        std::vector<Scope *> result_scopes;
        result_scopes.push_back(scope);
        result.SetScopes(result_scopes);
...
void ScopeBatchMultiClassNonMaxSuppressionPass::GenScopePatterns(ScopeFusionPatterns &patterns) {
  ...
  ScopePattern *ScopeSSDBatchMultiClassNMSPattern = new (std::nothrow) ScopePattern();
  if (ScopeSSDBatchMultiClassNMSPattern == nullptr) {
    OP_LOGE(kOpType, "Alloc an object failed.");
    return;
  }
  ScopeSSDBatchMultiClassNMSPattern->SetSubType(kScopeTypeSSDBatchMultiClassNonMaxSuppression);
  ScopeSSDBatchMultiClassNMSPattern->AddNodeOpTypeFeature(NodeOpTypeFeature("NonMaxSuppressionV3", 0, 1));
  ScopeSSDBatchMultiClassNMSPattern->AddNodeOpTypeFeature(NodeOpTypeFeature("Transpose", -1, 0));
  OP_LOGI(kOpType, "Add GenScopePatterns ScopeSSDBatchMultiClassNMSPattern.");
  batch1.push_back(ScopeSSDBatchMultiClassNMSPattern);
...
void ScopeBatchMultiClassNonMaxSuppressionPass::GenerateFusionResult(const std::vector<Scope *> &scopes, FusionScopesResult *fusion_rlt) {
  ...
  for (auto &scope : scopes) {
    ...
    if (scope->SubType() == kScopeTypeSecondBatchMultiClassNonMaxSuppression) {
      fusion_rlt->InsertInputs("SecondStagePostprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayUnstack/Shape", {0});    
      fusion_rlt->InsertInputs("SecondStagePostprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayUnstack_1/Shape", {1});    
      fusion_rlt->InsertInputs("SecondStagePostprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayUnstack_4/Shape", {3});
      fusion_rlt->InsertInputs("SecondStagePostprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayUnstack_3/Shape", {2});
      fusion_rlt->InsertOutputs("SecondStagePostprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayStack/TensorArrayGatherV3", {0}); 
      fusion_rlt->InsertOutputs("SecondStagePostprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayStack_1/TensorArrayGatherV3", {1});
      fusion_rlt->InsertOutputs("SecondStagePostprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayStack_2/TensorArrayGatherV3", {2});
      fusion_rlt->InsertOutputs("SecondStagePostprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayStack_4/TensorArrayGatherV3", {3}); 
      fusion_rlt->SetType(kScopeType);
      fusion_rlt->SetDescription("");
      std::string scope_name = scope->Name();
      fusion_rlt->SetName(scope_name.substr(0, scope_name.length() - 1));
    ...
    if (scope->SubType() == kScopeTypeSSDBatchMultiClassNonMaxSuppression) {
      fusion_rlt->InsertInputs("Postprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayUnstack/Shape", {0});    
      fusion_rlt->InsertInputs("Postprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayUnstack_1/Shape", {1});    
      fusion_rlt->InsertInputs("Postprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayUnstack_3/Shape", {2});
      fusion_rlt->InsertOutputs("Postprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayStack/TensorArrayGatherV3", {0}); 
      fusion_rlt->InsertOutputs("Postprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayStack_1/TensorArrayGatherV3", {1});
      fusion_rlt->InsertOutputs("Postprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayStack_2/TensorArrayGatherV3", {2});
      fusion_rlt->InsertOutputs("Postprocessor/BatchMultiClassNonMaxSuppression/map/TensorArrayStack_4/TensorArrayGatherV3", {3}); 
      fusion_rlt->SetType(kScopeType);
      fusion_rlt->SetDescription("");
      std::string scope_name = scope->Name();
      fusion_rlt->SetName(scope_name.substr(0, scope_name.length() - 1));
