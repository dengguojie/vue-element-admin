...
/*!
 * \file scope_fastrcnn_predictions_pass.h
 * \brief
 */
#ifndef OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_FASTRCNN_PREDICTIONS_PASS_H_
#define OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_FASTRCNN_PREDICTIONS_PASS_H_
...
/**
 * @ingroup domi_omg
 * @brief ScopeFastrcnnPredictionsPass
 */
class ScopeFastrcnnPredictionsPass : public ScopeBasePass {
 protected:
