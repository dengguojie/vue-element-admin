...
/*!
 * \file scope_instancenorm_grad_pass.h
 * \brief
 */
#ifndef OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_INSTANCENORM_GRAD_PASS_H_
#define OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_INSTANCENORM_GRAD_PASS_H_
...
/**
 * @ingroup domi_omg
 * @brief ScopeInstanceNormGradPass
 */
class ScopeInstanceNormGradPass : public ScopeBasePass {
 protected:
...
#endif  // OPS_BUILT_IN_FRAMEWORK_TF_SCOPE_FUSION_PASSES_SCOPE_INSTANCENORM_GRAD_PASS_H_
