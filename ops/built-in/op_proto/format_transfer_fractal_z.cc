...
/*!
 * \file format_transfer_fractal_z.cpp
 * \brief
 */
...
namespace formats {
namespace {
Status CheckDataTypeSupport(DataType data_type) {
  return GetSizeByDataType(data_type) > 0 ? SUCCESS : FAILED;
}
...
Status FormatTransferFractalZ_TBE::TransShape(Format src_format, const std::vector<int64_t>& src_shape,
