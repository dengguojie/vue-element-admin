                    ...
                    const std::string &correct_shape)
{
  ...
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_INPUT_SHAPE);
  (void)ErrorManager::GetInstance().ReportErrMessage(report_error_code,
                                                     err_map);
}
                        ...
                        const std::string &correct_value)
{
  ...
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_ATTR_VALUE);
  (void)ErrorManager::GetInstance().ReportErrMessage(report_error_code,
                                                     err_map);
}
                       ...
                       const std::string &correct_size)
{
  ...
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_ATTR_SIZE);
                       ...
                       const std::string &param_name)
{
  ...
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_MISS_INPUT);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                       ...
                       const std::string &param_name)
{
  ...
  err_map["param_name"] = param_name;
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_GET_ATTR);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                       ...
                       const std::string &param_name)
{
  ...
  err_map["param_name"] = param_name;
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_SET_ATTR);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                       ...
                       const std::string &input_value)
{
  ...
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_OPS_ATTR_VALUE);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                       ...
                       const std::string &param_name)
{
  ...
  err_map["param_name"] = param_name;
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::FAILED_UPDATE_OP);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                       ...
                       const std::string &param_value)
{
  ...
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_SHAPE);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                          ...
                          const std::string &error_detail)
{
  ...
  err_map["error_detail"] = error_detail;
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_TWO_INPUT_SHAPE);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                          ...
                          const std::string &error_detail)
{
  ...
  err_map["error_detail"] = error_detail;
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_ONE_OUTPUT_SHAPE);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                           ...
                           const std::string &param_name)
{
  ...
  err_map["param_name"] = param_name;
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::FAILED_GET_COMPILIE_PARAMS);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                       ...
                       const std::string &real_value)
{
  ...
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_SHAPE_SIZE);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                       ...
                       const std::string &real_value)
{
  ...
  err_map["real_value"] = real_value;
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_SHAPE_DIM);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                      ...
                      const std::string &input2_shape)
{
  ...
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_BROADCAST_SHAPE);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                     ...
                     const std::string &input2_dtype)
{
    ...
    std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_TWO_INPUT_DTYPE);
    ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
                       ...
                       const std::string &data_W)
{
  ...
  std::string report_error_code =
    GetViewErrorCodeStr(ViewErrorCode::INVALID_AIPP_ERROR);
  ErrorManager::GetInstance().ReportErrMessage(report_error_code, err_map);
}
