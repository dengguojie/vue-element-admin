...
*/
REG_OP(CTCLossV2)
    .INPUT(log_probs, TensorType({DT_FLOAT16, DT_FLOAT, DT_DOUBLE}))
    .INPUT(targets, TensorType({DT_INT32}))
    .INPUT(input_lengths, TensorType({DT_INT32}))
    .INPUT(target_lengths, TensorType({DT_INT32}))
    .OUTPUT(neg_log_likelihood, TensorType({DT_FLOAT16, DT_FLOAT, DT_DOUBLE}))
    .OUTPUT(log_alpha, TensorType({DT_FLOAT16, DT_FLOAT, DT_DOUBLE}))
    .ATTR(blank, Int, 0)
