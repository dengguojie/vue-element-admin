...
IMPLEMT_VERIFIER(ApplyAdaMax, ApplyAdaMaxVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdaMax proto verifyFunction!");
...
IMPLEMT_COMMON_INFERFUNC(ApplyAdaMaxInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdaMax op_proto inferfunction!");
...
IMPLEMT_VERIFIER(ApplyAdaMaxD, ApplyAdaMaxDVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdaMaxD proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("m");
  inputTensorList.push_back("v");
...
IMPLEMT_VERIFIER(ApplyAdagrad, ApplyAdagradVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdagrad proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
...
IMPLEMT_COMMON_INFERFUNC(ApplyAdagradInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdagrad op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(ApplyAdagradD, ApplyAdagradDVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdagradD proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("accum");
  inputTensorList.push_back("grad");
...
IMPLEMT_COMMON_INFERFUNC(ApplyAdagradDInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyCenteredRMSPropD op_proto inferfunction!");
...
IMPLEMT_VERIFIER(ApplyAdagradV2, ApplyAdagradV2Verify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdagradV2 proto verifyFunction!");
...
IMPLEMT_COMMON_INFERFUNC(ApplyAdagradV2InferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdagradV2 op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(ApplyAdagradV2D, ApplyAdagradV2DVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdagradV2D proto verifyFunction!");
  const std::vector<std::string> kInputTensorList{"var", "accum", "grad"};
...
IMPLEMT_VERIFIER(ApplyAdagradDA, ApplyAdagradDAVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdagradDA proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
...
IMPLEMT_COMMON_INFERFUNC(ApplyAdagradDAInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdagradDA op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(ApplyAdagradDAD, ApplyAdagradDADVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdagradDAD proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("gradient_accumulator");
  inputTensorList.push_back("gradient_squared_accumulator");
...
IMPLEMT_VERIFIER(ApplyAddSign, ApplyAddSignVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAddSign proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("m");
  inputTensorList.push_back("grad");
...
IMPLEMT_COMMON_INFERFUNC(ApplyAddSignInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAddSign op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(ApplyAddSignD, ApplyAddSignDVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAddSignD proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("m");
  inputTensorList.push_back("grad");
...
IMPLEMT_COMMON_INFERFUNC(ApplyAddSignDInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAddSignD op_proto inferfunction!");
  if (!OneInOneOutDynamicInfer(op, "var", {"var"})) {
    return GRAPH_FAILED;
  }
...
IMPLEMT_VERIFIER(ApplyCenteredRMSProp, ApplyCenteredRMSPropVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyCenteredRMSProp proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
...
IMPLEMT_COMMON_INFERFUNC(ApplyCenteredRMSPropInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyCenteredRMSProp op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(ApplyCenteredRMSPropD, ApplyCenteredRMSPropDVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyCenteredRMSPropD proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("mg");
  inputTensorList.push_back("ms");
...
IMPLEMT_VERIFIER(ApplyGradientDescent, ApplyGradientDescentVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyGradientDescent proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
...
IMPLEMT_COMMON_INFERFUNC(ApplyGradientDescentInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyGradientDescent op_proto inferfunction!");
  if (!OneInOneOutDynamicInfer(op, "var", {"var"})) {
    return GRAPH_FAILED;
  }
  return GRAPH_SUCCESS;
...
IMPLEMT_VERIFIER(ApplyMomentum, ApplyMomentumVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyMomentum proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("accum");
  inputTensorList.push_back("grad");
...
IMPLEMT_COMMON_INFERFUNC(ApplyMomentumInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyMomentum op_proto inferfunction!");
...
IMPLEMT_VERIFIER(ApplyMomentumD, ApplyMomentumDVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyMomentumD proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("accum");
  inputTensorList.push_back("grad");
...
IMPLEMT_COMMON_INFERFUNC(ApplyMomentumDInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyMomentumD op_proto inferfunction!");
...
IMPLEMT_VERIFIER(ApplyKerasMomentum, ApplyKerasMomentumVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyKerasMomentum proto verifyFunction!");
  const std::vector<std::string> kInputTensorList{"var", "accum", "grad"};
...
IMPLEMT_COMMON_INFERFUNC(ApplyKerasMomentumInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyKerasMomentum op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(ApplyPowerSign, ApplyPowerSignVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyPowerSign proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("m");
  inputTensorList.push_back("grad");
...
IMPLEMT_COMMON_INFERFUNC(ApplyPowerSignInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyPowerSign op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(ApplyPowerSignD, ApplyPowerSignDVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyPowerSignD proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("m");
  inputTensorList.push_back("grad");
...
IMPLEMT_COMMON_INFERFUNC(ApplyPowerSignDInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyPowerSignD op_proto inferfunction!");
  if (!OneInOneOutDynamicInfer(op, "var", {"var"})) {
    return GRAPH_FAILED;
  }
  if (!OneInOneOutDynamicInfer(op, "m", {"m"})) {
...
IMPLEMT_VERIFIER(ApplyProximalGradientDescent, ApplyProximalGradientDescentVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyProximalGradientDescent proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("delta");
  std::vector<std::string> inputScalarList;
...
IMPLEMT_COMMON_INFERFUNC(ApplyProximalGradientDescentInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyProximalGradientDescent op_proto inferfunction!");
  if (OneInOneOutDynamicInfer(op, "var", {"var"})) {
    return GRAPH_SUCCESS;
  }
  return GRAPH_SUCCESS;
...
IMPLEMT_VERIFIER(DataFormatDimMap, DataFormatDimMapVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "the op begin verify");
  ...
  OP_LOGI(TbeGetName(op).c_str(), "the op verify success");
  return GRAPH_SUCCESS;
}
VERIFY_FUNC_REG(DataFormatDimMap, DataFormatDimMapVerify);

IMPLEMT_COMMON_INFERFUNC(DataFormatDimMapInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter DataFormatDimMapInferShape");
...
IMPLEMT_VERIFIER(ApplyProximalAdagrad, ApplyProximalAdagradVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyProximalAdagrad proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("accum");
  inputTensorList.push_back("grad");
...
IMPLEMT_COMMON_INFERFUNC(ApplyProximalAdagradInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyProximalAdagrad op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(ApplyProximalAdagradD, ApplyProximalAdagradDVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyProximalAdagradD proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("accum");
  inputTensorList.push_back("grad");
...
IMPLEMT_COMMON_INFERFUNC(ApplyProximalAdagradDInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyProximalAdagradD op_proto inferfunction!");
  if (OneInOneOutDynamicInfer(op, "var", {"var"})) {
    if (OneInOneOutDynamicInfer(op, "accum", {"accum"})) {
    return GRAPH_SUCCESS;
    }
...
IMPLEMT_VERIFIER(ApplyFtrl, ApplyFtrlVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyFtrl proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("accum");
...
IMPLEMT_COMMON_INFERFUNC(ApplyFtrlInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyFtrl op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(ApplyFtrlD, ApplyFtrlDVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyFtrlD proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("accum");
  inputTensorList.push_back("linear");
...
IMPLEMT_COMMON_INFERFUNC(ApplyFtrlDInferShape) {
    OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyFtrlD op_proto inferfunction!");
    if (!OneInOneOutDynamicInfer(op, "var", {"var"})) {
        return GRAPH_FAILED;
    }
    if (!OneInOneOutDynamicInfer(op, "accum", {"accum"})) {
...
IMPLEMT_VERIFIER(ApplyFtrlV2, ApplyFtrlV2Verify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyFtrlV2 proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("accum");
  inputTensorList.push_back("linear");
...
IMPLEMT_COMMON_INFERFUNC(ApplyFtrlV2InferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyFtrlV2 op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(ApplyFtrlV2D, ApplyFtrlV2DVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyFtrlV2D proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("accum");
  inputTensorList.push_back("linear");
...
IMPLEMT_COMMON_INFERFUNC(ApplyFtrlV2DInferShape) {
    OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyFtrlV2D op_proto inferfunction!");
    if (!OneInOneOutDynamicInfer(op, "var", {"var"})) {
        return GRAPH_FAILED;
    }
    if (!OneInOneOutDynamicInfer(op, "accum", {"accum"})) {
...
IMPLEMT_VERIFIER(ApplyAdadelta, ApplyAdadeltaVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdadelta proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("accum");
...
IMPLEMT_COMMON_INFERFUNC(ApplyAdadeltaInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdadelta op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(ApplyAdadeltaD, ApplyAdadeltaDVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdadeltaD proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("accum");
  inputTensorList.push_back("accum_update");
...
IMPLEMT_COMMON_INFERFUNC(ApplyAdadeltaDInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdadeltaD op_proto inferfunction!");
  if (!OneInOneOutDynamicInfer(op, "var", {"var"})) {
    return GRAPH_FAILED;
  }
  if (!OneInOneOutDynamicInfer(op, "accum", {"accum"})) {
...
IMPLEMT_INFERFORMAT_FUNC(ApplyAdam, ApplyAdamInferFormat) {
  OP_LOGD(TbeGetName(op).c_str(), "Enter ApplyAdam op_proto infer format function!");
  ...
  for (size_t i = 0; i < inputs.size(); i++) {
    if (ApplyAdamSetNd(op, inputs[i]) != true) {
      OP_LOGE(TbeGetName(op).c_str(), "ApplyAdam's scalar input failed to set ND format.");
      return GRAPH_FAILED;
    }
  }
...
IMPLEMT_VERIFIER(ApplyAdam, ApplyAdamVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdam proto verifyFunction!");
  std::vector<std::string> inputTensorList;
  inputTensorList.push_back("var");
  inputTensorList.push_back("m");
  inputTensorList.push_back("v");
...
IMPLEMT_COMMON_INFERFUNC(ApplyAdamInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdam op_proto inferfunction!");
  if (OneInOneOutDynamicInfer(op, "var", {"var"})) {
    return GRAPH_SUCCESS;
  }
  return GRAPH_FAILED;
...
IMPLEMT_COMMON_INFERFUNC(ApplyAdamDInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdamD op_proto inferfunction!");
  if (!OneInOneOutDynamicInfer(op, "var", {"var"})) {
    return GRAPH_FAILED;
  }
  if (!OneInOneOutDynamicInfer(op, "m", {"m"})) {
...
IMPLEMT_VERIFIER(ApplyRMSProp, ApplyRMSPropVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyRMSProp proto verifyFunction!");
...
IMPLEMT_COMMON_INFERFUNC(ApplyRMSPropInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyRMSProp op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(ApplyRMSPropD, ApplyRMSPropDVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyRMSPropD proto verifyFunction!");
...
IMPLEMT_COMMON_INFERFUNC(ApplyRMSPropDInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyRMSPropD proto inferfunction!");
  if (OneInOneOutDynamicInfer(op, "var", {"var"})) {
    if (OneInOneOutDynamicInfer(op, "ms", {"ms"})) {
      if (OneInOneOutDynamicInfer(op, "mom", {"mom"})) {
        return GRAPH_SUCCESS;
...
IMPLEMT_VERIFIER(SparseApplyRMSProp, SparseApplyRMSPropVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter SparseApplyRMSProp verifyFunction!");
  ...
  for (unsigned int dim_index = 1; dim_index < var_dims.size(); dim_index++) {
    if (var_dims[dim_index] != grad_dims[dim_index]) {
      OP_LOGE(TbeGetName(op).c_str(), "Input var and grad must match in dimension (%u)", dim_index);
      return GRAPH_FAILED;
    }
  }
  return GRAPH_SUCCESS;
...
IMPLEMT_COMMON_INFERFUNC(SparseApplyRMSPropInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter SparseApplyRMSProp inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(SparseApplyRMSPropD, SparseApplyRMSPropDVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter SparseApplyRMSPropD verifyFunction!");
...
IMPLEMT_VERIFIER(SparseApplyAdadelta, SparseApplyAdadeltaVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter SparseApplyAdadelta verifyFunction!");
...
IMPLEMT_COMMON_INFERFUNC(SparseApplyAdadeltaInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter SparseApplyAdadelta inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
...
IMPLEMT_VERIFIER(SparseApplyAdadeltaD, SparseApplyAdadeltaDVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter SparseApplyAdadeltaD verifyFunction!");
...
IMPLEMT_COMMON_INFERFUNC(SparseApplyAdadeltaDInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter SparseApplyAdadeltaD inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  ApplyInferShapeAndDtype(op, "accum", "accum");
...
IMPLEMT_COMMON_INFERFUNC(FusedMulApplyMomentumInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter FusedMulApplyMomentum op_proto inferfunction!");
  if (!TwoInOneOutDynamicInferNoBroadcast(op, "var", "accum", {"var", "accum"})) {
    return GRAPH_FAILED;
  }
  return GRAPH_SUCCESS;
...
IMPLEMT_COMMON_INFERFUNC(FusedMulApplyMomentumExternInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter FusedMulApplyMomentumExtern op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
...
IMPLEMT_COMMON_INFERFUNC(FusedMulApplyKerasMomentumInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter FusedMulApplyKerasMomentum op_proto inferfunction!");
  if (!TwoInOneOutDynamicInferNoBroadcast(op, "var", "accum", {"var", "accum"})) {
    return GRAPH_FAILED;
  }
  return GRAPH_SUCCESS;
...
IMPLEMT_VERIFIER(ApplyAdamWithAmsgrad, ApplyAdamWithAmsgradVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdamWithAmsgrad proto verifyFunction!");
...
IMPLEMT_COMMON_INFERFUNC(ApplyAdamWithAmsgradInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter ApplyAdamWithAmsgrad op_proto inferfunction!");
  ApplyInferShapeAndDtype(op, "var", "var");
  return GRAPH_SUCCESS;
}
