...
IMPLEMT_INFERFUNC(TridiagonalSolve, TridiagonalSolveInfer) {
  ...
  if (lhs_dim != 3) {
    OP_LOGE(op.GetName().c_str(), "The value of lhs_dim must be 3.");
    return GRAPH_FAILED;
  }
