...
IMPLEMT_COMMON_INFER_DATA_SLICE(ElewiseTwoInputInferDataSlice) {
  ...
  if (x1_format == x2_format) {
    ...
    if ((x1_format == FORMAT_NC1HWC0 && x2_format == FORMAT_ND) ||
        (x1_format == FORMAT_ND && x2_format == FORMAT_NC1HWC0)) {
      // 5HD+ND
    ...
    } else if ((x1_format == FORMAT_FRACTAL_NZ && x2_format == FORMAT_ND) ||
               (x1_format == FORMAT_ND && x2_format == FORMAT_FRACTAL_NZ)) {
      // NZ+ND
    ...
    } else if ((x1_format == FORMAT_FRACTAL_Z && x2_format == FORMAT_ND) ||
               (x1_format == FORMAT_ND && x2_format == FORMAT_FRACTAL_Z)) {
      // F_Z+ND
