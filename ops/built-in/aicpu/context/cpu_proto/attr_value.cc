 ...
 */
std::string AttrValue::GetString() const
{
 ...
 */
int32_t AttrValue::ListStringSize() const
{
    return impl_->ListStringSize();
}
 ...
 */
void AttrValue::SetString(const std::string &byte)
{
    impl_->SetString(byte);
}
 ...
 */
void AttrValue::AddListInt(int64_t i)
{
    impl_->AddListInt(i);
}
 ...
 */
int32_t AttrValue::ListIntSize() const
{
    return impl_->ListIntSize();
}

/*
 * set int value to attr.
 */
void AttrValue::SetInt(int64_t i)
{
    impl_->SetInt(i);
}
 ...
 */
void AttrValue::AddListFloat(float f)
{
    impl_->AddListFloat(f);
}

/*
 * set float value to attr.
 */
void AttrValue::SetFloat(float f)
{
    impl_->SetFloat(f);
}
 ...
 */
int32_t AttrValue::ListFloatSize() const
{
    return impl_->ListFloatSize();
}
 ...
 */
void AttrValue::AddListBool(bool b)
{
    impl_->AddListBool(b);
}
 ...
 */
int32_t AttrValue::ListBoolSize() const
{
    return impl_->ListBoolSize();
}

/*
 * set bool value to attr.
 */
void AttrValue::SetBool(bool b)
{
    impl_->SetBool(b);
}
 ...
 */
DataType AttrValue::GetDataType() const
{
 ...
 */
void AttrValue::AddListDataType(DataType type)
{
    impl_->AddListDataType(type);
}
 ...
 */
void AttrValue::SetDataType(DataType type)
{
 ...
 */
int32_t AttrValue::ListTensorSize() const
{
    return impl_->ListTensorSize();
}
} // namespace aicpu
