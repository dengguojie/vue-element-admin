...
#ifndef AICPU_KERNELS_NORMALIZED_RIGHTSHIFT_H_
#define AICPU_KERNELS_NORMALIZED_RIGHTSHIFT_H_
...
class RightShiftCpuKernel : public CpuKernel {
 ...
 private:
  static uint32_t RightShiftParamCheck(CpuKernelContext &ctx);
  ...
  template <typename T>
  uint32_t RightShiftCompute(CpuKernelContext &ctx);
};
}  // namespace aicpu
#endif