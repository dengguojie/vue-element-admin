...
private:
  static uint32_t BandParamCheck(Tensor *x, Tensor *num_lower,
                                 Tensor *num_upper, Tensor *y);

  template <typename T>
  static uint32_t BandCompute(Tensor *x, int64_t lower, int64_t upper,
                              Tensor *y, int64_t rows, int64_t cols,
