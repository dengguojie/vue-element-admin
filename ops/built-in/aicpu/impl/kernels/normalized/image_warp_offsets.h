...
#ifndef AICPU_KERNELS_NORMALIZED_IMAGE_WARP_OFFSET_H_
#define AICPU_KERNELS_NORMALIZED_IMAGE_WARP_OFFSET_H_
...
class ImageWarpOffsetsCpuKernel : public CpuKernel {
 ...
 private:
  ...
  uint32_t CheckParam(CpuKernelContext &ctx, const std::string &in_or_out,
