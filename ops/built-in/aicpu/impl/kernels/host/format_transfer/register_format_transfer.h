 ...
 */
#ifndef AICPU_KERNELS_HOST_FORMAT_TRANSFER_REGISTER_FORMAT_TRANSFER_H_
#define AICPU_KERNELS_HOST_FORMAT_TRANSFER_REGISTER_FORMAT_TRANSFER_H_
...
#define REGISTER_FORMAT_TRANSFER(TransferClass, format1, format2)      \
  namespace {                                                          \
  FormatTransferRegister                                               \
      format_transfer_register_##TransferClass##format1##format2(      \
          []() { return std::make_shared<TransferClass>(); }, format1, \
          format2);                                                    \
  }
