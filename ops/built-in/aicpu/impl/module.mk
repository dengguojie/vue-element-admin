...
LOCAL_CFLAGS += -fstack-protector-all -D_FORTIFY_SOURCE=2 -Dgoogle=ascend_private -O2 -ftrapv -std=c++14 -fvisibility-inlines-hidden -fvisibility=hidden -DEIGEN_NO_DEBUG -DEIGEN_MPL2_ONLY -DNDEBUG -DEIGEN_HAS_CXX11_MATH -DEIGEN_OS_GNULINUX
