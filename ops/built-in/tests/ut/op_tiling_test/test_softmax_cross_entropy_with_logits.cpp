...
// no known no multi-core case
TEST_F(SoftmaxCrossEntropyWithLogitsTiling, SoftmaxCrossEntropyWithLogits_tiling_test_36) {
  std::string op_name = "SoftmaxCrossEntropyWithLogits";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find(op_name);
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  std::string compileInfo = R"({
    "_align_base_key":10000,
    "_available_size":12640,
    "_core_num":32,
    "_custom_vars":{
        "1":[
          "dim_0_0",
  ...
  std::vector<ge::DataType> input_types{ge::DT_FLOAT, ge::DT_FLOAT16};
  std::vector<ge::DataType> output_types{ge::DT_FLOAT, ge::DT_FLOAT16};
  ge::Format data_format = ge::FORMAT_ND;
