...
TEST_F(Conv2DBackpropInputTiling, Conv2d_bp_input_dynamic_None) {
  ...
  std::string compileInfo = R"({"_pattern": "Conv2d_backprop_input", "tiling_type": "default_tiling", "default_range": {"10000": [1, null, 16, 16, 16, 16]}, "block_dim": {"10000": 1}, "_vars": {"10000": ["batch_n"]}})";
