...
TEST_F(Conv2DTiling, Conv2d_tiling_dynamic_nhw) {
  ...
  std::string compileInfo = R"({"_pattern": "Convolution", "repo_seeds": {}, "repo_range": {}, "cost_range": {"10000": [1, 10, 10, 25, 10, 25]}, "block_dim": {"10000": 2}, "_vars": {"10000": ["batch_n", "fmap_h", "ho", "fmap_w", "wo"]}})";
