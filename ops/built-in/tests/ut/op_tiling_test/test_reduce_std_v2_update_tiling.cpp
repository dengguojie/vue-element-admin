...
class ReduceStdV2UpdateTiling : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "ReduceStdV2UpdateTiling SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "ReduceStdV2UpdateTiling TearDown" << std::endl;
  }
};
...
TEST_F(ReduceStdV2UpdateTiling, ReduceStdV2UpdateTiling1) {
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ReduceStdV2Update");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  auto opParas = op::ReduceStdV2Update("ReduceStdV2Update");
...
TEST_F(ReduceStdV2UpdateTiling, ReduceStdV2UpdateTiling2) {
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ReduceStdV2Update");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  auto opParas = op::ReduceStdV2Update("ReduceStdV2Update");
...
TEST_F(ReduceStdV2UpdateTiling, ReduceStdV2UpdateTiling3) {
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ReduceStdV2Update");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  auto opParas = op::ReduceStdV2Update("ReduceStdV2Update");
...
TEST_F(ReduceStdV2UpdateTiling, ReduceStdV2UpdateTiling4) {
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ReduceStdV2Update");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  auto opParas = op::ReduceStdV2Update("ReduceStdV2Update");
