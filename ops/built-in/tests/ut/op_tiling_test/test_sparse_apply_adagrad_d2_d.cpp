...
TEST_F(SparseApplyAdagradV2DTiling, sparseapplyadagrad_tiling_0) {
  using namespace optiling;
  string op_name = "SparseApplyAdagrad";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("SparseApplyAdagrad");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  ...
  vector<int64_t> input1{12, 4, 16, 32};
  vector<int64_t> input2{12, 4, 16, 32};
  vector<int64_t> input3{1,};
  vector<int64_t> input4{12, 4, 16, 32};
...
TEST_F(SparseApplyAdagradV2DTiling, sparseapplyadagrad_tiling_1) {
  using namespace optiling;
  string op_name = "SparseApplyAdagrad";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("SparseApplyAdagrad");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  ...
  vector<int64_t> input1{64, 4};
  vector<int64_t> input2{64, 4};
  vector<int64_t> input3{1,};
  vector<int64_t> input4{12, 4};
  vector<int64_t> input5{12,};
  vector<int64_t> output1{64, 4};
  vector<int64_t> output2{64, 4};
  ...
  EXPECT_EQ(to_string(runInfo.tiling_data), "64 12 4 2 32 0 0 ");
}

TEST_F(SparseApplyAdagradV2DTiling, sparseapplyadagrad_tiling_2) {
  using namespace optiling;
  string op_name = "SparseApplyAdagrad";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("SparseApplyAdagrad");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());

  string compileInfo = "{\"vars\": {\"core_num\": 0, \"ub_size\": 131072, \"indices_dsize\": 4, \"ub_take_parts\": 1, \"ub_block_num\":4, \"cache_threshold_col\":0}}";
...
TEST_F(SparseApplyAdagradV2DTiling, sparseapplyadagrad_tiling_3) {
  using namespace optiling;
  string op_name = "SparseApplyAdagrad";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("SparseApplyAdagrad");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  ...
  vector<int64_t> input1{1056, 4};
  vector<int64_t> input2{1056, 4};
  vector<int64_t> input3{1,};
  vector<int64_t> input4{12, 4};
  vector<int64_t> input5{12,};
  vector<int64_t> output1{1056, 4};
  vector<int64_t> output2{1056, 4};
  ...
  EXPECT_EQ(to_string(runInfo.tiling_data), "1056 12 4 32 32 0 0 ");
}