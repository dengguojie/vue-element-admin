...
TEST_F(LayerNormXBackpropV2Tiling, LayerNormXBackpropV2_tiling_test_1) {
  ...
  // optiling::LayerNormXBackpropV2CompileInfo info;
  // int32_t tiling_len = 6*4;
  // // prepare compile info from json string to compile struct members
  // TILING_PARSE_JSON_TO_COMPILEINFO("LayerNormXBackpropV2", compileInfo, info);
  // ATTACH_OPERATOR_TO_HOLDER(holder, opParas, tiling_len, info);
  // HOLDER_DO_TILING(holder, "LayerNormXBackpropV2", ge::GRAPH_SUCCESS);
  // TILING_DATA_VERIFY_BYTYPE(holder, int64_t, "14880 456 465 19 990885924 999274532 ");
}
...
TEST_F(LayerNormXBackpropV2Tiling, LayerNormXBackpropV2_tiling_test_2) {
  ...
  TENSOR_INPUT_WITH_SHAPE(opParas, dy, input_shapes[0], dtypes[0], ge::FORMAT_FRACTAL_NZ, {});
  TENSOR_INPUT_WITH_SHAPE(opParas, x, input_shapes[1], dtypes[1], ge::FORMAT_FRACTAL_NZ, {});
  TENSOR_INPUT_WITH_SHAPE(opParas, variance, input_shapes[2], dtypes[2], ge::FORMAT_ND, {});
  TENSOR_INPUT_WITH_SHAPE(opParas, mean, input_shapes[3], dtypes[3], ge::FORMAT_ND, {});
  TENSOR_INPUT_WITH_SHAPE(opParas, gamma, input_shapes[4], dtypes[4], ge::FORMAT_ND, {});

  vector<vector<int64_t>> output_shapes = {{64, 1824, 16}, {64, 1824, 16}};
  TENSOR_OUTPUT_WITH_SHAPE(opParas, pd_x, output_shapes[0], dtypes[0], ge::FORMAT_ND, {});
  TENSOR_OUTPUT_WITH_SHAPE(opParas, res_for_gamma, output_shapes[1], ge::DT_FLOAT, ge::FORMAT_ND, {});
  ...
  // optiling::LayerNormXBackpropV2CompileInfo info;
  // int32_t tiling_len = 7*8;
  // prepare compile info from json string to compile struct members
  // TILING_PARSE_JSON_TO_COMPILEINFO("LayerNormXBackpropV2", compileInfo, info);
  // ATTACH_OPERATOR_TO_HOLDER(holder, opParas, tiling_len, info);
  // HOLDER_DO_TILING(holder, "LayerNormXBackpropV2", ge::GRAPH_SUCCESS);
  // TILING_DATA_VERIFY_BYTYPE(holder, int64_t, "64 1824 16 57 10 981467136 989855744 ");
}
...
TEST_F(LayerNormXBackpropV2Tiling, LayerNormXBackpropV2_tiling_test_runtime_1) {
  std::string op_name = "LayerNormXBackpropV2";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find(op_name);
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  ...
  vector<vector<int64_t>> inputs = {{30, 496, 456}, {30, 496, 456}, {30, 496, 1}, {30, 496, 1}, {456}};
  vector<ge::DataType> input_types = {ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT};
  vector<vector<int64_t>> outputs = {{30, 496, 456}, {30, 496, 456}};
  vector<ge::DataType> output_types = {ge::DT_FLOAT, ge::DT_FLOAT};
  
  ge::Format data_format1 = ge::FORMAT_ND;
  ...
  ATTACH_OPERATOR_TO_HOLDER(holder, opParas, tiling_len, info);
  HOLDER_DO_TILING(holder, "LayerNormXBackpropV2", ge::GRAPH_SUCCESS);
  TILING_DATA_VERIFY_BYTYPE(holder, int32_t, "990885924 999274532 ");
}

TEST_F(LayerNormXBackpropV2Tiling, LayerNormXBackpropV2_tiling_test_runtime_2) {
  std::string op_name = "LayerNormXBackpropV2";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find(op_name);
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
...
TEST_F(LayerNormXBackpropV2Tiling, LayerNormXBackpropV2_tiling_test_runtime_3) {
  std::string op_name = "LayerNormXBackpropV2";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find(op_name);
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  ...
  ATTACH_OPERATOR_TO_HOLDER(holder, opParas, tiling_len, info);
  HOLDER_DO_TILING(holder, "LayerNormXBackpropV2", ge::GRAPH_SUCCESS);
  TILING_DATA_VERIFY_BYTYPE(holder, int32_t, "981467136 989855744 ");
}
