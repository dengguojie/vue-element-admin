...
class LayerNormXBackpropTiling : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "LayerNormXBackpropTiling SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "LayerNormXBackpropTiling TearDown" << std::endl;
    }
};
...
TEST_F(LayerNormXBackpropTiling, LayerNormXBackprop_tiling_test_1)
{
