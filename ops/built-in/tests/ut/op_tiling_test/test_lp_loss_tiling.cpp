...
class LpLossTiling : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "LpLossTiling SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "LpLossTiling TearDown" << std::endl;
  }
};
...
TEST_F(LpLossTiling, LpLoss_tiling_test_1) {
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("LpLoss");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  auto opParas = op::LpLoss("LpLoss");
...
TEST_F(LpLossTiling, LpLoss_tiling_test_2) {
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("LpLoss");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  auto opParas = op::LpLoss("LpLoss");
