...
TEST_F(ScatterSubTiling, scatter_sub_tiling_0) {
  using namespace optiling;
  std::string op_name = "ScatterSub";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ScatterSub");
  ...
  auto opParas = op::ScatterMax("ScatterSub");
...
TEST_F(ScatterSubTiling, scatter_sub_tiling_1) {
  using namespace optiling;
  std::string op_name = "ScatterSub";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ScatterSub");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
...
TEST_F(ScatterSubTiling, scatter_sub_tiling_4) {
  using namespace optiling;
  std::string op_name = "ScatterSub";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ScatterSub");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
...
TEST_F(ScatterSubTiling, scatter_sub_tiling_5) {
  using namespace optiling;
  std::string op_name = "ScatterSub";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ScatterSub");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
...
TEST_F(ScatterSubTiling, scatter_sub_tiling_6) {
  using namespace optiling;
  std::string op_name = "ScatterSub";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ScatterSub");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
...
TEST_F(ScatterSubTiling, scatter_sub_tiling_7) {
  using namespace optiling;
  std::string op_name = "ScatterSub";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ScatterSub");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
...
TEST_F(ScatterSubTiling, scatter_sub_tiling_8) {
  using namespace optiling;
  std::string op_name = "ScatterSub";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ScatterSub");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
...
TEST_F(ScatterSubTiling, scatter_sub_tiling_9) {
  using namespace optiling;
  std::string op_name = "ScatterSub";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ScatterSub");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
...
TEST_F(ScatterSubTiling, scatter_sub_tiling_10) {
  using namespace optiling;
  std::string op_name = "ScatterSub";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ScatterSub");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
...
TEST_F(ScatterSubTiling, scatter_sub_tiling_13) {
  using namespace optiling;
  std::string op_name = "ScatterSub";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ScatterSub");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
...
TEST_F(ScatterSubTiling, scatter_sub_tiling_14) {
  using namespace optiling;
  std::string op_name = "ScatterSub";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ScatterSub");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
...
TEST_F(ScatterSubTiling, scatter_sub_tiling_15) {
  using namespace optiling;
  std::string op_name = "ScatterSub";
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("ScatterSub");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
