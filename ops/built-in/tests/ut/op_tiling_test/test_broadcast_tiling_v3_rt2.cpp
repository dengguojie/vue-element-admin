...
TEST_F(BroadcastTilingV3, broadcast_rt_case3) {
  std::string compileInfo = R"({"_fusion_index": [[0],[1]], "_pattern": "Broadcast", "_ub_factor_align": 128, "_soc_version": "Ascend910", "_flag_info": [false, false, true, true, false, false, false], "_base_info": {"320":[32, 4, 21840, 10920], "000":[32, 4, 21840, 10920]},  "_elewise_vars": { "232000000":[10001, 20000, 30000], "0":[10100], "1":[10100, 20000, 30000], "2":[10100, 20000, 30001], "4": [10100, 20001, 30001]}})";
...
TEST_F(BroadcastTilingV3, broadcast_rt_case4) {
  std::string compileInfo = R"({"_fusion_index": [[0],[1]], "_pattern": "Broadcast", "_ub_factor_align": 128, "_flag_info": [false, false, true, true, false, false, false], "_base_info": {"110":[32, 4, 32768, 16384]},  "_elewise_vars": { "232000000":[10001, 20000, 30000], "0":[10100], "1":[10100, 20000, 30000], "2":[10100, 20000, 30001], "4": [10100, 20001, 30001]}})";
...
TEST_F(BroadcastTilingV3, broadcast_rt_case5) {
  std::string compileInfo = R"({"_fusion_index": [[0],[1]], "_pattern": "Broadcast", "_ub_factor_align": 128, "_flag_info": [false, false, true, true, false, false, false], "_base_info": {"120":[32, 4, 32768, 16384]},  "_elewise_vars": { "232000000":[10001, 20000, 30000], "0":[10100], "1":[10100, 20000, 30000], "2":[10100, 20000, 30001], "4": [10100, 20001, 30001]}})";
  std::vector<std::vector<int64_t>> inputs {{1, 33, 1}, {1, 33, 1089}};
  std::vector<std::vector<int64_t>> outputs {{1, 33, 1089}};;
  ge::DataType dtype = ge::DT_FLOAT;
  AutoTilingTest test(inputs, outputs, dtype, dtype);
...
TEST_F(BroadcastTilingV3, broadcast_rt_case6) {
  std::string compileInfo = R"({"_fusion_index": [[0],[1]], "_pattern": "Broadcast", "_ub_factor_align": 128, "_flag_info": [false, false, true, true, false, false, false], "_base_info": {"210":[32, 4, 21832, 10912]},  "_elewise_vars": { "221000001":[10000, 10001, 10100, 20000, 30000], "221000002":[10000, 10001, 10100, 20000, 30001]}})";
...
TEST_F(BroadcastTilingV3, broadcast_rt_case9) {
  std::string compileInfo = R"({"_fusion_index": [[0],[1],[2]], "_pattern": "Broadcast", "_ub_factor_align": 128, "_soc_version": "Ascend910B", "_flag_info": [false, false, true, true, true, false, true], "_base_info": {"100": [48, 2, 32768, 16384], "120": [48, 2, 24576, 12288], "121": [48, 2, 19648, 9824], "210": [48, 2, 19648, 9824], "320": [48, 2, 32752, 16368], "230": [48, 2, 32752, 16368], "000": [48, 2, 19648, 9824], "999": [48, 2, 19648, 9824]},  "_elewise_vars": {"210000000": [10000, 20000, 30000],  "210010000": [10000, 20000, 30000],  "212000000": [10000, 10100, 10101],  "212000001": [10000, 10100, 10101, 20000, 30000],  "212000002": [10000, 10100, 10101, 20000, 30001],  "212010002": [10000, 10100, 10101, 20000, 30001],  "212000004": [10000, 10100, 10101, 20001, 30001],  "212010004": [10000, 10100, 10101, 20001, 30001],  "212100000": [10000, 10100, 10101, 10200],  "212100001": [10000, 10100, 10101, 10200, 20000, 30000],  "212100002": [10000, 10100, 10101, 10200, 20000, 30001],  "212100003": [10000, 10100, 10101, 10200, 20000, 30002],  "212100005": [10000, 10100, 10101, 10200, 20001, 30001],  "212100006": [10000, 10100, 10101, 10200, 20001, 30002],  "212100009": [10000, 10100, 10101, 10200, 20002, 30002],  "221000000": [10000, 10001, 10100],  "221000001": [10000, 10001, 10100, 20000, 30000],  "221000002": [10000, 10001, 10100, 20000, 30001],  "221000004": [10000, 10001, 10100, 20001, 30001],  "232000000": [10001, 20000, 30000],  "223000000": [10000, 20000, 30000],  "0": [10000, 10001, 10100, 10101, 10200, 10201],  "1": [10000, 10001, 10100, 10101, 10200, 10201, 20000, 30000],  "2": [10000, 10001, 10100, 10101, 10200, 10201, 20000, 30001],  "3": [10000, 10001, 10100, 10101, 10200, 10201, 20000, 30002],  "5": [10000, 10001, 10100, 10101, 10200, 10201, 20001, 30001],  "6": [10000, 10001, 10100, 10101, 10200, 10201, 20001, 30002],  "9": [10000, 10001, 10100, 10101, 10200, 10201, 20002, 30002],  "299900000": [10000, 10001, 10100, 10101],  "299900001": [10000, 10001, 10100, 10101, 20000, 30000],  "299900002": [10000, 10001, 10100, 10101, 20000, 30001],  "299900004": [10000, 10001, 10100, 10101, 20001, 30001]}})";
...
TEST_F(BroadcastTilingV3, broadcast_rt_case10) {
  std::string compileInfo = R"({"_fusion_index": [[0],[1],[2]], "_pattern": "Broadcast", "_ub_factor_align": 128, "_soc_version": "Ascend910", "_flag_info": [false, false, true, true, true, false, true], "_base_info": {"100": [32, 4, 21840, 10920]},  "_elewise_vars": {"210000000":[20000, 30000], "210010000":[20000, 30000]}})";
...
TEST_F(BroadcastTilingV3, broadcast_rt_case11) {
  std::string compileInfo = R"({"_fusion_index": [[0, 1],[2]], "_pattern": "Broadcast", "_ub_factor_align": 128, "_soc_version": "Ascend910B", "_flag_info": [true], "_base_info": {"000":[48, 2, 32768, 16384]},  "_elewise_vars": {}, "_broadcast_axis": [false, true]})";
...
TEST_F(BroadcastTilingV3, broadcast_rt_case24) {
  std::string compileInfo = R"({"_ub_factor_align": 128,  "_pattern": "Broadcast", "_fusion_index": [[0,1,2,3]],"_soc_version": "Ascend910B", "push_status": 0, "_flag_info": [false, false, true, true, false, false, false], "_base_info": {"100": [48, 4, 16384, 8192]}, "_elewise_vars": { "210000000": [10000, 20000, 30000],"210010000": [10000, 20000, 30000]} })";
...
TEST_F(BroadcastTilingV3, broadcast_rt_case25) {
  std::string compileInfo = R"({"_ub_factor_align": 128,  "_pattern": "Broadcast", "_fusion_index": [[0],[1],[2],[3]],"_soc_version": "Ascend910B", "push_status": 0, "_flag_info": [false, false, true, true, false, false, false], "_base_info": {"0": [48, 4, 16384, 8192]}, "_elewise_vars": { "210000000": [10000, 20000, 30000],"210010000": [10000, 20000, 30000]} })";
