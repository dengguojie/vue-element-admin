...
TEST_F(Conv3DBackpropInputTiling, Conv3d_bp_input_tiling_dynamic_dhw_not_cover) {
  ...
  std::string compileInfo = R"({"_pattern": "Conv3d_backprop_input","repo_seeds": {"10000": [52,112,32]},"cost_range": {}, "repo_range": {"10000": [1,1,24,54,92,122,128,158]},"block_dim": {"10000": 2},"_vars": {"10000": ["dedy_d","dedy_h","dedy_w","dedx_d","dedx_h","dedx_w"]}})";
...
TEST_F(Conv3DBackpropInputTiling, Conv3d_bp_input_tiling_dynamic_dhw_repo_range) {
  ...
  std::string compileInfo = R"({"push_status": 0, "_pattern": "Conv3d_backprop_input","repo_seeds": {"10000": [1,52,112,32]},"cost_range": {}, "repo_range": {"10000": [1,1,24,54,92,122,128,158]},"block_dim": {"10000": 2},"_vars": {"10000": ["dedy_d","dedy_h","dedy_w","dedx_d","dedx_h","dedx_w"]}})";
...
TEST_F(Conv3DBackpropInputTiling, Conv3d_bp_input_tiling_dynamic_dhw_cost_range) {
  ...
  std::string compileInfo = R"({"push_status": 0,"_pattern": "Conv3d_backprop_input","repo_seeds": {"10000": [1,52,112,32]},"cost_range": {"10001": [1,1,24,54,92,122,128,158]},"repo_range": {"10000": [1,1,12,12,92,122,128,158]},"block_dim": {"10000": 2,"10001": 4},"_vars": {"10000": ["dedy_d","dedy_h","dedy_w","dedx_d","dedx_h","dedx_w"]}})";
...
TEST_F(Conv3DBackpropInputTiling, Conv3d_bp_input_tiling_dynamic_batch) {
  ...
  std::string compileInfo = R"({"_pattern": "Conv3d_backprop_input","repo_seeds": {"10000": [1,52,112,32]},"repo_range": {"10000": [1,1,24,54,92,122,128,158]},"block_dim": {"10000": 2},"_vars": {"10000": ["dedy_d","dedy_h","dedy_w","dedx_d","dedx_h","dedx_w"]}})";
