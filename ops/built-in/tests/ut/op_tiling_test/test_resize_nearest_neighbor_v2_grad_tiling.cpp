...
TEST_F(ResizeNearestNeighborV2GradTiling, resize_nearest_neighbor_tiling_0) {
  ...
  EXPECT_EQ(to_string(runInfo.tiling_data), "111000 16 1 1000 1000 1000 1000 16 1 2 ");
}
...
TEST_F(ResizeNearestNeighborV2GradTiling, resize_nearest_neighbor_tiling_2) {
  ...
  OpRunInfo runInfo;
  ASSERT_TRUE(iter->second(opParas, op_compile_info, runInfo));
  EXPECT_EQ(to_string(runInfo.tiling_data), "100000 16 1 1000 1000 999 1001 2 4 4 ");
}
...
TEST_F(ResizeNearestNeighborV2GradTiling, resize_nearest_neighbor_tiling_3) {
  ...
  OpRunInfo runInfo;
  ASSERT_TRUE(iter->second(opParas, op_compile_info, runInfo));
  EXPECT_EQ(to_string(runInfo.tiling_data), "101000 16 1 1000 1000 999 2000 2 4 4 ");
}
...
TEST_F(ResizeNearestNeighborV2GradTiling, resize_nearest_neighbor_tiling_4) {
  ...
  OpRunInfo runInfo;
  ASSERT_TRUE(iter->second(opParas, op_compile_info, runInfo));
  EXPECT_EQ(to_string(runInfo.tiling_data), "100010 16 1 1000 1000 999 22 2 4 4 ");
}
...
TEST_F(ResizeNearestNeighborV2GradTiling, resize_nearest_neighbor_tiling_5) {
  ...
  OpRunInfo runInfo;
  ASSERT_TRUE(iter->second(opParas, op_compile_info, runInfo));
  EXPECT_EQ(to_string(runInfo.tiling_data), "100110 16 1 1000 1000 999 20 1 1 20 ");
}
