...
using namespace std;
using namespace ge;
class PadV2Tiling : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "PadV2Tiling SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "PadV2Tiling TearDown" << std::endl;
  }
};
...
static void run_case(std::vector<int64_t> input_shape, std::string data_dtype, std::vector<int32_t> const_value,
  ...
  auto iter = optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().find("PadV2");
  ASSERT_TRUE(iter != optiling::OpTilingFuncRegistry::RegisteredOpFuncInfo().end());
  auto test_op = op::PadV2("PadV2");
...
TEST_F(PadV2Tiling, rpad_v2_tiling_0) {
...
TEST_F(PadV2Tiling, rpad_v2_tiling_1) {
  std::string compileInfo = "{\"vars\": {\"ub_size\": 65536, \"core_num\": 32, \"dtype_rate\": 2}}";
...
TEST_F(PadV2Tiling, rpad_v2_tiling_2) {
  std::string compileInfo = "{\"vars\": {\"ub_size\": 65536, \"core_num\": 32, \"dtype_rate\": 2}}";
