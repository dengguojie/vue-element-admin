...
TEST_F(SigmoidCrossEntropyWithLogitsGradV2Tiling, SigmoidCrossEntropyWithLogitsGradV2_Tiling_test_1) {
  ...
  auto iter = optiling::OpTilingRegistryInterf::RegisteredOpInterf().find("SigmoidCrossEntropyWithLogitsGradV2");
  ...
  vector<string> dtypes = {"float32", "float32", "float32", "float32", "float32"};
