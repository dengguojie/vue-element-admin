...
TEST_F(BroadcastTilingV3, TilingTest1) {
  ...
  actual_ptr.base_info_compile.second = {{"100", {32, 2, 43680, 21840, 2}}, {"200", {32, 2, 28656, 14320, 2}}};
...
TEST_F(BroadcastTilingV3, TilingTest2) {
  ...
  actual_ptr.base_info_compile.first = true;
  actual_ptr.base_info_compile.second = {{"320", {32, 4, 21840, 10920, 4}}, {"000", {32, 4, 21840, 10920, 4}}};
  actual_ptr.flag_info_compile = {false, false, true, true, false, false, false};
  ...
  EXPECT_EQ(to_string(runInfo.GetAllTilingData()), "5824 2 3 ");
}
...
TEST_F(BroadcastTilingV3, TilingTest3) {
  ...
  v3::BroadcastCompileInfo actual_ptr;
  actual_ptr.base_info_compile.first = true;
  actual_ptr.base_info_compile.second = {{"110", {32, 4, 32768, 16384, 4}}};
  actual_ptr.flag_info_compile = {false, false, true, true, false, false, false};
  actual_ptr.ub_factor_align = 128;
  actual_ptr.elewise_vars_compile.first = true;
...
TEST_F(BroadcastTilingV3, TilingTest4) {
  ...
  v3::BroadcastCompileInfo actual_ptr;
  actual_ptr.base_info_compile.first = true;
  actual_ptr.base_info_compile.second = {{"888", {32, 4, 32768, 16384, 4}}};
  actual_ptr.flag_info_compile = {false, false, true, true, false, false, false};
  actual_ptr.ub_factor_align = 128;
  actual_ptr.elewise_vars_compile.first = true;
  actual_ptr.elewise_vars_compile.second = {
    { "488800001", {10000, 10001, 10100, 10101, 10200, 10201, 20000, 30000}},
    { "488800002", {10000, 10001, 10100, 10101, 10200, 10201, 20000, 30001}},
    { "488800003", {10000, 10001, 10100, 10101, 10200, 10201, 20000, 30002}},
  };
  actual_ptr.const_block_dims_compile.first = false;
  actual_ptr.const_block_dims_compile.second = {};
...
TEST_F(BroadcastTilingV3, TilingTest5) {
  ...
  v3::BroadcastCompileInfo actual_ptr;
  actual_ptr.base_info_compile.first = true;
  actual_ptr.base_info_compile.second = {{"888", {32, 2, 32768, 16384, 2}}, {"210", {32, 2, 43680, 21840, 2}}};
  actual_ptr.flag_info_compile = {false, false, true, true, false, false, false};
  actual_ptr.ub_factor_align = 128;
  actual_ptr.elewise_vars_compile.first = true;
  actual_ptr.elewise_vars_compile.second ={
  ...
  actual_ptr.soc_version.first = false;
  actual_ptr.soc_version.second = "";
  actual_ptr.has_store_align = true;
...
TEST_F(BroadcastTilingV3, TilingTest6) {
  ...
  v3::BroadcastCompileInfo actual_ptr;
  actual_ptr.base_info_compile.first = true;
  // actual_ptr.base_info_compile.second = {{"100", {32, 2, 43680, 21840, 2}}, {"120", {32, 2, 28656, 14320, 2}}, {"121", {32, 2, 30704, 15344, 2}}, {"210", {32, 2, 30704, 15344, 2}}, {"320", {32, 2, 42320, 21152, 2}}, {"230", {32, 2, 42320, 21152, 2}}, {"000", {32, 2, 30704, 15344, 2}}, {"999", {32, 2, 30704, 15344, 2}}};
  actual_ptr.base_info_compile.second = {{"888", {32, 4, 16384, 8192, 4}}, {"999", {32, 4, 21840, 10920, 4}}};
  ...
  actual_ptr.elewise_vars_compile.second ={
    { "488800001", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30000}},
    { "488800002", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30001}},
    { "488800003", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30002}},
    { "488800004", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30003}},
    { "488800005", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30004}},
  };
  actual_ptr.const_block_dims_compile.first = false;
  actual_ptr.const_block_dims_compile.second = {};
...
TEST_F(BroadcastTilingV3, TilingTest7) {
  ...
  actual_ptr.base_info_compile.second = {
    {"100", {32, 2, 43680, 21840, 1}},
		{"120", {32, 2, 43680, 21840, 2}},
		{"121", {32, 2, 43680, 21840, 2}},
		{"210", {32, 2, 43680, 21840, 2}},
		{"320", {32, 2, 43664, 21824, 1}},
		{"230", {32, 2, 43664, 21824, 1}},
		{"000", {32, 2, 43680, 21840, 2}},
		{"888", {32, 2, 32768, 16384, 2}},
		{"999", {32, 2, 43680, 21840, 2}}
  };
  actual_ptr.flag_info_compile = {false, false, true, true, true, false, true};
  actual_ptr.ub_factor_align = 128;
  actual_ptr.elewise_vars_compile.first = true;
  actual_ptr.elewise_vars_compile.second = {
    {"210000000", {10000, 20000, 30000}},
		...
		{"212000000", {10000, 10100, 10101}},
		{"212000001", {10000, 10100, 10101, 20000, 30000}},
		{"212000002", {10000, 10100, 10101, 20000, 30001}},
		{"212010002", {10000, 10100, 10101, 20000, 30001}},
		{"212100000", {10000, 10100, 10101, 10200}},
		{"212100001", {10000, 10100, 10101, 10200, 20000, 30000}},
		{"212100002", {10000, 10100, 10101, 10200, 20000, 30001}},
		{"212100003", {10000, 10100, 10101, 10200, 20000, 30002}},
		{"221000000", {10000, 10001, 10100}},
		{"221000001", {10000, 10001, 10100,20000,30000}},
		{"221000002", {10000, 10001, 10100,20000,30001}},
		{"232000000", {10001, 20000, 30000}},
		{"232010000", {10001, 20000, 30000}},
		{"223000000", {10000, 20000, 30000}},
		{"223010000", {10000, 20000, 30000}},
		{"0", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401}},
		{"1", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30000}},
		{"2", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30001}},
		{"3", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30002}},
		{"4", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30003}},
		{"5", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30004}},
		{"488800001", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30000}},
		{"488800002", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30001}},
		{"488800003", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30002}},
		{"488800004", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30003}},
		{"488800005", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 10400, 10401, 20000, 30004}},
		{"299900000", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301}},
		{"299900001", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 20000, 30000}},
		{"299900002", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 20000, 30001}},
		{"299900003", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 20000, 30002}},
		{"299900004", {10000, 10001, 10100, 10101, 10200, 10201, 10300, 10301, 20000, 30003}}
  };
  actual_ptr.const_block_dims_compile.first = false;
  actual_ptr.const_block_dims_compile.second = {};
...
TEST_F(BroadcastTilingV3, TilingTest8) {
  ...
  v3::BroadcastCompileInfo actual_ptr;
  actual_ptr.base_info_compile.first = true;
  actual_ptr.base_info_compile.second = {{"100", {48, 2, 32768, 16384, 2}}, {"120", {48, 2, 24576, 12288, 2}}, {"121", {48, 2, 19648, 9824, 2}}, {"210", {48, 2, 19648, 9824, 2}}, {"320", {48, 2, 32752, 16368, 2}}, {"230", {48, 2, 32752, 16368, 2}}, {"000", {48, 2, 19648, 9824, 2}}, {"999", {48, 2, 19648, 9824, 2}}};
  actual_ptr.flag_info_compile = {false, false, true, true, true, false, true};
  actual_ptr.ub_factor_align = 128;
  actual_ptr.elewise_vars_compile.first = true;
...
TEST_F(BroadcastTilingV3, TilingTest10) {
  ...
  v3::BroadcastCompileInfo actual_ptr;
  actual_ptr.base_info_compile.first = true;
  actual_ptr.base_info_compile.second = {{"100", {32, 4, 21840, 10920, 4}}};
  actual_ptr.flag_info_compile = {false, false, true, true, true, false, true};
  actual_ptr.ub_factor_align = 128;
  actual_ptr.elewise_vars_compile.first = true;
...
TEST_F(BroadcastTilingV3, TilingTest11) {
  ...
  v3::BroadcastCompileInfo actual_ptr;
  actual_ptr.base_info_compile.first = true;
  actual_ptr.base_info_compile.second = {{"000", {48, 2, 32768, 16384, 2}}};
