...
TEST_F(BroadcastTilingV3, TilingTest18) {
  ...
  std::string compileInfo = R"({"_fusion_index": [[0], [1]], "_pattern": "Broadcast", "_outs_uint1": false,  "_flag_info": [false, false, true, true, false, false, true], "_base_info": {"000": [32, 4, 13104, 6552], "100": [32, 4, 13104, 6552], "120": [32, 4, 13096, 6544], "200": [32, 4, 13104, 6552], "210": [32, 4, 13104, 6552]}, "_elewise_vars": {"0": [10000,10001,10002, 10100,10101,10102],"1": [10000,10001,10002, 10100,10101,10102, 20000, 30000], "2": [10000,10001,10002, 10100,10101,10102, 20000, 30001], "4": [10000,10001,10002, 10100,10101,10102, 20001, 30001], "210000000": [10000, 20000, 30000], "210010000": [10000, 20000, 30000], "212000000": [10000, 10100, 10101, 10102],"212000001": [10000, 10100, 10101, 10102, 20000, 30000],"212000002": [10000, 10100, 10101, 10102, 20000, 30001],"212000004": [10000, 10100, 10101, 10102, 20001, 30001],"212010002": [10000, 10100, 10101, 2000, 30001],"212010004": [10000, 10100, 10101, 20001, 30001], "220000000": [ 10000, 10001, 10002, 20000, 30000 ], "221000000": [10000, 10001, 10100],"221000001": [10000, 10001, 10100, 20000, 30000],"221000002": [10000, 10001, 10100, 20000, 30001], "221000004": [10000, 10001, 10100, 20001, 30001]}})";
  std::shared_ptr<AutoTilingHandler> outer_compile_info = \
    CreateBroadcastTilingHandler(this->test_info_->name(),
                              "autotiling",
                              nlohmann::json::parse(compileInfo));
...
TEST_F(BroadcastTilingV3, TilingTest19) {
  ...
  std::string compileInfo = R"({"_outs_uint1": false,  "_pattern": "Broadcast", "_fusion_index": [[0,1]], "push_status": 0, "_flag_info": [false, false, true, true, true, false, false], "_base_info": {"320": [32, 4, 21840, 10920], "100": [32, 4, 21840, 10920]}, "_elewise_vars": { "232000000": [10001, 20000, 30000],  "210000000": [20000, 30000], "210010000": [10001, 20000, 30000] } })";
  std::shared_ptr<AutoTilingHandler> outer_compile_info = \
    CreateBroadcastTilingHandler(this->test_info_->name(),
                              "autotiling",
                              nlohmann::json::parse(compileInfo));
...
TEST_F(BroadcastTilingV3, TilingTest20) {
  ...
  std::string compileInfo = R"({"_outs_uint1": false,  "_pattern": "Broadcast", "_fusion_index": [[0,1,2,3,4]], "push_status": 0, "_flag_info": [false, false, true, true, true, false, false], "_base_info": {"230": [32, 2, 42320, 21152]}, "_elewise_vars": { "223000000": [10000, 20000, 30000] } })";
  std::shared_ptr<AutoTilingHandler> outer_compile_info = \
    CreateBroadcastTilingHandler(this->test_info_->name(),
                              "autotiling",
                              nlohmann::json::parse(compileInfo));
