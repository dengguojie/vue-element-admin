...
class UnsortedSegmentProdTiling : public testing::Test {
 protected:
    static void SetUpTestCase() {
        std::cout << "UnsortedSegmentProdTiling SetUp" << std::endl;
    }

    static void TearDownTestCase() {
        std::cout << "UnsortedSegmentProdTiling TearDown" << std::endl;
    }
};
...
TEST_F(UnsortedSegmentProdTiling, unsortedsegmentprod_tiling_0) {
    ...
    auto iter = optiling::OpTilingRegistryInterf::RegisteredOpInterf().find("UnsortedSegmentProd");
