...
class UnsortedSegmentMaxTiling : public testing::Test {
 protected:
  static void SetUpTestCase() { std::cout << "UnsortedSegmentMaxTiling SetUp" << std::endl; }

  static void TearDownTestCase() { std::cout << "UnsortedSegmentMaxTiling TearDown" << std::endl; }
};
...
TEST_F(UnsortedSegmentMaxTiling, unsortedsegmentmax_tiling_0) {
  ...
  auto opParas = op::UnsortedSegmentMax(op_name);
