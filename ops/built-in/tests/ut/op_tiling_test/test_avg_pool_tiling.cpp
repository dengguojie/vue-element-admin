...
TEST_F(AvgPoolTiling, AvgPool_tiling_dynamic_nhw) {
  ...
  "strides_h" : 60, "strides_w" : 60, "k_size_h": 2, "k_size_w": 2, "filter" : 1,
...
TEST_F(AvgPoolTiling, AvgPool_tiling_dynamic_Vector) {
  ...
  const ge::AscendString compileInfo = R"({"strides_h" : 64, "strides_w" : 64, "k_size_h": 1, "k_size_w": 1, "filter" : 0,
...
TEST_F(AvgPoolTiling, AvgPool_tiling_fuzz_build_list_input) {
  ...
  "filter" : 1, "_vars": {"0": ["batch_n", "fmap_h", "ho", "fmap_w", "wo"]}},
