...
TEST_F(DepthwiseConv2DTiling, DepthwiseConv2d_tiling_dynamic_nhw) {
  ...
  std::string compileInfo = R"({"_pattern": "DepthwiseConvolution", "push_status": 0, "tiling_type": "dynamic_tiling", "repo_seeds": {}, "repo_range": {}, "cost_range": {"10000": [1, 10, 10, 25, 10, 25]}, "block_dim": {"10000": 2}, "_vars": {"10000": ["batch_n", "fmap_h", "ho", "fmap_w", "wo"]}})";
  ...
  op_compile_info.key = "DepthwiseConv2d_tiling_dynamic_nhw";
  OpRunInfo runInfo;
...
TEST_F(DepthwiseConv2DTiling, DepthwiseConv2d_tiling_dynamic_None) {
  ...
  std::string compileInfo = R"({"_pattern": "DepthwiseConvolution", "push_status": 0, "tiling_type": "default_tiling", "default_range": {"10000": [1, 2147483647, 16, 16, 16, 16]}, "block_dim": {"10000": 1}, "_vars": {"10000": ["batch_n"]}})";
  ...
  OpCompileInfo op_compile_info;
  op_compile_info.str = compileInfo;
  op_compile_info.key = "DepthwiseConv2d_tiling_dynamic_None";
  OpRunInfo runInfo;
  ASSERT_TRUE(iter->second(opParas, op_compile_info, runInfo));
