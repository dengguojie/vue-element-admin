...
TEST_F(DepthwiseConv2DTiling, DepthwiseConv2d_tiling_dynamic_None) {
  ...
  std::string compileInfo = R"({"_pattern": "DepthwiseConvolution", "push_status": 0, "tiling_type": "default_tiling", "default_range": {"10000": [1, null, 16, 16, 16, 16]}, "block_dim": {"10000": 1}, "_vars": {"10000": ["batch_n"]}})";
