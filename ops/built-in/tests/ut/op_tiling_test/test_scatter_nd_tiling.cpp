...
TEST_F(ScatterNdTiling, scatter_nd_tiling_0) {
  ...
  auto iter = optiling::OpTilingRegistryInterf::RegisteredOpInterf().find("ScatterNd");
  ...
  EXPECT_EQ(to_string(runInfo.tiling_data), "14 112 32 4235 0 210 296450 0 4235 15118950 0 4235 59290 51878 3570 474320 3 35 7 0 0 0 0 0 19 21968 17 10294 ");
}
