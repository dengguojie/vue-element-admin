...
TEST_F(EletwiseTilingV2, Eletwise_tiling1) {
  ...
  ASSERT_TRUE(iter->second.tiling_func_v2_(add_op, op_compile_info, runInfo));
...
TEST_F(EletwiseTilingV2, Eletwise_tiling2) {
  ...
  ASSERT_TRUE(iter->second.tiling_func_v2_(exp_op, op_compile_info, runInfo));
...
TEST_F(EletwiseTilingV2, Eletwise_tiling3) {
  ...
  ASSERT_TRUE(iter->second.tiling_func_v2_(cast_op, op_compile_info, runInfo));
  EXPECT_EQ(runInfo.GetBlockDim(), 32);
...
//optiling::utils::OpCompileInfo op_compile_info(this->test_info_->name(), compileInfo);
//optiling::utils::OpRunInfo runInfo;
//ASSERT_TRUE(iter->second.tiling_func_v2_(fusedmuladd_op, op_compile_info, runInfo));
//EXPECT_EQ(runInfo.GetBlockDim(), 25);
...
ASSERT_TRUE(iter->second.tiling_func_v2_(reluV2_op, op_compile_info, runInfo));
}
