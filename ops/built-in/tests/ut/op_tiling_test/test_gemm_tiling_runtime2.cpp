...
static GEMMTilingTestParam general_cases_params[] = {
  ...
  },
  {
    "GEMM_op_tiling_obj_batchmatmul_formula01", "BatchMatMul", R"({"_pattern": "MatMul", "format_a": "FRACTAL_NZ", "format_b": "FRACTAL_NZ", "dynamic_mode":"dynamic_mknb",
        "repo_seeds": {}, "repo_range": {}, "attrs":{"transpose_a": false, "transpose_b": false}, "block_dim": {"20000001": 32}, "correct_range_flag":null,
        "_vars":{"20000001":["m", "k", "n", "batch_single_core", "m_single_core", "n_single_core", "batch_dim",
        "n_dim", "m_dim", "m_al1", "n_bl1", "cub_n1", "m_l0", "k_l0", "n_ub_l0_time", "kal0_factor", "kbl0_factor",
        "kal1_factor", "kbl1_factor", "kal1_16", "kbl1_16", "kl1_times", "batch"]},
        "_custom_vars":{"20000001":["m", "k", "n", "batch_single_core", "m_single_core", "n_single_core", "batch_dim",
        "n_dim", "m_dim", "m_al1", "n_bl1", "cub_n1", "m_l0", "k_l0", "n_ub_l0_time", "kal0_factor", "kbl0_factor",
        "kal1_factor", "kbl1_factor", "kal1_16", "kbl1_16", "kl1_times", "batch"]}, "_normal_vars":{"20000001":[]},
        "_attr_vars":{"20000001":[]}})",
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, false, false, {1, 16, 512}, {512, 16}, {1, 16, 16}, false, 0, 0, 1, 20000001,
  ...
  },
  {
    "GEMM_op_tiling_obj_batchmatmul_formula02", "BatchMatMul", R"({"_pattern": "MatMul", "format_a": "FRACTAL_NZ", "format_b": "FRACTAL_NZ", "dynamic_mode":"dynamic_mknb",
        "repo_seeds": {}, "repo_range": {}, "attrs":{"transpose_a": false, "transpose_b": false}, "block_dim": {"20001001": 32}, "correct_range_flag":null,
        "_vars":{"20001001":["m", "k", "n", "batch_single_core", "m_single_core", "n_single_core", "batch_dim",
        "n_dim", "m_dim", "m_al1", "n_bl1", "cub_n1", "m_l0", "k_l0", "n_ub_l0_time", "kal0_factor", "kbl0_factor",
        "kal1_factor", "kbl1_factor", "kal1_16", "kbl1_16", "kl1_times", "batch"]},
        "_custom_vars":{"20001001":["m", "k", "n", "batch_single_core", "m_single_core", "n_single_core", "batch_dim",
        "n_dim", "m_dim", "m_al1", "n_bl1", "cub_n1", "m_l0", "k_l0", "n_ub_l0_time", "kal0_factor", "kbl0_factor",
        "kal1_factor", "kbl1_factor", "kal1_16", "kbl1_16", "kl1_times", "batch"]}, "_normal_vars":{"20001001":[]},
        "_attr_vars":{"20001001":[]}})",
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, false, false, {1, 240, 768}, {768, 6000}, {1, 240, 6000}, false, 0, 0, 15, 20001001,
  ...
  },
  {
    "GEMM_op_tiling_obj_batchmatmul_formula03", "BatchMatMul", R"({"_pattern": "MatMul", "format_a": "FRACTAL_NZ", "format_b": "FRACTAL_NZ", "dynamic_mode":"dynamic_mknb",
        "repo_seeds": {}, "repo_range": {}, "attrs":{"transpose_a": false, "transpose_b": false}, "block_dim": {"80221001": 32}, "correct_range_flag":null,
        "_vars":{"80221001":["m", "k", "n", "batch_single_core", "m_single_core", "n_single_core", "batch_dim",
        "n_dim", "m_dim", "m_al1", "n_bl1", "cub_n1", "m_l0", "k_l0", "n_ub_l0_time", "kal0_factor", "kbl0_factor",
        "kal1_factor", "kbl1_factor", "kal1_16", "kbl1_16", "kl1_times", "batch"]},
        "_custom_vars":{"80221001":["m", "k", "n", "batch_single_core", "m_single_core", "n_single_core", "batch_dim",
        "n_dim", "m_dim", "m_al1", "n_bl1", "cub_n1", "m_l0", "k_l0", "n_ub_l0_time", "kal0_factor", "kbl0_factor",
        "kal1_factor", "kbl1_factor", "kal1_16", "kbl1_16", "kl1_times", "batch"]}, "_normal_vars":{"80221001":[]},
        "_attr_vars":{"80221001":[]}})",
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, false, false, {1, 16, 2048}, {2048, 1008}, {1, 16, 1008}, false, 0, 0, 7, 80221001,
  ...
  },
  {
    "GEMM_op_tiling_obj_batchmatmul_formula04", "BatchMatMul", R"({"_pattern": "MatMul", "format_a": "FRACTAL_NZ", "format_b": "FRACTAL_NZ", "dynamic_mode":"dynamic_mknb",
        "repo_seeds": {}, "repo_range": {}, "attrs":{"transpose_a": false, "transpose_b": false}, "block_dim": {"70220001": 32}, "correct_range_flag":null,
        "_vars":{"70220001":["m", "k", "n", "batch_single_core", "m_single_core", "n_single_core", "batch_dim",
        "n_dim", "m_dim", "m_al1", "n_bl1", "cub_n1", "m_l0", "k_l0", "n_ub_l0_time", "kal0_factor", "kbl0_factor",
        "kal1_factor", "kbl1_factor", "kal1_16", "kbl1_16", "kl1_times", "batch"]},
        "_custom_vars":{"70220001":["m", "k", "n", "batch_single_core", "m_single_core", "n_single_core", "batch_dim",
        "n_dim", "m_dim", "m_al1", "n_bl1", "cub_n1", "m_l0", "k_l0", "n_ub_l0_time", "kal0_factor", "kbl0_factor",
        "kal1_factor", "kbl1_factor", "kal1_16", "kbl1_16", "kl1_times", "batch"]}, "_normal_vars":{"70220001":[]},
        "_attr_vars":{"70220001":[]}})",
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, false, false, {1, 4096, 3136}, {3136, 1024}, {1, 4096, 1024}, false, 0, 0, 32, 70220001,
  ...
  },
  {
    "GEMM_op_tiling_obj_batchmatmul_formula05", "BatchMatMul", R"({"_pattern": "MatMul", "format_a": "FRACTAL_NZ", "format_b": "FRACTAL_NZ", "dynamic_mode":"dynamic_mknb",
        "repo_seeds": {}, "repo_range": {}, "attrs":{"transpose_a": false, "transpose_b": false}, "block_dim": {"62211001": 32}, "correct_range_flag":null,
        "_vars":{"62211001":["m", "k", "n", "batch_single_core", "m_single_core", "n_single_core", "batch_dim",
        "n_dim", "m_dim", "m_al1", "n_bl1", "cub_n1", "m_l0", "k_l0", "n_ub_l0_time", "kal0_factor", "kbl0_factor",
        "kal1_factor", "kbl1_factor", "kal1_16", "kbl1_16", "kl1_times", "batch"]},
        "_custom_vars":{"62211001":["m", "k", "n", "batch_single_core", "m_single_core", "n_single_core", "batch_dim",
        "n_dim", "m_dim", "m_al1", "n_bl1", "cub_n1", "m_l0", "k_l0", "n_ub_l0_time", "kal0_factor", "kbl0_factor",
        "kal1_factor", "kbl1_factor", "kal1_16", "kbl1_16", "kl1_times", "batch"]}, "_normal_vars":{"62211001":[]},
        "_attr_vars":{"62211001":[]}})",
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, false, false, {1, 16000, 1024}, {1024, 512}, {1, 16000, 512}, false, 0, 0, 25, 62211001,
  ...
  },
  {
    "GEMM_op_tiling_obj_batchmatmul_formula06", "BatchMatMul", R"({"_pattern": "MatMul", "format_a": "FRACTAL_NZ", "format_b": "FRACTAL_NZ", "dynamic_mode":"dynamic_mknb",
        ...
        "kal1_factor", "kbl1_factor", "kal1_16", "kbl1_16", "kl1_times", "batch"]}, "_normal_vars":{"20000001":[]},
        "_attr_vars":{"20000001":[]}})",
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, false, false, {1, 128, 128}, {128, 64}, {1, 128, 64}, false, 0, 0, 32, 20000001,
  ...
  },
  {
    ...
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, false, false, {4352, 16, 64}, {4352, 64, 32}, {4352, 16, 32}, false, 0, 0, 32, 800001301,
  ...
  },
  {
    "GEMM_op_tiling_nd_nonrange_pattern_02", "BatchMatMul", R"({"_pattern": "MatMul", "attrs":{"transpose_a":true,"transpose_b":true},
        ...
        "block_dim":{"CORE_NUM":32},"correct_range_flag":null,"dynamic_mode":"dynamic_mknb",
        "format_a":"ND","format_b":"ND","repo_range":{},"repo_seeds":{}})",
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, false, false, {4352, 64, 16}, {4352, 32, 64}, {4352, 16, 32}, false, 0, 0, 32, 800001301,
  ...
  },
  {
    "GEMM_op_tiling_nd_nonrange_pattern_03", "MatMul", R"({"_pattern": "MatMul", "attrs":{"transpose_a":false,"transpose_b":true},
        ...
        "block_dim":{"CORE_NUM":32},"correct_range_flag":null,"dynamic_mode":"dynamic_mknb",
        "format_a":"ND","format_b":"ND","repo_range":{},"repo_seeds":{}})",
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, false, false, {8192, 512}, {512, 512}, {8192, 512}, false, 0, 0, 32, 622010001,
  ...
  },
  {
    "GEMM_op_tiling_nd_nonrange_pattern_04", "MatMul", R"({"_pattern": "MatMul", "attrs":{"transpose_a":true,"transpose_b":false},
      ...
      "block_dim":{"CORE_NUM":32},"correct_range_flag":null,"dynamic_mode":"dynamic_mknb",
      "format_a":"ND","format_b":"ND","repo_range":{},"repo_seeds":{}})",
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, true, false, {40960, 512}, {40960, 1024}, {512, 1024}, false, 0, 0, 32, 802210001,
  ...
  },
  {
    "GEMM_op_tiling_nd_nonrange_pattern_05", "MatMul", R"({"_pattern": "MatMul", "attrs":{"transpose_a":false,"transpose_b":false},
      ...
      "block_dim":{"CORE_NUM":32},"correct_range_flag":null,"dynamic_mode":"dynamic_mknb",
      "format_a":"ND","format_b":"ND","repo_range":{},"repo_seeds":{}})",
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, false, false, {11776, 2048}, {2048, 512}, {11776, 512}, false, 0, 0, 32, 522010101,
  ...
  },
  {
    "GEMM_op_tiling_nd_nonrange_pattern_split_k", "MatMul", R"({"_pattern": "MatMul", "attrs":{"transpose_a":true,"transpose_b":false},
      ...
      "format_a":"ND","format_b":"ND","repo_range":{},"repo_seeds":{}})",
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, false, false, {11776, 512}, {11776, 512}, {512, 512}, false, 0, 0, 32, 1622000101,
  ...
  },
  {
    "GEMM_op_tiling_fractal_z", "MatMul", R"([{"_pattern": "Matmul", "format_a": "FRACTAL_NZ", "format_b": "FRACTAL_NZ", "dynamic_mode":"dynamic_mkn",
      "repo_seeds": {}, "repo_range": {}, "cost_range": {}, "block_dim": {"20000001": 6},
      ...
      "block_dim": {"20000001": 6},
      "attrs":{"transpose_a": false, "transpose_b": true}}])",
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, false, false, {1, 256}, {96, 256}, {1, 96}, true, 17, 50, 6, 20000001,
