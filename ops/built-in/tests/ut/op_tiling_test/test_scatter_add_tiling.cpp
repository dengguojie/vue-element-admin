...
TEST_F(ScatterAddTiling, scatter_add_tiling_0) {
  ...
  EXPECT_EQ(to_string(runInfo.tiling_data), "7 2 17 704 0 2112 1486848 0 704 23232 0 23232 176 88 33 1408 ");
}
...
TEST_F(ScatterAddTiling, scatter_add_tiling_1) {
  ...
  EXPECT_EQ(to_string(runInfo.tiling_data), "14 1 3 2210 0 258 570180 0 2210 6630 0 2210 0 0 3 0 ");
}