...
TEST_F(transpose_reshape_fusion_test, transpose_reshape_fusion_test_3) {
  ge::Graph graph("transpose_reshape_fusion_test_3");
  std::vector<int64_t> dims_a{1000, 5, 64, 64};
  ge::Shape shape_a(dims_a);
  ge::TensorDesc tensorDesc_a(shape_a, ge::FORMAT_ND, ge::DT_FLOAT);
  tensorDesc_a.SetOriginShape(shape_a);
  tensorDesc_a.SetOriginFormat(ge::FORMAT_ND);
  auto input_data = op::Data("input_data");
  input_data.update_input_desc_x(tensorDesc_a);
  input_data.update_output_desc_y(tensorDesc_a);
...
TEST_F(transpose_reshape_fusion_test, transpose_reshape_fusion_test_4) {
  ge::Graph graph("transpose_reshape_fusion_test_3");
  std::vector<int64_t> dims_a{1000, 5, 64, 64};
  ge::Shape shape_a(dims_a);
  ge::TensorDesc tensorDesc_a(shape_a, ge::FORMAT_ND, ge::DT_FLOAT);
