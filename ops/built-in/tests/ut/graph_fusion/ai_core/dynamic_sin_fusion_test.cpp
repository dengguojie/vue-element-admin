...
class DynamicCeilFusionTest : public testing::Test {
protected:
    static void SetUpTestCase() {
        std::cout << "DynamicCeilFusionTest SetUp" << std::endl;
    }

    static void TearDownTestCase() {
        std::cout << "DynamicCeilFusionTest TearDown" << std::endl;
    }
};

TEST_F(DynamicCeilFusionTest, DynamicCeilFusionTest_1) {

    const char* cls = "DynamicCeilFusionTest_1 ";
...
TEST_F(DynamicCeilFusionTest, DynamicCeilFusionTest_2) {

    const char* cls = "DynamicCeilFusionTest_2 ";

    cout << cls << "start !!!" << endl;

    // input x shape: [-1, -1]
    // input x range: [(1, 1), (2, 2)]
    // output y shape: [-1, -1]
    // output y range: [(1, 1), (2, 2)]
    ...
    std::vector<std::pair<int64_t, int64_t>> input_x_range;
    input_x_range.push_back(std::pair<int64_t, int64_t>{1, 1});
    input_x_range.push_back(std::pair<int64_t, int64_t>{2, 2});
    input_x_tensor_desc.SetShapeRange(input_x_range);
