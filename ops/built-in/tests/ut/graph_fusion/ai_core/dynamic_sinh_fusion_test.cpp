...
class DynamicSinhFusionTest : public testing::Test{
protected:
    static void SetUpTestCase(){
        std::cout << "dynamic_sinh SetUp" << std::endl;
    }

    static void TearDownTestCase(){
        std::cout << "dynamic_sinh TearDown" << std::endl;
    }
};

TEST_F(DynamicSinhFusionTest, DynamicSinhFusionTest_1){

    const char* cls = "DynamicSinhFusionTest_1 ";
