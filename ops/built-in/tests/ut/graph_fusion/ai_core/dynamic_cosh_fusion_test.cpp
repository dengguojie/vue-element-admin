...
class DynamicCoshFusionTest : public testing::Test{
protected:
    static void SetUpTestCase(){
        std::cout << "dynamic_cosh SetUp" << std::endl;
    }

    static void TearDownTestCase(){
        std::cout << "dynamic_cosh TearDown" << std::endl;
    }
};

TEST_F(DynamicCoshFusionTest, DynamicCoshFusionTest_1){

    const char* cls = "DynamicCoshFusionTest_1 ";
