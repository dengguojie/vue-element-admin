...
class slice_fusion_test : public testing::Test {
protected:
...
TEST_F(slice_fusion_test, slice_fusion_test_1) {
  ge::Graph graph("slice_fusion_test_1");
  ...
  *(strides_data + 2) = 1;
  ...
  slice_op.update_input_desc_x(output_desc);
  slice_op.update_output_desc_y(output_desc);
  std::vector<Operator> inputs{data_x, begin, end, strides};
  std::vector<Operator> outputs{slice_op};
  graph.SetInputs(inputs).SetOutputs(outputs);

  ge::ComputeGraphPtr compute_graph_ptr = ge::GraphUtils::GetComputeGraph(graph);
  fe::FusionPassTestUtils::InferShapeAndType(compute_graph_ptr);
    //    GE_DUMP(compute_graph_ptr, "slice_fusion_test_1_before");
  fe::FusionPassTestUtils::RunGraphFusionPass("ConstToAttrSliceFusion", fe::BUILT_IN_GRAPH_PASS, *compute_graph_ptr);

  bool findOp = false;
  for (auto node: compute_graph_ptr->GetAllNodes()) {
        if (node->GetType() == "SliceD") {
            findOp = true;
        }
    }
...
TEST_F(slice_fusion_test, slice_fusion_test_2) {
  ge::Graph graph("slice_fusion_test_2");
  ge::Tensor begin_tensor;
...
TEST_F(slice_fusion_test, slice_fusion_test_3) {
  ge::Graph graph("slice_fusion_test_3");
  ge::Tensor end_tensor;
  std::vector<int64_t> end_vec{3};
  ge::Shape end_shape(end_vec);
  ge::TensorDesc end_desc(end_shape, FORMAT_ND, DT_INT32);
...
TEST_F(slice_fusion_test, slice_fusion_test_4) {
  ge::Graph graph("slice_fusion_test_4");
  ge::Tensor begin_tensor;
  std::vector<int64_t> begin_vec{3};
  ge::Shape begin_shape(begin_vec);
  ge::TensorDesc begin_desc(begin_shape, FORMAT_ND, DT_INT32);
...
TEST_F(slice_fusion_test, slice_fusion_test_5) {
  ge::Graph graph("slice_fusion_test_5");
  ge::Tensor begin_tensor;
  std::vector<int64_t> begin_vec{3};
  ge::Shape begin_shape(begin_vec);
  ge::TensorDesc begin_desc(begin_shape, FORMAT_ND, DT_INT32);
...
TEST_F(slice_fusion_test, slice_fusion_test_6) {
  ge::Graph graph("slice_fusion_test_6");
  ge::Tensor begin_tensor;
  std::vector<int64_t> begin_vec{3};
  ge::Shape begin_shape(begin_vec);
  ge::TensorDesc begin_desc(begin_shape, FORMAT_ND, DT_INT32);
...
TEST_F(slice_fusion_test, slice_fusion_test_7) {
  ge::Graph graph("slice_fusion_test_7");
  ge::Tensor begin_tensor;
  std::vector<int64_t> begin_vec{3};
  ge::Shape begin_shape(begin_vec);
  ge::TensorDesc begin_desc(begin_shape, FORMAT_ND, DT_INT32);
...
TEST_F(slice_fusion_test, slice_fusion_test_8) {
  ge::Graph graph("slice_fusion_test_8");
  ge::Tensor begin_tensor;
  std::vector<int64_t> begin_vec{3};
  ge::Shape begin_shape(begin_vec);
  ge::TensorDesc begin_desc(begin_shape, FORMAT_ND, DT_INT32);
