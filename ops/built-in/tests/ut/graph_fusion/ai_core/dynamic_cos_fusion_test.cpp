...
class DynamicCosFusionTest : public testing::Test{
protected:
    static void SetUpTestCase(){
        std::cout << "dynamic_cos SetUp" << std::endl;
    }

    static void TearDownTestCase(){
        std::cout << "dynamic_cos TearDown" << std::endl;
    }
};

TEST_F(DynamicCosFusionTest, DynamicCosFusionTest_1){

    const char* cls = "DynamicCosFusionTest_1 ";
