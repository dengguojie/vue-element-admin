...
protected:
   ...
   * *******************************************
   */
  void BuildGraphForBiasNotND(ge::ComputeGraphPtr &sub_graph) {
    ge::GeShape bias_shape({64});
...
/*
   ...
   * *******************************************
   */
void BuildGraphForSplitNotND(ge::ComputeGraphPtr &parent_graph, ge::ComputeGraphPtr &sub_graph) {
    ge::GeShape bias_shape({64});
    ge::GeTensorDesc bias_desc(bias_shape, ge::FORMAT_NHWC, ge::DT_FLOAT);
    bias_desc.SetOriginFormat(ge::FORMAT_NHWC);
    bias_desc.SetOriginDataType(ge::DT_FLOAT);
...
TEST_F(conv2d_to_fullyconnection_fusion_pass_test, bias_not_ND_format_test) {
ge::ComputeGraphPtr compute_graph;
BuildGraphForBiasNotND(compute_graph);
FusionPassTestUtils::RunGraphFusionPass("ConvToFullyConnectionFusionPass", fe::BUILT_IN_GRAPH_PASS, *compute_graph);
}

TEST_F(conv2d_to_fullyconnection_fusion_pass_test, input_bias_parent_graph_not_ND_test) {
ge::ComputeGraphPtr parent_graph;
ge::ComputeGraphPtr sub_graph;
BuildGraphForSplitNotND(parent_graph, sub_graph);
FusionPassTestUtils::RunGraphFusionPass("ConvToFullyConnectionFusionPass", fe::BUILT_IN_GRAPH_PASS, *sub_graph);
}
