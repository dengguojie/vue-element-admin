...
protected:
  ...
  static void TearDownTestCase() {
    std::cout << "layer_norm_onnx_mul_fusion_test TearDown" << std::endl;
  }
};

TEST_F(layer_norm_onnx_mul_fusion_test, layer_norm_onnx_mul_fusion_test_1) {
  ge::Graph graph("layer_norm_onnx_mul_fusion_test_1");
  ...
  auto mul0 = op::Mul("mul0").set_input_x1(sub1).set_input_x2(sub1);
  auto mean1 = op::ReduceMeanD("mean1").set_input_x(mul0).set_attr_axes(axes).set_attr_keep_dims(true);
...
TEST_F(layer_norm_onnx_mul_fusion_test, layer_norm_onnx_mul_fusion_test_2) {
  ge::Graph graph("layer_norm_onnx_mul_fusion_test_1");
