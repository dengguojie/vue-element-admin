...
class DynamicSigmoidFusionTest : public testing::Test{
protected:
    static void SetUpTestCase(){
        std::cout << "dynamic_sigmoid SetUp" << std::endl;
    }

    static void TearDownTestCase(){
        std::cout << "dynamic_sigmoid TearDown" << std::endl;
    }
};

TEST_F(DynamicSigmoidFusionTest, DynamicSigmoidFusionTest_1){

    const char* cls = "DynamicSigmoidFusionTest_1 ";
    ...
    // build op input
    auto outputOp = op::Sigmoid("Sigmoid_1");
