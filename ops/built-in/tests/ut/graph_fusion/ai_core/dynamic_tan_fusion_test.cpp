...
class dynamic_tan_fusion_test : public testing::Test {
protected:
    static void SetUpTestCase() {
        std::cout << "dynamic_tan SetUp" << std::endl;
    }

    static void TearDownTestCase() {
        std::cout << "dynamic_tan TearDown" << std::endl;
    }
};

TEST_F(dynamic_tan_fusion_test, dynamic_tan_fusion_test_1) {

    const char* cls = "dynamic_tan_fusion_test_1 ";
