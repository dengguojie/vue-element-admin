...
#include "buffer_fusion/ub_fusion/ai_core/conv/tbe_conv_double_in_fusion_pass.h"
#undef protected
#undef private

using namespace ge;

class ConvDoubleInFusionTest : public testing::Test {
protected:
  static void SetUpTestCase() {
    std::cout << "Conv double in fusion pass SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "Conv double in fusion pass TearDown" << std::endl;
  }
};

TEST_F(ConvDoubleInFusionTest, ConvDoubleInFusionTest_1) {
  ...
  fe::ConvDoubleInFusionPass fusion_pass;
