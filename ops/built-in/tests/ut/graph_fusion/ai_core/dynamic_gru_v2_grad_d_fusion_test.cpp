...
TEST_F(dynamic_gru_v2_grad_d_fusion_test, dynamic_gru_v2_grad_d_fusion_test_5) {
  ge::Graph graph("dynamic_gru_v2_grad_d_fusion_test_5");
  int64_t tSize = -1;
  int64_t batchSize = 16;
  int64_t inputSize = 16;
  int64_t hiddenSize = 16;
  ...
  std::vector<int64_t> seqVec{batchSize};
  ge::Shape seqShape(seqVec);
  ge::TensorDesc seqDesc(seqShape, FORMAT_ND, DT_INT32);
  ...
  seqLengthData.update_input_desc_x(seqDesc);
  seqLengthData.update_output_desc_y(seqDesc);
