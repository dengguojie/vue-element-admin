...
class fc_transdata_transdata_fusion_pass_test : public testing::Test {
protected:
    static void SetUpTestCase() {
        std::cout << "fc_transdata_transdata_fusion_pass_test SetUp" << std::endl;
    }

    static void TearDownTestCase() {
        std::cout << "fc_transdata_transdata_fusion_pass_test TearDown" << std::endl;
    }
};

TEST_F(fc_transdata_transdata_fusion_pass_test, fc_transdata_transdata_fusion_pass_test_1) {
    ge::Graph graph("fc_transdata_transdata_fusion_pass_test_1");
    auto input_data = op::Data("Transdata_input_data");
    std::vector<int64_t> data_dims{1, 26, 1, 1, 32};
    ge::Shape data_shape(data_dims);
    ge::TensorDesc dataInputTensorDesc(data_shape, FORMAT_NC1HWC0, DT_FLOAT16);
    ...
    ge::TensorDesc Trasdata1InputTensorDesc(transdata1_input_shape, FORMAT_NC1HWC0, DT_FLOAT16);
    ...
    ge::TensorDesc ReformatInputTensorDesc(reformat_shape, FORMAT_NCHW, DT_FLOAT16);
    ge::TensorDesc ReformatOutputTensorDesc(reformat_shape, FORMAT_ND, DT_FLOAT16);
    ...
    ge::TensorDesc FCTensorDesc(fc_shape, FORMAT_FRACTAL_NZ, DT_FLOAT16);
    ...
    fe::FusionPassTestUtils::RunGraphFusionPass("TransdataTransdataPass", fe::SECOND_ROUND_BUILT_IN_GRAPH_PASS, *compute_graph_ptr);
