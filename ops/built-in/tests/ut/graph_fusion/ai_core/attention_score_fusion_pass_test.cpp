...
TEST_F(attention_score_fusion_pass_test, attention_score_fusion_pass_test_02) {
  std::string testCaseName = "attention_score_fusion_pass_test_02";
  int32_t batch_dim1 = 32;
  int32_t batch_dim2 = 16;
  int32_t seq_num = 24;
  int32_t nz_dim = 16;
  ...
  auto confusion_trans_op_last = op::ConfusionTransposeD("Quant_end");
  confusion_trans_op_last.set_input_x(confusion_trans_op)
                         .set_attr_perm({0, 2, 1, 3})
                         .set_attr_shape({32, 16, 384, 64})
                         .set_attr_transpose_first(true);
  confusion_trans_op_last.update_output_desc_y(tensor_confusion_output);

  std::vector<Operator> inputs{query, key, value, pad_mask, scale, drop_mask};
  std::vector<Operator> outputs{confusion_trans_op_last};
...
TEST_F(attention_score_fusion_pass_test, attention_score_fusion_pass_test_03) {
  std::string testCaseName = "attention_score_fusion_pass_test_03";
  int32_t batch_dim1 = 32;
  int32_t batch_dim2 = 16;
  int32_t seq_num = 24;
  int32_t nz_dim = 16;
  ...
  auto pad_mask = CreateDataNode("padding_mask", {batch_dim1, 1, seq_num * nz_dim, seq_num * nz_dim}, FORMAT_ND, DT_FLOAT16);
  auto scale = CreateDataNode("scale", {1}, FORMAT_ND, DT_FLOAT16);
  auto drop_mask = CreateDataNode("drop_mask", {batch_dim1, batch_dim2, seq_num * nz_dim, seq_num * nz_dim}, FORMAT_ND, DT_UINT8);
