...
TEST_F(common_lstm_fusion_test, common_lstm_fusion_test_7) {
  // bidirectional lstm with const init_h, init_c
  ge::Graph graph("common_lstm_fusion_test_7");
  ...
  // sequence_lens
  auto data_sequence_lens = op::Data("sequence_lens");
  std::vector<int64_t> data_sequence_lens_vec{1};
  ge::Shape data_sequence_lens_shape(data_sequence_lens_vec);
  ge::TensorDesc data_sequence_lens_desc(data_sequence_lens_shape, FORMAT_ND, DT_INT32);
  data_sequence_lens.update_input_desc_x(data_sequence_lens_desc);
  data_sequence_lens.update_output_desc_y(data_sequence_lens_desc);
  ...
  common_lstm_op.set_input_x(data_x)
      ...
      .set_input_r(data_r)
      .set_input_b(data_b)
      .set_input_sequence_lens(data_sequence_lens)
      .set_input_initial_h(data_h)
      .set_input_initial_c(data_c)
      .set_attr_hidden_size(32)
      .set_attr_direction(direction);
