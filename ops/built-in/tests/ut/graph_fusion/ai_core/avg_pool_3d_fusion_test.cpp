...
TEST_F(avg_pool_3d_fusion_test, avg_pool_3d_fusion_static_case2) {
    ge::Graph graph("avg_pool_3d_fusion_static_case2");
    auto avg_pool_3d_input_data = op::Data("avg_pool_3d_input_data");
    std::vector<int64_t> dims{1, 28, 28, 28, 1};
    ge::Shape shape(dims);
    ge::TensorDesc tensorDesc(shape, ge::FORMAT_NDHWC, ge::DT_FLOAT16);
...
TEST_F(avg_pool_3d_fusion_test, avg_pool_3d_fusion_static_case3) {
    ge::Graph graph("avg_pool_3d_fusion_static_case3");
    auto avg_pool_3d_input_data = op::Data("avg_pool_3d_input_data");
    std::vector<int64_t> dims{1, 1, 28, 28, 28};
    ge::Shape shape(dims);
    ge::TensorDesc tensorDesc(shape, ge::FORMAT_NCDHW, ge::DT_FLOAT16);
    avg_pool_3d_input_data.update_input_desc_x(tensorDesc);
    avg_pool_3d_input_data.update_output_desc_y(tensorDesc);
    auto avg_pool_3d_op = op::AvgPool3D("avgpool3d_0");
    avg_pool_3d_op.set_input_x(avg_pool_3d_input_data);
    avg_pool_3d_op.set_attr_ksize({1, 1, 1, 1, 1});
    avg_pool_3d_op.set_attr_strides({1, 1, 2, 2, 2});
    avg_pool_3d_op.set_attr_pads({1, 1, 1, 1, 1, 1});
    avg_pool_3d_op.set_attr_ceil_mode(false);
    avg_pool_3d_op.set_attr_count_include_pad(false);
    avg_pool_3d_op.set_attr_divisor_override(0);
    avg_pool_3d_op.set_attr_data_format("NCDHW");
    auto end_op = op::Square("end_op_0");
    end_op.set_input_x(avg_pool_3d_op);
    std::vector<Operator> inputs{avg_pool_3d_input_data};
    std::vector<Operator> outputs{end_op};
...
TEST_F(avg_pool_3d_fusion_test, avg_pool_3d_fusion_static_case4) {
    ge::Graph graph("avg_pool_3d_fusion_static_case4");
    auto avg_pool_3d_input_data = op::Data("avg_pool_3d_input_data");
    std::vector<int64_t> dims{28, 28, 28, 1, 1};
    ge::Shape shape(dims);
    ge::TensorDesc tensorDesc(shape, ge::FORMAT_DHWCN, ge::DT_FLOAT16);
    avg_pool_3d_input_data.update_input_desc_x(tensorDesc);
    avg_pool_3d_input_data.update_output_desc_y(tensorDesc);
    auto avg_pool_3d_op = op::AvgPool3D("avgpool3d_0");
    avg_pool_3d_op.set_input_x(avg_pool_3d_input_data);
    avg_pool_3d_op.set_attr_ksize({1, 1, 1, 1, 1});
    avg_pool_3d_op.set_attr_strides({2, 2, 2, 1, 1});
    avg_pool_3d_op.set_attr_pads({1, 1, 1, 1, 1, 1});
    avg_pool_3d_op.set_attr_ceil_mode(false);
    avg_pool_3d_op.set_attr_count_include_pad(false);
    avg_pool_3d_op.set_attr_divisor_override(0);
    avg_pool_3d_op.set_attr_data_format("DHWCN");
    auto end_op = op::Square("end_op_0");
    end_op.set_input_x(avg_pool_3d_op);
    std::vector<Operator> inputs{avg_pool_3d_input_data};
    std::vector<Operator> outputs{end_op};
