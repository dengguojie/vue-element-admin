...
class matrix_diag_fusion_test : public testing::Test {
protected:
...
TEST_F(matrix_diag_fusion_test, matrix_diag_fusion_test_1) {
    ge::Graph graph("matrix_diag_fusion_test_1");
...
TEST_F(matrix_diag_fusion_test, matrix_diag_fusion_test_4) {
    ge::Graph graph("matrix_diag_fusion_test_4");
    auto matrix_diag_input_data = op::Data("matrix_diag_input_data");
    std::vector<int64_t> dims{128};
    ge::Shape shape(dims);
...
TEST_F(matrix_diag_fusion_test, matrix_diag_fusion_test_5) {
    ge::Graph graph("matrix_diag_fusion_test_5");
    auto matrix_diag_input_data = op::Data("matrix_diag_input_data");
    std::vector<int64_t> dims{128};
    ge::Shape shape(dims);
...
TEST_F(matrix_diag_fusion_test, matrix_diag_fusion_test_6) {
    ge::Graph graph("matrix_diag_fusion_test_6");
    auto matrix_diag_input_data = op::Data("matrix_diag_input_data");
    std::vector<int64_t> dims{128};
    ge::Shape shape(dims);
