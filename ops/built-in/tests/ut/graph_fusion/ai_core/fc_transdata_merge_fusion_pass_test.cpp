...
// no fusion, transdata2: output format is FORMAT_FRACTAL_NZ, not FORMAT_NC1HWC0
...
// no fusion, transdata2: output dtype is DT_FLOAT, not DT_FLOAT16 or DT_INT8
TEST_F(fc_transdata_merge_fusion_pass_test, fc_transdata_merge_fusion_pass_test_3) {
    ge::Graph graph("fc_transdata_merge_fusion_pass_test_3");
    auto input_data = op::Data("Transdata_input_data");
    std::vector<int64_t> data_dims{21, 19, 16, 16};
    ge::Shape data_shape(data_dims);
    ge::TensorDesc dataInputTensorDesc(data_shape, FORMAT_FRACTAL_NZ, DT_FLOAT16);
    ...
    ge::Shape transdata2_output_shape(transdata2_output_dims);
    ge::TensorDesc Trasdata2InputTensorDesc(transdata2_input_shape, FORMAT_NCHW, DT_FLOAT16);
    ge::TensorDesc Trasdata2OutputTensorDesc(transdata2_output_shape, FORMAT_NC1HWC0, DT_FLOAT);
    transdata2_op.update_input_desc_src(Trasdata2InputTensorDesc);
    transdata2_op.update_output_desc_dst(Trasdata2OutputTensorDesc);
...
// no fusion, transdata2: input format is FORMAT_FRACTAL_NZ, not FORMAT_NCHW or FORMAT_ND
TEST_F(fc_transdata_merge_fusion_pass_test, fc_transdata_merge_fusion_pass_test_4) {
    ge::Graph graph("fc_transdata_merge_fusion_pass_test_4");
    auto input_data = op::Data("Transdata_input_data");
    std::vector<int64_t> data_dims{21, 19, 16, 16};
    ge::Shape data_shape(data_dims);
    ge::TensorDesc dataInputTensorDesc(data_shape, FORMAT_FRACTAL_NZ, DT_FLOAT16);
...
// no fusion, transdata1: input format is FORMAT_ND, not FORMAT_FRACTAL_NZ
TEST_F(fc_transdata_merge_fusion_pass_test, fc_transdata_merge_fusion_pass_test_5) {
    ge::Graph graph("fc_transdata_merge_fusion_pass_test_5");
    auto input_data = op::Data("Transdata_input_data");
    std::vector<int64_t> data_dims{21, 19, 16, 16};
    ge::Shape data_shape(data_dims);
    ge::TensorDesc dataInputTensorDesc(data_shape, FORMAT_FRACTAL_NZ, DT_FLOAT16);
...
// no fusion, transdata1: output format is FORMAT_NCHW, not FORMAT_ND
TEST_F(fc_transdata_merge_fusion_pass_test, fc_transdata_merge_fusion_pass_test_6) {
    ge::Graph graph("fc_transdata_merge_fusion_pass_test_6");
    auto input_data = op::Data("Transdata_input_data");
    std::vector<int64_t> data_dims{21, 19, 16, 16};
    ge::Shape data_shape(data_dims);
    ge::TensorDesc dataInputTensorDesc(data_shape, FORMAT_FRACTAL_NZ, DT_FLOAT16);
    ...
    ge::TensorDesc Trasdata1InputTensorDesc(transdata1_input_shape, FORMAT_FRACTAL_NZ, DT_FLOAT16);
    Trasdata1InputTensorDesc.SetOriginShape(transdata1_input_origin_shape);
    ge::TensorDesc Trasdata1OutputTensorDesc(transdata1_output_shape, FORMAT_NCHW, DT_FLOAT16);
    transdata1_op.update_input_desc_src(Trasdata1InputTensorDesc);
    transdata1_op.update_output_desc_dst(Trasdata1OutputTensorDesc);
