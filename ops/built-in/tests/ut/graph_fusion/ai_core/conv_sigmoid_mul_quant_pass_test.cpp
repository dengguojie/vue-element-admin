...
#include "buffer_fusion/ub_fusion/ai_core/conv/tbe_conv_sigmoid_mul_quant_pass.h"
#undef protected
#undef private

using namespace ge;

class ConvSigmoidMulQunat : public testing::Test {
protected:
  static void SetUpTestCase() {
    std::cout << "Conv sigmoid mul quant pass SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "Conv sigmoid mul quant pass TearDown" << std::endl;
  }
};

TEST_F(ConvSigmoidMulQunat, ConvSigmoidMulQunat_1) {
  ...
  fe::ConvSigmoidMulQuantFusionPass fusion_pass;
