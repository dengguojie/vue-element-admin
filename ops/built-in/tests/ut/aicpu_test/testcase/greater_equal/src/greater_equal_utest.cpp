...
#define ADD_CASE(base_type, aicpu_type)                                      \
  TEST_F(TEST_GREATER_EQUAL_UT, TestGreaterEqual_##aicpu_type) {             \
    ...
    bool output_exp[8] = {1, 1, 1, 0, 1, 1, 1, 0};                           \
...
TEST_F(TEST_GREATER_EQUAL_UT, X_SCALAR_SUCCESS) {
...
TEST_F(TEST_GREATER_EQUAL_UT, Y_SCALAR_SUCCESS) {
  vector<DataType> data_types = {DT_FLOAT, DT_FLOAT, DT_BOOL};
  vector<vector<int64_t>> shapes = {{4}, {}, {4}};
...
TEST_F(TEST_GREATER_EQUAL_UT, TWO_SCALAR_SUCCESS) {
  vector<DataType> data_types = {DT_FLOAT, DT_FLOAT, DT_BOOL};
  vector<vector<int64_t>> shapes = {{}, {}, {}};
