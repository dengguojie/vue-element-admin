...
void RunTestSinh() {
  ...
  std::uint64_t dim[1];
  std::string data_dim_path{ktestcaseFilePath + "sinh/data/sinh_data_" +
                            data_name + "_dim.txt"};
  EXPECT_EQ(ReadFile(data_dim_path, dim, 1), true);

  std::uint64_t shape[dim[0]];
  std::string data_shape_path{ktestcaseFilePath + "sinh/data/sinh_data_" +
  ...
  T data1[input1_size];
  std::string data_path{ktestcaseFilePath + "sinh/data/sinh_data_input_" +
                        data_name + ".bin"};
  ...
  std::string out_data_path{ktestcaseFilePath + "sinh/data/sinh_data_output_" +
                            data_name + ".bin"};
