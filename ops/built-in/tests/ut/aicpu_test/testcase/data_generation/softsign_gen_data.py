...
def gen_random_data_float_2(data_files):
    np.random.seed(23457)
    shape_x = [32, 64, 64]
...
def gen_random_data_float16_2(data_files):
    np.random.seed(23457)
    shape_x = [32, 64, 64]
    a = gen_data_file(data_files[0], shape_x, np.float16, "uniform", -100, 100)
    x = tf.compat.v1.placeholder(tf.float16, shape=shape_x)
...
def gen_random_data_double_2(data_files):
    np.random.seed(23457)
    shape_x = [64, 64, 64]
    a = gen_data_file(data_files[0], shape_x, np.double, "uniform", -100, 100)
    x = tf.compat.v1.placeholder(tf.double, shape=shape_x)
...
def run():
    data_files = [
        "softsign/data/softsign_data_input_1.txt", "softsign/data/softsign_data_output_1.txt",
        "softsign/data/softsign_data_input_2.txt", "softsign/data/softsign_data_output_2.txt",
        "softsign/data/softsign_data_input_3.txt", "softsign/data/softsign_data_output_3.txt",
        "softsign/data/softsign_data_input_4.txt", "softsign/data/softsign_data_output_4.txt",
        "softsign/data/softsign_data_input_5.txt", "softsign/data/softsign_data_output_5.txt",
        "softsign/data/softsign_data_input_6.txt", "softsign/data/softsign_data_output_6.txt"
    ]
    ...
    gen_random_data_float_2([data_files[6], data_files[7]])
    gen_random_data_float16_2([data_files[8], data_files[9]])
    gen_random_data_double_2([data_files[10], data_files[11]])
