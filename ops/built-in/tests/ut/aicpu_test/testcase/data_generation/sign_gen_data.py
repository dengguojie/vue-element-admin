...
def gen_random_data_float16():
    data_files = ["sign/data/sign_data_input1_0.txt",
...
def gen_random_data_float():
    data_files = ["sign/data/sign_data_input1_1.txt",
...
def gen_random_data_double():
    data_files = ["sign/data/sign_data_input1_2.txt",
...
def gen_random_data_int32():
    data_files = ["sign/data/sign_data_input1_3.txt",
...
def gen_random_data_int64():
    data_files = ["sign/data/sign_data_input1_4.txt",
...
def gen_random_data_complex64():
    data_files=["sign/data/sign_data_input_1_5.txt",
...
def gen_random_data_complex128():
    data_files=["sign/data/sign_data_input_1_6.txt",
...
def gen_random_data_float16less():
    data_files=["sign/data/sign_data_input_1_7.txt",
...
def gen_random_data_complex64less():
    data_files=["sign/data/sign_data_input_1_8.txt",
...
def gen_random_data_complex64zero():
    data_files=["sign/data/sign_data_input_1_9.txt",
                "sign/data/sign_data_output_1_9.txt"]
    np.random.seed(3457)
    shape_x1 = [2]
    a = gen_data_file(data_files[0], shape_x1, np.complex64, "complex", 0, 0)
    x1 = tf.compat.v1.placeholder(tf.complex64, shape=shape_x1)
    re = tf.sign(x1)
    with tf.compat.v1.Session(config=config('cpu')) as session:
        data = session.run(re, feed_dict={x1:a})   
...
def run():
    ...
    gen_random_data_float16less()
    gen_random_data_complex64less()
    gen_random_data_complex64zero()
