...
def gen_random_data_float():
    data_files=["sigmoid/data/sigmoid_data_input1_0.txt",
...
def gen_random_data_double():
    data_files=["sigmoid/data/sigmoid_data_input_1_1.txt",
...
def gen_random_data_float16():
    data_files=["sigmoid/data/sigmoid_data_input_1_2.txt",
...
def gen_random_data_complex64():
    data_files=["sigmoid/data/sigmoid_data_input_1_3.txt",
...
def gen_random_data_complex128():
    data_files=["sigmoid/data/sigmoid_data_input_1_4.txt",
...
def gen_random_data_float_4D():
    data_files=["sigmoid/data/sigmoid_data_input_1_5.txt",
...
def gen_random_data_floatless():
    data_files=["sigmoid/data/sigmoid_data_input_1_6.txt",
...
def gen_random_data_floatexp():
    data_files=["sigmoid/data/sigmoid_data_input_1_7.txt",
...
def gen_random_data_float16lessexp():
    data_files=["sigmoid/data/sigmoid_data_input_1_8.txt",
...
def gen_random_data_floatlessexp():
    data_files=["sigmoid/data/sigmoid_data_input_1_9.txt",
...
def gen_random_data_doublelessexp():
    data_files=["sigmoid/data/sigmoid_data_input_1_10.txt",
...
def gen_random_data_complex64lessexp():
    data_files=["sigmoid/data/sigmoid_data_input_1_11.txt",
...
def gen_random_data_complex128lessexp():
    data_files=["sigmoid/data/sigmoid_data_input_1_12.txt",
...
def gen_random_data_complex128big():
    data_files=["sigmoid/data/sigmoid_data_input1_13.txt",
