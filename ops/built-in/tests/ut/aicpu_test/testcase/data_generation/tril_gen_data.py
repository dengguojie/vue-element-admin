...
def gen_random_data_int32():
    data_files = ["tril/data/tril_data_input1_1.txt",
...
def gen_random_data_int64():
    data_files = ["tril/data/tril_data_input1_2.txt",
...
def gen_random_data_float():
    data_files = ["tril/data/tril_data_input1_3.txt",
...
def gen_random_data_double():
    data_files = ["tril/data/tril_data_input1_4.txt",
...
def gen_random_data_int8():
    data_files = ["tril/data/tril_data_input1_5.txt",
...
def gen_random_data_uint8():
    data_files = ["tril/data/tril_data_input1_6.txt",
...
def gen_random_data_int16():
    data_files = ["tril/data/tril_data_input1_7.txt",
...
def gen_random_data_float16():
    data_files = ["tril/data/tril_data_input1_8.txt",
...
def gen_random_data_bool():
    data_files = ["tril/data/tril_data_input1_9.txt",
                  "tril/data/tril_data_output1_9.txt"]
    np.random.seed(12345)
    shape_x = [6, 5]
    a = gen_data_file(data_files[0], shape_x, np.bool_, "randint", 0, 2)
...
def gen_random_data_diagonal_positive():
    data_files = ["tril/data/tril_data_input1_10.txt",
...
def gen_random_data_diagonal_negative():
    data_files = ["tril/data/tril_data_input1_11.txt",
...
def gen_random_data_batch_matrixs():
    data_files = ["tril/data/tril_data_input1_12.txt",
