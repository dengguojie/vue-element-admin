...
def gen_random_data_float():
    data_files=["sub/data/sub_data_input1_1.txt",
...
def gen_random_data_float2():
    data_files=["sub/data/sub_data_input1_2.txt",
...
def gen_random_data_float3():
    data_files=["sub/data/sub_data_input1_3.txt",
...
def gen_random_data_float4():
    data_files=["sub/data/sub_data_input1_4.txt",
...
def gen_random_data_float5():
    data_files=["sub/data/sub_data_input1_5.txt",
...
def gen_random_data_double():
    data_files=["sub/data/sub_data_input1_6.txt",
...
def gen_random_data_float16():
    data_files=["sub/data/sub_data_input1_7.txt",
...
def gen_random_data_uint8():
    data_files=["sub/data/sub_data_input1_8.txt",
                "sub/data/sub_data_input2_8.txt",
                "sub/data/sub_data_output1_8.txt"]
    np.random.seed(23457)
    shape_x1 = [4]
    shape_x2 = [4]
    a = gen_data_file(data_files[0], shape_x1, np.uint8, "uniform", 0, 100)
    b = gen_data_file(data_files[1], shape_x2, np.uint8, "uniform", 0, 100)
...
def gen_random_data_int8():
    data_files=["sub/data/sub_data_input1_9.txt",
                "sub/data/sub_data_input2_9.txt",
                "sub/data/sub_data_output1_9.txt"]
    np.random.seed(23457)
    shape_x1 = [4]
    shape_x2 = [4]
    a = gen_data_file(data_files[0], shape_x1, np.int8, "uniform", 0, 100)
    b = gen_data_file(data_files[1], shape_x2, np.int8, "uniform", 0, 100)
...
def gen_random_data_int16():
    data_files=["sub/data/sub_data_input1_10.txt",
                "sub/data/sub_data_input2_10.txt",
                "sub/data/sub_data_output1_10.txt"]
    np.random.seed(23457)
    shape_x1 = [4]
    shape_x2 = [4]
    a = gen_data_file(data_files[0], shape_x1, np.int16, "uniform", 0, 100)
    b = gen_data_file(data_files[1], shape_x2, np.int16, "uniform", 0, 100)
...
def gen_random_data_uint16():
    data_files=["sub/data/sub_data_input1_11.txt",
                "sub/data/sub_data_input2_11.txt",
                "sub/data/sub_data_output1_11.txt"]
    np.random.seed(23457)
    shape_x1 = [4]
    shape_x2 = [4]
    a = gen_data_file(data_files[0], shape_x1, np.uint16, "uniform", 0, 100)
    b = gen_data_file(data_files[1], shape_x2, np.uint16, "uniform", 0, 100)
...
def gen_random_data_int32():
    data_files=["sub/data/sub_data_input1_12.txt",
...
def gen_random_data_int64():
    data_files=["sub/data/sub_data_input1_13.txt",
    ...
    b = gen_data_file(data_files[1], shape_x2, np.int64, "uniform", 0, 100)
