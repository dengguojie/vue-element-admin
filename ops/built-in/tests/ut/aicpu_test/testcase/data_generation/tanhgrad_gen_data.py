...
def run():
    ...
    gen_random_data(np.float32, [20, 100, 30],[20, 100, 30], "uniform", -6, 6, 0)
    gen_random_data(np.float64, [7, 12, 30],[7, 12, 30], "uniform", -6, 6, 1)
    gen_random_data(np.float64, [20, 100, 30],[20, 100, 30], "uniform", -6, 6, 0)
    gen_random_data(np.complex64, [15, 12, 30],[15, 12, 30], "uniform", -6, 6, 1)
    gen_random_data(np.complex64,  [20, 100, 30],[20, 100, 30], "uniform", -6, 6, 0)
    gen_random_data(np.complex128, [7, 12, 30],[7, 12, 30], "uniform", -6, 6, 1)
    gen_random_data(np.complex128, [20, 100, 30],[20, 100, 30], "uniform", -6, 6, 0)
    # test broadcast data
    gen_random_data(np.float16, [2, 2, 1], [2, 2, 2], "uniform", -6, 6, 1)
    gen_random_data(np.float16, [20, 50, 30], [20, 100, 30], "uniform", -6, 6, 0)
    gen_random_data(np.float32, [2, 1, 4], [1, 2, 4], "uniform", -6, 6, 1)
    gen_random_data(np.float32, [20, 50, 30], [20, 100, 30], "uniform", -6, 6, 0)
    gen_random_data(np.float64, [1], [2, 2, 2], "uniform", -6, 6, 1)
    gen_random_data(np.float64, [20, 20, 30], [20, 100, 30], "uniform", -6, 6, 0)
    gen_random_data(np.complex64, [15, 12, 15], [15, 12, 30], "uniform", -6, 6, 1)
    gen_random_data(np.complex64, [10, 100, 30], [20, 100, 30], "uniform", -6, 6, 0)
    gen_random_data(np.complex128, [7, 6, 30], [7, 12, 30], "uniform", -6, 6, 1)
    gen_random_data(np.complex128, [20, 50, 30], [20, 100, 30], "uniform", -6, 6, 0)
