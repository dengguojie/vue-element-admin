...
def run():
    ...
    gen_random_data(np.int64, [97000], "uniform", -100000, 100000, 1)
    gen_random_data(np.float16, [7, 12, 30], "uniform", -1000, 1000, 0)
    gen_random_data(np.float16, [49000], "uniform", -1000, 1000, 1)
    gen_random_data(np.float32, [7, 12, 30], "uniform", -100, 100, 0)
    gen_random_data(np.float32, [48000], "uniform", -100, 100, 1)
    gen_random_data(np.float64, [7, 12, 30], "uniform", -100000, 100000, 0)
    gen_random_data(np.float64, [65536], "uniform", -100000, 100000, 1)
    gen_random_data(np.complex64, [15, 12, 30], "uniform", -10, 10, 0)
    gen_random_data(np.complex64,  [32768], "uniform", -10, 10, 1)
    gen_random_data(np.complex128, [7, 12, 30], "uniform", -999, 999, 0)
    gen_random_data(np.complex128, [32768], "uniform", -999, 999, 1)
