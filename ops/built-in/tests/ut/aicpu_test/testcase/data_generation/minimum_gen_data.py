...
def gen_random_data_int32():
    data_files=["minimum/data/minimum_data_input1_1.txt",
...
def gen_random_data_int32_11():
    data_files=["minimum/data/minimum_data_input1_11.txt",
...
def gen_random_data_int64():
    data_files=["minimum/data/minimum_data_input1_2.txt",
...
def gen_random_data_float():
    data_files=["minimum/data/minimum_data_input1_3.txt",
...
def gen_random_data_float_333():
    data_files=["minimum/data/minimum_data_input1_7.txt",
...
def gen_random_data_double():
    data_files=["minimum/data/minimum_data_input1_4.txt",
...
def gen_random_data_double_111():
    data_files=["minimum/data/minimum_data_input1_5.txt",
...
def gen_random_data_double_222():
    data_files=["minimum/data/minimum_data_input1_6.txt",
...
def gen_random_data_float16():
    data_files=["minimum/data/minimum_data_input1_8.txt",
...
def run():
    ...
    gen_random_data_int32_11()
    gen_random_data_int64()
    gen_random_data_float()
    gen_random_data_float_333()
    gen_random_data_double()
    gen_random_data_double_111()
    gen_random_data_double_222()
