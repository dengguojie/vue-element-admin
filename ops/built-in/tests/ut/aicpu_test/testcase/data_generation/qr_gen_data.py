...
def gen_random_data_2d(data_files):
    ...
    re = tf.qr(x, full_matrices = False)
...
def gen_random_data_double_full(data_files):
    np.random.seed(23457)
    shape_x = [16, 32, 32]
    a = gen_data_file(data_files[0], shape_x, np.double, "uniform", -100, 100)

    x = tf.compat.v1.placeholder(tf.double, shape=shape_x)
    re = tf.qr(x, full_matrices = True)
    with tf.compat.v1.Session(config=config('cpu')) as session:
        data = session.run(re, feed_dict={x:a})
    write_file_txt(data_files[1], data[0], fmt="%s")
    write_file_txt(data_files[2], data[1], fmt="%s")
...
def run():
    data_files=["qr/data/qr_data_input1_1.txt",
                "qr/data/qr_data_output1_1.txt",
                "qr/data/qr_data_output2_1.txt",
                "qr/data/qr_data_input1_2.txt",
                "qr/data/qr_data_output1_2.txt",
                "qr/data/qr_data_output2_2.txt",
                "qr/data/qr_data_input1_3.txt",
                "qr/data/qr_data_output1_3.txt",
                "qr/data/qr_data_output2_3.txt",
                "qr/data/qr_data_input1_4.txt",
                "qr/data/qr_data_output1_4.txt",
                "qr/data/qr_data_output2_4.txt",
                "qr/data/qr_data_input1_5.txt",
                "qr/data/qr_data_output1_5.txt",
                "qr/data/qr_data_output2_5.txt",
                "qr/data/qr_data_input1_6.txt",
                "qr/data/qr_data_output1_6.txt",
                "qr/data/qr_data_output2_6.txt",
                "qr/data/qr_data_input1_7.txt",
                "qr/data/qr_data_output1_7.txt",
                "qr/data/qr_data_output2_7.txt",
                "qr/data/qr_data_input1_8.txt",
                "qr/data/qr_data_output1_8.txt",
                "qr/data/qr_data_output2_8.txt",
                "qr/data/qr_data_input1_9.txt",
                "qr/data/qr_data_output1_9.txt",
                "qr/data/qr_data_output2_9.txt",]
    gen_random_data_2d([data_files[0], data_files[1], data_files[2]])
    gen_random_data_3d([data_files[3], data_files[4], data_files[5]])
    gen_random_data_float16([data_files[6], data_files[7], data_files[8]])
    gen_random_data_float([data_files[9], data_files[10], data_files[11]])
    gen_random_data_double([data_files[12], data_files[13], data_files[14]])
    ...
    gen_random_data_double_full([data_files[21], data_files[22], data_files[23]])
    gen_random_data_float_full([data_files[24], data_files[25], data_files[26]])