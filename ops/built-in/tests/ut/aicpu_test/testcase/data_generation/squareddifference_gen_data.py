...
def gen_random_data_float16():
    data_files = ["squareddifference/data/squareddifference_data_input1_0.txt",
...
def gen_random_data_float():
    data_files = ["squareddifference/data/squareddifference_data_input1_1.txt",
...
def gen_random_data_double():
    data_files = ["squareddifference/data/squareddifference_data_input1_2.txt",
...
def gen_random_data_int32():
    data_files = ["squareddifference/data/squareddifference_data_input1_3.txt",
...
def gen_random_data_int64():
    data_files = ["squareddifference/data/squareddifference_data_input1_4.txt",
...
def gen_random_data_complex64():
    data_files=["squareddifference/data/squareddifference_data_input1_5.txt",
...
def gen_random_data_complex128():
    data_files=["squareddifference/data/squareddifference_data_input1_6.txt",
...
def gen_random_data_2d():
    data_files=["squareddifference/data/squareddifference_data_input1_7.txt",
                "squareddifference/data/squareddifference_data_input2_7.txt",
                "squareddifference/data/squareddifference_data_output1_7.txt"]
    np.random.seed(23457)
    shape_x1 = [4, 1024]
    shape_x2 = [1, 1024]
...
def gen_random_data_x_num_one():
    data_files=["squareddifference/data/squareddifference_data_input1_8.txt",
                "squareddifference/data/squareddifference_data_input2_8.txt",
                "squareddifference/data/squareddifference_data_output1_8.txt"]
    np.random.seed(23457)
    shape_x1 = [1]
    shape_x2 = [1,3]
    a = gen_data_file(data_files[0], shape_x1, np.int32, "randint", 0, 10)
...
def gen_random_data_y_num_one():
    data_files=["squareddifference/data/squareddifference_data_input1_9.txt",
                "squareddifference/data/squareddifference_data_input2_9.txt",
                "squareddifference/data/squareddifference_data_output1_9.txt"]
    np.random.seed(23457)
    shape_x1 = [1,3]
    shape_x2 = [1]
    a = gen_data_file(data_files[0], shape_x1, np.int32, "randint", 0, 10)
