...
class TEST_BTWISE_OR_UT : public testing::Test {};
...
#define CREATE_NODEDEF(shapes, data_types, datas)                  \
  ...
  NodeDefBuilder(node_def.get(), "BitwiseOr", "BitwiseOr")         \
...
void RunBitwiseOrKernel(vector<string> data_files,
...
template<typename T1, typename T2, typename T3>
void RunBitwiseOrKernel2(vector<DataType> data_types,
                         vector<vector<int64_t>> &shapes) {
...
// exception instance
TEST_F(TEST_BTWISE_OR_UT, INPUT_SHAPE_EXCEPTION) {
  vector<DataType> data_types = {DT_INT32, DT_INT32, DT_INT32};
...
TEST_F(TEST_BTWISE_OR_UT, INPUT_DTYPE_EXCEPTION) {
...
TEST_F(TEST_BTWISE_OR_UT, INPUT_NULL_EXCEPTION) {
  vector<DataType> data_types = {DT_INT32, DT_INT32, DT_INT32};
  vector<vector<int64_t>> shapes = {{2, 11}, {2, 11}, {2, 11}};
...
TEST_F(TEST_BTWISE_OR_UT, INPUT_BOOL_UNSUPPORT) {
