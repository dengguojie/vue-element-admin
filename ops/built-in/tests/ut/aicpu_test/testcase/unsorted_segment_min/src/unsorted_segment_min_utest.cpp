...
class TEST_UNSORTEDSEGMENTMIN_UT : public testing::Test {};

#define CREATE_NODEDEF(shapes, data_types, datas)                            \
  auto node_def = CpuKernelUtils::CpuKernelUtils::CreateNodeDef();           \
  NodeDefBuilder(node_def.get(), "UnsortedSegmentMin", "UnsortedSegmentMin") \
...
void RunUnsortedSegmentMinKernel(vector<string> data_files,  
...
TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_INT32_SUCC) {
  vector<DataType> data_types = {DT_INT32, DT_INT32, DT_INT32, DT_INT32};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_1.txt",
  ...
  RunUnsortedSegmentMinKernel<int32_t, int32_t, int32_t, int32_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_INT32_SUCC_WITHINT64ID) {
  vector<DataType> data_types = {DT_INT32, DT_INT64, DT_INT64, DT_INT32};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_2.txt",
  ...
  RunUnsortedSegmentMinKernel<int32_t, int64_t, int64_t, int32_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_INT16_SUCC) {
  vector<DataType> data_types = {DT_INT16, DT_INT32, DT_INT32, DT_INT16};
  vector<vector<int64_t>> shapes = {{5, 6}, {5}, {1}, {5, 6}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_3.txt",
  ...
  RunUnsortedSegmentMinKernel<int16_t, int32_t, int32_t, int16_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_INT16_SUCC_WITHINT64ID) {
  vector<DataType> data_types = {DT_INT16, DT_INT64, DT_INT64, DT_INT16};
  vector<vector<int64_t>> shapes = {{5, 6}, {5}, {1}, {5, 6}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_4.txt",
  ...
  RunUnsortedSegmentMinKernel<int16_t, int64_t, int64_t, int16_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_FLOAT_SUCC) {
  vector<DataType> data_types = {DT_FLOAT, DT_INT32, DT_INT32, DT_FLOAT};
  vector<vector<int64_t>> shapes = {{3, 3, 3}, {3}, {1}, {3, 3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_5.txt",
  ...
  RunUnsortedSegmentMinKernel<float, int32_t, int32_t, float>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_FLOAT_SUCC_WITHINT64ID) {
  vector<DataType> data_types = {DT_FLOAT, DT_INT64, DT_INT64, DT_FLOAT};
  vector<vector<int64_t>> shapes = {{3, 3, 3}, {3}, {1}, {3, 3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_6.txt",
  ...
  RunUnsortedSegmentMinKernel<float, int64_t, int64_t, float>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_DOUBLE_SUCC) {
  vector<DataType> data_types = {DT_DOUBLE, DT_INT32, DT_INT32, DT_DOUBLE};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_7.txt",
  ...
  RunUnsortedSegmentMinKernel<double, int32_t, int32_t, double>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_DOUBLE_SUCC_WITHINT64ID) {
  vector<DataType> data_types = {DT_DOUBLE, DT_INT64, DT_INT64, DT_DOUBLE};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_8.txt",
  ...
  RunUnsortedSegmentMinKernel<double, int64_t, int64_t, double>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_FLOAT16_SUCC) {
  vector<DataType> data_types = {DT_FLOAT16, DT_INT32, DT_INT32, DT_FLOAT16};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_9.txt",
  ...
  RunUnsortedSegmentMinKernel<Eigen::half, int32_t, int32_t, Eigen::half>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_FLOAT16_SUCC_WITHINT64ID) {
  vector<DataType> data_types = {DT_FLOAT16, DT_INT64, DT_INT64, DT_FLOAT16};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_10.txt",
  ...
  RunUnsortedSegmentMinKernel<Eigen::half, int64_t, int64_t, Eigen::half>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_INT8_SUCC) {
  vector<DataType> data_types = {DT_INT8, DT_INT32, DT_INT32, DT_INT8};
  vector<vector<int64_t>> shapes = {{5, 5, 5}, {5}, {1}, {5, 5, 5}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_11.txt",
  ...
  RunUnsortedSegmentMinKernel<int8_t, int32_t, int32_t, int8_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_INT8_SUCC_WITHINT64ID) {
  vector<DataType> data_types = {DT_INT8, DT_INT64, DT_INT64, DT_INT8};
  vector<vector<int64_t>> shapes = {{5, 5, 5}, {5}, {1}, {5, 5, 5}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_12.txt",
  ...
  RunUnsortedSegmentMinKernel<int8_t, int64_t, int64_t, int8_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_INT64_SUCC) {
  vector<DataType> data_types = {DT_INT64, DT_INT32, DT_INT32, DT_INT64};
  vector<vector<int64_t>> shapes = {{10, 10}, {10}, {1}, {10, 10}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_13.txt",
  ...
  RunUnsortedSegmentMinKernel<int64_t, int32_t, int32_t, int64_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_INT64_SUCC_WITHINT64ID) {
  vector<DataType> data_types = {DT_INT64, DT_INT64, DT_INT64, DT_INT64};
  vector<vector<int64_t>> shapes = {{10, 10}, {10}, {1}, {10, 10}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_14.txt",
  ...
  RunUnsortedSegmentMinKernel<int64_t, int64_t, int64_t, int64_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_UINT8_SUCC) {
  vector<DataType> data_types = {DT_UINT8, DT_INT32, DT_INT32, DT_UINT8};
  vector<vector<int64_t>> shapes = {{10, 11, 12}, {10}, {1}, {10, 11, 12}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_15.txt",
  ...
  RunUnsortedSegmentMinKernel<uint8_t, int32_t, int32_t, uint8_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_UINT8_SUCC_WITHINT64ID) {
  vector<DataType> data_types = {DT_UINT8, DT_INT64, DT_INT64, DT_UINT8};
  vector<vector<int64_t>> shapes = {{10, 11, 12}, {10}, {1}, {10, 11, 12}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_16.txt",
  ...
  RunUnsortedSegmentMinKernel<uint8_t, int64_t, int64_t, uint8_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_UINT16_SUCC) {
  vector<DataType> data_types = {DT_UINT16, DT_INT32, DT_INT32, DT_UINT16};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_17.txt",
  ...
  RunUnsortedSegmentMinKernel<uint16_t, int32_t, int32_t, uint16_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_UINT16_SUCC_WITHINT64ID) {
  vector<DataType> data_types = {DT_UINT16, DT_INT64, DT_INT64, DT_UINT16};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_18.txt",
  ...
  RunUnsortedSegmentMinKernel<uint16_t, int64_t, int64_t, uint16_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_UINT32_SUCC) {
  vector<DataType> data_types = {DT_UINT32, DT_INT32, DT_INT32, DT_UINT32};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_19.txt",
  ...
  RunUnsortedSegmentMinKernel<uint32_t, int32_t, int32_t, uint32_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_UINT32_SUCC_WITHINT64ID) {
  vector<DataType> data_types = {DT_UINT32, DT_INT64, DT_INT64, DT_UINT32};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_20.txt",
  ...
  RunUnsortedSegmentMinKernel<uint32_t, int64_t, int64_t, uint32_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_UINT64_SUCC) {
  vector<DataType> data_types = {DT_UINT64, DT_INT32, DT_INT32, DT_UINT64};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_21.txt",
  ...
  RunUnsortedSegmentMinKernel<uint64_t, int32_t, int32_t, uint64_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, DATA_TYPE_UINT64_SUCC_WITHINT64ID) {
  vector<DataType> data_types = {DT_UINT64, DT_INT64, DT_INT64, DT_UINT64};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_22.txt",
  ...
  RunUnsortedSegmentMinKernel<uint64_t, int64_t, int64_t, uint64_t>(files, data_types, shapes);
}

TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, BIG_DATA_TYPE_INT32_SUCC) {
  vector<DataType> data_types = {DT_INT32, DT_INT32, DT_INT32, DT_INT32};
  vector<vector<int64_t>> shapes = {{4, 9, 1024}, {4}, {1}, {4, 9, 1024}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_23.txt",
...
TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, BIG_DATA_TYPE_INT32_SUCC_WITHINT64ID) {
  vector<DataType> data_types = {DT_INT32, DT_INT64, DT_INT64, DT_INT32};
  vector<vector<int64_t>> shapes = {{33, 1024}, {33}, {1}, {33, 1024}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_24.txt",
...
TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, BIG_DATA_TYPE_INT16_SUCC) {
  vector<DataType> data_types = {DT_INT16, DT_INT32, DT_INT32, DT_INT16};
  vector<vector<int64_t>> shapes = {{50, 1500}, {50}, {1}, {50, 1500}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_25.txt",
...
TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, BIG_DATA_TYPE_DOUBLE_SUCC) {
  vector<DataType> data_types = {DT_DOUBLE, DT_INT32, DT_INT32, DT_DOUBLE};
  vector<vector<int64_t>> shapes = {{1024, 33}, {1024}, {1}, {1024, 33}};
  vector<string> files{"unsorted_segment_min/data/unsorted_segment_min_data_input1_26.txt",
...
// exception instance
TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, OUTPUT_SHAPE_EXCEPTION) {
  vector<DataType> data_types = {DT_INT32, DT_INT32, DT_INT32, DT_INT32};
...
TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, INPUT1_DTYPE_EXCEPTION) {
...
TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, INPUT_NULL_EXCEPTION) {
  vector<DataType> data_types = {DT_INT32, DT_INT32, DT_INT32, DT_INT32};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
...
TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, OUTPUT_NULL_EXCEPTION) {
  vector<DataType> data_types = {DT_INT32, DT_INT32, DT_INT32, DT_INT32};
  vector<vector<int64_t>> shapes = {{3, 3}, {3}, {1}, {3, 3}};
  int32_t input1[9] = {(int32_t)1};
  int32_t input2[3] = {(int32_t)0};
...
TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, INPUT1_BOOL_UNSUPPORT) {
...
TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, INPUT2_BOOL_UNSUPPORT) {
...
TEST_F(TEST_UNSORTEDSEGMENTMIN_UT, INPUT3_BOOL_UNSUPPORT) {
