...
class TEST_MUL_KERNEL_UTest : public testing::Test {
  protected:
    virtual void SetUp() {}
...
TEST_F(TEST_MUL_KERNEL_UTest, scalar_mul_scalar) {
...
TEST_F(TEST_MUL_KERNEL_UTest, scalar_mul_vector) {
    cout<<"Test Kernel Begin."<<endl;
    int16_t input_0[1] = {1};
...
TEST_F(TEST_MUL_KERNEL_UTest, vector_mul_scalar) {
    cout<<"Test Kernel Begin."<<endl;
...
TEST_F(TEST_MUL_KERNEL_UTest, vector_mul_vector_match) {
    cout<<"Test Kernel Begin."<<endl;
...
TEST_F(TEST_MUL_KERNEL_UTest, vector_mul_vector_broatcast_0) {
    cout<<"Test Kernel Begin."<<endl;
    uint8_t input_0[1] = {1};
...
TEST_F(TEST_MUL_KERNEL_UTest, vector_mul_vector_broatcast_1) {
    cout<<"Test Kernel Begin."<<endl;
...
TEST_F(TEST_MUL_KERNEL_UTest, vector_mul_vector_broatcast_both) {
    cout<<"Test Kernel Begin."<<endl;
...
TEST_F(TEST_MUL_KERNEL_UTest, data_type_not_match) {
    cout<<"Test Kernel Begin."<<endl;
    float input_0[1] = {1};
    double input_1[1] = {1};
    float output[1] = {0};
...
TEST_F(TEST_MUL_KERNEL_UTest, data_type_not_support) {
    cout<<"Test Kernel Begin."<<endl;
    bool input_0[1] = {true};
    bool input_1[1] = {true};
    bool output[1] = {false};
...
TEST_F(TEST_MUL_KERNEL_UTest, bcast_max_size_not_match) {
    cout<<"Test Kernel Begin."<<endl;
    float input_0[1] = {1};
    float input_1[1] = {1};
    float output[1] = {0};
...
TEST_F(TEST_MUL_KERNEL_UTest, bcast_shape_not_match) {
    cout<<"Test Kernel Begin."<<endl;
    float input_0[1] = {1};
    float input_1[1] = {1};
    float output[1] = {0};
...
TEST_F(TEST_MUL_KERNEL_UTest, bcast_not_support) {
    cout<<"Test Kernel Begin."<<endl;
    float input_0[1] = {1};
    float input_1[1] = {1};
    float output[1] = {0};
