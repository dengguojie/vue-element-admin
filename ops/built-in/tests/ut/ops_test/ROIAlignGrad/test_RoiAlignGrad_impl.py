...
case1 = {"params": [
    {"shape": (2, 4, 16, 16, 16), "dtype": "float32", "format": "NC1HWC0", "ori_shape": (2, 4, 16, 16, 16),
     "ori_format": "NC1HWC0"},
    # x
...
case2 = {"params": [
    {"shape": (1, 1, 36, 36, 16), "dtype": "float32", "format": "NC1HWC0", "ori_shape": (1, 1, 36, 36, 16),
     "ori_format": "NC1HWC0"},
    # x
