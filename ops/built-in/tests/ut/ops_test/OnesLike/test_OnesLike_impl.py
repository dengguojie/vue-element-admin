...
ut_case = ElementwiseOpUT("OnesLike", None, None)
...
ut_case.add_precision_case("Ascend910", {"params": [{"shape": (1, 24, 1, 256), "dtype": "int8", "format": "ND", "ori_shape": (1, 24, 1, 256),"ori_format": "ND", "param_type": "input"},
