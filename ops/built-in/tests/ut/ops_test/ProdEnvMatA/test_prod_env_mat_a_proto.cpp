...
class ProdEnvMatACalcRijTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "ProdEnvMatACalcRij Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "ProdEnvMatACalcRij Test TearDown" << std::endl;
  }
};

TEST_F(ProdEnvMatACalcRijTest, ProdEnvMatACalcRijVerifyTest_0) {
  ge::op::ProdEnvMatACalcRij op;
  op.UpdateInputDesc("coord", create_desc({1, 84984}, ge::DT_FLOAT));
  op.UpdateInputDesc("type", create_desc({1, 28328}, ge::DT_INT32));
  op.UpdateInputDesc("natoms", create_desc({4}, ge::DT_INT32));
  op.UpdateInputDesc("box", create_desc({1, 9}, ge::DT_FLOAT));
...
TEST_F(ProdEnvMatACalcRijTest, ProdEnvMatACalcRijVerifyTest_1) {
  int32_t nsample = 1;
  int32_t nloc = 12288;
  int32_t n_a_sel = 138;
  int32_t n_r_sel = 0;
...
TEST_F(ProdEnvMatACalcRijTest, ProdEnvMatACalcRijVerifyTest_2) {
  int32_t nsample = 1;
  int32_t nloc = 12288;
  int32_t n_a_sel = 138;
  int32_t n_r_sel = 0;
