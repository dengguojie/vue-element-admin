...
class asingrad : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "asingrad SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "asingrad TearDown" << std::endl;
  }
};

TEST_F(asingrad, asingrad_infer_shape_fp16) {
  ge::op::AsinGrad op;
...
TEST_F(asingrad, asingrad_infer_shape_1) {
  ge::op::AsinGrad op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 100}};
