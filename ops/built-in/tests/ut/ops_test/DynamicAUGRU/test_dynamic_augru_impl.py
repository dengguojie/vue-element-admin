...
def get_params(t_size, m_size, in_x, hidden_size, bias_dtype, data_range=[0.01, 0.1], init_data_range=[0.01, 0.1], seq_dtype='int32'):
    ...
    weight_att = {"shape":shape_att, "dtype":bias_dtype, "param_type": "input", "value_range": data_range, "ori_format": "NC1HWC0", "format": "NC1HWC0", "ori_shape": shape_x}
    ...
    i_att = {"shape":shape_c, "dtype":bias_dtype, "param_type": "output", "ori_format": "NC1HWC0", "format": "NC1HWC0", "ori_shape": shape_x}
    return x, w1, w2, weight_att, b1, b2, seq, s_init_h_gm, output_y, output_h, i, i_att, r, n, hn
