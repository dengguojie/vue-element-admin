...
class erf : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "erf Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "erf Proto Test TearDown" << std::endl;
  }
};

TEST_F(erf, erf_infershape_diff_test){
  ge::op::Erf op;
...
TEST_F(erf, erf_infershape_same_test){
  ge::op::Erf op;
