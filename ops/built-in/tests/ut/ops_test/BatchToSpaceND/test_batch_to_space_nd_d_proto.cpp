...
class batch_to_space_nd_d_infer_test : public testing::Test {
  protected:
  static void SetUpTestCase() {
    std::cout << "batch_to_space_nd_d_infer_test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "batch_to_space_nd_d_infer_test TearDown" << std::endl;
  }
};

TEST_F(batch_to_space_nd_d_infer_test, batch_to_space_nd_d_infer_test_1) {
  ...
  auto crops = vector<int64_t>({0,0,0,0});
...
TEST_F(batch_to_space_nd_d_infer_test, batch_to_space_nd_d_infer_test_2) {
...
TEST_F(batch_to_space_nd_d_infer_test, batch_to_space_nd_d_infer_test_3) {
