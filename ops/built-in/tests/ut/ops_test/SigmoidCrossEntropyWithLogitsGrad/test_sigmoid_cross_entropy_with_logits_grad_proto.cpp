...
class SigmoidCrossEntropyWithLogitsGrad : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "SigmoidCrossEntropyWithLogitsGrad SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "SigmoidCrossEntropyWithLogitsGrad TearDown" << std::endl;
  }
};

TEST_F(SigmoidCrossEntropyWithLogitsGrad, scewlg_infer_shape_fp16) {
  ge::op::SigmoidCrossEntropyWithLogitsGrad op;
