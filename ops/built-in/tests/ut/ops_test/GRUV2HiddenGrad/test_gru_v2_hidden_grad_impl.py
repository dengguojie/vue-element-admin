...
from gru_numpy import gruv2_hidden_grad_data


ut_case = OpUT("gru_v2_hidden_grad", "impl.gru_v2_hidden_grad", "gru_v2_hidden_grad")


def calc_expect_func(weight_hidden, init_h, h, dy, dh, update, reset, new,
                     hidden_new, dh_prev, dgate_h, dnt_x):
    print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%" * 3)
...
def gen_gru_v2_hidden_grad_precision_case(shape_val, dtype):
    ...
    gru_dict = gruv2_hidden_grad_data(t, batch * 16, input_dim * 16, output_dim * 16, dtype, (0, 1),
    ...
    return {
        "params": [weight_hidden, init_h, h, dy, dh, update, reset, new,
                   hidden_new, dh_prev, dgate_h, dnt_x],
        "case_name": "gru_v2_hidden_grad",
