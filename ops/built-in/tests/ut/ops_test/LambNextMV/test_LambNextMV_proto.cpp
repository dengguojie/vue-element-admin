...
class LambNextMV_UT : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "LambNextMV_UT SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "LambNextMV_UT TearDown" << std::endl;
  }
};

TEST_F(LambNextMV_UT, InfershapeLambNextMV_001) {
  ge::op::LambNextMV op;
