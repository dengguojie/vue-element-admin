 ...
 *
 * @file test_FastGeluGrad_proto.cpp
 */
...
class fast_gelu_grad : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "fast_gelu_grad SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "fast_gelu_grad TearDown" << std::endl;
  }
};

TEST_F(fast_gelu_grad, fast_gelu_grad_infershape_test) {
