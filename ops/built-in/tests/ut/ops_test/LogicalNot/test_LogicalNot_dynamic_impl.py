...
ut_case = OpUT("LogicalNot", "impl.dynamic.logical_not", "logical_not")
...
case1 = {"params": [{"shape": (-1,), "dtype": "int8", "format": "ND", "ori_shape": (1,),"ori_format": "ND", "range":[(1, 100)]},
                    {"shape": (-1,), "dtype": "int8", "format": "ND", "ori_shape": (1,),"ori_format": "ND", "range":[(1, 100)]},
                    ],
