...
ut_case.add_case(["Ascend910A", "Ascend310P3", "Ascend610", "Ascend310"], case1)
ut_case.add_case(["Ascend910A", "Ascend310P3", "Ascend610", "Ascend310"], case2)

if __name__ == '__main__':
    ut_case.run(["Ascend910A", "Ascend310P3", "Ascend610", "Ascend310"])
