...
class xlogy:public testing::Test{
    protected:
        static void SetUpTestCase(){
            std::cout<<"xlogy Proto Test SetUp"<<std::endl;
        }

        static void TearDownTestCase(){
            std::cout<<"xlogy Proto Test TearDown"<<std::endl;
        }
};


TEST_F(xlogy,xlogy_infershape_diff_test){
    ge::op::Xlogy op;
