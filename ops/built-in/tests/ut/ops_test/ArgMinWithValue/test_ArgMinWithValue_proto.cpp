...
class arg_min_with_value : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "arg_min_with_value Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "arg_min_with_value Proto Test TearDown" << std::endl;
  }
};

TEST_F(arg_min_with_value, arg_min_with_value_infershape_1) {
  // set input info
...
TEST_F(arg_min_with_value, arg_min_with_value_infershape_2) {
  // set input info
...
TEST_F(arg_min_with_value, arg_min_with_value_infershape_3) {
  // set input info
