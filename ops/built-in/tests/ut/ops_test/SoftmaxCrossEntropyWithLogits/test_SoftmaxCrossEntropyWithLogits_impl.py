...
case11 = {"params": [{"shape": (64, 32, 1, 4), "dtype": "float32", "format": "NHWC", "ori_shape": (64, 32, 1, 4),"ori_format": "NHWC"},
         ...
         "format_expect": [],
         "support_expect": True}
case12 = {"params": [{"shape": (72, 9, 104, 50), "dtype": "float32", "format": "NHWC", "ori_shape": (72, 9, 104, 50),"ori_format": "NHWC"},
                     {"shape": (72, 9, 104, 50), "dtype": "float32", "format": "NHWC", "ori_shape": (72, 9, 104, 50),"ori_format": "NHWC"},
                     {"shape": (72, 1, 104, 50), "dtype": "float32", "format": "NHWC", "ori_shape": (72, 1, 104, 50),"ori_format": "NHWC"},
                     {"shape": (72, 9, 104, 50), "dtype": "float32", "format": "NHWC", "ori_shape": (72, 9, 104, 50),"ori_format": "NHWC"}],
