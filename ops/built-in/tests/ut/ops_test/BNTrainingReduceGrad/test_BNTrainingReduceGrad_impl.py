...
def gen_bn_training_reduce_grad_case1(shape_grads, shape_x_norm, shape_diff_scale, shape_diff_offset, shape_scale,
    ...
    return {"params": [{"shape":shape_grads, "ori_shape": shape_grads, "dtype":dtype, "format":"NDC1HWC0", "ori_format":"NDC1HWC0"},
            ...
            "format_expect": [],
            "support_expect": True}
case5 = gen_bn_training_reduce_grad_case1((2,3,2,2,2,16), (2,3,2,2,2,16), (1,1,2,1,1,16), (1,1,2,1,1,16), (1,1,2,1,1,16),
...
case3 = gen_bn_training_reduce_grad_case((2,3,4,2,19,16,1), (2,3,4,2,16), (1,3,1,1,16), (1,3,1,1,16), (1,3,1,1,16),
...
case1 = gen_bn_training_reduce_grad_case((2,3,4,2,18), (2,3,4,2,16), (1,3,1,1,16), (1,3,1,1,16), (1,3,1,1,16),
                                         (1,3,1,1,16), "float16", "float32", "bn_training_reduce_grad_1")
def test_op_select_format(test_arg):
    from impl.bn_training_reduce_grad import op_select_format
    op_select_format({"shape":(2,3,2,2,2,16), "ori_shape": (2,3,2,2,2,16), "dtype":"float16", "format":"NDC1HWC0", "ori_format":"NDC1HWC0"},
                     {"shape":(2,3,2,2,2,16), "ori_shape": (2,3,2,2,2,16), "dtype":"float16", "format":"NDC1HWC0", "ori_format":"NDC1HWC0"},
                     {"shape":(1,1,2,1,1,16), "ori_shape": (1,1,2,1,1,16), "dtype":"float32", "format":"NDC1HWC0", "ori_format":"NDC1HWC0"},
                     {"shape":(1,1,2,1,1,16), "ori_shape": (1,1,2,1,1,16), "dtype":"float32", "format":"NDC1HWC0", "ori_format":"NDC1HWC0"},
                     {"shape":(1,1,2,1,1,16), "ori_shape": (1,1,2,1,1,16), "dtype":"float32", "format":"NDC1HWC0", "ori_format":"NDC1HWC0"},
                     {"shape":(1,1,2,1,1,16), "ori_shape": (1,1,2,1,1,16), "dtype":"float32", "format":"NDC1HWC0", "ori_format":"NDC1HWC0"},
                     {"shape":(1,1,2,1,1,16), "ori_shape": (1,1,2,1,1,16), "dtype":"float32", "format":"NDC1HWC0", "ori_format":"NDC1HWC0"},
                     {"shape":(1,1,2,1,1,16), "ori_shape": (1,1,2,1,1,16), "dtype":"float16", "format":"NDC1HWC0", "ori_format":"NDC1HWC0"},0.001)
