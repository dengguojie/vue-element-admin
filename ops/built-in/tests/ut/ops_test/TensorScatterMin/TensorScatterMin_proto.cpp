...
class TensorScatterMin : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "TensorScatterMin Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "TensorScatterMin Proto Test TearDown" << std::endl;
  }
};

TEST_F(TensorScatterMin,
       tensor_scatter_max_infershape_verify_test) {
  ge::op::TensorScatterMin op;
