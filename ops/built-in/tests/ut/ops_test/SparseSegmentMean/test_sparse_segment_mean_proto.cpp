...
class SparseSegmentMeanTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "SparseSegmentMeanTest SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "SparseSegmentMeanTest TearDown" << std::endl;
  }
};

TEST_F(SparseSegmentMeanTest, InferShape) {
  ge::op::SparseSegmentMean op;
