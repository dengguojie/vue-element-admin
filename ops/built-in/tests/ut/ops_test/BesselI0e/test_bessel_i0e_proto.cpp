 ...
 *
 * @file test_bessel_i0e_proto.cpp
 *
 * @brief
 *
 * @version 1.0
...
class bessel_i0e:public testing::Test{
    protected:
        static void SetUpTestCase(){
            std::cout<<"bessel_i0e Proto Test SetUp"<<std::endl;
        }

        static void TearDownTestCase(){
            std::cout<<"bessel_i0e Proto Test TearDown"<<std::endl;
        }
};


TEST_F(bessel_i0e,bessel_i0e_infershape_diff_test){
    ge::op::BesselI0e op;
