...
class softsign : public testing::Test {
 protected:
...
TEST_F(softsign, softsgin_infershape_diff_test){
  ge::op::Softsign op;
...
TEST_F(softsign, softsign_infershape_same_test){
  ge::op::Softplus op;
...
TEST_F(softsign,softsign_infershape_diff_test_1){
    ge::op::Softsign op;
