 ...
 *
 * @file test_matrix_diag_v3_proto.cpp
 *
 * @brief
 *
 * @version 1.0
...
class MatrixDiagV3 : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "MatrixDiagV3 test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "MatrixDiagV3 test TearDown" << std::endl;
  }
};

TEST_F(MatrixDiagV3, matrix_diag_v3_infer_shape) {
  ge::op::MatrixDiagV3 op;
...
TEST_F(MatrixDiagV3, matrix_diag_v3_infer_diagonal_shape_failed) {
  ge::op::MatrixDiagV3 op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}};
  auto tensor_desc1 = create_desc_shape_range({2},
                                             ge::DT_INT64, ge::FORMAT_ND,
  ...
  op.UpdateInputDesc("x", tensor_desc2);
  op.UpdateInputDesc("k", tensor_desc1);
  op.UpdateInputDesc("num_rows", tensor_desc2);
  op.UpdateInputDesc("num_cols", tensor_desc2);
  op.UpdateInputDesc("padding_value", tensor_desc2);
...
TEST_F(MatrixDiagV3, matrix_diag_v3_infer_k_shape_failed) {
  ge::op::MatrixDiagV3 op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}};
  auto tensor_desc1 = create_desc_shape_range({2},
                                             ge::DT_INT64, ge::FORMAT_ND,
...
TEST_F(MatrixDiagV3, matrix_diag_v3_infer_num_rows_shape_failed) {
  ge::op::MatrixDiagV3 op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}};
  auto tensor_desc1 = create_desc_shape_range({2},
                                             ge::DT_INT64, ge::FORMAT_ND,
...
TEST_F(MatrixDiagV3, matrix_diag_v3_infer_num_cols_shape_failed) {
  ge::op::MatrixDiagV3 op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}};
  auto tensor_desc1 = create_desc_shape_range({2},
                                             ge::DT_INT64, ge::FORMAT_ND,
...
TEST_F(MatrixDiagV3, matrix_diag_v3_infer_padding_value_shape_failed) {
  ge::op::MatrixDiagV3 op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}};
  auto tensor_desc1 = create_desc_shape_range({2},
                                             ge::DT_INT64, ge::FORMAT_ND,
...
TEST_F(MatrixDiagV3, matrix_diag_v3_infer_shape_k_num_failed) {
  ge::op::MatrixDiagV3 op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}};
  auto tensor_desc1 = create_desc_shape_range({2},
                                             ge::DT_INT64, ge::FORMAT_ND,
  ...
  auto tensor_desc2 = create_desc_shape_range({},
                                             ...
                                             {},
                                             ge::FORMAT_ND, {{}});
  auto const_desc = create_desc_shape_range({3},
...
TEST_F(MatrixDiagV3, matrix_diag_v3_infer_shape_k_val_failed) {
  ge::op::MatrixDiagV3 op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}};
  auto tensor_desc1 = create_desc_shape_range({2},
                                             ge::DT_INT64, ge::FORMAT_ND,
  ...
  auto tensor_desc2 = create_desc_shape_range({},
                                             ...
                                             {},
                                             ge::FORMAT_ND, {{}});
  auto const_desc = create_desc_shape_range({2},
                                             ge::DT_INT32, ge::FORMAT_ND,
                                             {},
                                             ge::FORMAT_ND, {{}});
  op.UpdateInputDesc("x", tensor_desc1);
...
TEST_F(MatrixDiagV3, matrix_diag_v3_infer_shape_k_val_failed2) {
  ge::op::MatrixDiagV3 op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}};
  auto tensor_desc1 = create_desc_shape_range({2},
                                             ge::DT_INT64, ge::FORMAT_ND,
...
TEST_F(MatrixDiagV3, matrix_diag_v3_infer_shape_k_val_failed3) {
  ge::op::MatrixDiagV3 op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}};
  auto tensor_desc1 = create_desc_shape_range({2},
                                             ge::DT_INT64, ge::FORMAT_ND,
  ...
  auto tensor_desc2 = create_desc_shape_range({},
                                             ...
                                             {},
                                             ge::FORMAT_ND, {{}});
  auto const_desc0 = create_desc_shape_range({2},
                                             ge::DT_INT32, ge::FORMAT_ND,
                                             {},
                                             ge::FORMAT_ND, {{}});
  auto const_desc = create_desc_shape_range({2},
  ...
  op.set_input_x(const_op0);
  op.UpdateInputDesc("x", const_desc0);
...
TEST_F(MatrixDiagV3, matrix_diag_v3_infer_shape_k_val_failed4) {
  ge::op::MatrixDiagV3 op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}};
  auto tensor_desc1 = create_desc_shape_range({2},
                                             ge::DT_INT64, ge::FORMAT_ND,
...
TEST_F(MatrixDiagV3, matrix_diag_v3_infer_shape_k_val_failed5) {
  ge::op::MatrixDiagV3 op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}};
  auto tensor_desc1 = create_desc_shape_range({2},
                                             ge::DT_INT64, ge::FORMAT_ND,
...
TEST_F(MatrixDiagV3, matrix_diag_v3_infer_shape_k_val_success) {
  ge::op::MatrixDiagV3 op;
  auto tensor_desc2 = create_desc_shape_range({},
                                             ge::DT_INT64, ge::FORMAT_ND,
                                             {},
  ...
  auto const_desc = create_desc_shape_range({2},
                                             ...
                                             {2},
                                             ge::FORMAT_ND, {{}});
  auto const_desc1 = create_desc_shape_range({},
                                             ge::DT_INT32, ge::FORMAT_ND,
                                             {},
                                             ge::FORMAT_ND, {{}});
  auto const_desc2 = create_desc_shape_range({},
                                             ge::DT_INT32, ge::FORMAT_ND,
                                             {},
                                             ge::FORMAT_ND, {{}});
  int32_t const_value0[2] = {2, 7};
