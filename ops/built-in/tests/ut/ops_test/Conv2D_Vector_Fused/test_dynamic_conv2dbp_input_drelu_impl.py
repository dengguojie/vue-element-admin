...
def test_conv2d_backprop_input_drelu_dynamic(test_arg):
    from te import tvm
    ...
    def shape_to_list(shape):
        ...
        for i in shape:
            ...
            j += 1
        return tmp
    print("[ conv2d_backprop_input_drelu_dynamic_case ]")
    ...
    groups = 1
    data_format = case[6]
    kernel_name = 'conv2d_backprop_input_drelu_dynamic_' + cce_conf.cce_conf.get_product_version()
...
ut_case.add_cust_test_func(test_func=test_conv2d_backprop_input_drelu_dynamic)
