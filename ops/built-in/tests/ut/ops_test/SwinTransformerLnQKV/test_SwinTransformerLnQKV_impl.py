...
from impl.swin_transformer_ln_qkv import swin_transformer_ln_qkv
ut_case = OpUT("SwinTransformerLnQKV", "impl.swin_transformer_ln_qkv", "swin_transformer_ln_qkv")


def create_case(batch, m, k, n, input_type, head_num, head_dim, seq_length, shifts, epsilon):
...
def add_case_310p3(test_arg):
    ...
    for index, case_0 in enumerate(case_all):
        ...
        params = create_case(batch, m, k, n, input_type, head_num, head_dim, seq_length, shifts, epsilon)
