...
class power:public testing::Test{
    protected:
        static void SetUpTestCase(){
            std::cout<<"power Proto Test SetUp"<<std::endl;
        }

        static void TearDownTestCase(){
            std::cout<<"power Proto Test TearDown"<<std::endl;
        }
};


TEST_F(power,power_infershape_diff_test){
    ge::op::Power op;
