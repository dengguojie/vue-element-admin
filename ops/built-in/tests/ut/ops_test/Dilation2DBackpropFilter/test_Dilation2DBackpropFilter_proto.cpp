...
class dilation2d_filter_infer_test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "dilation2d_filter_infer_test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "dilation2d_filter_infer_test TearDown" << std::endl;
  }
};

TEST_F(dilation2d_filter_infer_test, dilation2d_filter_infer_test_1) {
  ...
  // expect result
  std::vector<int64_t> expected_shape = {1, 3, 3, 64};
...
TEST_F(dilation2d_filter_infer_test, dilation2d_filter_infer_test_2) {
  ...
  // expect result
  std::vector<int64_t> expected_shape = {1, 3, 3, 16};
...
TEST_F(dilation2d_filter_infer_test, dilation2d_filter_infer_test_3) {
  std::vector<int64_t> stride_list = vector<int64_t>({1, 1, 1, 1});
  std::vector<int64_t> rate_list = vector<int64_t>({1, 1, 1, 1});
  ...
  // expect result
  std::vector<int64_t> expected_shape = {1, 3, 3, 1024};
...
TEST_F(dilation2d_filter_infer_test, dilation2d_filter_infer_test_4) {
  std::vector<int64_t> stride_list = vector<int64_t>({1, 1, 1, 1});
  std::vector<int64_t> rate_list = vector<int64_t>({1, 1, 1, 1});
  std::vector<int64_t> pads = vector<int64_t>({0, 0, 0, 0});
  std::string padding_mode = "VALID";
  ...
  // expect result
  std::vector<int64_t> expected_shape = {1, 1024, 3, 3};
...
TEST_F(dilation2d_filter_infer_test, VerifierDilation2DBackpropFilter_007) {
  ...
  op.UpdateInputDesc(
      "out_backprop", create_desc_with_ori({1, 1024, 17, 17}, ge::DT_FLOAT16, ge::FORMAT_NHWC, {1, 1024, 17}, ge::FORMAT_NHWC));
...
TEST_F(dilation2d_filter_infer_test, VerifierDilation2DBackpropFilter_019) {
  ge::op::Dilation2DBackpropFilter op;
  op.UpdateInputDesc("x", create_desc_with_ori({1, 1024, 17, 17}, ge::DT_FLOAT16, ge::FORMAT_NHWC, {1, 1024, 17, 17},
                                               ge::FORMAT_NHWC));
  op.UpdateInputDesc(
...
TEST_F(dilation2d_filter_infer_test, InfershapeDilation2DBackpropFilter_001) {
  ge::op::Dilation2DBackpropFilter op;
