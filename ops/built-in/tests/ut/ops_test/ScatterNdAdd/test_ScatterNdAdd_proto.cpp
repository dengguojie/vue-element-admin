...
class scatter_nd_add : public testing::Test {
protected:
    static void SetUpTestCase() {
        std::cout << "scatter_nd_add SetUp" << std::endl;
    }

    static void TearDownTestCase() {
        std::cout << "scatter_nd_add TearDown" << std::endl;
    }
};

// TODO fix me run failed
// normal cases
//TEST_F(scatter_nd_add, scatter_nd_add_infershape_test) {
//    ge::op::ScatterNdAdd op;
...
//}
//
//TEST_F(scatter_nd_add, scatter_nd_add_verify_test) {
//    ge::op::ScatterNdAdd op;
//    op.UpdateInputDesc("x", create_desc_with_ori({33, 5}, ge::DT_FLOAT16, ge::FORMAT_ND, {33, 5}, ge::FORMAT_ND));
//    op.UpdateInputDesc("indices", create_desc_with_ori({33, 25, 1}, ge::DT_INT32, ge::FORMAT_ND, {33, 25, 1}, ge::FORMAT_ND));
//    op.UpdateInputDesc("updates", create_desc_with_ori({33, 25, 5}, ge::DT_FLOAT16, ge::FORMAT_ND, {33, 25, 5}, ge::FORMAT_ND));
...
// exception cases
TEST_F(scatter_nd_add, scatter_nd_add_verify_invalid_test) {
    ge::op::ScatterNdAdd op;
