...
case5 = {"params": [{"shape": (-2, ), "dtype": "float32", "format": "C1HWNCoC0", "ori_shape": (1, 1, 512, 218, 10, 1), "ori_format": "C1HWNCoC0"},
                    {"shape": (-2, ), "dtype": "float32", "format": "C1HWNCoC0", "ori_shape": (1, 1, 512, 218, 10, 1), "ori_format": "C1HWNCoC0"},
                    {"shape": (-1,), "dtype": "float32", "format": "ND", "ori_shape": (1,), "ori_format": "ND", "range": [(1, 1)]},
                    {"shape": (-1,), "dtype": "float32", "format": "ND", "ori_shape": (1,), "ori_format": "ND", "range": [(1, 1)]},
                    {"shape": (-1,), "dtype": "float32", "format": "ND", "ori_shape": (1,), "ori_format": "ND", "range": [(1, 1)]},
                    {"shape": (-1,), "dtype": "float32", "format": "ND", "ori_shape": (1,), "ori_format": "ND", "range": [(1, 1)]},
         ...
         "case_name": "lars_v2_update_dynamic_4",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
