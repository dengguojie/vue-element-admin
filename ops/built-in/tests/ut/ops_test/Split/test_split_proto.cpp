...
TEST_F(SplitTest, split_test_infershape_diff_test_3) {
  ge::op::Split op;

  op.UpdateInputDesc("x", create_desc_shape_range({1, 100}, ge::DT_INT32, ge::FORMAT_ND, {1, 100}, ge::FORMAT_ND,{{1,-1},{100,100}}));
  op.SetAttr("num_split", 2);
