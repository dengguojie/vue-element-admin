...
case1 = {
    "params": [
        {"shape": (-1,), "dtype": "int32", "format": "NCHW", "ori_shape": (2, 4),"ori_format": "NCHW","range":[(1, 4)]},
        {"shape": (-1,), "dtype": "int32", "format": "NCHW", "ori_shape": (2, 4),"ori_format": "NCHW","range":[(1, 4)]},
    ],
...
case2 = {
    "params": [
        {"shape": (-1, -1, -1), "dtype": "int32", "format": "NC1HWC0", "ori_shape": (2, 4, 4),
                                "ori_format": "NC1HWC0","range":[(1, 4), (1, 4), (1, 4)]},
        {"shape": (-1, -1, -1), "dtype": "int32", "format": "NC1HWC0", "ori_shape": (2, 4, 4),
                                "ori_format": "NC1HWC0","range":[(1, 4), (1, 4), (1, 4)]},
    ],
