...
TEST_F(cast, cast_infershape_test4) {
  ...
  op.UpdateInputDesc("x",
                     create_desc_with_ori({4, 3, 4, 10}, ge::DT_INT32, ge::FORMAT_ND, {4, 3, 4, 10}, ge::FORMAT_ND));
  op.SetAttr("dst_type", 9);
...
TEST_F(cast, cast_infershape_test5) {
  ge::op::Cast op;
  op.UpdateInputDesc(
      "x", create_desc_with_ori({4, 3, 4, 10, 2}, ge::DT_FLOAT, ge::FORMAT_ND, {4, 3, 4, 10, 2}, ge::FORMAT_ND));
...
TEST_F(cast, cast_infershape_test6) {
  ge::op::Cast op;
  op.UpdateInputDesc(
      "x", create_desc_with_ori({4, 3, 4, 10, 2, 1}, ge::DT_BF16, ge::FORMAT_ND, {4, 3, 4, 10, 2, 1}, ge::FORMAT_ND));
  op.SetAttr("dst_type", 0);
...
TEST_F(cast, cast_infershape_test7) {
  ge::op::Cast op;
  op.UpdateInputDesc("x", create_desc_with_ori({4, 3, 4, 10, 2, 1, 5}, ge::DT_FLOAT16, ge::FORMAT_ND,
                                               {4, 3, 4, 10, 2, 1, 5}, ge::FORMAT_ND));
  op.SetAttr("dst_type", 27);
...
TEST_F(cast, cast_infershape_test8) {
  ge::op::Cast op;
  op.UpdateInputDesc("x", create_desc_with_ori({4, 3, 4, 10, 2, 1, 5}, ge::DT_BF16, ge::FORMAT_ND,
                                               {4, 3, 4, 10, 2, 1, 5}, ge::FORMAT_ND));
...
TEST_F(cast, cast_axis_type_1) {
  ...
  ge::InferAxisTypeInfoFunc infer_axis_type_info_func = ge::OperatorFactoryImpl::GetInferAxisTypeInfoFunc("Cast");
  EXPECT_NE(infer_axis_type_info_func, nullptr);
  std::vector<ge::AxisTypeInfo> axis_type_info;
  const uint32_t ret1 = static_cast<uint32_t>(infer_axis_type_info_func(op, axis_type_info));
