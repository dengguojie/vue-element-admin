...
precision_case1 = {"params": [{"shape": (2, 1, 2, 2, 16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (2, 2, 2, 1),"ori_format": "NHWC","param_type":"input"}, #x
                              {"shape": (8, 1, 2, 2, 16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (8, 2, 2, 1),"ori_format": "NHWC","param_type":"output"},
                              2, ((1, 1), (1, 1))
                              ],
                   "expect": "success",
