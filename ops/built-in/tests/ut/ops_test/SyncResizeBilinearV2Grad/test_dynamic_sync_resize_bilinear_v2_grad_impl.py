...
ut_case = OpUT("SyncResizeBilinearV2Grad", "impl.dynamic.sync_resize_bilinear_v2_grad", "sync_resize_bilinear_v2_grad")

case1 = {"params": [{"shape": (-1, -1, -1, -1, 16), "dtype": "float32", "format": "NCHW",
                    ...
                    False, False],
         "case_name": "dynamic_sync_resize_bilinear_v2_grad_fp16_to_fp16",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
...
case2 = {"params": [{"shape": (-1, -1, -1, -1, 16), "dtype": "float32", "format": "NCHW",
                    ...
                    {"shape": (-1, -1, -1, -1, 16), "dtype": "float32", "format": "NCHW",
                     "ori_shape": (34, 2, 1, 1, 16), "ori_format": "NCHW",
                     "range": [(1, None), (1, None), (1, None), (1, None), (1, None)]}, [32, 16], [8, 8], 0, 0,
                    False, True],
...
case3 = {"params": [{"shape": (-1, -1, -1, -1, 16), "dtype": "float32", "format": "NCHW",
                    ...
                    {"shape": (-1, -1, -1, -1, 16), "dtype": "float32", "format": "NCHW",
                     "ori_shape": (34, 2, 1, 1, 16), "ori_format": "NCHW",
                     "range": [(1, None), (1, None), (1, None), (1, None), (1, None)]}, [16, 16], [16, 8], 0, 0,
                    True, False],
