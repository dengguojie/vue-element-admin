...
#NHWC-3D-branch_1
case1 = {"params": [{"shape": (8, 2, 1, 2, 16), "dtype": "float16", "format": "NC1HWC0",
                     "ori_shape": (8, 2, 32), "ori_format": "NHWC"},
                    {"shape": (16, 2, 1, 2, 16), "dtype": "float16", "format": "NC1HWC0",
                     "ori_shape": (16, 2, 32), "ori_format": "NHWC"},
                    [2], [[1, 1]]],
         "case_name": "space_to_batch_nd_d_1",
         "expect": "success",
         "support_expect": True}
case1_1 = {"params": [{"shape": (8, 2, 1, 2, 16), "dtype": "float16", "format": "NC1HWC0",
                       "ori_shape": (8, 2, 32), "ori_format": "NHWC"},
                      {"shape": (16, 2, 1, 2, 16), "dtype": "float16", "format": "NC1HWC0",
                       "ori_shape": (16, 2, 32), "ori_format": "NHWC"},
                      [2], [1, 1]],
...
#NHWC-4D-brach_1
ut_case.add_precision_case("all", {"params": [{"shape": (4, 2, 2, 2, 16), "dtype": "float16", "format": "NC1HWC0",
                                               "ori_shape": (4, 2, 2, 32), "ori_format": "NHWC",
                                               "param_type": "input", "value_range": [-10, 10]},
                                              {"shape": (16, 2, 2, 2, 16), "dtype": "float16", "format": "NC1HWC0",
                                               "ori_shape": (16, 2, 2, 32), "ori_format": "NHWC",
                                               "param_type": "output"},
                                              [2, 2], [[1, 1], [1, 1]]],
...
ut_case.add_precision_case("all", {"params": [{"shape": (4, 2, 2, 2, 16), "dtype": "float32", "format": "NC1HWC0",
                                               "ori_shape": (4, 32, 2, 2), "ori_format": "NCHW",
                                               "param_type": "input", "value_range": [-10, 10]},
                                              {"shape": (16, 2, 2, 2, 16), "dtype": "float32", "format": "NC1HWC0",
                                               "ori_shape": (16, 32, 2, 2), "ori_format": "NCHW",
                                               "param_type": "output"},
                                              [1, 2, 2], [[0, 0], [1, 1], [1, 1]]],
                                   "calc_expect_func": calc_expect_func_5hd,
                                   "precision_standard": precision_info.PrecisionStandard(0.001, 0.001)
