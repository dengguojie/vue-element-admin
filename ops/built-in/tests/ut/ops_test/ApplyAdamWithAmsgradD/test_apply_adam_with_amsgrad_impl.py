...
ut_case.add_precision_case("Ascend910A", {
    "params": [{"shape": (16, 32), "format": "ND", "dtype": "float32", "ori_shape": (16, 32),
                "ori_format": "ND", "param_type": "input"},
               {"shape": (16, 32), "format": "ND", "dtype": "float32", "ori_shape": (16, 32),
                "ori_format": "ND", "param_type": "input"},
               {"shape": (16, 32), "format": "ND", "dtype": "float32", "ori_shape": (16, 32),
                "ori_format": "ND", "param_type": "input"},
               {"shape": (16, 32), "format": "ND", "dtype": "float32", "ori_shape": (16, 32),
                "ori_format": "ND", "param_type": "input"},
               {"shape": (1,), "format": "ND", "dtype": "float32", "ori_shape": (1,),
                "ori_format": "ND", "param_type": "input"},
               {"shape": (1,), "format": "ND", "dtype": "float32", "ori_shape": (1,),
                "ori_format": "ND", "param_type": "input"},
               {"shape": (1,), "format": "ND", "dtype": "float32", "ori_shape": (1,),
...
ut_case.add_precision_case("Ascend910A", {
    "params": [{"shape": (2, 3, 4, 5), "format": "ND", "dtype": "float32",
                "ori_shape": (2, 3, 4, 5), "ori_format": "ND", "param_type": "input"},
               {"shape": (2, 3, 4, 5), "format": "ND", "dtype": "float32",
                "ori_shape": (2, 3, 4, 5), "ori_format": "ND", "param_type": "input"},
               {"shape": (2, 3, 4, 5), "format": "ND", "dtype": "float32",
                "ori_shape": (2, 3, 4, 5), "ori_format": "ND", "param_type": "input"},
               {"shape": (2, 3, 4, 5), "format": "ND", "dtype": "float32",
               ...
               {"shape": (2, 3, 4, 5), "format": "ND", "dtype": "float32",
                "ori_shape": (2, 3, 4, 5), "ori_format": "ND", "param_type": "input"},
               {"shape": (2, 3, 4, 5), "format": "ND", "dtype": "float32",
                "ori_shape": (2, 3, 4, 5), "ori_format": "ND", "param_type": "output"},
               {"shape": (2, 3, 4, 5), "format": "ND", "dtype": "float32",
                "ori_shape": (2, 3, 4, 5), "ori_format": "ND", "param_type": "output"},
               {"shape": (2, 3, 4, 5), "format": "ND", "dtype": "float32",
                "ori_shape": (2, 3, 4, 5), "ori_format": "ND", "param_type": "output"},
...
ut_case.add_precision_case("Ascend910A", {
    "params": [{"shape": (27, 9, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (27, 9, 7), "ori_format": "ND", "param_type": "input"},
               {"shape": (27, 9, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (27, 9, 7), "ori_format": "ND", "param_type": "input"},
               {"shape": (27, 9, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (27, 9, 7), "ori_format": "ND", "param_type": "input"},
               {"shape": (27, 9, 7), "format": "ND", "dtype": "float32",
               ...
               {"shape": (27, 9, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (27, 9, 7), "ori_format": "ND", "param_type": "input"},
               {"shape": (27, 9, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (27, 9, 7), "ori_format": "ND", "param_type": "output"},
               {"shape": (27, 9, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (27, 9, 7), "ori_format": "ND", "param_type": "output"},
               {"shape": (27, 9, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (27, 9, 7), "ori_format": "ND", "param_type": "output"},
...
ut_case.add_precision_case("Ascend910A", {
    "params": [{"shape": (17, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (17, 7), "ori_format": "ND", "param_type": "input"},
               {"shape": (17, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (17, 7), "ori_format": "ND", "param_type": "input"},
               {"shape": (17, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (17, 7), "ori_format": "ND", "param_type": "input"},
               {"shape": (17, 7), "format": "ND", "dtype": "float32",
               ...
               {"shape": (17, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (17, 7), "ori_format": "ND", "param_type": "input"},
               {"shape": (17, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (17, 7), "ori_format": "ND", "param_type": "output"},
               {"shape": (17, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (17, 7), "ori_format": "ND", "param_type": "output"},
               {"shape": (17, 7), "format": "ND", "dtype": "float32",
                "ori_shape": (17, 7), "ori_format": "ND", "param_type": "output"},
