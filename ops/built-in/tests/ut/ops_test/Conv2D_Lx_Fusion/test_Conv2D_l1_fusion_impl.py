...
def test_conv2d_l1(test_arg):
    ...
    def conv_layer(fm_shape, filter, pads, strides, bias_flag, data_flow, dilations,
        ...
        _conv_layer_cce(fm_shape, filter, fm_type, weight_type, output_type,
                           padh, padw, strideh, stridew, dilateh, dilatew, bias=bias_tensor, fusion_para=fusion_para,
    ...
    def run_testcase():
        testcases = tc.gen_dict_4_op("conv_l1_fusion_ut", platform="mini")
    ...
    def test_conv_lhisi():
        ...
        print("[ UNITTEST START conv2d l1_fusion]")
        run_testcase()
        set_ddk_version("v100")
