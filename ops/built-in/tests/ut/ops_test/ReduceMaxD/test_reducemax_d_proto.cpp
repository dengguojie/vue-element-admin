...
class ReduceMaxD : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "ReduceMaxD SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "ReduceMaxD TearDown" << std::endl;
  }
};

TEST_F(ReduceMaxD, reducemax_d_infer_shape_fp16) {
  ge::op::ReduceMaxD op;
...
TEST_F(ReduceMaxD, reducemax_d_infer_shape_fp32) {
  ge::op::ReduceMaxD op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}, {100, 200}, {4, 8}};
  auto tensor_desc = create_desc_shape_range({-1, 100, 4},
