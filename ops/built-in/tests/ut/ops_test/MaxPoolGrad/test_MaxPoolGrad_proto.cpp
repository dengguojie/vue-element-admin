...
class MaxPoolGrad_UT : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "MaxPoolGrad_UT SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "MaxPoolGrad_UT TearDown" << std::endl;
  }
};

TEST_F(MaxPoolGrad_UT, VerifyMaxPoolGrad_001) {
  ge::op::MaxPoolGrad op;
  op.UpdateInputDesc(
...
TEST_F(MaxPoolGrad_UT, VerifyMaxPoolGrad_002) {
  ge::op::MaxPoolGrad op;
...
TEST_F(MaxPoolGrad_UT, VerifyMaxPoolGrad_003) {
  ge::op::MaxPoolGrad op;
  op.UpdateInputDesc("x1", create_desc_with_ori({1, 6, 6, 6, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 6, 6, 6, 16},
                                                ge::FORMAT_NDHWC));
  op.UpdateInputDesc("x2", create_desc_with_ori({1, 2, 2, 2, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 2, 2, 2, 16},
...
TEST_F(MaxPoolGrad_UT, VerifyMaxPoolGrad_004) {
  ge::op::MaxPoolGrad op;
  op.UpdateInputDesc("x1", create_desc_with_ori({1, 6, 6, 6, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 6, 6, 6, 16},
                                                ge::FORMAT_NDHWC));
  op.UpdateInputDesc("x2", create_desc_with_ori({1, 2, 2, 2, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 2, 2, 2, 16},
...
TEST_F(MaxPoolGrad_UT, VerifyMaxPoolGrad_005) {
  ge::op::MaxPoolGrad op;
  op.UpdateInputDesc("x1", create_desc_with_ori({1, 6, 6, 6, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 6, 6, 6, 16},
                                                ge::FORMAT_NDHWC));
  op.UpdateInputDesc("x2", create_desc_with_ori({1, 2, 2, 2, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 2, 2, 2, 16},
...
TEST_F(MaxPoolGrad_UT, VerifyMaxPoolGrad_006) {
  ge::op::MaxPoolGrad op;
  op.UpdateInputDesc("x1", create_desc_with_ori({1, 6, 6, 6, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 6, 6, 6, 16},
                                                ge::FORMAT_NDHWC));
  op.UpdateInputDesc("x2", create_desc_with_ori({1, 2, 2, 2, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 2, 2, 2, 16},
...
TEST_F(MaxPoolGrad_UT, VerifyMaxPoolGrad_007) {
  ge::op::MaxPoolGrad op;
  op.UpdateInputDesc("x1", create_desc_with_ori({1, 6, 6, 6, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 6, 6, 6, 16},
                                                ge::FORMAT_NDHWC));
  op.UpdateInputDesc("x2", create_desc_with_ori({1, 2, 2, 2, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 2, 2, 2, 16},
...
TEST_F(MaxPoolGrad_UT, VerifyMaxPoolGrad_008) {
  ge::op::MaxPoolGrad op;
  op.UpdateInputDesc("x1", create_desc_with_ori({1, 6, 6, 6, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 6, 6, 6, 16},
                                                ge::FORMAT_NDHWC));
  op.UpdateInputDesc("x2", create_desc_with_ori({1, 2, 2, 2, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 2, 2, 2, 16},
...
TEST_F(MaxPoolGrad_UT, InfershapeMaxPoolGrad_001) {
  ge::op::MaxPoolGrad op;
  op.UpdateInputDesc("x1", create_desc_with_ori({1, 6, 6, 6, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 6, 6, 6, 16},
                                                ge::FORMAT_NDHWC));
  op.UpdateInputDesc("x2", create_desc_with_ori({1, 2, 2, 2, 16}, ge::DT_FLOAT16, ge::FORMAT_NDHWC, {1, 2, 2, 2, 16},
