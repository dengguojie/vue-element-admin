...
class BatchMatMulV2RuntimeInferShape : public testing::Test {
};

TEST_F(BatchMatMulV2RuntimeInferShape, basic) {
  auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("BatchMatMulV2")->infer_shape;
