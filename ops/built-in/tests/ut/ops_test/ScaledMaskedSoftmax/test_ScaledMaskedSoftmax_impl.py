...
ut_case = OpUT("ScaledMaskedSoftmax", None, None)
...
case1 = {"params": [{"shape": (16,6,8,8,16,16), "dtype": "float16", "format": "FRACTAL_NZ", "ori_shape": (16,6,128,128),"ori_format": "ND"},
                    ...
                    2.0, 
                    True],
         "case_name": "ScaledMaskedSoftmax_1",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
...
case2 = {"params": [{"shape": (16,6,32,32,16,16), "dtype": "float16", "format": "FRACTAL_NZ", "ori_shape": (16,6,512,512),"ori_format": "ND"},
                    ...
                    3.0, 
                    False],
         "case_name": "ScaledMaskedSoftmax_2",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
...
case3 = {"params": [{"shape": (16,6,32,8,16,16), "dtype": "float16", "format": "FRACTAL_NZ", "ori_shape": (16,6,128,512),"ori_format": "ND"},
                    ...
                    2.0, 
                    False],
         "case_name": "ScaledMaskedSoftmax_3",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
...
case4 = {"params": [{"shape": (16,6,32,8,16,16), "dtype": "float16", "format": "FRACTAL_NZ", "ori_shape": (16,6,128,512),"ori_format": "ND"},
                    ...
                    3.0, 
                    False],
         "case_name": "ScaledMaskedSoftmax_4",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}

case5 = {"params": [{"shape": (17,6,32,8,16,16), "dtype": "float16", "format": "FRACTAL_NZ", "ori_shape": (17,6,128,512),"ori_format": "ND"},
                    {"shape": (17,1,32,8,16,16), "dtype": "bool", "format": "FRACTAL_NZ", "ori_shape": (17,1,128,512),"ori_format": "ND"},
                    {"shape": (17,6,32,8,16,16), "dtype": "float16", "format": "FRACTAL_NZ", "ori_shape": (17,6,128,512),"ori_format": "ND"},
                    4.0, 
                    False],
         "case_name": "ScaledMaskedSoftmax_5",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
