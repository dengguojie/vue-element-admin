...
class BN3DTrainingReduce : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "BN3DTrainingReduce SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "BN3DTrainingReduce TearDown" << std::endl;
  }
};

TEST_F(BN3DTrainingReduce, bn_3d_training_reduce_test_1) {
  ge::op::BN3DTrainingReduce op;
...
TEST_F(BN3DTrainingReduce, bn_3d_training_reduce_test_2) {
  ge::op::BN3DTrainingReduce op;
...
TEST_F(BN3DTrainingReduce, bn_3d_training_reduce_test_3) {
  ge::op::BN3DTrainingReduce op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 3}, {1, 2}, {4, 18},{4, 18},{4, 18}};
  auto tensor_desc = create_desc_shape_range({2,1,4,5,6},
