...
ut_case = OpUT("UnsortedSegment", "impl.dynamic.unsorted_segment", "unsorted_segment")


def gen_dynamic_unsorted_case(shape_input, range_input, num_segments,
                              range_num_segments, dtype_val, expect, instruction):
