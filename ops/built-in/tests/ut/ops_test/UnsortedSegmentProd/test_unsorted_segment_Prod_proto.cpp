...
class unsorted_segment_prod : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "unsorted_segment_prod SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "unsorted_segment_prod TearDown" << std::endl;
  }
};

TEST_F(unsorted_segment_prod, unsorted_segment_prod_infershape_diff_test_1) {
  ...
  auto tensor_num_segments = op.GetInputDescByName("num_segments");
...
TEST_F(unsorted_segment_prod, unsorted_segment_prod_infershape_diff_test_2) {
  ge::op::UnsortedSegmentSum op;
...
TEST_F(unsorted_segment_prod, unsorted_segment_prod_infershape_diff_test_3) {
  ge::op::UnsortedSegmentSum op;
...
TEST_F(unsorted_segment_prod, unsorted_segment_prod_infershape_diff_test_5) {
  ge::op::UnsortedSegmentSum op;
...
TEST_F(unsorted_segment_prod, unsorted_segment_prod_infershape_diff_test_6) {
  ge::op::UnsortedSegmentSum op;
...
TEST_F(unsorted_segment_prod, unsorted_segment_prod_infershape_diff_test_7) {
  ge::op::UnsortedSegmentSum op;
  op.UpdateInputDesc("x", create_desc_shape_range({3, 4, 5, 6, 7}, ge::DT_INT32, ge::FORMAT_ND, {3, 4, 5, 6, 7}, ge::FORMAT_ND,{{3,3},{4,4},{5,5},{6,6},{7,7}}));
...
TEST_F(unsorted_segment_prod, unsorted_segment_prod_infershape_diff_test_8) {
  ge::op::UnsortedSegmentSum op;
...
TEST_F(unsorted_segment_prod, unsorted_segment_prod_infershape_diff_test_9) {
  ge::op::UnsortedSegmentSum op;
...
TEST_F(unsorted_segment_prod, unsorted_segment_prod_infershape_diff_test_10) {
  ge::op::UnsortedSegmentSum op;
  op.UpdateInputDesc("x", create_desc_shape_range({3, 4, 5, 6, 7}, ge::DT_INT32, ge::FORMAT_ND, {3, 4, 5, 6, 7}, ge::FORMAT_ND,{{3,3},{4,4},{5,5},{6,6},{7,7}}));
  op.UpdateInputDesc("segment_ids", create_desc_shape_range({-2}, ge::DT_INT32, ge::FORMAT_ND, {-2}, ge::FORMAT_ND,{{1,100},{2,10}}));
