...
def gen_dynamic_reduce_max_case(shape_x, range_x, shape_axes, range_axes, dtype_val, format,
...
ut_case.add_case("all", gen_dynamic_reduce_max_case((-1,3,-1,2), [(1,None), (3,3), (1,None), (2,2)],
                                       (1,), [(1,1),], "float16", "ND", (-1,3,-1,2), (1, ), 
                                       True, "dynamic_reduce_max_fp16_ND", "success"))
