...
ut_case = OpUT("SigmoidGrad", "impl.dynamic.sigmoid_grad", "sigmoid_grad")
...
case1 = {"params": [{"shape": (-1,), "ori_shape": (2,), "range": ((1, None),), "format": "NHWC", "ori_format": "NHWC",
                    ...
                    {"shape": (-1,), "ori_shape": (2,), "range": ((1, None),), "format": "NHWC", "ori_format": "NHWC",
                     'dtype': "float32"}],
         "case_name": "sigmoid_grad_dynamic_1",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
...
case2 = {"params": [
    ...
    {"shape": (-1, 10), "ori_shape": (2, 10), "range": ((1, None), (10, 10)), "format": "NHWC", "ori_format": "NHWC",
     'dtype': "float16"}],
    "case_name": "sigmoid_grad_dynamic_2",
    "expect": "success",
    "format_expect": [],
    "support_expect": True}
...
case3 = {"params": [
    ...
    {"shape": (-1, 10), "ori_shape": (2, 10), "range": ((1, None), (10, 10)), "format": "NHWC", "ori_format": "NHWC",
     'dtype': "int32"}],
    "case_name": "sigmoid_grad_dynamic_3",
    "expect": RuntimeError,
    "format_expect": [],
    "support_expect": True}
...
case4 = {"params": [
    ...
    {"shape": (-1, 10), "ori_shape": (2, 10), "range": ((1, None), (10, 10)), "format": "ND", "ori_format": "ND",
     'dtype': "float16"}],
    "case_name": "sigmoid_grad_dynamic_4",
    "expect": RuntimeError,
    "format_expect": [],
    "support_expect": True}
...
case5 = {"params": [
    ...
    {"shape": (-1, 10, -1), "ori_shape": (2, 10, 3), "range": ((1, None), (10, 10), (1, None)), "format": "ND",
     "ori_format": "ND", 'dtype': "float32"}],
    "case_name": "sigmoid_grad_dynamic_5",
    "expect": RuntimeError,
    "format_expect": [],
    "support_expect": True}

case6 = {"params": [{"shape": (-2,), "ori_shape": (-2,), "range": ((1, None),), "format": "NHWC", "ori_format": "NHWC",
                     'dtype': "float32"},
                    {"shape": (-2,), "ori_shape": (-2,), "range": ((1, None),), "format": "NHWC", "ori_format": "NHWC",
                     'dtype': "float32"},
                    {"shape": (-2,), "ori_shape": (-2,), "range": ((1, None),), "format": "NHWC", "ori_format": "NHWC",
                     'dtype': "float32"}],
         "case_name": "sigmoid_grad_dynamic_6",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
