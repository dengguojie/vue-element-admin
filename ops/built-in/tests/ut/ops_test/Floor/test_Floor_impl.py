...
ut_case = ElementwiseOpUT("Floor", None, None)
...
ut_case.add_precision_case("Ascend910", {"params": [{"shape": (1, 3, 10, 16), "dtype": "float16", "format": "ND", "ori_shape": (1, 3, 10, 16),"ori_format": "ND", "param_type": "input"},
