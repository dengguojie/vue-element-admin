...
ut_case = ElementwiseOpUT("Square", None, None)
...
ut_case.add_elewise_case_simple(["Ascend910"], ["float16", "float32", "int32"], (192000, 512000))
ut_case.add_elewise_case_simple(["Ascend910"], ["float16", "float32", "int32"], (512000, 512000))
...
ut_case.add_precision_case("all", {"params": [{"shape": (2, 16, 32), "dtype": "int32", "format": "ND", "ori_shape": (2, 16, 32),"ori_format": "ND", "param_type": "input"},
