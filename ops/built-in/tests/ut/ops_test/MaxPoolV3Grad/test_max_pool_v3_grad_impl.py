...
"""
ori_input_value_4 = np.random.uniform(0.1, 1.0, size=(107, 176, 16, 147)).astype(np.float16)
ori_input_4 = {"dtype": "float16", "format": "NC1HWC0", "ori_format": "NHWC", "ori_shape": (107, 176, 16, 147),
             "shape": (107, 9, 176, 16, 16), "value": ori_input_value_4, "param_type": "input"}

ori_output_value_4 = max_pooling_forward(ori_input_4, None, [1, 19, 12, 1], [1, 55, 61, 1], "SAME", [0, 0, 0, 0],
                                       "NC1HWC0", False, False).astype(np.float16)

ori_output_4 = {"dtype": "float16", "format": "NC1HWC0", "ori_format": "NHWC", "ori_shape": (107, 4, 1, 147),
              "shape": (107, 9, 4, 1, 16), "value": ori_output_value_4, "param_type": "input"}

grad_4 = {"dtype": "float16", "format": "NC1HWC0", "ori_format": "NHWC", "ori_shape": (107, 4, 1, 147),
        "shape": (107, 9, 4, 1, 16), "value": ori_output_value_4, "param_type": "input"}

output_4 = {"dtype": "float16", "format": "ND", "ori_format": "ND", "ori_shape": (107, 4, 1, 147),
          "shape": (107, 9, 4, 1, 16), "param_type": "output"}

ut_case.add_case(["Ascend910A"], case={
     "params": [ori_input_4, ori_output_4, grad_4, output_4, [1, 19, 12, 1], [1, 55, 61, 1], "SAME", [0, 0, 0, 0], "NHWC", False, False]
 })
"""
