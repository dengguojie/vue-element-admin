...
SwinAttentionScore ut case
"""
from op_test_frame.ut import OpUT
from impl.swin_attention_score import swin_attention_score
from tbe.common.platform.platform_info import set_current_compile_soc_info


ut_case = OpUT("SwinAttentionScore", "impl.swin_attention_score",
               "swin_attention_score")

def test_tuili(batch_dim0, batch_dim1, seq_num, n_num, nz_dim, kernel_name):
    set_current_compile_soc_info("Ascend710")
    swin_attention_score({"shape": (batch_dim0, batch_dim1, n_num, seq_num, nz_dim, nz_dim), "dtype": "float16",
                           "format": "FRACTAL_NZ",
                          ...
                          {"shape": (batch_dim0, batch_dim1, n_num, seq_num, nz_dim, nz_dim), "dtype": "float16",
                           "format": "FRACTAL_NZ",
                           "ori_shape": (batch_dim0, batch_dim1, seq_num * nz_dim, n_num * nz_dim), "ori_format": "ND"},
                          {"shape": (1, batch_dim1, seq_num, seq_num, nz_dim, nz_dim), "dtype": "float16",
                           "format": "FRACTAL_NZ",
                           "ori_shape": (1, batch_dim1, seq_num * nz_dim, seq_num * nz_dim), "ori_format": "ND"},
...
def test_swin_attention_score_case001(test_args):

    kernel_name = "swin_attention_score"
    batch_dim0 = 32
    batch_dim1 = 16
    seq_num = 24
    n_num = 4
...
ut_case.add_cust_test_func(test_func=test_swin_attention_score_case001)
