...
def calc_expect_func(src, dst, src_format, dst_format):
    ...
    tmp_input_tensor = np.pad(input_tensor, ((0, n_pad), (0, 0), (0, 0), (0, 0), (0, c_pad)),
...
def gen_trans_data_precision_case(src, dst, dtype, case_name_val, expect,
    ...
    dst = (src[1], _ceil_div(src[4], c0_len), src[2], src[3], _ceil_div(src[0], 16), 16, c0_len)
...
ut_case.add_precision_case(["Ascend910"],
                           gen_trans_data_precision_case((16, 3, 3, 3, 5), (3, 2, 16, 16),
                                                         "float16", "ndhwc_2_fractal_z_3d_001",
                                                         "success"))
ut_case.add_precision_case(["Ascend910"],
                           gen_trans_data_precision_case((16, 3, 3, 3, 5), (3, 2, 16, 16),
                                                         "float32", "ndhwc_2_fractal_z_3d_002",
                                                         "success"))
ut_case.add_precision_case(["Ascend910"],
                           gen_trans_data_precision_case((128, 3, 3, 3, 64), (3, 2, 16, 16),
                                                         "float16", "ndhwc_2_fractal_z_3d_003",
                                                         "success"))
ut_case.add_precision_case(["Ascend910"],
                           gen_trans_data_precision_case((128, 3, 3, 3, 64), (3, 2, 16, 16),
                                                         "float32", "ndhwc_2_fractal_z_3d_004",
                                                         "success"))
ut_case.add_precision_case(["Ascend910"],
                           gen_trans_data_precision_case((128, 3, 3, 3, 2), (3, 2, 16, 16),
                                                         "float16", "ndhwc_2_fractal_z_3d_005",
                                                         "success"))
#ut_case.add_precision_case(["Ascend910"],
#                           gen_trans_data_precision_case((116, 3, 3, 1000, 61), (3, 2, 16, 16),
#                                                         "float16", "ndhwc_2_fractal_z_3d_006",
#                                                         "success"))
#ut_case.add_precision_case(["Ascend910"],
#                           gen_trans_data_precision_case((116, 3, 3, 1000, 61), (3, 2, 16, 16),
#                                                         "float32", "ndhwc_2_fractal_z_3d_007",
#                                                         "success"))
