...
ut_case = OpUT("UnsortedSegmentMin", "impl.dynamic.unsorted_segment_min", "unsorted_segment_min")
...
ut_case.add_case("Ascend910A",
                 gen_dynamic_unsorted_case([-1, 16, 10419, 3], [[16, 16], [16, 16], [10419, 10419], [3, 3]],
                                           -1, [[16, 16]], "float32", "success"))
