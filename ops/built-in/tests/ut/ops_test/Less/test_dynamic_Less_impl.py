...
ut_case = OpUT("Less", "impl.dynamic.less", "less")


def gen_dynamic_less_case(shape_x, shape_y, range_x, range_y, dtype_val,
...
ut_case.add_case("all",
                 gen_dynamic_less_case((-1,), (1,), ((2, 16),), ((1, 1),),
                                        "float16", "dynamic_less_fp16_ND",
                                        "success"))

ut_case.add_case("all",
                 gen_dynamic_less_case((-2,), (-2,), ((2, 16),), ((1, 1),),
                                        "float16", "dynamic_less_rank_ND",
                                        "success"))
