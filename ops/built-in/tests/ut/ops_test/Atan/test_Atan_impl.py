...
ut_case = ElementwiseOpUT("Atan", None, None)


# ============ auto gen ["Ascend910"] test cases start ===============
ut_case.add_elewise_case_simple(["Ascend910"], ["float16"], (1,))
ut_case.add_elewise_case_simple(["Ascend910"], ["float32"], (1, 1))
