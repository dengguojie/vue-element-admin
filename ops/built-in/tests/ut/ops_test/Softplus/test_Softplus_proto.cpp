...
class softplus : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "softplus Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "softplus Proto Test TearDown" << std::endl;
  }
};

TEST_F(softplus, softplus_infershape_diff_test){
  ge::op::Softplus op;
...
TEST_F(softplus, softplus_infershape_same_test){
  ge::op::Softplus op;
...
TEST_F(softplus,softplus_infershape_diff_test_1){
    ge::op::Softplus op;
