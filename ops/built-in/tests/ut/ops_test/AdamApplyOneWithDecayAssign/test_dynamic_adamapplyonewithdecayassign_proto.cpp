 ...
 *
 * @file test_dynamic_adamapplyonewithdecayassign_proto.cpp
 *
 * @brief
 *
 * @version 1.0
...
class AdamApplyOneWithDecayAssign : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "AdamApplyOneWithDecayAssign SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "AdamApplyOneWithDecayAssign TearDown" << std::endl;
  }
};

TEST_F(AdamApplyOneWithDecayAssign, adam_apply_one_with_decay_assign_case_0) {
  ge::op::AdamApplyOneWithDecayAssign op;
  ...
  op.UpdateInputDesc("input4", tensor_desc);
  op.UpdateInputDesc("const_mul_x", tensor_desc_1);
  op.UpdateInputDesc("const_mul1_x", tensor_desc_1);
  op.UpdateInputDesc("const_mul2_x", tensor_desc_1);
  op.UpdateInputDesc("const_mul3_x", tensor_desc_1);
