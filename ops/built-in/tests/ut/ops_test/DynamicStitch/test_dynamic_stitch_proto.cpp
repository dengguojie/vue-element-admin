...
class DynamicStitch : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "DynamicStitch SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "DynamicStitch TearDown" << std::endl;
  }
};

TEST_F(DynamicStitch, DynamicStitch_infershape_test_1) {
...
TEST_F(DynamicStitch, DynamicStitch_infershape_test_2) {
  ge::op::DynamicStitch op;
...
TEST_F(DynamicStitch, DynamicStitch_infershape_test_3) {
  ge::op::DynamicStitch op;
  auto tensor_desc1 = create_desc_with_ori({2, 3},
                                             ge::DT_FLOAT16, ge::FORMAT_ND,
                                             {2, 3},
                                             ge::FORMAT_ND);
  auto tensor_desc2 = create_desc_with_ori({3,4},
                                             ge::DT_FLOAT16, ge::FORMAT_ND,
                                             {3,4},
                                             ge::FORMAT_ND);
  op.create_dynamic_input_indices(2);
