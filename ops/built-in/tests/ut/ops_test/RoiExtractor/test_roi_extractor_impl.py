...
ut_case.add_case("Ascend310", generate_case([(1, 16, 78, 87), (1, 16, 19, 39), (1, 16, 18, 58), (1, 16, 24, 35)], (100, 5), (100, 16, 7, 7), "float16", 7))
ut_case.add_case("Ascend310", generate_case([(1, 16, 21, 65), (1, 16, 21, 22), (1, 16, 10, 18), (1, 16, 24, 15)], (1000, 5), (1000, 16, 7, 7), "float16", 7))
ut_case.add_case("Ascend310", generate_case([(1, 16, 21, 65), (1, 16, 21, 22), (1, 16, 10, 18), (1, 16, 24, 15)], (1000, 5), (1000, 16, 7, 7), "float32", 7))
ut_case.add_case("Ascend310", generate_case([(1, 16, 16, 16), (1, 16, 9, 9), (1, 16, 8, 8), (1, 16, 4, 5)], (1000, 5), (1000, 16, 7, 7), "float32", 7))
ut_case.add_case("Ascend310", generate_case([(1, 16, 16, 16), (1, 16, 9, 9), (1, 16, 8, 8), (1, 16, 4, 5)], (1000, 4), (1000, 16, 7, 7), "float32", 7, iserror=True))
