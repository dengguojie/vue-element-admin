...
protected:
    static void SetUpTestCase() {
        std::cout << "sqrt SetUp" << std::endl;
    }

    static void TearDownTestCase() {
        std::cout << "sqrt TearDown" << std::endl;
    }
};

TEST_F(sqrt, sqrt_infershape_test_0) {
ge::op::Sqrt op;
...
TEST_F(sqrt, sqrt_infershape_test_1) {
ge::op::Sqrt op;
...
TEST_F(sqrt, sqrt_infershape_test_2) {
ge::op::Sqrt op;
...
TEST_F(sqrt, sqrt_infershape_test_3) {
ge::op::Sqrt op;
