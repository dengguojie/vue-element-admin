...
class sinh : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "sinh Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "sinh Proto Test TearDown" << std::endl;
  }
};

TEST_F(sinh, sinh_infershape_diff_test){
  ge::op::Sinh op;
...
TEST_F(sinh, sinh_infershape_same_test){
  ge::op::Sinh op;
