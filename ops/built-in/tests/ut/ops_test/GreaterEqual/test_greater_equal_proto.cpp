 ...
 *
 * @file test_greater_equal_proto.cpp
 *
 * @brief
 *
 * @version 1.0
...
class greater_equal : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "greater_equal SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "greater_equal TearDown" << std::endl;
  }
};

TEST_F(greater_equal, greater_equal_infer_shape_fp16) {
