...
def _gen_outputs(input_var, input_grad_accum, input_grad_squa_accum,
    ...
    # 3.tmp_val = sign(grad_accum) * max鈦 | grad_accum | -l1 * global_step, 0} if l1 > 0 else grad_accum
...
precision_case1 = {"params": [{"shape": (1,), "dtype": "float16", "format": "ND", "ori_shape": (1,),"ori_format": "ND", "param_type":"input"},
                              ...
                              {"shape": (1,), "dtype": "float16", "format": "ND", "ori_shape": (1,),"ori_format": "ND", "param_type":"input"},
                              {"shape": (1,), "dtype": "float16", "format": "ND", "ori_shape": (1,),"ori_format": "ND", "param_type":"input"},
                              {"shape": (1,), "dtype": "int32", "format": "ND", "ori_shape": (1,),"ori_format": "ND", "param_type":"input"},
