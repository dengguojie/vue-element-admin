...
case6 = {"params": [{"shape": (2,2,111,9), "dtype": "float16", "format": "ND", "ori_shape": (2,2,111,9),"ori_format": "ND"},
                    {"shape": (2,6,333,1), "dtype": "float16", "format": "ND", "ori_shape": (2,6,333,1),"ori_format": "ND"},
                    3, "NHWC",
                    ],
        "case_name": "DepthToSpace_6",
        "expect": "success",
        "support_expect": True}

case7 = {"params": [{"shape": (1,1,1,1440), "dtype": "float16", "format": "ND", "ori_shape": (1,1,1,1440),"ori_format": "ND"},
                    {"shape": (1,4,4,90), "dtype": "float16", "format": "ND", "ori_shape": (1,4,4,90),"ori_format": "ND"},
                    4, "NHWC",
                    ],
        "case_name": "DepthToSpace_7",
        "expect": "success",
        "support_expect": True}
