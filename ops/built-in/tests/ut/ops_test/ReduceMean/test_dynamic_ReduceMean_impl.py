...
def gen_dynamic_reduce_mean_case(shape_x, range_x, shape_axes, range_axes, dtype_val, data_format,
    ...
    return {"params": [{"shape": shape_x, "dtype": dtype_val,
                       ...
                       {"shape": shape_x, "dtype": dtype_val,
                        "range": range_x, "format": data_format,
                        "ori_shape": ori_shape_x, "ori_format": data_format}, keepdims],
            "case_name": kernel_name_val,
            "expect": expect,
            "format_expect": [],
            "support_expect": True}

ut_case.add_case("all", gen_dynamic_reduce_mean_case((-1,3,-1,2), [(1,None), (3,3), (1,None), (2,2)],
