...
from impl.dynamic.pad_v3 import op_select_format

ut_case = OpUT("PadV3", "impl.dynamic.pad_v3", "op_select_format")
...
def test_op_select_format(test_arg):
    ...
    ret = op_select_format(
        tensor_dict(x_shape, "ND", x_dtype),
        tensor_dict(padding_shape, "ND", "int32", const_value=[0, 0, 0, 0, 1, 1, 1, 1]),
        tensor_dict(x_shape, "ND", x_dtype, is_output=True),
        tensor_dict([1,], "ND", x_dtype, const_value=0),
        "constant", True
    )
