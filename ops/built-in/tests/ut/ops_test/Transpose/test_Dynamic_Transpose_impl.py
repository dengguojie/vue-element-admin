...
#add_ts_case(["Ascend910A"], "int8",    (3, 19, 2, 3976),           (0, 2, 1, 3),           (3, 2, 19, 3976),        "random") # scenario_2, not ok
#add_ts_case(["Ascend910A"], "int8",    (3, 1900, 2, 13),           (0, 2, 1, 3),           (3, 2, 1900, 13),        "random") # scenario_2, not ok
add_ts_case(["Ascend910A"], "int8",    (2, 3, 3876),               (1, 0, 2),              (3, 2, 3876),            "random") # scenario_2, not ok
