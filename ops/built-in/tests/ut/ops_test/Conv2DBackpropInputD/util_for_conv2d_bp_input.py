...
def gen_padding_size(
    ...
    if isinstance(padding, (list, tuple)):
        return padding
    fmap_h = shape_x[data_format.index("H")]
    fmap_w = shape_x[data_format.index("W")]
    filter_h = filter_sizes[filter_format.index("H")]
    filter_w = filter_sizes[filter_format.index("W")]
