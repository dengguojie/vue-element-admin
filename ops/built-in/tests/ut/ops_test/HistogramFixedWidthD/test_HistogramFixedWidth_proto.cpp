...
class histogram_fixed_with : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "histogram_fixed_with Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "histogram_fixed_with Proto Test TearDown" << std::endl;
  }
};

TEST_F(histogram_fixed_with, histogram_fixed_with_infershape_1){
  // set input info
