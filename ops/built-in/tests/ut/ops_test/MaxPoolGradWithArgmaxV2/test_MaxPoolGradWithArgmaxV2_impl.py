...
case4 = {"params": [{"shape": (2,2,620,620,16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (2,2,620,620,16),"ori_format": "NC1HWC0"},
         ...
         "format_expect": [],
         "support_expect": True}
case5 = {"params": [{"shape": (2,32,136,136,16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (2,32,136,136,16),"ori_format": "NC1HWC0"},
                    {"shape": (2,32,68,68,16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (2,32,68,68,16),"ori_format": "NC1HWC0"},
                    {"shape": (2,32,4,290,16), "dtype": "uint16", "format": "NC1HWC0", "ori_shape": (2,32,4,290,16),"ori_format": "NC1HWC0"},
                    {"shape": (2,32,136,136,16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (2,32,136,136,16),"ori_format": "NC1HWC0"},
                    [1, 1, 2, 2],
                    [1, 1, 2, 2],
                    [1, 1, 0, 0]],
         "case_name": "max_pool_grad_with_arxmax_v2_5",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
case6 = {"params": [{"shape": (16,1,256,256,16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (16,1,256,256,16),"ori_format": "NC1HWC0"},
                    {"shape": (16,1,256,256,16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (16,1,256,256,16),"ori_format": "NC1HWC0"},
                    {"shape": (16,1,961,4097,16), "dtype": "uint16", "format": "NC1HWC0", "ori_shape": (16,1,961,4097,16),"ori_format": "NC1HWC0"},
                    {"shape": (16,1,256,256,16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (16,1,256,256,16),"ori_format": "NC1HWC0"},
                    [1, 1, 31, 31],
                    [1, 1, 1, 1],
                    [1, 1, 15, 15]],
         "case_name": "max_pool_grad_with_arxmax_v2_6",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
