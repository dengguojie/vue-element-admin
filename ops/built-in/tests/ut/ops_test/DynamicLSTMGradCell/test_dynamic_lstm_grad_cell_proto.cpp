...
TEST_F(DynamicLSTMGradCellTest, dynamic_lstm_v2_test_case_1_success) {
  ...
  t_state_desc.SetOriginShape(t_state_shape);
  ...
  std::vector<int64_t> expected_output_shape = {batch, 4 * input_size};
