...
//main case for strided_slice_v2
TEST_F(strided_slice_v2, strided_slice_v2_infer_shape_range_head) {
...
//main case for strided_slice_v2
TEST_F(strided_slice_v2, strided_slice_v2_infer_shape_range_tail) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
  test_dynamic<int32_t>({9, 10, 11, 12},
                {0, 0},
...
TEST_F(strided_slice_v2, strided_slice_v2_infer_shape_range_no_all) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
  test_dynamic<int32_t>({9, 10, 11, 12},
                {},
...
TEST_F(strided_slice_v2, strided_slice_v2_infer_shape_range_begin_len_neg) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
...
TEST_F(strided_slice_v2, strided_slice_v2_infer_shape_range_no_stride_no_end) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
...
TEST_F(strided_slice_v2, strided_slice_v2_infer_shape_range_zero_input) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
...
TEST_F(strided_slice_v2, strided_slice_v2_infer_shape_range_net1) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
  test_dynamic<int32_t>({-1, 1, -1},
                {},
  ...
  std::vector<int64_t> expected_output_shape = {-1, -1, -1};
  std::vector<std::pair<int64_t, int64_t>> expected_shape_range = {{1, -1}, {0, 1}, {1, -1}};
  EXPECT_EQ(output_shape, expected_output_shape);
  EXPECT_EQ(output_shape_range, expected_shape_range);
}

TEST_F(strided_slice_v2, strided_slice_v2_infer_shape_normal_case1) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
  test_static<int32_t>({20, 10, 5} ,
                {0, 3},
                {10, 5},
                {1, 1},
                {1, 2},
  ...
  std::vector<int64_t> expected_output_shape = {20, 10, 2};
  std::vector<std::pair<int64_t, int64_t>> expected_shape_range = {};
  EXPECT_EQ(output_shape, expected_output_shape);
  EXPECT_EQ(output_shape_range, expected_shape_range);
}

TEST_F(strided_slice_v2, strided_slice_v2_infer_shape_normal_case2) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
  test_static<int32_t>({20, 10, 5} ,
                {0, 0},
...
TEST_F(strided_slice_v2, strided_slice_v2_infer_shape_normal_case3) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
  test_static<int64_t>({20, 10, 5} ,
...
TEST_F(strided_slice_v2, strided_slice_v2_infer_shape_normal_case4) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
...
TEST_F(strided_slice_v2, strided_slice_v2_infer_shape_normal_case6) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
  test_static<int64_t>({1, -1, 256} ,
                {1},
                {9223372036854775807},
                {1},
                {1},
  ...
  std::vector<int64_t> expected_output_shape = {1, -1, 256};
  std::vector<std::pair<int64_t, int64_t>> expected_shape_range = {{1, 1}, {0, -1}, {256, 256}};
  EXPECT_EQ(output_shape, expected_output_shape);
  EXPECT_EQ(output_shape_range, expected_shape_range);
}