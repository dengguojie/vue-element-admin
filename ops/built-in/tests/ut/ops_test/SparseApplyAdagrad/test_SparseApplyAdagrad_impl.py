...
import random
ut_case = OpUT("SparseApplyAdagrad", None, None)
...
def calc_expect_func(var, accum, lr, grad, indices, var_out, accum_out,
    ...
    outputArr = gen_training_ops.sparse_apply_adagrad(inputArr1_var, inputArr2_accum, lr[0], inputArr3_grad, inputArr4_indices, use_locking=use_locking,update_slots=update_slots)
...
ut_case.add_precision_case("Ascend910A", {
    'params': [{'shape': (33, 16), 'dtype': 'float32', 'ori_shape': (33, 16), 'ori_format': 'ND', 'format': 'ND', "param_type": "input"},
               ...
               {'shape': (1,), 'dtype': 'float32', 'ori_shape': (1,), 'ori_format': 'ND', 'format': 'ND',
                "param_type": "input", "value":np.array([0.01],dtype="float32")},
               {'shape': (33, 16), 'dtype': 'float32', 'ori_shape': (33, 16), 'ori_format': 'ND', 'format': 'ND', "param_type": "input"},
...
ut_case.add_precision_case("Ascend910A", {
    'params': [{'shape': (32, 3, 6, 32), 'dtype': 'float32', 'ori_shape': (32, 3, 6, 32), 'ori_format': 'ND', 'format': 'ND', "param_type": "input"},
               ...
               {'shape': (1,), 'dtype': 'float32', 'ori_shape': (1,), 'ori_format': 'ND', 'format': 'ND',
                "param_type": "input", "value": np.zeros((1,), dtype="float32")},
               {'shape': (32, 3, 6, 32), 'dtype': 'float32', 'ori_shape': (32, 3, 6, 32), 'ori_format': 'ND', 'format': 'ND', "param_type": "input"},
