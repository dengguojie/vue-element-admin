...
// ----------------SparseApplyAdagradProtoTest Begin-------------------
class SparseApplyAdagradProtoTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "SparseApplyAdagrad Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "SparseApplyAdagrad Proto Test TearDown" << std::endl;
  }
};


TEST_F(SparseApplyAdagradProtoTest, sparse_apply_adagrad_infershape_test){
  ge::op::SparseApplyAdagrad op;
...
TEST_F(SparseApplyAdagradProtoTest, sparse_apply_adagrad_verify_success_test){
  ge::op::SparseApplyAdagrad op;
  op.UpdateInputDesc("var", create_desc({2048, 16, 1024}, ge::DT_FLOAT));
  op.UpdateInputDesc("accum", create_desc({2048, 16, 1024}, ge::DT_FLOAT));
  op.UpdateInputDesc("lr", create_desc({1,}, ge::DT_FLOAT));
...
TEST_F(SparseApplyAdagradProtoTest, sparse_apply_adagrad_verify_failed_01_test){
  ge::op::SparseApplyAdagrad op;
  op.UpdateInputDesc("var", create_desc({2048, 16, 1024}, ge::DT_FLOAT));
