...
TEST_F(strided_slice_grad, strided_slice_grad_infer_shape_range_002) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
  testfalse<int32_t>({},
                     {},
...
TEST_F(strided_slice_grad, strided_slice_grad_infer_shape_range_003) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
  test<int32_t>({-2},
                {},
...
TEST_F(strided_slice_grad, strided_slice_grad_infer_shape_range_004) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
  test<int32_t>({-1},
                {},
...
TEST_F(strided_slice_grad, strided_slice_grad_infer_shape_range_005) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
  test<int32_t>({1},
                {},
...
TEST_F(strided_slice_grad, strided_slice_grad_infer_shape_range_006) {
  std::vector<int64_t> output_shape;
  std::vector<std::pair<int64_t,int64_t>> output_shape_range;
  test<int32_t>({-2},
                {},
