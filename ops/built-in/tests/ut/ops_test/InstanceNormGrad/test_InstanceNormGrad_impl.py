...
ut_case = OpUT("InstanceNormGrad", "impl.instance_norm_grad", "instance_norm_grad")


def gen_instance_norm_grad_case(shape_x, shape_gamma, shape_mean, data_format, dtype, kernel_name, expect):
    return {
        "params": [{
            "shape": shape_x,
            "ori_shape": shape_x,
