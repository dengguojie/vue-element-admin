...
class NonMaxSuppressionV4Test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "NonMaxSuppressionV4 SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "NonMaxSuppressionV4 TearDown" << std::endl;
  }
};

TEST_F(NonMaxSuppressionV4Test, non_max_suppressio_test_case_1) {
  ge::op::NonMaxSuppressionV4 op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 6, 4}, ge::DT_FLOAT, ge::FORMAT_ND, {2, 6, 4}, ge::FORMAT_ND));
  auto ret = op.InferShapeAndType();
  EXPECT_EQ(ret, ge::GRAPH_FAILED);
}

TEST_F(NonMaxSuppressionV4Test, non_max_suppressio_test_case_2) {
  ge::op::NonMaxSuppressionV4 op;
...
TEST_F(NonMaxSuppressionV4Test, non_max_suppressio_test_case_3) {
  ge::op::NonMaxSuppressionV4 op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 6}, ge::DT_FLOAT, ge::FORMAT_ND, {2, 6}, ge::FORMAT_ND));
...
TEST_F(NonMaxSuppressionV4Test, non_max_suppressio_test_case_4) {
  ge::op::NonMaxSuppressionV4 op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 6}, ge::DT_FLOAT, ge::FORMAT_ND, {2, 6}, ge::FORMAT_ND));
  op.UpdateInputDesc("scores", create_desc_with_ori({2}, ge::DT_FLOAT, ge::FORMAT_ND, {2}, ge::FORMAT_ND));
...
TEST_F(NonMaxSuppressionV4Test, non_max_suppressio_test_case_5) {
  ge::op::NonMaxSuppressionV4 op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 6}, ge::DT_FLOAT, ge::FORMAT_ND, {2, 6}, ge::FORMAT_ND));
  op.UpdateInputDesc("scores", create_desc_with_ori({3}, ge::DT_FLOAT, ge::FORMAT_ND, {3}, ge::FORMAT_ND));
  op.UpdateInputDesc("max_output_size", create_desc_with_ori({}, ge::DT_FLOAT, ge::FORMAT_ND, {}, ge::FORMAT_ND));
...
TEST_F(NonMaxSuppressionV4Test, non_max_suppressio_test_case_6) {
  ge::op::NonMaxSuppressionV4 op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 6}, ge::DT_FLOAT, ge::FORMAT_ND, {2, 6}, ge::FORMAT_ND));
  op.UpdateInputDesc("scores", create_desc_with_ori({3}, ge::DT_FLOAT, ge::FORMAT_ND, {3}, ge::FORMAT_ND));
  op.UpdateInputDesc("max_output_size", create_desc_with_ori({}, ge::DT_FLOAT, ge::FORMAT_ND, {}, ge::FORMAT_ND));
...
TEST_F(NonMaxSuppressionV4Test, non_max_suppressio_test_case_7) {
  ge::op::NonMaxSuppressionV4 op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 6}, ge::DT_FLOAT, ge::FORMAT_ND, {2, 6}, ge::FORMAT_ND));
  op.UpdateInputDesc("scores", create_desc_with_ori({2}, ge::DT_FLOAT, ge::FORMAT_ND, {2}, ge::FORMAT_ND));
  op.UpdateInputDesc("max_output_size", create_desc_with_ori({}, ge::DT_FLOAT, ge::FORMAT_ND, {}, ge::FORMAT_ND));
...
TEST_F(NonMaxSuppressionV4Test, non_max_suppressio_test_case_8) {
  ge::op::NonMaxSuppressionV4 op;
...
TEST_F(NonMaxSuppressionV4Test, non_max_suppressio_test_case_9) {
  ge::op::NonMaxSuppressionV4 op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 4}, ge::DT_FLOAT, ge::FORMAT_ND, {2, 4}, ge::FORMAT_ND));
  op.UpdateInputDesc("scores", create_desc_with_ori({2}, ge::DT_FLOAT, ge::FORMAT_ND, {2}, ge::FORMAT_ND));
  op.UpdateInputDesc("max_output_size", create_desc_with_ori({}, ge::DT_FLOAT, ge::FORMAT_ND, {}, ge::FORMAT_ND));
...
TEST_F(NonMaxSuppressionV4Test, non_max_suppressio_test_case_10) {
  ge::op::NonMaxSuppressionV4 op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 4}, ge::DT_FLOAT, ge::FORMAT_ND, {2, 4}, ge::FORMAT_ND));
  op.UpdateInputDesc("scores", create_desc_with_ori({2}, ge::DT_FLOAT, ge::FORMAT_ND, {2}, ge::FORMAT_ND));
  op.UpdateInputDesc("max_output_size", create_desc_with_ori({}, ge::DT_FLOAT, ge::FORMAT_ND, {}, ge::FORMAT_ND));
...
TEST_F(NonMaxSuppressionV4Test, non_max_suppressio_test_case_11) {
  ge::op::NonMaxSuppressionV4 op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 4}, ge::DT_FLOAT, ge::FORMAT_ND, {}, ge::FORMAT_ND));
  op.UpdateInputDesc("scores", create_desc_with_ori({2}, ge::DT_FLOAT, ge::FORMAT_ND, {}, ge::FORMAT_ND));
  op.UpdateInputDesc("max_output_size", create_desc_with_ori({}, ge::DT_FLOAT, ge::FORMAT_ND, {}, ge::FORMAT_ND));
  op.UpdateInputDesc("iou_threshold", create_desc_with_ori({}, ge::DT_FLOAT, ge::FORMAT_ND, {}, ge::FORMAT_ND));
  op.UpdateInputDesc("score_threshold", create_desc_with_ori({}, ge::DT_FLOAT, ge::FORMAT_ND, {}, ge::FORMAT_ND));
  op.SetAttr("pad_to_max_output_size", true);
