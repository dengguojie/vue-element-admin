...
class NonMaxSuppressionTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "NonMaxSuppression SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "NonMaxSuppression TearDown" << std::endl;
  }
};

TEST_F(NonMaxSuppressionTest, non_max_suppressio_test_case_1) {
...
TEST_F(NonMaxSuppressionTest, non_max_suppressio_test_case_2) {
  ge::op::NonMaxSuppression op;
...
TEST_F(NonMaxSuppressionTest, non_max_suppressio_test_case_3) {
  ge::op::NonMaxSuppression op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 6}, ge::DT_FLOAT, ge::FORMAT_ND, {2, 6}, ge::FORMAT_ND));
...
TEST_F(NonMaxSuppressionTest, non_max_suppressio_test_case_4) {
  ge::op::NonMaxSuppression op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 6}, ge::DT_FLOAT, ge::FORMAT_ND, {2, 6}, ge::FORMAT_ND));
  op.UpdateInputDesc("scores", create_desc_with_ori({2}, ge::DT_FLOAT, ge::FORMAT_ND, {2}, ge::FORMAT_ND));
  op.UpdateInputDesc("max_output_size", create_desc_with_ori({2}, ge::DT_FLOAT, ge::FORMAT_ND, {2}, ge::FORMAT_ND));
  auto ret = op.InferShapeAndType();
  EXPECT_EQ(ret, ge::GRAPH_FAILED);
}

TEST_F(NonMaxSuppressionTest, non_max_suppressio_test_case_5) {
  ge::op::NonMaxSuppression op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 6}, ge::DT_FLOAT, ge::FORMAT_ND, {2, 6}, ge::FORMAT_ND));
...
TEST_F(NonMaxSuppressionTest, non_max_suppressio_test_case_6) {
  ge::op::NonMaxSuppression op;
  op.UpdateInputDesc("boxes", create_desc_with_ori({2, 6}, ge::DT_FLOAT, ge::FORMAT_ND, {2, 6}, ge::FORMAT_ND));
  op.UpdateInputDesc("scores", create_desc_with_ori({2}, ge::DT_FLOAT, ge::FORMAT_ND, {2}, ge::FORMAT_ND));
  op.UpdateInputDesc("max_output_size", create_desc_with_ori({}, ge::DT_FLOAT, ge::FORMAT_ND, {2}, ge::FORMAT_ND));
