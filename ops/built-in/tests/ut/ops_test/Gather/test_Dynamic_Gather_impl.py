...
Dynamic Gather ut case
"""
from op_test_frame.ut import OpUT

ut_case = OpUT("Gather", "impl.dynamic.gather", "gather")
...
def test_get_op_support_info(test_arg):
    ...
    get_op_support_info({"shape": [-2], "dtype": "int8", "format": "ND", "ori_shape": [20, 28], "ori_format": "ND"},
                        ...
                        {"shape": [200, 28], "dtype": "int8", "format": "NCHW", "ori_shape": [200, 28],
                         "ori_format": "ND"})
...
def gen_dynamic_gather_case(dict_params, dict_indices, dict_y, batch_dims, kernel_name_val, expect):
    return {"params": [dict_params, dict_indices, dict_y, True, batch_dims],
