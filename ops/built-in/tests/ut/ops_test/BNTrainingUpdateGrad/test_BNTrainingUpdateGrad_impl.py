...
case3 = gen_bn_training_update_grad_case((2,3,4,2,19,16,1), (2,3,4,2,16), (1,3,1,1,16), (1,3,1,1,16), "float16", "float32",
...
case5 = gen_bn_training_update_grad_case1((2,1,2,5,5,16), (2,1,2,5,5,16), (1,1,2,1,1,16), (1,1,2,1,1,16), "float16", "float32",
...
def test_op_select_format(test_arg):
    ...
    op_select_format({"shape":(2,1,2,5,5,16), "ori_shape": (2,1,2,5,5,16), "dtype":"float32", "format":"NDC1HWC0", "ori_format":"NDC1HWC0"},
                     {"shape":(2,1,2,5,5,16), "ori_shape": (2,1,2,5,5,16), "dtype":"float32", "format":"NDC1HWC0", "ori_format":"NDC1HWC0"},
    ...
    op_select_format({"shape":(1,2,1,32), "ori_shape": (1,2,1,32), "dtype":"float32", "format":"NCHW", "ori_format":"NCHW"},
                     {"shape":(1,2,1,32), "ori_shape": (1,2,1,32), "dtype":"float32", "format":"NCHW", "ori_format":"NCHW"},
