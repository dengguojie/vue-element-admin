...
# ============================================================================
"""
INTrainingReduceGrad ut testcase
"""
...
ut_case = OpUT("INTrainingReduceGrad", "impl.in_training_reduce_grad", "in_training_reduce_grad")


def gen_in_training_reduce_grad_case(shape_x, shape_var, shape_gamma, data_format, dtype_x, dtype_var, kernel_name,
                                     expect):
    return {
        "params": [{
            "shape": shape_x,
