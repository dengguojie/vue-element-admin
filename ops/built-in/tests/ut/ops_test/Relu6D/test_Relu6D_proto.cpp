...
class Relu6D : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "Relu6D Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "Relu6D Proto Test TearDown" << std::endl;
  }
};

TEST_F(Relu6D, relu6_d_infershape_test) {
  ge::op::Relu6D op;
