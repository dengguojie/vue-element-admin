...
ut_case = OpUT("NPUClearFloatStatus", None, None)
...
case1 = {"params": [{"shape": (1,2,4), "dtype": "float32", "format": "ND", "ori_shape": (1,2,4),"ori_format": "ND"},
         ...
         "case_name": "n_p_u_clear_float_status_1",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
case2 = {"params": [{"shape": (16,16), "dtype": "float32", "format": "ND", "ori_shape": (16,16),"ori_format": "ND"},
         ...
         "case_name": "n_p_u_clear_float_status_2",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
...
case5 = {"params": [{"shape": (1, 2), "dtype": "float32", "format": "ND", "ori_shape": (1, 2),"ori_format": "ND"},
         ...
         "case_name": "n_p_u_clear_float_status_5",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
