...
ut_case.add_precision_case("Ascend910", {"params": [{"shape": (1, 1), "dtype": "int32", "format": "ND", "ori_shape": (1, 1),"ori_format": "ND", "param_type": "input"},
...
ut_case.add_precision_case("Ascend910", {"params": [{"shape": (2, 16, 32), "dtype": "float32", "format": "ND", "ori_shape": (2, 16, 32),"ori_format": "ND", "param_type": "input"},
...
ut_case.add_precision_case("Ascend910", {"params": [{"shape": (1, 1024, 256), "dtype": "float32", "format": "ND", "ori_shape": (1, 1024, 256),"ori_format": "ND", "param_type": "input"},
