...
def test_conv3d_backprop_filter_fuzz_compile_head_node_1(test_arg):
    input_list = [
...
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_head_node_1)


def test_conv3d_backprop_filter_fuzz_compile_head_node_2(test_arg):
    # N dim exceeds limit
    input_list = [
...
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_head_node_2)


def test_conv3d_backprop_filter_fuzz_compile_head_node_3(test_arg):
    # D dim exceeds limit
    input_list = [
    ...
    res = conv3d_backprop_filter_generalization(*input_list)
    assert res == UNSUPPORTED_FUZZ_RES
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_head_node_3)


def test_conv3d_backprop_filter_fuzz_compile_head_node_4(test_arg):
    ...
    res = conv3d_backprop_filter_generalization(*input_list)
    assert res == UNSUPPORTED_FUZZ_RES
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_head_node_4)


def test_conv3d_backprop_filter_fuzz_compile_head_node_5(test_arg):
    # [-2]
    input_list = [
    ...
    res = conv3d_backprop_filter_generalization(*input_list)
    assert res == UNSUPPORTED_FUZZ_RES
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_head_node_5)


def test_conv3d_backprop_filter_fuzz_compile_head_node_6(test_arg):
    ...
    res = conv3d_backprop_filter_generalization(*input_list)
    assert res == UNSUPPORTED_FUZZ_RES
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_head_node_6)


def test_conv3d_backprop_filter_fuzz_compile_head_node_7(test_arg):
...
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_head_node_7)


def test_conv3d_backprop_filter_fuzz_compile_body_node_1(test_arg):
    input_list = [
        {'ori_shape': [-1, -1, -1, -1, 32], 'ori_format': 'NDHWC', 'dtype': 'float16',
        'ori_range': [[1, 1], [16, 31], [16, 31], [16, 31], [32, 32]],
        'range': [[1, 1], [16, 31], [16, 31], [16, 31], [32, 32]]},
...
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_body_node_1)


def test_conv3d_backprop_filter_fuzz_compile_body_node_2(test_arg):
    ...
    res = conv3d_backprop_filter_generalization(*input_list)
    assert res == UNSUPPORTED_FUZZ_RES
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_body_node_2)


def test_conv3d_backprop_filter_fuzz_compile_body_node_3(test_arg):
...
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_body_node_3)


def test_conv3d_backprop_filter_fuzz_compile_body_node_4(test_arg):
...
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_body_node_4)


def test_conv3d_backprop_filter_fuzz_compile_body_node_5(test_arg):
...
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_body_node_5)


def test_conv3d_backprop_filter_fuzz_compile_body_node_6(test_arg):
...
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_body_node_6)


def test_conv3d_backprop_filter_fuzz_compile_body_node_7(test_arg):
...
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_body_node_7)


def test_conv3d_backprop_filter_fuzz_compile_body_node_8(test_arg):
...
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_body_node_8)


def test_conv3d_backprop_filter_fuzz_compile_body_node_9(test_arg):
    # upper bound is -1
    input_list = [
        {'ori_shape': [-1, -1, -1, -1, 32], 'ori_format': 'NDHWC', 'dtype': 'float16',
    ...
    res = conv3d_backprop_filter_generalization(*input_list)
    assert res == [{'result': 'UNSUPPORTED', 'reason': {'param_index': [0, 2], 'type': ['upper_limit', 'upper_limit']}}]
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_body_node_9)


def test_conv3d_backprop_filter_fuzz_compile_body_node_10(test_arg):
    # fmap exceeds l1 size
    input_list = [
        {'ori_shape': [-1, -1, -1, -1, 32], 'ori_format': 'NDHWC', 'dtype': 'float16',
    ...
    res = conv3d_backprop_filter_generalization(*input_list)
    assert res == [{'result': 'UNSUPPORTED', 'reason': {'param_index': [0], 'type': ['upper_limit']}}]
ut_case.add_cust_test_func(test_func=test_conv3d_backprop_filter_fuzz_compile_body_node_10)
