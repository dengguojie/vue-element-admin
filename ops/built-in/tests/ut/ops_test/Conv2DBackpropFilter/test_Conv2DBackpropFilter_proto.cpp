...
// FuzzyCompile
TEST_F(Conv2DBackpropFilterProtoTest, Conv2DBackpropFilterFuzzyCompile) {
    ge::op::Conv2DBackpropFilter op;
...
TEST_F(Conv2DBackpropFilterProtoTest, Conv2DBackpropFilterFuzzyCompilePartialStatic) {
    ge::op::Conv2DBackpropFilter op;
    op.SetAttr("_fuzz_build", true);
    op.UpdateInputDesc("x",
                    create_desc_shape_range({-1, 14, 14, 256},
                                            ge::DT_FLOAT16,
                                            ge::FORMAT_NHWC,
                                            {-1, 14, 14, 256},
                                            ge::FORMAT_NHWC,
                                            {{5, 15}, {14, 14}, {14, 14}, {256, 256}}));
    op.UpdateInputDesc("out_backprop",
                    create_desc_shape_range({-1, 7, 7, 512},
                                            ge::DT_FLOAT16,
                                            ge::FORMAT_NHWC,
                                            {-1, 7, 7, 512},
                                            ge::FORMAT_NHWC,
                                            {{5, 15}, {7, 7}, {7, 7}, {512, 512}}));
    op.UpdateOutputDesc("y", create_desc_with_ori({512, 1, 1, 256},
        ge::DT_FLOAT16, ge::FORMAT_NHWC, {512, 1, 1, 256}, ge::FORMAT_NHWC));
    op.SetAttr("strides", {1, 1, 2, 2});
    op.SetAttr("pads", {0, 0, 0, 0});
    op.SetAttr("dilations", {1, 1, 1, 1});
    op.SetAttr("data_format","NCHW");
    ...
    std::vector<int64_t> dims_filter_size{512, 1, 1, 256};
    ge::Tensor constTensor;
    ge::TensorDesc tensor_desc_filter_size(ge::Shape(),
...
// FuzzyCompile groups=0
TEST_F(Conv2DBackpropFilterProtoTest, Conv2DBackpropFilterFuzzyCompileZeroGroups) {
    ge::op::Conv2DBackpropFilter op;
    op.SetAttr("_fuzz_build", true);
    op.UpdateInputDesc("x", create_desc_with_ori({128, 256, 14, 14},
        ge::DT_FLOAT16, ge::FORMAT_NCHW, {128, 256, 14, 14}, ge::FORMAT_NCHW));
...
// FuzzyCompile error groups
TEST_F(Conv2DBackpropFilterProtoTest, Conv2DBackpropFilterFuzzyCompileErrorGroups) {
    ge::op::Conv2DBackpropFilter op;
    op.SetAttr("_fuzz_build", true);
    op.UpdateInputDesc("x", create_desc_with_ori({128, 256, 14, 14},
        ge::DT_FLOAT16, ge::FORMAT_NCHW, {128, 256, 14, 14}, ge::FORMAT_NCHW));
