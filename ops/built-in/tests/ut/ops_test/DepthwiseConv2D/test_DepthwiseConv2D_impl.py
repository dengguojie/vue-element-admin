...
print("adding conv2d test_depthwiseconv2d_split_info_unknown_shape testcase")
ut_case.add_cust_test_func(test_func=test_depthwiseconv2d_split_info_unknown_shape)

def test_depthwiseconv2d_split_info_split_n(test_arg):
    input_list = [
        {
    ...
    get_op_support_info(*input_list)
print("adding conv2d test_depthwiseconv2d_split_info_split_n testcase")
ut_case.add_cust_test_func(test_func=test_depthwiseconv2d_split_info_split_n)

def test_depthwiseconv2d_split_info_split_h(test_arg):
    input_list = [
        {
            'ori_shape': (1, 64, -1, 32),
            'ori_format': 'NCHW',
    ...
    get_op_support_info(*input_list)
print("adding conv2d test_depthwiseconv2d_split_info_split_h testcase")
ut_case.add_cust_test_func(test_func=test_depthwiseconv2d_split_info_split_h)

def test_depthwiseconv2d_split_info_split_w(test_arg):
    input_list = [
        {
            'ori_shape': (1, 64, 32, -1),
            'ori_format': 'NCHW',
    ...
    get_op_support_info(*input_list)
print("adding conv2d test_depthwiseconv2d_split_info_split_w testcase")
ut_case.add_cust_test_func(test_func=test_depthwiseconv2d_split_info_split_w)

def test_depthwiseconv2d_split_info_split_nhw(test_arg):
    input_list = [
        {
            'ori_shape': (-1, 64, -1, -1),
            'ori_format': 'NCHW',
    ...
    get_op_support_info(*input_list)
print("adding conv2d test_depthwiseconv2d_split_info_split_nhw testcase")
ut_case.add_cust_test_func(test_func=test_depthwiseconv2d_split_info_split_nhw)

def test_depthwiseconv2d_split_info_split_bias(test_arg):
    input_list = [
        {
            'ori_shape': (-1, 64, -1, -1),
            'ori_format': 'NCHW',
