...
test_dynamic_slice_format_impl.py
"""
...
case_fz_002 = {
    "params": [{
        "shape": [4 * 23 * 45, 2, 16, 16],
        "dtype": "float32",
        "format": "FRACTAL_Z",
        "ori_shape": [32, 23, 45, 65],
        "ori_format": "NHWC",
        "sub_format": 1
    }, {
        "shape": (4,),
...
case_5hd = {
    "params": [{
        ...
        "ori_shape": (4,),
        "ori_format": "NHWC",
        "const_value": (17, 6, 5, -1)
    }, {
        "shape": (14, 4, 5, 3, 16),
        "dtype": "float16",
        "format": "NC1HWC0",
        "ori_shape": (14, 15, 3, 49),
        "ori_format": "NHWC"
    }],
...
case_6hd = {
    "params": [{
        "shape": (34, 23, 5, 45, 65, 16),
        "dtype": "float16",
        "format": "NDC1HWC0",
        "ori_shape": (34, 23, 45, 65, 79),
        "ori_format": "NDHWC"
    }, {
        "shape": (5,),
        "dtype": "int64",
...
def check_format(support_dtype, support_format, format_json):
    ...
    def check_param_format(param_name):
        ...
        if result_format != support_format:
            raise RuntimeError("format of {} expected:{} actual:{}".format(param_name, support_format, result_format))
...
def test_op_select_format_001(test_arg):
    ...
    expect_dtype = {
        'uint64', 'int8', 'uint16', 'bool', 'int16', 'int64', 'uint32', 'int32', 'float', 'float16', 'uint8'
    }
...
def test_op_select_format_005(test_arg):
    result = op_select_format(
        {
            "shape": [32, 23, 45, 65, 79],
            "dtype": "float32",
            "format": "NDHWC",
            "ori_shape": [32, 23, 45, 65, 79],
            "ori_format": "NDHWC",
            "sub_format": 1
        }, {
            "shape": (5,),
            ...
            "ori_shape": (5,),
            "ori_format": "NCHW",
            "const_value": (32, 6, 5, 7, 32)
        }, {
            "shape": [16, 5, 3, 7, 16],
            "dtype": "float32",
            "format": "NHHWC",
            "ori_shape": [16, 5, 3, 7, 16],
            "ori_format": "NDHWC"
        })
    expect_dtype = {
        'uint64', 'int8', 'uint16', 'bool', 'int16', 'int64', 'uint32', 'int32', 'float', 'float16', 'uint8'
...
def test_op_select_format_dy_001(test_arg):
    # shape_c is -1 and slice all c, will support NC1HWC0
    result = op_select_format(
        {
            "shape": [32, 23, 45, -1],
            "dtype": "float32",
            "format": "NHWC",
            "ori_shape": [32, 23, 45, -1],
            "ori_format": "NHWC"
        }, {
            "shape": (4,),
            "dtype": "int64",
    ...
    # shape_c is -1 and do not slice all c, will not support NC1HWC0
    result = op_select_format(
        {
            "shape": [32, 23, 45, -1],
            "dtype": "float32",
    ...
    # shape_c is -1 and slice align c, will support NC1HWC0
    result = op_select_format(
        {
            "shape": [32, 23, 45, -1],
            "dtype": "float32",
...
ut_case.add_cust_test_func(test_func=test_op_select_format_dy_001)
