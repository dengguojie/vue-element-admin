...
def calc_expect_func(x, output_size,  y, kernel_size, dilation, padding, stride):
    ...
    img_nchw = torch.nn.functional.fold(col_nckl, (img_h, img_w), kernel_size, dilation, padding, stride)
...
ut_case.add_precision_case("all", {
    "params": [
        {"dtype": "float16", "format": "NC1HWC0", "ori_format": "NC1HWC0", "ori_shape": (2,12,9,196,16), "shape": (2,12,9,196,16),
                "param_type": "input","range_value":[0.1,2.0]},
        {"dtype": "int32", "format": "ND", "ori_format": "ND", "ori_shape": (2,), "shape": (2,),
                "param_type": "input","range_value":[28,28]},
        {"dtype": "float16", "format": "NC1HWC0", "ori_format": "NC1HWC0", "ori_shape": (2,12,28,28,16), "shape": (2,12,28,28,16),
                "param_type": "output"}, 
        (3,3), (1,1), (1,1), (2,2)
    ],
    "calc_expect_func": calc_expect_func,
...
ut_case.add_precision_case("all", {
    "params": [
        {"dtype": "float32", "format": "NC1HWC0", "ori_format": "NC1HWC0", "ori_shape": (2,12,9,196,16), "shape": (2,12,9,196,16),
                "param_type": "input","range_value":[0.1,2.0]},
        {"dtype": "int32", "format": "ND", "ori_format": "ND", "ori_shape": (2,), "shape": (2,),
                "param_type": "input","range_value":[28,28]},
        {"dtype": "float32", "format": "NC1HWC0", "ori_format": "NC1HWC0", "ori_shape": (2,12,28,28,16), "shape": (2,12,28,28,16),
                "param_type": "output"}, 
        (3,3), (1,1), (1,1), (2,2)
    ],
    "calc_expect_func": calc_expect_func,
