...
TEST_F(Col2imTest, col2im_test_case_1){
    ...
    ge::TensorDesc x_tensor_desc = create_desc_with_ori(
        {2,3,9,16,16}, ge::DT_FLOAT, ge::FORMAT_NC1HWC0, {2,3,9,16,16}, ge::FORMAT_NC1HWC0
    );
...
TEST_F(Col2imTest, col2im_test_case_2){
    ...
    ge::TensorDesc x_tensor_desc = create_desc_with_ori(
        {1,9,16,16}, ge::DT_FLOAT, ge::FORMAT_NC1HWC0, {1,9,16,16}, ge::FORMAT_NC1HWC0
    );
    op.UpdateInputDesc("x", x_tensor_desc);
...
TEST_F(Col2imTest, col2im_test_case_3){
    ...
    ge::TensorDesc x_tensor_desc = create_desc_with_ori(
        {1,1,9,16,16}, ge::DT_FLOAT, ge::FORMAT_NC1HWC0, {1,1,9,16,16}, ge::FORMAT_NC1HWC0
    );
    op.UpdateInputDesc("x", x_tensor_desc);
