...
ut_case = OpUT("ReduceLogSumExp", "impl.dynamic.reduce_log_sum_exp", "reduce_log_sum_exp")

def gen_dynamic_reduce_log_sum_exp_case(shape_x, range_x, 
...
ut_case.add_case("all", gen_dynamic_reduce_log_sum_exp_case((-1,3,-1,2), [(1,None), (3,3), (1,None), (2,2)],
                                       (1,), [(1,1),], 
                                       (-1,1,-1,2), [(1,None), (1,1), (1,None), (2,2)], 
                                       "float16", "ND", 
                                       (4,3,4,2), (1, ), (4,1,4,2),
                                       True, 
                                       "dynamic_reduce_log_sum_exp_float16_true", 
                                       "success"))
ut_case.add_case("all", gen_dynamic_reduce_log_sum_exp_case((4,3,4,2), [(4,4), (3,3), (4,4), (2,2)],
                                       (1,), [(1,1),], 
                                       (4,4,2), [(4,4), (4,4), (2,2)], 
                                       "float32", "ND", 
                                       (4,3,4,2), (1, ), (4,4,2),
                                       False, 
                                       "static_reduce_log_sum_exp_float32_false", 
                                       "success"))
