 ...
 *
 * @file test_sparse_sparse_minimum_proto.cpp
 *
 * @brief
 *
 * @version 1.0
...
class SparseSparseMinimumTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "SparseSparseMinimum SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "SparseSparseMinimum TearDown" << std::endl;
  }
};

TEST_F(SparseSparseMinimumTest, InferShape_01) {
  ge::op::SparseSparseMinimum op;
