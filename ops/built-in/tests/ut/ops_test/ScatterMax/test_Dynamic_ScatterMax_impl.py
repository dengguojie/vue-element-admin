...
ut_case = OpUT("ScatterMax", "impl.dynamic.scatter_max", "scatter_max")


def gen_dynamic_scatter_max_case(shape_x, shape_y, range_x, range_y, dtype_val, kernel_name_val, expect):
...
ut_case.add_case("all",
                 gen_dynamic_scatter_max_case((-1,), (1,),
                                       ((1, None),), ((1, 1),),
                                       "float32", "dynamic_scatter_max_case", "success"))
