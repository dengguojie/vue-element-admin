...
case5 = {"params": [{"shape": (1, 4), "dtype": "float32", "format": "ND", "ori_shape": (1, 4),"ori_format": "ND"},
         ...
         "format_expect": [],
         "support_expect": True}
case6 = {"params": [{"shape": (1, 4), "dtype": "float32", "format": "ND", "ori_shape": (1, 4),"ori_format": "ND"},
                    {"shape": (16, 4), "dtype": "float32", "format": "ND", "ori_shape": (16, 4),"ori_format": "ND"},
                    {"shape": (16, 1), "dtype": "float32", "format": "ND", "ori_shape": (16, 1),"ori_format": "ND"},
                    "iou", 0.01],
         "case_name": "iou_6",
         ...
         "format_expect": [],
         "support_expect": True}
case7 = {"params": [{"shape": (1, 4), "dtype": "float32", "format": "ND", "ori_shape": (1, 4),"ori_format": "ND"},
                    {"shape": (16, 4), "dtype": "float32", "format": "ND", "ori_shape": (16, 4),"ori_format": "ND"},
                    {"shape": (16, 1), "dtype": "float32", "format": "ND", "ori_shape": (16, 1),"ori_format": "ND"},
                    "iou"],
         "case_name": "iou_7",
