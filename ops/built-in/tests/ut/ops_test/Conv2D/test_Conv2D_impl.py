...
def _test_get_op_support_info(test_arg):
    for index, test_case  in enumerate(tc.op_support_info_testcase):
...
for index_2, test_case in enumerate(tc.conv2D_ut_testcase):
    ut_case.add_case(test_case[0], gen_trans_data_case(*test_case[1:], index_2))
