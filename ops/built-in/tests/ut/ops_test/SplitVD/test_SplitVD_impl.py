...
case9 = {"params": [{"shape": (8, 46, 46, 63), "dtype": "float16", "format": "ND",
                     ...
                     "ori_shape": (8, 46, 46, 21),"ori_format": "ND"},
                     {"shape": (8, 46, 46, 21), "dtype": "float16", "format": "ND",
                     "ori_shape": (8, 46, 46, 21),"ori_format": "ND"},], [21, 21, 21], 3, 3],
         "case_name": "split_d_v_9",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}

case10 = {"params": [{"shape": (1, 128, 18, 32, 32), "dtype": "int8", "format": "NC1HWC0",
                     "ori_shape": (1, 18, 32, 4096),"ori_format": "NHWC"},
                     [{"shape": (1, 32, 18, 32, 32), "dtype": "int8", "format": "NC1HWC0",
                     "ori_shape": (1, 18, 32, 1024),"ori_format": "NHWC"},
                     {"shape": (1, 32, 18, 32, 32), "dtype": "int8", "format": "NC1HWC0",
                     "ori_shape": (1, 18, 32, 1024),"ori_format": "NHWC"},
                     {"shape": (1, 32, 18, 32, 32), "dtype": "int8", "format": "NC1HWC0",
                     "ori_shape": (1, 18, 32, 1024),"ori_format": "NHWC"},
                     {"shape": (1, 32, 18, 32, 32), "dtype": "int8", "format": "NC1HWC0",
                     "ori_shape": (1, 18, 32, 1024),"ori_format": "NHWC"}], [1024, 1024, 1024, 1024], 3, 4],
         "case_name": "split_d_v_10",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
