...
class LpNormTest : public testing::Test {
protected:
...
TEST_F(LpNormTest, lp_norm_infer_shape_p_1_keepdim_true) {
  ge::op::LpNorm op;
...
TEST_F(LpNormTest, lp_norm_infer_shape_p_2_keepdim_false) {
  ge::op::LpNorm op;
...
TEST_F(LpNormTest, lp_norm_infer_shape_fp16) {
  ge::op::LpNorm op;
