...
class ReduceLogSum : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "ReduceLogSum SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "ReduceLogSum TearDown" << std::endl;
  }
};

TEST_F(ReduceLogSum, reduce_log_sum_infer_shape_float16_int32_true) {
  ge::op::ReduceLogSum op;
...
TEST_F(ReduceLogSum, reduce_log_sum_infer_shape_float32_int64_false) {
  ge::op::ReduceLogSum op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{2, 2}, {100, 200}, {4, 8}};
  auto tensor_desc = create_desc_shape_range({-1, 100, 4},
                                             ge::DT_FLOAT, ge::FORMAT_ND,
