...
class space_to_batch_d_infer_test : public testing::Test {
protected:
  static void SetUpTestCase() {
    std::cout << "space_to_batch_d_infer_test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "space_to_batch_d_infer_test TearDown" << std::endl;
  }
};
...
TEST_F(space_to_batch_d_infer_test, space_to_batch_d_infer_test_2) {
...
TEST_F(space_to_batch_d_infer_test, space_to_batch_d_infer_test_3) {
