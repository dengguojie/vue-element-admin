...
class YoloV3DetectionOutputDTest_UT : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "YoloV3DetectionOutputDTest_UT test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "YoloV3DetectionOutputDTest_UT test TearDown" << std::endl;
  }
};

TEST_F(YoloV3DetectionOutputDTest_UT, InferShapeYoloV3DetectionOutputD_000) {
  ge::op::YoloV3DetectionOutputD op;
...
TEST_F(YoloV3DetectionOutputDTest_UT, InferShapeYoloV3DetectionOutputD_001) {
  ge::op::YoloV3DetectionOutputD op;
  op.UpdateInputDesc("coord_data_low", create_desc({1, 4, 1}, ge::DT_INT8));
...
TEST_F(YoloV3DetectionOutputDTest_UT, InferShapeYoloV3DetectionOutputD_002) {
  ge::op::YoloV3DetectionOutputD op;
