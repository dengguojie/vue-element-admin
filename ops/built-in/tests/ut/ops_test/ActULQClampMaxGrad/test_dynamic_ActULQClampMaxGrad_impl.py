...
ut_case.add_case(
    ...
    {'params': [
        ...
        {'shape': (1,), 'dtype': 'float16', 'format': 'ND', 'ori_shape': (1,), 'ori_format': 'ND'}],
        'expect': RuntimeError,
        'case_name': 'test_act_ulq_clamp_max_grad_float16_shape_range_none',
        'support_expect': True})
...
ut_case.add_case(
    ...
    {'params': [
        ...
        'expect': RuntimeError,
        'case_name': 'test_act_ulq_clamp_max_grad_float16_output_shape_error',
        'support_expect': True})
...
ut_case.add_case(
    ...
    {'params': [
        ...
        {'shape': (1,), 'dtype': 'float16', 'format': 'ND', 'ori_shape': (1,), 'ori_format': 'ND'}],
        'expect': RuntimeError,
        'case_name': 'test_act_ulq_clamp_max_grad_float16_clamp_max_mask_type_error',
        'support_expect': True})
...
ut_case.add_case(
    ...
    {'params': [
        ...
        {'shape': (1,), 'dtype': 'float16', 'format': 'ND', 'ori_shape': (1,), 'ori_format': 'ND'}],
        'expect': RuntimeError,
        'case_name': 'test_act_ulq_clamp_max_grad_float16_x_clamped_loss_type_error',
        'support_expect': True})
...
ut_case.add_case(
    ...
    {'params': [
        ...
        'expect': RuntimeError,
        'case_name': 'test_act_ulq_clamp_max_grad_float16_output_type_error',
        'support_expect': True})
