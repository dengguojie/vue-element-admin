...
ut_case = OpUT("BN3DTrainingReduceGrad", "impl.dynamic.bn3d_training_reduce_grad", "bn3d_training_reduce_grad")


# pylint: disable=too-many-arguments
def gen_bn3d_training_reduce_grad_case(shape_grads, shape_x_norm, shape_diff_scale, shape_diff_offset, shape_scale,
...
case1 = gen_bn3d_training_reduce_grad_case(
    ...
    "bn3d_training_reduce_grad_dynamic_003", "dynamic")

case2 = gen_bn3d_training_reduce_grad_case(
    ...
    "bn3d_training_reduce_grad_dynamic_005", "static")
