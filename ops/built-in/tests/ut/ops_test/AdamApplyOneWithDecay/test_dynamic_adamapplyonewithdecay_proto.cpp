 ...
 *
 * @file test_dynamic_adamapplyonewithdecay_proto.cpp
 *
 * @brief
 *
 * @version 1.0
...
class AdamApplyOneWithDecay : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "AdamApplyOneWithDecay SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "AdamApplyOneWithDecay TearDown" << std::endl;
  }
};

TEST_F(AdamApplyOneWithDecay, adam_apply_one_with_decay_case_0) {
  ge::op::AdamApplyOneWithDecay op;
