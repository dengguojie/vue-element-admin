...
ut_case = BroadcastOpUT("kl_div_loss_grad")
...
ut_case.add_case("Ascend910A", {
    "params": [{"dtype": "float16", "format": "ND", "ori_format": "ND", "ori_shape": (1,), "shape": (1,),
               ...
               "mean",
               False],
    "case_name": "test_kl_div_loss_grad_case_1"
})
...
ut_case.add_case("Ascend910A", {
    "params": [{"dtype": "float32", "format": "ND", "ori_format": "ND", "ori_shape": (1,), "shape": (1,),
               ...
               "mean",
               False],
    "case_name": "test_kl_div_loss_grad_case_2",
})
...
ut_case.add_case("Ascend910A", {
    "params": [{"dtype": "float32", "format": "ND", "ori_format": "ND", "ori_shape": (1,), "shape": (1,),
               ...
               "batchmean",
               False],
    "case_name": "test_kl_div_loss_grad_case_3",
})
...
ut_case.add_case("Ascend910A", {
    "params": [{"dtype": "float32", "format": "ND", "ori_format": "ND", "ori_shape": (1,), "shape": (1,),
               ...
               {"dtype": "float32", "format": "ND", "ori_format": "ND", "ori_shape": (3, 4, 5), "shape": (3, 4, 5),
                "param_type": "output"}],
    "case_name": "test_kl_div_loss_grad_case_4"
})
...
ut_case.add_case("Ascend910A", {
    "params": [{"dtype": "float32", "format": "ND", "ori_format": "ND", "ori_shape": (1,), "shape": (1,),
               ...
               "mean",
               True],
    "case_name": "test_kl_div_loss_grad_case_5",
})
