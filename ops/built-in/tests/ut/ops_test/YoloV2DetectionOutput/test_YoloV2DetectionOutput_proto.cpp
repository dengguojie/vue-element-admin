...
class YoloV2DetectionOutputTest_UT : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "YoloV2DetectionOutputTest_UT test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "YoloV2DetectionOutputTest_UT test TearDown" << std::endl;
  }
};

TEST_F(YoloV2DetectionOutputTest_UT, InferShapeYoloV2DetectionOutput_000) {
  ge::op::YoloV2DetectionOutput op;
...
TEST_F(YoloV2DetectionOutputTest_UT, InferShapeYoloV2DetectionOutput_001) {
  ge::op::YoloV2DetectionOutput op;
...
TEST_F(YoloV2DetectionOutputTest_UT, InferShapeYoloV2DetectionOutput_002) {
  ge::op::YoloV2DetectionOutput op;
