...
case1 = {"params": [{"shape": (65536, 128), "dtype": "float32", "format": "ND", "ori_shape": (65536, 128), "ori_format": "ND"},
...
case2 = {"params": [{"shape": (65536, 32), "dtype": "float32", "format": "ND", "ori_shape": (65536, 32), "ori_format": "ND"},
...
case3 = {"params": [{"shape": (65536, 128), "dtype": "float32", "format": "ND", "ori_shape": (65536, 128), "ori_format": "ND"},
...
case4 = {"params": [{"shape": (65536, 32), "dtype": "float32", "format": "ND", "ori_shape": (65536, 32), "ori_format": "ND"},
                    {"shape": (256, 32), "dtype": "float32", "format": "ND", "ori_shape": (256, 32), "ori_format": "ND"},
                    {"shape": (1, 256), "dtype": "float32", "format": "ND", "ori_shape": (1, 256), "ori_format": "ND"},
                    {"shape": (65536, 1), "dtype": "float32", "format": "ND", "ori_shape": (65536, 1), "ori_format": "ND"},
                    {"shape": (256, 32), "dtype": "float32", "format": "ND", "ori_shape": (256, 32), "ori_format": "ND"},
...
case5 = {"params": [{"shape": (256, 128), "dtype": "float32", "format": "ND", "ori_shape": (256, 128), "ori_format": "ND"},
                    {"shape": (128, 128), "dtype": "float32", "format": "ND", "ori_shape": (128, 128), "ori_format": "ND"},
                    {"shape": (1, 128), "dtype": "float32", "format": "ND", "ori_shape": (1, 128), "ori_format": "ND"},
                    {"shape": (256, 1), "dtype": "float32", "format": "ND", "ori_shape": (256, 1), "ori_format": "ND"},
                    {"shape": (128, 128), "dtype": "float32", "format": "ND", "ori_shape": (128, 128), "ori_format": "ND"},
         ...
         "case_name": "KMeansCentroids_5",
         "expect": "success",
         "support_expect": True}

case6 = {"params": [{"shape": (17680, 128), "dtype": "float32", "format": "ND", "ori_shape": (17680, 128), "ori_format": "ND"},
                    {"shape": (256, 128), "dtype": "float32", "format": "ND", "ori_shape": (256, 128), "ori_format": "ND"},
                    {"shape": (1, 256), "dtype": "float32", "format": "ND", "ori_shape": (1, 256), "ori_format": "ND"},
