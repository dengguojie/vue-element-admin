...
TEST_F(matmul_infer_test, fuzzy_compile_1) {
  auto shape_x1 = vector<int64_t>({32, 1LL + std::numeric_limits<int32_t>::max()});
  std::vector<std::pair<int64_t,int64_t>> range_x1 = {};
  auto shape_x2 = vector<int64_t>({1LL + std::numeric_limits<int32_t>::max(), 64});
...
TEST_F(matmul_infer_test, fuzzy_compile_2) {
  auto shape_x1 = vector<int64_t>({32, 64});
  std::vector<std::pair<int64_t,int64_t>> range_x1 = {};
