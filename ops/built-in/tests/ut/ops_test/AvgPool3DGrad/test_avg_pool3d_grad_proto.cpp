...
// invalid orig input shape
TEST_F(AvgPool3DGradProtoTest, StaticValidOrigInputShape){
  ge::op::AvgPool3DGrad op;
  op.UpdateInputDesc("grads", create_desc_with_ori(
    {16, 2, 3, 6, 1}, ge::DT_FLOAT16, ge::FORMAT_NDHWC,
    {16, 2, 1, 3, 6, 16}, ge::FORMAT_NDHWC));
  ...
  ge::Tensor constTensor;
  std::vector<int64_t> dims_orig_input_size{16 ,12 ,12 ,12 ,1, 1};
  ge::TensorDesc tensor_desc_input_size(ge::Shape({6}),
    ge::FORMAT_NDHWC, ge::DT_INT32);
  int element_size = dims_orig_input_size.size();
  tensor_desc_input_size.SetSize(element_size * sizeof(int32_t));
  constTensor.SetTensorDesc(tensor_desc_input_size);
...
// dynamic invalid pads case
TEST_F(AvgPool3DGradProtoTest, DynamicPadsInvalid){
  ge::op::AvgPool3DGrad op;
...
// dynamic const but invalid orig_input_shape case
TEST_F(AvgPool3DGradProtoTest, DynamicInvalidOrigInputShape){
  ge::op::AvgPool3DGrad op;
  ...
  op.UpdateInputDesc("grads", create_desc_shape_range(
    ...
    {{16,16},{2,2},{3,3},{3,3},{1,1}}));
  op.UpdateInputDesc("orig_input_shape", create_desc_shape_range(
    {16, 12, 12, 12, 1, 1}, ge::DT_FLOAT16, ge::FORMAT_NDHWC,
    {16, 12, 12, 12, 1, 1}, ge::FORMAT_NDHWC,
    {{16, 16}, {12, 12}, {12, 12}, {12, 12}, {1,1}}));
...
// dynamic invalid grads range dim case
TEST_F(AvgPool3DGradProtoTest, DynamicInvalidGradsRangeDim){
  ge::op::AvgPool3DGrad op;

  op.UpdateInputDesc("grads", create_desc_shape_range(
    {16, 2, 3, -1, 1}, ge::DT_FLOAT16, ge::FORMAT_NDHWC,
    {16, 2, 1, 3, -1, 16}, ge::FORMAT_NDHWC,
    {{16,16},{2,2},{3,3},{3,40},{1,1}, {1,1}}));
  op.UpdateInputDesc("orig_input_shape", create_desc_shape_range(
    {5}, ge::DT_FLOAT16, ge::FORMAT_NDHWC,
    {5}, ge::FORMAT_NDHWC, {{5, 5}}));
...
// dynamic invalid grads shape dim case
TEST_F(AvgPool3DGradProtoTest, DynamicInvalidGradsShapeDim){
  ge::op::AvgPool3DGrad op;

  op.UpdateInputDesc("grads", create_desc_shape_range(
    {16, 2, 3, -1, 1, 1}, ge::DT_FLOAT16, ge::FORMAT_NDHWC,
    {16, 2, 1, 3, -1, 16}, ge::FORMAT_NDHWC,
    {{16,16},{2,2},{3,3},{3,40},{1,1}}));
  op.UpdateInputDesc("orig_input_shape", create_desc_shape_range(
    {5}, ge::DT_FLOAT16, ge::FORMAT_NDHWC,
...
// dynamic output shape is all const case
TEST_F(AvgPool3DGradProtoTest, DynamicOutputAllConst){
  ge::op::AvgPool3DGrad op;

  op.UpdateInputDesc("grads", create_desc_shape_range(
    {1, 48, 4, -1, 1}, ge::DT_FLOAT16, ge::FORMAT_NDHWC,
    {1, 48, 1, 4, -1, 16}, ge::FORMAT_NDHWC,
    {{1,1},{48,48},{4,4},{8,8},{1,1}}));
  op.UpdateInputDesc("orig_input_shape", create_desc_shape_range(
    {5}, ge::DT_FLOAT16, ge::FORMAT_NDHWC,
    {5}, ge::FORMAT_NDHWC, {{5, 5}}));
...
// dynamic orig input shape has range
TEST_F(AvgPool3DGradProtoTest, DynamicOrigInputShapeRange){
  ge::op::AvgPool3DGrad op;
  ...
  op.UpdateInputDesc("grads", create_desc_shape_range(
    ...
    {{16,16},{2,2},{3,3},{3,3},{1,1}}));
  op.UpdateInputDesc("orig_input_shape", create_desc_shape_range(
    {-1, 12, 12, 12, 1}, ge::DT_FLOAT16, ge::FORMAT_NDHWC,
    {-1, 12, 12, 12, 1}, ge::FORMAT_NDHWC,
    {{16, 16}, {12, 12}, {12, 12}, {12, 12}, {1,1}}));
