...
dynamic_conv2d_transpose_testcase = [
    ...
    ((5, 5, 240, 240), (2, 14, 14, 240), (2, 28, 28, 240), (2, 2), (-1, -1, -1, -1), "NHWC", 1, [0, 2, 3], "success"),
...
def _gen_trans_data_case(param):
    ...
    if out_backprop_ori_shape == [-2]:
        ...
        x = {'shape': [4], 'format': 'NC1HWC0', 'ori_shape': [4], 'ori_format': 'NHWC', 'dtype': 'float16',
             'range': None}
        filter = {'shape': _shape_to_C1HWNCoC0(filter_ori_shape, "HWCN", dtype),
                  'ori_shape': filter_ori_shape, 'ori_format': 'HWCN',
