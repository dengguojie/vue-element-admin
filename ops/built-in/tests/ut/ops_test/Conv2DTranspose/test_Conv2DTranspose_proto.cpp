...
// Fuzzy Compile
TEST_F(Conv2DTransposeProtoTest, conv2dTransposeIneferFuzzyCompile) {
    ge::op::Conv2DTranspose op;
...
TEST_F(Conv2DTransposeProtoTest, conv2dTransposeIneferFuzzyCompilePartialStatic) {
    ge::op::Conv2DTranspose op;
    op.SetAttr("_fuzz_build", true);
    op.UpdateInputDesc("filter", create_desc_with_ori({512, 256, 1, 1},
                                ge::DT_FLOAT16, ge::FORMAT_NCHW, {512, 256, 1, 1}, ge::FORMAT_NCHW));
    op.UpdateInputDesc("x",
                       create_desc_shape_range({-1, 512, 7, 7},
                                               ge::DT_FLOAT16,
                                               ge::FORMAT_NCHW,
                                               {-1, 512, 7, 7},
                                               ge::FORMAT_NCHW,
                                               {{5, 15}, {512, 512}, {7, 7}, {7, 7}}));
    op.UpdateOutputDesc("y", create_desc_shape_range({-1, 256, 7, 7},
                                                    ge::DT_FLOAT16,
                                                    ge::FORMAT_NCHW,
                                                    {-1, 256, 7, 7},
                                                    ge::FORMAT_NCHW,
                                                    {{5, 15}, {256, 256}, {7, 7}, {7, 7}}));
