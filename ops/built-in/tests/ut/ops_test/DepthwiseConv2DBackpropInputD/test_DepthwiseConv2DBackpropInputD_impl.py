...
dp_conv2d_bp_input_op_testcase = [
    # fp16 without bias
    ((1, 960, 3, 3), (32, 960, 7, 7), (32, 960, 7, 7), 1, 1, (1, 1, 1, 1), "NCHW", "success"),
    ((1, 192, 5, 5), (16, 192, 1, 1), (16, 192, 2, 2), 2, 1, (2, 2, 2, 2), "NCHW", "success"),
    ((1, 96, 3, 3), (8, 96, 1, 1), (8, 96, 3, 3), 1, 1, (0, 0, 0, 0), "NCHW", "success"),
    ((1, 32, 3, 3), (1, 32, 2, 2), (1, 32, 5, 5), 2, 1, (0, 0, 0, 0), "NCHW", "success"),
