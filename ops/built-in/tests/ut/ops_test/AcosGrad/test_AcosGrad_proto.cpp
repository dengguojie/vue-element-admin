...
class acosgrad : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "acosgrad SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "acosgrad TearDown" << std::endl;
  }
};

TEST_F(acosgrad, acosgrad_infer_shape_fp16) {
  ge::op::AcosGrad op;
...
TEST_F(acosgrad, acosgrad_infer_same_test) {
  ge::op::AcosGrad op;
