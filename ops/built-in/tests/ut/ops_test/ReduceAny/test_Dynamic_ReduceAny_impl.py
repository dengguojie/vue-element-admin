...
ut_case = OpUT("ReduceAny", "impl.dynamic.reduce_any", "reduce_any")

def gen_dynamic_reduce_any_case(shape_x, range_x, shape_axes, range_axes, dtype_val, format,
...
ut_case.add_case(
    "all", gen_dynamic_reduce_any_case((-1,3,-1,2), [(1,None), (3,3), (1,None), (2,2)],
                                       (1,), [(1,1),], "int8", "ND", (-1,3,-1,2), (1, ), 
                                       True, "dynamic_reduce_any_fp16_ND", "success"))
