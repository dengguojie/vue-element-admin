...
ProdEnvMatACalcDescrpt ut case
"""
...
ut_case = OpUT("ProdEnvMatA", "impl.dynamic.prod_env_mat_a_calc_descrpt", "prod_env_mat_a_calc_descrpt")


def simple_water_test_910(test_args, nsample, nloc, nall, n_a_sel, n_r_sel, rcut_a, rcut_r, rcut_r_smth, sel_a, sel_r):
    nnei = n_a_sel + n_r_sel

    set_current_compile_soc_info("Ascend910A")
...
def test_prod_env_mat_a_calc_descrpt_case001(test_args):
    simple_water_test_910(test_args, 1, 12288, 28328, 138, 0, 0.0, 8.0, 2.0, [46, 92], [])


ut_case.add_cust_test_func(test_func=test_prod_env_mat_a_calc_descrpt_case001)
