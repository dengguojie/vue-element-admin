...
case1 = {"params": [{"shape": (1, -1), "dtype": "float16", "format": "ND", "ori_shape": (1, 16),
                    ...
                    {"shape": (1, -1), "dtype": "float16", "format": "ND", "ori_shape": (1, 16),
                     "ori_format": "ND", "range": [(1, 1), (1, None)]}],
         "case_name": "dynamic_apply_add_sign_d_001_float16",
         "expect": "success"}

case2 = {"params": [{"shape": (1, -1), "dtype": "float32", "format": "ND", "ori_shape": (1, 16),
                     "ori_format": "ND", "range": [(1, 1), (1, None)]},
                    ...
                    {"shape": (1, -1), "dtype": "float32", "format": "ND", "ori_shape": (1, 16),
                     "ori_format": "ND", "range": [(1, 1), (1, None)]}],
         "case_name": "dynamic_apply_add_sign_d_002_float32",
         "expect": "success"}
