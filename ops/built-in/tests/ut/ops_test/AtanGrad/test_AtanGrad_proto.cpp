...
class atangrad : public testing::Test {
protected:
    static void SetUpTestCase() {
        std::cout << "atangrad SetUp" << std::endl;
    }
    static void TearDownTestCase() {
        std::cout << "atangrad TearDown" << std::endl;
    }
};

TEST_F(atangrad, atangrad_infershape_diff_test) {
    ge::op::AtanGrad op;
...
// TEST_F(atangrad, atangrad_infershape_same_test) {
//     ge::op::AtanGrad op;
