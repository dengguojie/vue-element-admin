...
class arg_min_d : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "arg_min_d Proto Test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "arg_min_d Proto Test TearDown" << std::endl;
  }
};

TEST_F(arg_min_d, arg_min_d_infershape_1){
  // set input info
...
TEST_F(arg_min_d, arg_min_d_infershape_2){
  // set input info
...
TEST_F(arg_min_d, arg_min_d_infershape_3){
  // set input info
...
TEST_F(arg_min_d, InfershapeArgMinD_001){
  ge::op::ArgMinD op;
...
TEST_F(arg_min_d, InfershapeArgMinD_002){
  ge::op::ArgMinD op;
