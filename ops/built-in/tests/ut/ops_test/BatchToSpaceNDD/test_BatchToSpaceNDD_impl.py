...
#NHWC-3D-branch_1
case1 = {"params": [{"shape": (16, 2, 1, 2, 16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (16, 2, 32),
                     "ori_format": "NHWC"},
                    {"shape": (8, 2, 1, 2, 16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (8, 2, 32),
                     "ori_format": "NHWC"},
                    [2], [1, 1]],
...
#NHWC-4D-brach_2
case2 = {"params": [{"shape": (16, 2, 2, 2, 16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (16, 2, 2, 32),
                     "ori_format": "NHWC"},
                    {"shape": (4, 2, 2, 2, 16), "dtype": "float16", "format": "NC1HWC0", "ori_shape": (4, 2, 2, 32),
                     "ori_format": "NHWC"},
                    [2, 2], [[1, 1], [1, 1]]],
...
#NHWC-4D-brach_1
ut_case.add_precision_case("all", {"params": [{"shape": (16, 2, 2, 2, 16), "dtype": "float16", "format": "NC1HWC0",
                                               "ori_shape": (16, 2, 2, 32), "ori_format": "NHWC", "param_type": "input",
                                               "value_range": [-10, 10]}, {"shape": (4, 2, 2, 2, 16),
                                                                           "dtype": "float16",
                                                                           "format": "NC1HWC0",
                                                                           "ori_shape": (4, 2, 2, 32),
                                                                           "ori_format": "NHWC",
...
ut_case.add_precision_case("all", {"params": [{"shape": (16, 2, 2, 2, 16), "dtype": "float32", "format": "NC1HWC0",
                                               "ori_shape": (16, 32, 2, 2), "ori_format": "NCHW", "param_type": "input",
                                               "value_range": [-10, 10]}, {"shape": (4, 2, 2, 2, 16),
                                                                           "dtype": "float32",
                                                                           "format": "NC1HWC0",
                                                                           "ori_shape": (4, 32, 2, 2),
