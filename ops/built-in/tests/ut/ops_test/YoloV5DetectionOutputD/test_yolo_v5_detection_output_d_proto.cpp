...
TEST_F(YoloV5DetectionOutputDTest, InfershapeYoloV5DetectionOutputD_001) {
  ge::op::YoloV5DetectionOutputD op;
...
TEST_F(YoloV5DetectionOutputDTest, InfershapeYoloV5DetectionOutputD_002) {
  ge::op::YoloV5DetectionOutputD op;
  op.create_dynamic_input_x(1);
...
TEST_F(YoloV5DetectionOutputDTest, InfershapeYoloV5DetectionOutputD_003) {
  ge::op::YoloV5DetectionOutputD op;
  op.create_dynamic_input_x(1);
  op.UpdateDynamicInputDesc(
      "x", 0, create_desc_with_ori({1, 12, 6416}, ge::DT_FLOAT, ge::FORMAT_ND, {1, 12, 6416}, ge::FORMAT_ND));
...
TEST_F(YoloV5DetectionOutputDTest, InfershapeYoloV5DetectionOutputD_004) {
  ge::op::YoloV5DetectionOutputD op;
  op.create_dynamic_input_x(1);
  op.UpdateDynamicInputDesc(
      "x", 0, create_desc_with_ori({1, 12, 6416}, ge::DT_FLOAT, ge::FORMAT_ND, {1, 12, 6416}, ge::FORMAT_ND));
