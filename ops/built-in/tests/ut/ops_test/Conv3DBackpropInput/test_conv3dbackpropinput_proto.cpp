...
// fuzzy compile
TEST_F(Conv3DBackpropInputProtoTest, Conv3dbackpropinputFuzzyCompile)
{
    ge::op::Conv3DBackpropInput op;
    ...
    op.UpdateInputDesc("filter", create_desc_with_ori(
      {1, 1, 1, 256, 64}, ge::DT_FLOAT16, ge::FORMAT_NDHWC,
      {1, 1, 1, 256, 64}, ge::FORMAT_NDHWC));
    op.UpdateInputDesc("out_backprop", create_desc_with_ori(
      {1, 8, 56, 56, 64}, ge::DT_FLOAT16, ge::FORMAT_NDHWC,
      {1, 8, 56, 56, 64}, ge::FORMAT_NDHWC));

    ge::Tensor constTensor;
    std::vector<int64_t> dims_input_size{1, 8, 56, 56, 256};
    ge::TensorDesc tensor_desc_input_size(ge::Shape(),
      ge::FORMAT_NCDHW, ge::DT_INT32);
    int element_size = dims_input_size.size();
    tensor_desc_input_size.SetSize(element_size * sizeof(int32_t));
    ...
    op.UpdateOutputDesc("y", create_desc_with_ori(
      {1, 8, 56, 56, 256}, ge::DT_FLOAT16, ge::FORMAT_NDHWC,
      {1, 8, 56, 56, 256}, ge::FORMAT_NDHWC));
    ...
    out_backprop_desc.GetShapeRange(input_range);
    std::vector<std::pair<int64_t, int64_t>> expect_input_range = {{1, 1}, {8, 15}, {32, 63}, {32, 63}, {64, 64}};
