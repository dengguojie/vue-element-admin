...
class minimum_grad:public testing::Test{
    protected:
        static void SetUpTestCase(){
            std::cout<<"minimum_grad Proto Test SetUp"<<std::endl;
        }

        static void TearDownTestCase(){
            std::cout<<"minimum_grad Proto Test TearDown"<<std::endl;
        }
};


TEST_F(minimum_grad,minimum_grad_infershape_diff_test){
    ge::op::MinimumGrad op;
