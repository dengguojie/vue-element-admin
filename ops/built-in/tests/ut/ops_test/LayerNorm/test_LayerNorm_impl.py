...
def test_get_op_support_info_000(test_arg):
    ...
    input_gamma = {"shape": (32, 62,), "dtype": "float32", "format": "ND", "ori_shape": (32, 62), "ori_format": "ND",
                    "param_type": "input"}
    input_beta = {"shape": (32, 62,), "dtype": "float32", "format": "ND", "ori_shape": (32, 62), "ori_format": "ND",
                  "param_type": "input"}
