...
TEST_F(add, DataSliceAdd_001) {
  ge::op::Add op;
  std::vector<std::pair<int64_t, int64_t>> shape_range = {{1, 1}};
  auto tensor_desc =
      create_desc_shape_range({1}, ge::DT_FLOAT16, ge::FORMAT_FRACTAL_Z, {1}, ge::FORMAT_NCHW, shape_range);

  auto tensor_desc_1 = create_desc_shape_range({1}, ge::DT_FLOAT16, ge::FORMAT_ND, {1}, ge::FORMAT_ND, shape_range);
  op.UpdateInputDesc("x1", tensor_desc);
  op.UpdateInputDesc("x2", tensor_desc_1);
  op.UpdateOutputDesc("y", tensor_desc);
...
TEST_F(add, DataSliceAdd_002) {
  ge::op::Add op;
  std::vector<std::pair<int64_t, int64_t>> shape_range = {{1, 100}, {1, 100}, {1, 100}, {1, 100}, {1, 100}};
  auto tensor_desc = create_desc_shape_range({16, 16, 1, 16, 16}, ge::DT_FLOAT16, ge::FORMAT_NCHW, {16, 16, 16, 16},
                                             ge::FORMAT_NCHW, shape_range);
  std::vector<std::pair<int64_t, int64_t>> shape_range_1 = {{1, 1}};
  auto tensor_desc_1 =
      create_desc_shape_range({1}, ge::DT_FLOAT16, ge::FORMAT_NCHW, {1}, ge::FORMAT_NCHW, shape_range_1);
  op.UpdateInputDesc("x1", tensor_desc);
  op.UpdateInputDesc("x2", tensor_desc_1);
  op.UpdateOutputDesc("y", tensor_desc);
  ...
  ge::AttrUtils::GetListListInt(tensor_desc_x1, ge::ATTR_NAME_DATA_SLICE, x1_data_slice);
  ge::AttrUtils::GetListListInt(tensor_desc_x2, ge::ATTR_NAME_DATA_SLICE, x2_data_slice);
  std::vector<std::vector<int64_t>> excepted_x1_data_slice = {{0, 4}, {0, 4}, {0, 1}, {0, 4}, {0, 4}};
  std::vector<std::vector<int64_t>> excepted_x2_data_slice = {{0, 1}};
  EXPECT_EQ(excepted_x1_data_slice, x1_data_slice);
  EXPECT_EQ(excepted_x2_data_slice, x2_data_slice);
}

TEST_F(add, DataSliceAdd_003) {
  ge::op::Add op;
  std::vector<std::pair<int64_t, int64_t>> shape_range = {{1, 1}};
  auto tensor_desc = create_desc_shape_range({1}, ge::DT_FLOAT16, ge::FORMAT_NCHW, {1}, ge::FORMAT_NCHW, shape_range);
  op.UpdateInputDesc("x1", tensor_desc);
  op.UpdateInputDesc("x2", tensor_desc);
  op.UpdateOutputDesc("y", tensor_desc);
  ...
  ge::AttrUtils::GetListListInt(tensor_desc_x1, ge::ATTR_NAME_DATA_SLICE, x1_data_slice);
  ge::AttrUtils::GetListListInt(tensor_desc_x2, ge::ATTR_NAME_DATA_SLICE, x2_data_slice);
  std::vector<std::vector<int64_t>> excepted_x1_data_slice = {{0, 1}};
  std::vector<std::vector<int64_t>> excepted_x2_data_slice = {{0, 1}};
  EXPECT_EQ(excepted_x1_data_slice, x1_data_slice);
  EXPECT_EQ(excepted_x2_data_slice, x2_data_slice);
}

TEST_F(add, add_infer_shape_001) {
  ge::op::Add op;
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{1, 1}, {100, 256}, {100, 256}, {64, 64}};
  auto tensor_desc_1 = create_desc_shape_range({1, -1, -1, 64},
                                               ge::DT_FLOAT16, ge::FORMAT_ND,
                                               {1, 128, 128, 64},
                                               ge::FORMAT_ND, shape_range);
  auto tensor_desc_2 = create_desc_shape_range({},
                                               ge::DT_FLOAT16, ge::FORMAT_ND,
                                               {},
                                               ge::FORMAT_ND, {});
  op.UpdateInputDesc("x1", tensor_desc_1);
  op.UpdateInputDesc("x2", tensor_desc_2);
...
TEST_F(add, add_infer_shape_002) {
  ge::op::Add op;
  auto tensor_desc_1 = create_desc_shape_range({},
                                               ge::DT_FLOAT16, ge::FORMAT_ND,
                                               {},
                                               ge::FORMAT_ND, {});
  std::vector<std::pair<int64_t,int64_t>> shape_range = {{1, 1}, {100, 256}, {100, 256}, {64, 64}};
  auto tensor_desc_2 = create_desc_shape_range({1, -1, -1, 64},
                                               ge::DT_FLOAT16, ge::FORMAT_ND,
                                               {1, 128, 128, 64},
                                               ge::FORMAT_ND, shape_range);
