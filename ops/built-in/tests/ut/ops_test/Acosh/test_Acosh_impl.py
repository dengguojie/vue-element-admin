...
ut_case.add_precision_case("Ascend910", {"params": [{"shape": (1, 1), "dtype": "float16", "format": "ND", "ori_shape": (1, 1),"ori_format": "ND", "param_type": "input", "value_range":[1,65500]},
...
ut_case.add_precision_case("Ascend910", {"params": [{"shape": (3, 16, 32), "dtype": "float16", "format": "ND", "ori_shape": (3, 16, 32),"ori_format": "ND", "param_type": "input", "value_range":[1,65500]},
...
ut_case.add_precision_case("Ascend910", {"params": [{"shape": (1, 3, 100, 16), "dtype": "float16", "format": "ND", "ori_shape": (1, 3, 100, 16),"ori_format": "ND", "param_type": "input", "value_range":[1,65500]},
