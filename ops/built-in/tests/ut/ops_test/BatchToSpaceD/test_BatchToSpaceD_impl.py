...
case1 = {"params": [{"shape": (288, 128, 6, 8, 16), "dtype": "float16", "format": "NC1HWC0",
                     "ori_shape": (288, 128, 6, 8, 16), "ori_format": "NHWC"}, #x
                    {"shape": (2, 128, 48, 72, 16), "dtype": "float16", "format": "NC1HWC0",
                     "ori_shape": (2, 128, 48, 72, 16), "ori_format": "NHWC"},
                    12, [[12, 12], [12, 12]],
                    ],
...
case2 = {"params": [{"shape": (338, 128, 6, 8, 16), "dtype": "float32", "format": "NC1HWC0",
                     "ori_shape": (338, 128, 6, 8, 16), "ori_format": "NHWC"}, #x
                    {"shape": (2, 128, 54, 80, 16), "dtype": "float32", "format": "NC1HWC0",
                     "ori_shape": (2, 128, 54, 80, 16), "ori_format": "NHWC"},
                    13, [[12, 12], [12, 12]],
                    ],
...
ut_case.add_precision_case("all", {"params": [{"shape": (40, 2, 5, 4, 16), "dtype": "float16", "format": "NC1HWC0",
                                               "ori_shape": (40, 2, 5, 4, 16), "ori_format": "NCHW",
                                               "param_type": "input",
                                               "value_range": [-10, 10]},
                                              {"shape": (10, 2, 6, 4, 16), "dtype": "float16", "format": "NC1HWC0",
                                               "ori_shape": (10, 2, 6, 4, 16), "ori_format": "NCHW",
                                               "param_type": "output"}, 2, [[1, 3], [1, 3]]],
