...
class LpNormUpdateTest : public testing::Test {
protected:
  static void SetUpTestCase() {
    std::cout << "LpNormUpdate SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "LpNormUpdate TearDown" << std::endl;
  }
};

TEST_F(LpNormUpdateTest, lp_norm_update_infer_shape_p_1_keepdim_true) {
  ge::op::LpNormUpdate op;
...
TEST_F(LpNormUpdateTest, lp_norm_update_infer_shape_p_2_keepdim_false) {
  ge::op::LpNormUpdate op;
  auto tensor_desc_x = create_desc_shape_range({2, 64, 224, 224},
...
TEST_F(LpNormUpdateTest, lp_norm_update_infer_shape_fp16) {
  ge::op::LpNormUpdate op;
