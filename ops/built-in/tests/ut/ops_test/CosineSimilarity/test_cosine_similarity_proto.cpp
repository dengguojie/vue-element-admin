...
TEST_F(CosineSimilarityTest, cosine_similarity_test_case_1) {
  ...
  auto status = cosine_similarity_op.VerifyAllAttr(true);
...
TEST_F(CosineSimilarityTest, cosine_similarity_test_case_2) {
  ge::op::CosineSimilarity cosine_similarity_op;
  cosine_similarity_op.UpdateInputDesc("input_x1", create_desc({2, 3, 4}, ge::DT_INT16));
  cosine_similarity_op.UpdateInputDesc("input_x2", create_desc({2, 3, 4}, ge::DT_INT8));
