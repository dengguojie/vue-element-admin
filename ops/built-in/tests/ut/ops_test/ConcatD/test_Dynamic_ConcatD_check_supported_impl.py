...
ut_case = OpUT("ConcatD", "impl.dynamic.concat_d", "concat_d")

def test_op_check_supported(test_arg):
    from impl.dynamic.concat_d import check_supported
    case1 = {"params": [[{"shape": (128, 128, 128, 128), "dtype": "float16", "format": "NHWC", "ori_shape": (128, 128, 128, 128),"ori_format": "NHWC"},
                    ...
                    {"shape": (128, 128, 128, 128), "dtype": "float16", "format": "NHWC", "ori_shape": (128, 128, 128, 128),"ori_format": "NHWC"},
                    1],
         "case_name": "dynamic_concat_d_check_supported_1",
         "expect": "success",
         "format_expect": [],
         "support_expect": True}
    ...
    concat_dim = case1.get("params")[2]
    kernel_name = case1.get("case_name")
    res, _ = check_supported(input_datas, output_data, concat_dim, kernel_name)
