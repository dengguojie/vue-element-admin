...
class test_Dequant_or_quant_onnx_plugin_test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "test_Dequant_or_quant_onnx_plugin_test SetUp" << std::endl;
  }


  static void TearDownTestCase() {
    std::cout << "test_Dequant_or_quant_onnx_plugin_test TearDown" << std::endl;
  }
};

TEST_F(test_Dequant_or_quant_onnx_plugin_test, test_Dequant_or_quant_onnx_plugin_test_case_1) {
  CleanGlobal();
  ge::Graph graph;
  ...
  std::string modelFile = caseDir + "/amct10_onnx_data_type_range_gemm_006_deploy.onnx";
