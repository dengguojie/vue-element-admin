...
class selu_onnx_plugin_test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "selu_onnx_plugin_test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "selu_onnx_plugin_test TearDown" << std::endl;
  }
};
...
TEST_F(selu_onnx_plugin_test, selu_onnx_plugin_test_case_1) {
  ...
  std::string modelFile = caseDir + "/test_selu_case_11.onnx";
...
TEST_F(selu_onnx_plugin_test, selu_onnx_plugin_test_case_2) {
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_selu_case_9.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
...
TEST_F(selu_onnx_plugin_test, selu_onnx_plugin_test_case_3) {
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_selu_case_10.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
...
TEST_F(selu_onnx_plugin_test, selu_onnx_plugin_test_case_4) {
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_selu_case_12.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
...
TEST_F(selu_onnx_plugin_test, selu_onnx_plugin_test_case_5) {
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_selu_case_13.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
...
TEST_F(selu_onnx_plugin_test, selu_onnx_plugin_test_case_6) {
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_selu_case_with_attr.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
