...
TEST_F(matmul_onnx_plugin_test, matmul_onnx_plugin_test_case_5) {
  CleanGlobal();
  ge::Graph graph;
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_matmul_case_transa_v11.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
...
TEST_F(matmul_onnx_plugin_test, matmul_onnx_plugin_test_case_6) {
  CleanGlobal();
  ge::Graph graph;
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_matmul_case_transb_v11.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
