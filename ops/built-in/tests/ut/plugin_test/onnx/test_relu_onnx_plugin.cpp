...
class relu_onnx_plugin_test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "relu_onnx_plugin_test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "relu_onnx_plugin_test TearDown" << std::endl;
  }
};
...
TEST_F(relu_onnx_plugin_test, test_relu_case_version_9) {
  ...
  std::string modelFile = caseDir + "/test_relu_case_version_9.onnx";
...
TEST_F(relu_onnx_plugin_test, test_relu_case_version_11) {
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_relu_case_version_11.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
...
TEST_F(relu_onnx_plugin_test, test_relu_case_version_12) {
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_relu_case_version_12.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
...
TEST_F(relu_onnx_plugin_test, test_relu_case_version_13) {
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_relu_case_version_13.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
