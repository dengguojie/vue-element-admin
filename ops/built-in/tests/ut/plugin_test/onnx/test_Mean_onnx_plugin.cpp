...
class test_Mean_onnx_plugin_test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "test_Mean_onnx_plugin_test SetUp" << std::endl;
  }


  static void TearDownTestCase() {
    std::cout << "test_Mean_onnx_plugin_test TearDown" << std::endl;
  }
};
...
TEST_F(test_Mean_onnx_plugin_test, test_Mean_onnx_plugin_test_case_1) {
  ...
  std::string modelFile = caseDir + "/test_Mean_case1.onnx";
...
TEST_F(test_Mean_onnx_plugin_test, test_Mean_onnx_plugin_test_case_2) {
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_Mean_case2.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
