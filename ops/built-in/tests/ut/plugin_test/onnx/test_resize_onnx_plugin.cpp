...
class resize_onnx_plugin_test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "resize_onnx_plugin_test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "resize_onnx_plugin_test TearDown" << std::endl;
  }
};

TEST_F(resize_onnx_plugin_test, resize_onnx_plugin_test_case_1) {
  CleanGlobal();
  ge::Graph graph;
  ...
  std::string modelFile = caseDir + "/test_resize_case_v11.onnx";
...
TEST_F(resize_onnx_plugin_test, resize_onnx_plugin_test_case_2) {
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_resize_case_v12.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
...
TEST_F(resize_onnx_plugin_test, resize_onnx_plugin_test_case_6) {
  CleanGlobal();
  ge::Graph graph;
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_resize_case_v10_1.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
...
TEST_F(resize_onnx_plugin_test, resize_onnx_plugin_test_case_7) {
  CleanGlobal();
  ge::Graph graph;
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string modelFile = caseDir + "/test_resize_case_v10.onnx";
  std::map<ge::AscendString, ge::AscendString> parser_params;
