...
class test_Hardswish_onnx_plugin_test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "test_Hardswish_onnx_plugin_test SetUp" << std::endl;
  }


  static void TearDownTestCase() {
    std::cout << "test_Hardswish_onnx_plugin_test TearDown" << std::endl;
  }
};
...
TEST_F(test_Hardswish_onnx_plugin_test, test_Hardswish_onnx_plugin_test_case_1) {
  ...
  std::string modelFile = caseDir + "/test_hardswish_case_v14.onnx";
