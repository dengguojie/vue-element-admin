...
class avgpool3dgrad_plugin_test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "avgpool3dgrad_plugin_test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "avgpool3dgrad_plugin_test TearDown" << std::endl;
  }
};
