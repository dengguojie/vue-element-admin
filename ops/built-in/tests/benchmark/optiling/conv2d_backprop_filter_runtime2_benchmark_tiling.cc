...
static void Conv2DBpFilterTilingRuntime2Benchmark(benchmark::State &state, const char *compile_info_str) {
  ...
  gert::StorageShape filter_sizes = {{257, 5, 3, 3}, {257, 5, 3, 3}};
  gert::StorageShape out_backprop_shape = {{8, 257, 56, 56}, {8, 17, 56, 56, 16}};
  gert::StorageShape fmap_shape = {{8, 5, 56, 56}, {8, 1, 56, 56, 16}};
  std::vector<gert::StorageShape> output_shapes(1, {{257, 5, 3, 3}, {257, 5, 3, 3}});
  ...
  auto holder = gert::TilingContextFaker()
                    ...
                    .NodeAttrs({{"strides", ge::AnyValue::CreateFrom<std::vector<int64_t>>(strides)},
                                ...
                                {"padding", ge::AnyValue::CreateFrom<std::string>(padding)}})
                    .NodeInputTd(0, ge::DT_FLOAT16, FORMAT_NCHW, FORMAT_NC1HWC0)
                    .NodeInputTd(1, ge::DT_FLOAT16, FORMAT_NCHW, FORMAT_NC1HWC0)
                    .NodeInputTd(2, ge::DT_FLOAT16, FORMAT_NCHW, FORMAT_NC1HWC0)
...
BENCHMARK(Conv2DBpFilterTilingRuntime2CostSize100);

static void Conv2DBpFilterTilingRuntime2Binary(benchmark::State &state) {
  const char *compile_info_str = R"({"_pattern": "Conv2d_backprop_input", "tiling_type": "binary", "block_dim": {"CORE_NUM": 32}, "aub_num": 1, "cub_num": 2, "ub_size": 262000, "binary_mode": 2})";
  Conv2DBpFilterTilingRuntime2Benchmark(state, compile_info_str);
}
BENCHMARK(Conv2DBpFilterTilingRuntime2Binary);