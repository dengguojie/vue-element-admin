...
static void BatchMatMulV2TilingRuntime2Benchmark(benchmark::State &state, const char *compile_info_str) {
...
static void BatchMatMulV2TilingRuntime2RepoSize10(benchmark::State &state) {
  ...
  BatchMatMulV2TilingRuntime2Benchmark(state, json_str);
}
BENCHMARK(BatchMatMulV2TilingRuntime2RepoSize10);

static void BatchMatMulV2TilingRuntime2RepoSize100(benchmark::State &state) {
...
BENCHMARK(BatchMatMulV2TilingRuntime2RepoSize100);

static void BatchMatMulV2TilingRuntime2CostSize100(benchmark::State &state) {
...
BENCHMARK(BatchMatMulV2TilingRuntime2CostSize100);

static void BatchMatMulV2TilingRuntime2Binary(benchmark::State &state) {
...
BENCHMARK(BatchMatMulV2TilingRuntime2Binary);
