...
def calc_expect_func(weight, out_backprop, y, input_size, strides, pads, dilations, data_format='NCHW'):
    ...
    print('------------params:', filter_shape, dy_shape, y, input_size, strides, pads, data_format)
    ...
    if data_format == 'NHWC':
        ...
        w = filter_data.transpose(2, 3, 1, 0).astype(filter_dtype) # NCHW->HWCN
