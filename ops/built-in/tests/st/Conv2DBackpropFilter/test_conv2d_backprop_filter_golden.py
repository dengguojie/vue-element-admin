...
def calc_expect_func(x, filter_size, out_backprop, y, strides, pads, dilations, groups=1, data_format='NCHW'):
    ...
    if groups == 1:
        ...
        padding = _getPadding(pads, x.shape, [kh, kw, filter_c, filter_n], dy.shape,
