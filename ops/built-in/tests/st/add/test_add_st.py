...
def test_add(shape_x, shape_y, dtype_val, kernel_name_val):
    add({"shape": shape_x, "dtype": dtype_val, "ori_shape": shape_x, "ori_format": "ND", "format":"ND"},
        {"shape": shape_y, "dtype": dtype_val, "ori_shape": shape_y, "ori_format": "ND", "format":"ND"},
        {"shape": shape_y, "dtype": dtype_val, "ori_shape": shape_x, "ori_format": "ND", "format":"ND"},
