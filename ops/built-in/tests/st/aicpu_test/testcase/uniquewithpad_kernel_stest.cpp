...
class TEST_Unique_STest : public testing::Test {
protected:
    virtual void SetUp()
    {
    }
...
TEST_F(TEST_Unique_STest, Int32Nor1)
{
...
TEST_F(TEST_Unique_STest, Int64Nor2)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("UniqueWithPad");
...
TEST_F(TEST_Unique_STest, ExpDType3)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("UniqueWithPad");
...
TEST_F(TEST_Unique_STest, ExpInput4)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("UniqueWithPad");
...
TEST_F(TEST_Unique_STest, ExpOutput5)
{
    auto nodeDef = CpuKernelUtils::CreateNodeDef();
    nodeDef->SetOpType("UniqueWithPad");
