...
class TEST_MUL_KERNEL_STest : public testing::Test {
  protected:
    virtual void SetUp() {}
...
TEST_F(TEST_MUL_KERNEL_STest, scalar_mul_scalar) {
    ...
    NodeDefBuilder(nodeDef.get(), "Mul", "Mul")
...
TEST_F(TEST_MUL_KERNEL_STest, scalar_mul_vector) {
    cout<<"Test Kernel Begin."<<endl;
    int16_t input_0[1] = {1};
...
TEST_F(TEST_MUL_KERNEL_STest, vector_mul_scalar) {
    cout<<"Test Kernel Begin."<<endl;
    ...
    auto nodeDef = CpuKernelUtils::CpuKernelUtils::CreateNodeDef();
    NodeDefBuilder(nodeDef.get(), "Mul", "Mul")
        .Input({"x1", DT_INT32, {2, 1}, (void *)input_0})
        .Input({"x2", DT_INT32, {}, (void *)input_1})
        .Output({"y", DT_INT32, {2, 1}, (void *)output});
...
TEST_F(TEST_MUL_KERNEL_STest, vector_mul_vector_match) {
    cout<<"Test Kernel Begin."<<endl;
...
TEST_F(TEST_MUL_KERNEL_STest, vector_mul_vector_broatcast_0) {
    cout<<"Test Kernel Begin."<<endl;
    uint8_t input_0[1] = {1};
...
TEST_F(TEST_MUL_KERNEL_STest, vector_mul_vector_broatcast_1) {
    cout<<"Test Kernel Begin."<<endl;
...
TEST_F(TEST_MUL_KERNEL_STest, vector_mul_vector_broatcast_both) {
    cout<<"Test Kernel Begin."<<endl;
...
TEST_F(TEST_MUL_KERNEL_STest, data_type_not_match) {
    cout<<"Test Kernel Begin."<<endl;
    float input_0[1] = {1};
    double input_1[1] = {1};
    float output[1] = {0};
...
TEST_F(TEST_MUL_KERNEL_STest, data_type_not_support) {
    cout<<"Test Kernel Begin."<<endl;
    bool input_0[1] = {true};
    bool input_1[1] = {true};
    bool output[1] = {false};
...
TEST_F(TEST_MUL_KERNEL_STest, bcast_max_size_not_match) {
    cout<<"Test Kernel Begin."<<endl;
    float input_0[1] = {1};
    float input_1[1] = {1};
    float output[1] = {0};
    ...
    auto nodeDef = CpuKernelUtils::CpuKernelUtils::CreateNodeDef();
    NodeDefBuilder(nodeDef.get(), "Mul", "Mul")
        .Input({"x1", DT_FLOAT, {1}, (void *)input_0})
        .Input({"x2", DT_FLOAT, {1}, (void *)input_1})
        .Output({"y", DT_FLOAT, {1, 1}, (void *)output});
...
TEST_F(TEST_MUL_KERNEL_STest, bcast_shape_not_match) {
    cout<<"Test Kernel Begin."<<endl;
    float input_0[1] = {1};
    float input_1[1] = {1};
    float output[1] = {0};
    ...
    auto nodeDef = CpuKernelUtils::CpuKernelUtils::CreateNodeDef();
    NodeDefBuilder(nodeDef.get(), "Mul", "Mul")
        .Input({"x1", DT_FLOAT, {1, 2}, (void *)input_0})
        .Input({"x2", DT_FLOAT, {1, 3}, (void *)input_1})
        .Output({"y", DT_FLOAT, {1, 1}, (void *)output});
...
TEST_F(TEST_MUL_KERNEL_STest, bcast_not_support) {
    cout<<"Test Kernel Begin."<<endl;
    float input_0[1] = {1};
    float input_1[1] = {1};
    float output[1] = {0};
    ...
    NodeDefBuilder(nodeDef.get(), "Mul", "Mul")
        .Input({"x1", DT_FLOAT, {1, 2}, (void *)input_0})
        .Input({"x2", DT_FLOAT, {1, 3}, (void *)input_1})
        .Output({"y", DT_FLOAT, {1, 3}, (void *)output});
