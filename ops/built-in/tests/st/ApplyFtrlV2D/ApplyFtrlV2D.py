...
def apply_ftrl_v2_d_compute(var, accum, linear, grad, lr, l1, l2, l2_shrinkage,
    ...
    output = gen_training_ops.apply_ftrl_v2(Var, Accum, Linear, grad.get("value"), lr.get("value")[0], l1.get("value")[0], l2.get("value")[0], l2_shrinkage.get("value")[0], lr_power.get("value")[0])
