...
def _define_cache_tiling_var(input_x1: dict, input_x2: dict, bias:dict) -> None:
    if get_cache_tiling_flag(input_x1, input_x2, bias):
        ...
        operation.var("batch_l1_factor")
        operation.var("batch_ub_l0_time")
        operation.var("batch_cub")
        if _check_nd_in(input_x1, input_x2):
            operation.var("m_aub")
            operation.var("n_bub")
            operation.var("k_aub")
            operation.var("k_bub")
            operation.var("batch_aub")
            operation.var("batch_bub")
            operation.var("multi_n_ub_l1")
            operation.var("multi_m_ub_l1")
            operation.var("multi_k_aub_l1")
            operation.var("multi_k_bub_l1")
            operation.var("multi_batch_aub_l1")
            operation.var("multi_batch_bub_l1")
