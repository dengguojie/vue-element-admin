...
class ScatterNdAdd():
    ...
    def vadd(self, update_num):
        ...
        with self.tik_instance.if_scope(last > 0):
            ...
            self.tik_instance.vec_add(lastmask_scalar, self.adds_ub[lastindex * mask], self.adds_ub[lastindex * mask],
    ...
    def vec_add_with_addr(self, update_num, adds_addr, var_addr):
        ...
        with self.tik_instance.if_scope(last > 0):
            ...
            self.tik_instance.vec_add(lastmask_scalar, self.adds_ub[lastindex * mask + adds_addr],
