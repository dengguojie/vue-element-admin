...
class SquareSumAll():
    ...
    def _get_tiling_args(self):
        ...
        None
        """
        self.need_core_num_input_scalar = self.tik_instance.Scalar(dtype="int32", name="need_core_num_input_scalar")
        self.data_num_each_core = self.tik_instance.Scalar(dtype="int32", name="data_num_each_core")
        self.process_times_per_core = self.tik_instance.Scalar(dtype="int32", name="process_times_per_core")
        self.process_times_remain_core = self.tik_instance.Scalar(dtype="int32", name="process_times_remain_core")
        self.every_process_data_num_per_core = self.tik_instance.Scalar(dtype="int32",
                                                                        name="every_process_data_num_per_core")
        self.every_process_data_num_remain_core = self.tik_instance.Scalar(dtype="int32",
                                                                           name="every_process_data_num_remain_core")
        self.tail_num_per_core = self.tik_instance.Scalar(dtype="int32", name="tail_num_per_core")
        self.tail_num_remain_core = self.tik_instance.Scalar(dtype="int32", name="tail_num_remain_core")
        self.reduce_sum_loop_per_core = self.tik_instance.Scalar(dtype="int32", name="reduce_sum_loop_per_core")
        self.reduce_sum_loop_tail_per_core = self.tik_instance.Scalar(dtype="int32",
                                                                      name="reduce_sum_loop_tail_per_core")
        self.reduce_sum_loop_remain_core = self.tik_instance.Scalar(dtype="int32", name="reduce_sum_loop_remain_core")
        self.reduce_sum_loop_tail_remain_core = self.tik_instance.Scalar(dtype="int32",
                                                                         name="reduce_sum_loop_tail_remain_core")
        self.burst_len_per_core = self.tik_instance.Scalar(dtype="int32", name="burst_len_per_core")
        self.burst_len_tail_per_core = self.tik_instance.Scalar(dtype="int32", name="burst_len_tail_per_core")
        self.burst_len_remain_core = self.tik_instance.Scalar(dtype="int32", name="burst_len_remain_core")
        self.burst_len_tail_remain_core = self.tik_instance.Scalar(dtype="int32", name="burst_len_tail_remain_core")
    ...
    def _set_tensor(self, is_remain_core):
        ...
        if is_remain_core:
            ...
            self.burst_len = self.burst_len_remain_core
            self.burst_len_tail = self.burst_len_tail_remain_core
        else:
            ...
            self.burst_len = self.burst_len_per_core
            self.burst_len_tail = self.burst_len_tail_per_core
