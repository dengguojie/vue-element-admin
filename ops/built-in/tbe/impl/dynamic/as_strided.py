...
class AsStrided():
    ...
    def __init__(self, tik_inst, x_dtype, tensor_list):
        ...
        self.ub_size_b8 = get_ub_size_by_b8()
...
def as_strided(x, size, stride, storage_offset, y, kernel_name="as_strided"):
    ...
    size = tik_inst.Tensor(size_dtype, (Constant.MAX_INT64_VALUE,), tik.scope_gm, "size")
    ...
    tbe_context.get_context().add_compile_info("vars", {"ub_size": Constant.UB_SIZE, \
    "core_num": Constant.CORE_NUM, "dtype": x_dtype})
