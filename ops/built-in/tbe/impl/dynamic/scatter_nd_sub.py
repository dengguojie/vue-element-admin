...
class ScatterNdSub():
    ...
    def __init__(self, var, indices, subs, var_out, use_locking, kernel_name):
        ...
        self.indices_gm = self.tik_instance.Tensor(self.indice_dtype, (MAX_INT64_VALUE,), name="indices_gm", scope=tik.scope_gm)
    ...
    def tiling_args(self):
        ...
        self.subs_num.set_as(self.tiling_ub[6])
        self.subs_loop_num.set_as(self.tiling_ub[7])
        self.subs_last_num.set_as(self.tiling_ub[8])
...
def scatter_nd_sub(var, indices, subs, var_out, use_locking=False, kernel_name="scatter_nd_sub"):
    """
