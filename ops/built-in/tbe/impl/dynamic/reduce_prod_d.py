...
@register_operator_compute("ReduceProdD", op_mode="dynamic", support_fusion=True)
def reduce_prod_d_compute(x, y, axes=None, keepdims=None, kernel_name="reduce_prod_d"):
    """
    reduce_prod_d compute
...
@register_operator("ReduceProdD")
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_ATTR_LIST_INT,
                            para_check.OPTION_ATTR_BOOL, para_check.KERNEL_NAME)
def reduce_prod_d(x, y, axes=None, keepdims=None, kernel_name="reduce_prod_d"):
    """
    ...
    kernel_name : str
        kernel name, default value is "reduce_prod_d"
    ...
    for (x, axes) in ins:
        with tbe.compute():
            ...
            res = reduce_prod_d_compute(data_input, y, axes.get("value"), keepdims, kernel_name)
