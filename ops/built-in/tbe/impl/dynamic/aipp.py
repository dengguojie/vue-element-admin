...
def check_input_params(input_data, input_dync_param, output_data, aipp_config_json):
    """
    check input params
    """
    ...
    if aipp_mode != 'dynamic':
        cause_desc = "aipp_mode must be set to dynamic mode for dynamic shape"
...
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.OPTION_INPUT,
                            para_check.REQUIRED_OUTPUT, para_check.REQUIRED_ATTR_STR, para_check.KERNEL_NAME)
def aipp(input_data, input_dync_param, output_data, aipp_config_json, kernel_name="aipp"):
    ...
    tik_instance
    """
    check_input_params(input_data, input_dync_param, output_data, aipp_config_json)
