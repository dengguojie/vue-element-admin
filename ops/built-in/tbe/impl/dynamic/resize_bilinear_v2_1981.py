...
class ResizeBilinearV2(OpBase):
    ...
    def _function_default_with_l1(self, is_src_stride_copy=False, is_dst_stride_copy=False,
            ...
            def _do_single_nc(do_nc_num, _nc_loop_idx):
                    ...
                    with self.tik_instance.new_stmt_scope(disable_sync=True):
                        with self.tik_instance.for_range(0, w_do_len) as w_idx:
                            ...
                            self.tik_instance.data_move(input_ub[w_idx * self.images_shape_c0 * 2],
                                                        ...
                                                        0, burst_num, range_burst_len,
                                                        range_cbuf_burst_stride, range_ub_burst_strde)
                ...
                if self.images_dtype != self.inner_dtype:
                    resize_inner_ub_ping = self.tik_instance.Tensor(self.inner_dtype, (ub_max_num,),
                                                                    name="resize_inner_ub_ping", scope=tik.scope_ubuf)
                    resize_inner_ub_pang = self.tik_instance.Tensor(self.inner_dtype, (ub_max_num,),
                                                                    name="resize_inner_ub_pang", scope=tik.scope_ubuf)
    ...
    def _function_default_apply_ub_1981(self):
        ...
        if self.inner_dtype != self.images_dtype:
            mem_default["src0_mid"] = self.tik_instance.Tensor(self.inner_dtype,
                                                               (self.width_idx_sigment_num * self.images_shape_c0 * 4,),
    ...
    def resize_bilinear_v2_operator(self):
        ...
        if check_vgatherb_supported and check_vbi_supported:
            self.regist_compute(100000, self._function_default_1981)
        else:
            self.regist_compute(100000, self._function_default_with_l1)
...
def resize_bilinear_v2_with_gatherb(images, size, y, align_corners=False, half_pixel_centers=False,
