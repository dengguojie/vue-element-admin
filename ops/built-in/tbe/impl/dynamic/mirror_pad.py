...
class MirrorPadInit:
    ...
    def __init__(self, mode, kernel_name):
        ...
        self.outer_process_num = None
        self.segment_total = None
        self.process_blks = None
        self.segment_move_offset = None
        self.num_tail_segment = None
        self.inner_process_num = None
        self.address_rollback = None
        self.address_rollback_sum = None
        self.start_blocks = None
        self.now_process_lines = None
    ...
    def set_dividends_scalars(self, axis_nums):
        ...
        self.dividends[9].set_as(self.pading_00 - self.two_mode_diff)
        self.dividends[10].set_as(self.pading_10 - self.two_mode_diff)
        self.dividends[11].set_as(self.pading_20 - self.two_mode_diff)
        ...
        if axis_nums == Constant.AXIS_DIMS_3:
            ...
            self.dividends[12].set_as(self.pading_30 - self.two_mode_diff)
            self.dividends[16].set_as(2 * self.tiling_input_shape[3] + self.pading_30 - 2 + self.two_mode_diff)
        else:
            pass
