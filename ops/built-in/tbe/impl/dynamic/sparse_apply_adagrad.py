...
class SparseApplyAdagrad(SparseApplyDynamic):
    ...
    def _calculate(self, repeat_times, mask, offset):
        ...
        def _func():
            ...
            self.tik_instance.vmuls(mask, tmp_ub, tmp_ub, self.lr_scalar, repeat_times, 1, 1, 8, 8)
...
@register_operator("SparseApplyAdagrad")
...
def sparse_apply_adagrad(var,
    ...
    kernel_name: str
        kernel name, default value is "sparse_apply_adagrad"
    ...
    apply_adagrad.allocate_scalar_gm("lr_gm", var_dtype)
    apply_adagrad.add_output("var_out_gm", "float32")
    apply_adagrad.add_output("accum_out_gm", "float32")
