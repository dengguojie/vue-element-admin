...
# ============================================================================
"""
dynamic fused_mul_apply_keras_momentum
"""
...
from impl.fused_mul_apply_keras_momentum import \
    get_op_support_info as fused_mul_apply_keras_momentum_get_op_support_info
...
def get_op_support_info(var,
    ...
    """
    get fusedMulApplyKerasMomentum slice info
    """
    return fused_mul_apply_keras_momentum_get_op_support_info(var, accum, lr, x1, momentum, x2, out_var,
                                                              out_accum, use_nesterov, kernel_name)


# 'pylint: disable=unused-argument,invalid-name,too-many-locals,too-many-arguments
@register_operator_compute("FusedMulApplyKerasMomentum", op_mode="dynamic", support_fusion=True)
...
@register_operator("FusedMulApplyKerasMomentum")
...
def fused_mul_apply_keras_momentum(var,
    ...
    data_momentum = tvm.placeholder(
        shape_scalar, dtype=var_dtype, name="data_momentum")
    ...
    for (_var, _accum, _x1) in ins:
        with tbe.compute():
            ...
            res = fused_mul_apply_keras_momentum_compute(data_var, data_accum,
                                                         data_lr, data_x1,
