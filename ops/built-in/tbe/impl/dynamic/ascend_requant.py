...
def ascend_requant_compute(x, req_scale, y, relu_flag=False, kernel_name="ascend_requant"):
    ...
    conv_flag = 0
    if x.op.input_tensors and x.op.input_tensors[0].name in ('mad1', 'convolution_c_col_bias'):
        conv_flag = 1
    ...
    if x.op.tag == "depthwise_conv2d":
        ...
        res_ub = _s32_to_s8_normal_compute(x, req_scale, align_shape, c1_index, tensor_flag, relu_flag, conv_flag)
...
def _s32_to_s8_normal_compute(x, req_scale, align_shape, c1_index, tensor_flag, relu_flag, conv_flag):
    """
