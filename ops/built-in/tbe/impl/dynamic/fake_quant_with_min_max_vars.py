...
def fake_quant_with_min_max_vars(x, min, max, y, num_bits=8,
    ...
    para_check.check_shape(min_shape, min_rank=1, max_rank=1, max_dim=1, param_name="min")
    para_check.check_shape(max_shape, min_rank=1, max_rank=1, max_dim=1, param_name="max")
