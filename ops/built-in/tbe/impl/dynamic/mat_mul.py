...
from impl.dynamic.batch_matmul_v2 import get_cache_tiling_flag
...
def base_op_select_format(bias_fp32_flag: bool, impl_mode: str = "") -> tuple:
    """
...
def op_select_format(input_x: dict, input_y: dict, bias: dict = None, offset_w: dict = None,
    ...
    scenario_combinations, _ = base_op_select_format(bias_fp32_flag)
