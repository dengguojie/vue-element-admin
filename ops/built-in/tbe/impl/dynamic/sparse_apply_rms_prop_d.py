...
def sparse_apply_rms_prop_d(var,
    ...
    sparse_apply_rms_prop.add_input("var_in_gm", var_dtype)
    sparse_apply_rms_prop.add_input("ms_in_gm", var_dtype)
    sparse_apply_rms_prop.add_input("mom_in_gm", var_dtype)
    sparse_apply_rms_prop.allocate_scalar_gm("lr_gm", var_dtype)

    sparse_apply_rms_prop.add_output("var_out_gm", var_dtype)
    sparse_apply_rms_prop.add_output("ms_out_gm", var_dtype)
    sparse_apply_rms_prop.add_output("mom_out_gm", var_dtype)
