...
@te.op.register_operator("UnsortedSegmentMin")
@para_check.check_op_params(para_check.REQUIRED_INPUT,
                            para_check.REQUIRED_INPUT,
                            para_check.REQUIRED_INPUT,
                            para_check.REQUIRED_OUTPUT, para_check.KERNEL_NAME)
def unsorted_segment_min(x_dict,
                         segment_ids_dict,
                         num_segments_dict,
                         y_dict,
    ...
    unsorted_segment.unsorted_segment(
        x_dict, segment_ids_dict, num_segments_dict, y_dict, kernel_name, instruction='segment_min')
