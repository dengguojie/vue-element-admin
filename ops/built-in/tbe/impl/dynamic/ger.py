...
@register_operator_compute("Ger", op_mode="dynamic", support_fusion=True)
def ger_compute(data_x1, data_x2, y, kernel_name="ger"):
    ...
    shape_x1, shape_x2, shape_broadcast = shape_util.unify_broadcast_shapes([shape_x1, shape_x2])
