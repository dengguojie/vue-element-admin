...
class Eye:
    ...
    def __init__(self, y, num_rows, num_columns, batch_shape, dtype="float32", kernel_name="eye"):
        ...
        self.tik_dprofile = tik.Dprofile("v100", "mini")
        self.batch_num = 1
        self.dtype = dtype
        ...
        ub_size_bytes = self.tik_dprofile.get_unified_buffer_size()

        # get the number of element in one blok according to 'dtype'
        dtype_bytes_size = cce.cce_intrin.get_bit_len(self.dtype) // 8
