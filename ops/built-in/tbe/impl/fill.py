...
def check_supported_with_reason(dims, value, y, kernel_name="fill"):
    """
    verify the types of cast supported by tbe
    """
    if -2 in dims["shape"] or -2 in y["shape"] or -1 in dims["shape"] or -2 in value["ori_shape"]:
        reason = "the shape dim not supported, -2 in dims[\"shape\"] or -2 in y[\"shape\"] or -1 in dims[\"shape\"] or -2 in value[\"ori_shape\"]"\
