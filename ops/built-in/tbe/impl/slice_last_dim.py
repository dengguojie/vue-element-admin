...
class SliceLastDim():
    ...
    def __init__(self, x, y, start, end, stride=1, kernel_name="slice_last_dim"):
        ...
        self.x_byte_size = tbe_platform.cce_intrin.get_bit_len(self.x_dtype) // 8
        ...
        self.x_gm = self.tik_instance.Tensor(self.x_dtype, self.reformat_x_shape, name="x_gm", scope=tik.scope_gm)
        self.out_gm = self.tik_instance.Tensor(self.x_dtype, self.out_shape, name="out_gm", scope=tik.scope_gm)
