...
def get_op_support_info(input_dic, coord_out_dic, obj_out_dic, class_out_dic,
                        ...
                        kernel_name="yolo_pre_detection"):
    """
    get split info
...
class SoftmaxComputer(ComputerCommon):
    ...
    def softmax_tiling(self, available_ub, is_bc_sfmx):
        ...
        if dlen < 32:
            error_manager_vector.raise_err_specific_reson("yolo_pre_detection", "Classes num overflow")
        chn_ceil_len = ceil_x(self.hw_size * self.dtype_size, 32)
...
class YoloOp(InitTikAndTensor):
    ...
    def get_yolo_mode(self, yolo_ver):
        ...
        Parameters
        ----------
        yolo_ver: yolo version, "V2", "V3" or "V5"
        Returns
        -------
        yolo compute mode
        """
    ...
    def run_yolo_computer(self, batch, yolo_ver):
        ...
        with self.tik_inst.for_range(0, 2, thread_num=2) as wh_loop:
            self.run_sig_mov(op_sgmd, batch, wh_loop + 2, dbbuf_inside=False)
...
def yolo_computer(yolo_op, shape_info, yolo_version):
    ...
    shape_info: shape info
    yolo_version: yolo version, "V2","V3" or "V5"
    Returns
    -------
    NONE
    """
...
def yolo_pre_detection(input_dic, coord_out_dic, obj_out_dic, class_out_dic,
                       boxes, coords, classes, yolo_version="V5",
                       softmax=False, background=False, softmaxtree=False,
                       kernel_name="yolo_pre_detection"):
    """
    yolo_pre_detection interface, v2: region, v5:yolo
    divide core and run yolo computer
    Parameters
    ----------
    ...
    boxes: anchor box num, "V2" default 5, "V5" default 3
    coords: x, y, w, h, always 4
    classes: class num, default 80
    yolo_version: "V2","V3" or "V5"
