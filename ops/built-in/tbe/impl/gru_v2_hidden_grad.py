...
def copy_input_to_ub_compute(tensor_weight, tensor_h1, tensor_n2,
                             tensor_i2, tensor_r2, tensor_n2_mid,
                             tensor_d_h2, tensor_dy,
                             tensor_list, emit_list, scope_list):
    """
    """
    tensor_ele_shape = [1, tensor_h1.shape[1].value, tensor_h1.shape[2].value, tensor_h1.shape[3].value, tensor_h1.shape[4].value]
    # tensor_h1_ub_ele tensor_n2_i2_ub_ele tensor_n2_ub_ele tensor_i2_ub_ele tensor_i2_n2i_ub_ele tensor_r2_dn2i_ub_ele tensor_r2_ub_ele tensor_n2_mid_ub_ele tensor_d_h2_i2_ub_ele
    # tensor_d_h2_n2i_ub_ele tensor_dy_i2_ub_ele tensor_dy_n2i_ub_ele tensor_d_n2_i_ub_ele tensor_dy_i2_ub_ele
    ...
    scope_list["tensor_h1_ub_ele"] = scope_ubuf

    tensor_n2_i2_ub = tvm.compute(tensor_ele_shape, lambda t, i, j, k, l: tensor_n2[0, i, j, k, l],
    ...
    scope_list["tensor_n2_i2_ub_ele"] = scope_ubuf

    tensor_n2_ub = tvm.compute(tensor_ele_shape, lambda t, i, j, k, l: tensor_n2[0, i, j, k, l],
                               name="tensor_n2_ub", tag="tensor_n2_ub")
    tensor_list["tensor_n2_ub_ele"] = tensor_n2_ub
    emit_list["tensor_n2_ub_ele"] = insn_cmd.DMA_COPY
    scope_list["tensor_n2_ub_ele"] = scope_ubuf

    tensor_i2_ub = tvm.compute(tensor_ele_shape, lambda t, i, j, k, l: tensor_i2[0, i, j, k, l],
                               name="tensor_i2_ub", tag="tensor_i2_ub")
    tensor_list["tensor_i2_ub_ele"] = tensor_i2_ub
    emit_list["tensor_i2_ub_ele"] = insn_cmd.DMA_COPY
    scope_list["tensor_i2_ub_ele"] = scope_ubuf

    tensor_i2_n2i_ub = tvm.compute(tensor_ele_shape, lambda t, i, j, k, l: tensor_i2[0, i, j, k, l],
    ...
    scope_list["tensor_i2_n2i_ub_ele"] = scope_ubuf

    tensor_r2_dn2h_ub = tvm.compute(tensor_ele_shape, lambda t, i, j, k, l: tensor_r2[0, i, j, k, l],
    ...
    scope_list["tensor_r2_dn2h_ub_ele"] = scope_ubuf
    ...
    scope_list["tensor_r2_ub_ele"] = scope_ubuf

    tensor_n2_mid_ub = tvm.compute(tensor_ele_shape, lambda t, i, j, k, l: tensor_n2_mid[0, i, j, k, l],
    ...
    scope_list["tensor_n2_mid_ub_ele"] = scope_ubuf

    tensor_d_h2_i2_ub = tvm.compute(tensor_ele_shape, lambda t, i, j, k, l: tensor_d_h2[0, i, j, k, l],
    ...
    scope_list["tensor_d_h2_i2_ub_ele"] = scope_ubuf

    tensor_d_h2_n2i_ub = tvm.compute(tensor_ele_shape, lambda t, i, j, k, l: tensor_d_h2[0, i, j, k, l],
    ...
    scope_list["tensor_d_h2_n2i_ub_ele"] = scope_ubuf
    ...
    scope_list["tensor_dy_i2_ub_ele"] = scope_ubuf
    ...
    scope_list["tensor_dy_n2i_ub_ele"] = scope_ubuf

    return tensor_list, emit_list, scope_list


def elewise_compute_for_gate(tensor_dh2_di2, tensor_dy_di2, tensor_h1, tensor_n2_di2, tensor_i2_di2,
                             tensor_dh2_dn2i, tensor_dy_dn2i, tensor_n2_dn2i, tensor_i2_dn2i,
                             tensor_r2_dn2h, tensor_n2_mid, tensor_r2_dr2,
    ...
    # compute for di2
    tensor_dh2_di2_add = vadd(tensor_dh2_di2, tensor_dy_di2)
    tensor_list["tensor_dh2_di2_add_ele"] = tensor_dh2_di2_add
    emit_list["tensor_dh2_di2_add_ele"] = insn_cmd.ADD
    scope_list["tensor_dh2_di2_add_ele"] = scope_ubuf

    tensor_dh1_sub_n2_di2 = vsub(tensor_h1, tensor_n2_di2)
    tensor_list["tensor_dh1_sub_n2_di2_ele"] = tensor_dh1_sub_n2_di2
    emit_list["tensor_dh1_sub_n2_di2_ele"] = insn_cmd.SUB
    scope_list["tensor_dh1_sub_n2_di2_ele"] = scope_ubuf

    data_one_di2 = broadcast(tvm.const(1, dtype), vector_shape_list, dtype)
    tensor_list["data_one_di2_ele"] = data_one_di2
    emit_list["data_one_di2_ele"] = insn_cmd.DUP
    scope_list["data_one_di2_ele"] = scope_ubuf

    tensor_one_sub_i2_di2 = vsub(data_one_di2, tensor_i2_di2)
    tensor_list["tensor_one_sub_i2_di2_ele"] = tensor_one_sub_i2_di2
    emit_list["tensor_one_sub_i2_di2_ele"] = insn_cmd.SUB
    scope_list["tensor_one_sub_i2_di2_ele"] = scope_ubuf

    tensor_res_mul_dh2_di2 = vmul(tensor_dh1_sub_n2_di2, tensor_dh2_di2_add)
    tensor_list["tensor_res_mul_dh2_di2_ele"] = tensor_res_mul_dh2_di2
    emit_list["tensor_res_mul_dh2_di2_ele"] = insn_cmd.MUL
    scope_list["tensor_res_mul_dh2_di2_ele"] = scope_ubuf

    tensor_res_mul_one_di2 = vmul(tensor_res_mul_dh2_di2, tensor_one_sub_i2_di2)
    tensor_list["tensor_res_mul_one_di2_ele"] = tensor_res_mul_one_di2
    emit_list["tensor_res_mul_one_di2_ele"] = insn_cmd.MUL
    scope_list["tensor_res_mul_one_di2_ele"] = scope_ubuf

    tensor_res_mul_i2_di2 = vmul(tensor_res_mul_one_di2, tensor_i2_di2)
    tensor_list["tensor_res_mul_i2_di2_ele"] = tensor_res_mul_i2_di2
    emit_list["tensor_res_mul_i2_di2_ele"] = insn_cmd.MUL
    scope_list["tensor_res_mul_i2_di2_ele"] = scope_ubuf

    # compute for dn2_i
    tensor_power_n2_dn2i = vmul(tensor_n2_dn2i, tensor_n2_dn2i)
    tensor_list["tensor_power_n2_dn2i_ele"] = tensor_power_n2_dn2i
    emit_list["tensor_power_n2_dn2i_ele"] = insn_cmd.MUL
    scope_list["tensor_power_n2_dn2i_ele"] = scope_ubuf

    data_one_dn2i = broadcast(tvm.const(1, dtype), vector_shape_list, dtype)
    tensor_list["data_one_dn2i_ele"] = data_one_dn2i
    emit_list["data_one_dn2i_ele"] = insn_cmd.DUP
    scope_list["data_one_dn2i_ele"] = scope_ubuf

    tensor_one_sub_n2_dn2i = vsub(data_one_dn2i, tensor_power_n2_dn2i)
    tensor_list["tensor_one_sub_n2_dn2i_ele"] = tensor_one_sub_n2_dn2i
    emit_list["tensor_one_sub_n2_dn2i_ele"] = insn_cmd.SUB
    scope_list["tensor_one_sub_n2_dn2i_ele"] = scope_ubuf

    tensor_one_sub_i2_dn2i = vsub(data_one_dn2i, tensor_i2_dn2i)
    tensor_list["tensor_one_sub_i2_dn2i_ele"] = tensor_one_sub_i2_dn2i
    emit_list["tensor_one_sub_i2_dn2i_ele"] = insn_cmd.SUB
    scope_list["tensor_one_sub_i2_dn2i_ele"] = scope_ubuf

    tensor_n2_mul_i2_dn2i = vmul(tensor_one_sub_n2_dn2i, tensor_one_sub_i2_dn2i)
    tensor_list["tensor_n2_mul_i2_dn2i_ele"] = tensor_n2_mul_i2_dn2i
    emit_list["tensor_n2_mul_i2_dn2i_ele"] = insn_cmd.MUL
    scope_list["tensor_n2_mul_i2_dn2i_ele"] = scope_ubuf
    # dn2i_ele dn2i_add_ele
    tensor_dh2_dn2i_add = vadd(tensor_dh2_dn2i, tensor_dy_dn2i)
    tensor_list["tensor_dh2_dn2i_add_ele"] = tensor_dh2_dn2i_add
    emit_list["tensor_dh2_dn2i_add_ele"] = insn_cmd.ADD
    scope_list["tensor_dh2_dn2i_add_ele"] = scope_ubuf

    tensor_dh2_mul_i2_dn2i = vmul(tensor_n2_mul_i2_dn2i, tensor_dh2_dn2i_add)
    tensor_list["tensor_dh2_mul_i2_dn2i_ele"] = tensor_dh2_mul_i2_dn2i
    emit_list["tensor_dh2_mul_i2_dn2i_ele"] = insn_cmd.MUL
    scope_list["tensor_dh2_mul_i2_dn2i_ele"] = scope_ubuf

    tensor_dh2_mul_i2_dn2i_gm = tvm.compute(vector_shape_list, lambda t, i, j, k, l: tensor_dh2_mul_i2_dn2i[0, i, j, k, l],
    ...
    tensor_fake_dh2_mul_i2_dn2i_ub = tvm.compute(vector_shape_list, lambda t, i, j, k, l: tensor_dh2_mul_i2_dn2i_gm[0, i, j, k, l],
    ...
    scope_list["tensor_fake_dh2_mul_i2_dn2i_ub_ele"] = scope_ubuf
    emit_list["tensor_fake_dh2_mul_i2_dn2i_ub_ele"] = insn_cmd.DMA_COPY

    # compute for dn2h
    tensor_dn2i_mul_r2_dn2h = vmul(tensor_fake_dh2_mul_i2_dn2i_ub, tensor_r2_dn2h)
    tensor_list["tensor_dn2i_mul_r2_dn2h_ele"] = tensor_dn2i_mul_r2_dn2h
    emit_list["tensor_dn2i_mul_r2_dn2h_ele"] = insn_cmd.MUL
    scope_list["tensor_dn2i_mul_r2_dn2h_ele"] = scope_ubuf

    # compute for dr2
    data_one_dr2 = broadcast(tvm.const(1, dtype), vector_shape_list, dtype)
    tensor_list["data_one_dr2_ele"] = data_one_dr2
    emit_list["data_one_dr2_ele"] = insn_cmd.DUP
    scope_list["data_one_dr2_ele"] = scope_ubuf

    data_one_sub_r2_dr2 = vsub(data_one_dr2, tensor_r2_dr2)
    tensor_list["data_one_sub_r2_dr2_ele"] = data_one_sub_r2_dr2
    emit_list["data_one_sub_r2_dr2_ele"] = insn_cmd.SUB
    scope_list["data_one_sub_r2_dr2_ele"] = scope_ubuf

    data_n2_mid_mul_r2_dr2 = vmul(data_one_sub_r2_dr2, tensor_n2_mid)
    tensor_list["data_n2_mid_mul_r2_dr2_ele"] = data_n2_mid_mul_r2_dr2
    emit_list["data_n2_mid_mul_r2_dr2_ele"] = insn_cmd.MUL
    scope_list["data_n2_mid_mul_r2_dr2_ele"] = scope_ubuf

    data_dn2h_mul_r2_dr2 = vmul(data_n2_mid_mul_r2_dr2, tensor_dn2i_mul_r2_dn2h)
    tensor_list["data_dn2h_mul_r2_dr2_ele"] = data_dn2h_mul_r2_dr2
    emit_list["data_dn2h_mul_r2_dr2_ele"] = insn_cmd.MUL
    scope_list["data_dn2h_mul_r2_dr2_ele"] = scope_ubuf
    if gate_order == "zrh":
        ...
        tensors = [tensor_list["data_dn2h_mul_r2_dr2_ele"],
                   ...
                   tensor_list["tensor_dn2i_mul_r2_dn2h_ele"]]
    tensor_d_gate = concat(tensors, 1)
    tensor_list["tensor_d_gate"] = tensor_d_gate

    return tensor_list, emit_list, scope_list


def matmul_compute(tensor_weight, tensor_d_h2, tensor_dy, tensor_i2, tensor_list, emit_list, scope_list, dst_type):
    """

    """
    tensor_d_gate = tensor_list["tensor_d_gate"]
    if dst_type == "float32":
        tensor_d_gate_ub = tvm.compute(tensor_d_gate.shape, lambda *i: tensor_d_gate(*i), name="tensor_d_gate_ub")
        tensor_list["tensor_d_gate_ub"] = tensor_d_gate_ub
        tensor_d_gate_cast = cast_to(tensor_d_gate_ub, "float16")
        tensor_list["tensor_d_gate_cast"] = tensor_d_gate_cast
        tensor_d_gate = tensor_d_gate_cast
    matmul_res_gm = matmul(tensor_a=tensor_d_gate, tensor_b=tensor_weight, trans_a=True,
                           trans_b=False,
    ...
    tensor_d_h2_res = tvm.compute(tensor_ele_shape, lambda t, i, j, k, l: tensor_d_h2[0, i, j, k, l],
    ...
    # tensor_d_h2_res tensor_dy_res tensor_i2_res tensor_res_dh2_add tensor_res_dh2_mul_i2 tensor_dh1_res tensor_dh1_gm
    ...
    tensor_res_dh2_add = vadd(tensor_d_h2_res, tensor_dy_res)
    tensor_list["tensor_res_dh2_add"] = tensor_res_dh2_add

    tensor_res_dh2_mul_i2 = vmul(tensor_res_dh2_add, tensor_i2_res)
    tensor_list["tensor_res_dh2_mul_i2"] = tensor_res_dh2_mul_i2

    tensor_dh1_res = vadd(matmul_res, tensor_res_dh2_mul_i2)
...
def basic_gru_cell_compute(tensor_weight, tensor_h1, tensor_n2, tensor_i2,
    ...
    tensor_list, \
    emit_list, \
    scope_list = copy_input_to_ub_compute(tensor_weight, tensor_h1, tensor_n2,
                                          tensor_i2, tensor_r2, tensor_n2_mid,
                                          tensor_d_h2, tensor_dy,
                                          tensor_list, emit_list, scope_list)

    # tensor_h1_ub_ele tensor_n2_i2_ub_ele tensor_n2_ub_ele tensor_i2_ub_ele
    # tensor_i2_n2i_ub_ele tensor_r2_dn2h_ub_ele tensor_r2_ub_ele tensor_n2_mid_ub_ele tensor_d_h2_i2_ub_ele
    # tensor_d_h2_n2i_ub_ele tensor_dy_i2_ub_ele tensor_dy_n2i_ub_ele tensor_d_n2_i_ub_ele tensor_dy_i2_ub_ele
    # tensor_list["tensor_r2_dn2h_ub_ele"]

    #(tensor_dh2_di2, tensor_dy_di2, tensor_h1, tensor_n2_di2, tensor_i2_di2,
    #tensor_dh2_dn2i, tensor_dy_dn2i, tensor_n2_dn2i, tensor_i2_dn2i,
    #tensor_r2_dn2h, tensor_n2_mid, tensor_r2_dr2,
    #tensor_list, emit_list, scope_list)
    dtype = "float16"
    if cast_type:
        dtype = "float32"
    tensor_list, \
    emit_list, scope_list = elewise_compute_for_gate(tensor_list["tensor_d_h2_i2_ub_ele"],
    ...
    if cast_type:
        dst_type = "float32"
    tensor_list = matmul_compute(tensor_weight, tensor_d_h2,
                                 tensor_dy, tensor_i2,
                                 tensor_list, emit_list, scope_list, dst_type)

    return tensor_list, emit_list, scope_list


def get_tiling(batch_size, output_size):
    """
    """
...
def schedule_for_cell(tensor_input_list, tensor_list, tensor_output_list, emit_list, scope_list, build_list, cast_type):
    ...
    tensor_d_gate = tensor_list["tensor_d_gate"]
    batch_size = tensor_d_gate.shape[2].value
    output_size = tensor_d_gate.shape[1].value // 3
    tiling_info = get_tiling(batch_size, output_size)
    ...
    if cast_type:
        ...
        n_ub_outer, n_ub_inner = sch[tensor_d_gate_ub].split(tensor_d_gate_ub.op.axis[2], factor=batch_factor)
        sch[tensor_d_gate_ub].set_scope(scope_ubuf)
        sch[tensor_d_gate_ub].emit_insn(n_ub_outer, insn_cmd.DMA_COPY)
        sch[tensor_list["tensor_d_gate_cast"]].set_scope(scope_ubuf)
        sch[tensor_list["tensor_d_gate_cast"]].emit_insn(tensor_list["tensor_d_gate_cast"].op.axis[1], insn_cmd.CAST)
    ...
    sch[tensor_d_h2_res].set_scope(scope_ubuf)
    sch[tensor_dy_res].set_scope(scope_ubuf)
    ...
    sch[tensor_i2_res].set_scope(scope_ubuf)
    sch[tensor_i2_res].emit_insn(tensor_i2_res.op.axis[1], insn_cmd.DMA_COPY)

    sch[tensor_res_dh2_add].set_scope(scope_ubuf)
    sch[tensor_res_dh2_add].emit_insn(tensor_res_dh2_add.op.axis[1], insn_cmd.ADD)
    sch[tensor_res_dh2_mul_i2].set_scope(scope_ubuf)
    sch[tensor_res_dh2_mul_i2].emit_insn(tensor_res_dh2_mul_i2.op.axis[1], insn_cmd.MUL)
    sch[tensor_dh1_res].set_scope(scope_ubuf)
...
def do_cell_process(input_list, isExtentbuffer):
    ...
    cast_type = isExtentbuffer[0]

    gate_order = isExtentbuffer[1]

    tensor_list, \
    emit_list, scope_list = basic_gru_cell_compute(tensor_weight, tensor_h1, tensor_n2, tensor_i2,
                                                   tensor_r2, tensor_n2_mid,
                                                   tensor_d_h2, tensor_dy, cast_type, gate_order)

    build_list = [tensor_weight, tensor_h1, tensor_n2,
                  tensor_i2, tensor_r2, tensor_n2_mid,
                  tensor_d_h2, tensor_dy, tensor_list["tensor_dh1_gm"],
                  tensor_list["tensor_d_gate"],
                  tensor_list["tensor_dh2_mul_i2_dn2i_gm_ele"]]

    tensor_input_list = []
    tensor_output_list = [tensor_list["tensor_dh1_gm"], tensor_list["tensor_d_gate"], tensor_list["tensor_dh2_mul_i2_dn2i_gm_ele"]]

    sch = schedule_for_cell(tensor_input_list, tensor_list,
                            tensor_output_list, emit_list,
                            scope_list, build_list, cast_type)
...
def gru_v2_hidden_grad(weight_hidden, init_h, h, dy, dh, update, reset, new,
                       hidden_new, dh_prev, dgate_h, dnt_x, gate_order="zrh", kernel_name="gru_hidden_grad"):
    ...
    w_shape = [1, weight_hidden["shape"][0], weight_hidden["shape"][1], weight_hidden["shape"][2], weight_hidden["shape"][3]]
    tensor_w = tik_instance.Tensor(weight_src_dtype, w_shape, scope_gm, "tensor_w")

    init_h_shape = [1, init_h["shape"][0], init_h["shape"][1], init_h["shape"][2], init_h["shape"][3]]
    tensor_init_h = tik_instance.Tensor(inp_src_dtype, init_h_shape, scope_gm, "tensor_init_h")

    h_shape = [h["shape"][0], h["shape"][1], h["shape"][2], h["shape"][3], h["shape"][4]]
    tensor_h = tik_instance.Tensor(inp_src_dtype, h_shape, scope_gm, "tensor_h")

    dy_shape = [dy["shape"][0], dy["shape"][1], dy["shape"][2], dy["shape"][3], dy["shape"][4]]
    tensor_dy = tik_instance.Tensor(inp_src_dtype, dy_shape, scope_gm, "tensor_dy")
    ...
    update_shape = [update["shape"][0], update["shape"][1], update["shape"][2], update["shape"][3], update["shape"][4]]
    tensor_update = tik_instance.Tensor(inp_src_dtype, update_shape, scope_gm, "tensor_update")

    reset_shape = [reset["shape"][0], reset["shape"][1], reset["shape"][2], reset["shape"][3], reset["shape"][4]]
    tensor_reset = tik_instance.Tensor(inp_src_dtype, reset_shape, scope_gm, "tensor_reset")

    new_shape = [new["shape"][0], new["shape"][1], new["shape"][2], new["shape"][3], new["shape"][4]]
    tensor_new = tik_instance.Tensor(inp_src_dtype, new_shape, scope_gm, "tensor_new")

    hidden_new_shape = [hidden_new["shape"][0], hidden_new["shape"][1], hidden_new["shape"][2], hidden_new["shape"][3], hidden_new["shape"][4]]
    tensor_hidden_new = tik_instance.Tensor(inp_src_dtype, hidden_new_shape, scope_gm, "tensor_hidden_new")

    # output
    dh1_shape = [1, dh1["shape"][0], dh1["shape"][1], dh1["shape"][2], dh1["shape"][3]]
    tensor_dh1 = tik_instance.Tensor(inp_src_dtype, dh1_shape, scope_gm, "tensor_dh1")

    dgate_h_shape = [dgate_h["shape"][0], dgate_h["shape"][1], dgate_h["shape"][2], dgate_h["shape"][3], dgate_h["shape"][4]]
    tensor_dgate_h = tik_instance.Tensor(inp_src_dtype, dgate_h_shape, scope_gm, "tensor_dgate_h")

    dn_i_shape = [dn_i["shape"][0], dn_i["shape"][1], dn_i["shape"][2], dn_i["shape"][3], dn_i["shape"][4]]
    tensor_dn_i = tik_instance.Tensor(inp_src_dtype, dn_i_shape, scope_gm, "tensor_dn_i")

    temp_output_dh1_shape = [dgate_h["shape"][0], dh1["shape"][0], dh1["shape"][1], dh1["shape"][2], dh1["shape"][3]]
    temp_output_dh1 = tik_instance.Tensor(inp_src_dtype, temp_output_dh1_shape, scope_gm,
