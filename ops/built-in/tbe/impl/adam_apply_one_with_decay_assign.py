...
def _check_broadcast_shape(input0, input1, input2, input3, input4,
    ...
    shape3, shape_max_4add3, _ = shape_util.broadcast_shapes(
...
@tbe_platform.fusion_manager.fusion_manager.register("adam_apply_one_with_decay_assign")
...
def adam_apply_one_with_decay_assign(input0,
    ...
    # Fusion with assign
    fusion_util.reuse_input_as_output(input_place1, y1, kernel_name)
    fusion_util.reuse_input_as_output(input_place2, y2, kernel_name)
    fusion_util.reuse_input_as_output(input_place3, y3, kernel_name)
