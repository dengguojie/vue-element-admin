...
def check_supported(x, y, argmax, output_size, kernel_name='adaptive_max_pool2d'):
    ...
    dtype_bytes = tbe_platform.get_bit_len(input_dtype) // Constant.BITS_OF_BYTE
    ub_cell_available = (tbe_platform.cce_conf.get_soc_spec(
        tbe_platform.cce_conf.UB_SIZE) - 8 * 1024) // Constant.BLOCK_BYTES // dtype_bytes // Constant.UB_DIVIDE_NUM
...
class AdaptiveMaxPool2d:
    ...
    def __init__(self, x, y, argmax, output_size, kernel_name='adaptive_max_pool2d'):
        ...
        self.ub_availble = tbe_platform.cce_conf.get_soc_spec(
            tbe_platform.cce_conf.UB_SIZE) - Constant.UB_RESERVED_SIZE
        # params run on cpu
        ...
        self.k_info_size = (self.output_h + self.output_w) * (
                tbe_platform.get_bit_len('int32') // Constant.BITS_OF_BYTE)
        ...
        self.dtype_bytes = tbe_platform.get_bit_len(self.x_dtype) // Constant.BITS_OF_BYTE
