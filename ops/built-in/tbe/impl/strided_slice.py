...
def strided_slice(input_x,
    ...
    def init_tiling(tiling_inst: StridedSlice.TilingParam):
        ...
        ub_size = (tbe_platform.cce_conf.get_soc_spec(tbe_platform.cce_conf.UB_SIZE) - reserve_ub_size) // \
        ...
        def _set_tiling_data(perf_input_shape, perf_output_shape, perf_begin, perf_end, perf_strides, mode):
        ...
        _set_tiling_data(perf_input_shape, perf_output_shape, perf_begin, perf_end, perf_stride, mode)
