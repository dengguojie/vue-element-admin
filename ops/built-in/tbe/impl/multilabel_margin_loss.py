...
class MultilabelMarginLoss:
    ...
    def __init__(self, x, target, reduction, kernel_name):
        ...
        # cal multi core
        self.ub_size_bytes = (cce.cce_conf.get_soc_spec(cce.cce_conf.UB_SIZE) - 8192)
        self.var_dtype_bytes_size = cce.cce_intrin.get_bit_len(self.dtype_input) // 8
        self.target_dtype_bytes_size = cce.cce_intrin.get_bit_len(self.dtype_target) // 8
        ...
        if self.update_data_num < self.var_data_each_block or self.nframe == 1 or self.ori_type == "float16":
            ...
            ai_core_num = cce.cce_conf.get_soc_spec(cce.cce_conf.CORE_NUM)
