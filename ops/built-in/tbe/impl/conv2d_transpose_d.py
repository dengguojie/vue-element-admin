...
@util.check_input_type(dict, dict, (dict, type(None)), (dict, type(None)), dict,  (tuple, list),
                       (tuple, list), (str, tuple, list), (tuple, list),
                       int, str, (list, tuple), int, str)
def conv2d_transpose_d(x, filter, bias, offset_w, y, input_size, strides,
...
def conv2d_transpose_d_compute(x, filter, bias, offset_w, y, input_size, strides,
                            pads, dilations=(1, 1, 1, 1),
                            groups=None, data_format="NHWC", output_padding=(0, 0, 0, 0), offset_x=0,
    ...
    if filter_dtype == 'int8':
        ori_shape_filter[0], ori_shape_filter[1] = ori_shape_filter[1],\
                                                   ori_shape_filter[0]
...
@util.check_input_type((list, tuple), (list, tuple), (list, tuple),
                       ...
                       int,
                       str)
def conv2d_transpose_cce(shape_filter, shape_x, input_size,
