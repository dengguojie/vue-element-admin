...
def poisson_nll_loss_compute(input_x,
    ...
    """
    shape_input_x = shape_to_list(input_x.shape)
    shape_target = shape_to_list(target.shape)
    shape_input_x, shape_target, shape_max = broadcast_shapes(shape_input_x, shape_target)
