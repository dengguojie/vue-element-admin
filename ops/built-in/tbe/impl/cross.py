...
class Cross():
    ...
    def set_data2ub(self, dst, src, index):
        ...
        with self.tik_instance.if_scope(index < self.ub_lower_index):
            ...
            self.tik_instance.data_move(self.x1_ub[0], self.x1_gm[self.ub_lower_index * self.vector_mask_max],
                                        0, 1, 8, 0, 0)
            self.tik_instance.data_move(self.x2_ub[0], self.x2_gm[self.ub_lower_index * self.vector_mask_max],
                                        0, 1, 8, 0, 0)
