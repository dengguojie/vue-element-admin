...
@tbe_platform.fusion_manager.fusion_manager.register("stride_add")
class StrideAdd():
    """
    ...
    def compute_each_batch(self, batch_id):
        ...
        """
        # C1_len * H * W * C0
        compute_num = functools.reduce(lambda x, y: x * y, self.y_shape[1:])
    ...
    def compute_offset(self, batch_id, x_id):
        ...
        # H * W * C0
        hwc0 = functools.reduce(lambda x, y: x * y, self.input_dict[x_id]["shape"][2:])
