...
@util.check_input_type(dict, dict, dict, float, dict, str)
def addcdiv(x1, x2, x3, alpha=1.0, y=None, kernel_name="addcdiv"):
    ...
    util.check_tensor_shape_size(shape_max)     # 对shape_max进行校验
    shape_x1, _, _ = broadcast_shapes(shape_x1, shape_max)    # 将input_x的shape广播为shape_max
