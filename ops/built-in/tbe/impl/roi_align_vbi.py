...
def _roi_align_perf_gengrid_fp32(tik_instance, curr_roi, rois_fp32,
    ...
    tik_instance.vmuls(64, x_pos_fp32, index_array_fp32[0, ], delta_w, 1, 1, 1, 8, 8)
    tik_instance.vmuls(64, y_pos_fp32, index_array_fp32[0, ], delta_h, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, x_pos_fp32, x_pos_fp32, w_start, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, y_pos_fp32, y_pos_fp32, h_start, 1, 1, 1, 8, 8)

    # need to substract 0.5 in TensorFlow
    neg_point_five = tik_instance.Scalar(dtype="float32",
                                         init_value=-0.5)
    tik_instance.vadds(64, x_pos_fp32, x_pos_fp32, neg_point_five, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, y_pos_fp32, y_pos_fp32, neg_point_five, 1, 1, 1, 8, 8)
    ...
    tik_instance.vconv(64, "floor", x_low_int, x_pos_fp32, 1, 1, 1, 8, 8)
    tik_instance.vconv(64, "floor", y_low_int, y_pos_fp32, 1, 1, 1, 8, 8)
    ...
    zero = tik_instance.Scalar(dtype="float32", init_value=0.0)
    tik_instance.vadds(64, x_high_fp32, x_low_fp32, point_five, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, y_high_fp32, y_low_fp32, point_five, 1, 1, 1, 8, 8)
    tik_instance.vconv(64, "ceil", x_high_int, x_high_fp32, 1, 1, 1, 8, 8)
    tik_instance.vconv(64, "ceil", y_high_int, y_high_fp32, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, x_high_fp32, x_low_fp32, one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, y_high_fp32, y_low_fp32, one, 1, 1, 1, 8, 8)
    ...
    tik_instance.vsub(64, lx_fp32, x_pos_fp32, x_low_fp32, 1, 1, 1, 1, 8, 8, 8)
    tik_instance.vsub(64, ly_fp32, y_pos_fp32, y_low_fp32, 1, 1, 1, 1, 8, 8, 8)
    tik_instance.vsub(64, hx_fp32, x_high_fp32, x_pos_fp32, 1, 1, 1, 1, 8, 8, 8)
    tik_instance.vsub(64, hy_fp32, y_high_fp32, y_pos_fp32, 1, 1, 1, 1, 8, 8, 8)
    ...
    tik_instance.vadds(64, lx_neg_cmp, lx_fp32, neg_one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, ly_neg_cmp, ly_fp32, neg_one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, hx_neg_cmp, hx_fp32, neg_one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, hy_neg_cmp, hy_fp32, neg_one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, x_low_pos_cmp, x_low_fp32, one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, y_low_pos_cmp, y_low_fp32, one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, x_high_pos_cmp, x_high_fp32, one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, h_high_pos_cmp, y_high_fp32, one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, x_low_neg_cmp, x_low_fp32, neg_one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, y_low_neg_cmp, y_low_fp32, neg_one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, x_high_neg_cmp, x_high_fp32, neg_one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, y_high_neg_cmp, y_high_fp32, neg_one, 1, 1, 1, 8, 8)
    ...
    tik_instance.vadds(64, cmp_buf, x_low_fp32, point_five, 1, 1, 1, 8, 8)
    tik_instance.vconv(64, "floor", x_low_int, cmp_buf, 1, 1, 1, 8, 8)
    tik_instance.vconv(64, "ceil", x_high_int, cmp_buf, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, cmp_buf, y_low_fp32, point_five, 1, 1, 1, 8, 8)
    ...
    tik_instance.vadds(64, cmp_xy, x_low_fp32, point_five, 1, 1, 1, 8, 8)
    ...
    tik_instance.vadds(64, cmp_buf, cmp_buf, neg_one, 1, 1, 1, 8, 8)
    tik_instance.vadds(64, cmp_xy, y_low_fp32, point_five, 1, 1, 1, 8, 8)
    cmpmask = tik_instance.vcmp_gt(64, cmp_xy, cmp_buf, 1, 1)
    tik_instance.vector_dup(64, cmp_const, zero, 1, 1, 8)
...
def _get_vbi_addr_1x1grid(tik_instance, point_distance_int32):
    """
    :param tik_instance:
...
def _get_vbi_weights_1x1grid(tik_instance, point_weights_fp32):
    """
    :param tik_instance:
...
def _prepare_vbi_xm(tik_instance, point_weights_fp32):
    """
    :param tik_instance:
...
def _do_vbi_one_row_mode(tik_instance, cur_roi_num,
                         feature_shape,
                ...
                with tik_instance.if_scope(feature_map_h > height):
                    ...
                    with tik_instance.if_scope(
                        ...
                        _do_vbi_full_featuremap_mode(tik_instance,
                                                     ...
                                                     width, height)
                    with tik_instance.else_scope():
                        _do_vbi_one_row_mode(tik_instance, cur_roi_num,
                                             feature_shape, featuremap_gm,
