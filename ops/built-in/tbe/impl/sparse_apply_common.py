...
class SparseApply():
    ...
    def __init__(self, var, grad, indices, kernel_name):
        ...
        self.indices_gm = self.tik_instance.Tensor(self.indices_dtype,
                                                   ...
                                                   name="indices_gm",
                                                   scope=tik.scope_gm)
        self.grad_gm = self.tik_instance.Tensor(self.grad_dtype, self.grad_shape, name="grad_gm", scope=tik.scope_gm)
    ...
    def add_input(self, name, dtype, shape):
        ...
        None
        """
        tensor = self.tik_instance.Tensor(dtype, shape, name=name, scope=tik.scope_gm)
