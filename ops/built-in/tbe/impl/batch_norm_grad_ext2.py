...
def _get_parms_cast(y_backprop, x):
    ...
    if dtype_y_backprop == "float16" and tbe_platform.cce_conf.api_check_support("te.lang.cce.vdiv", "float32"):
        y_backprop = tbe.cast_to(y_backprop, "float32")

    if dtype_x == "float16" and tbe_platform.cce_conf.api_check_support("te.lang.cce.vdiv", "float32"):
