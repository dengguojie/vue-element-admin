...
class Pdist():
    def __init__(self, input_x, output_y, p, kernel_name="pdist"):
        ...
        self.ai_core_num = te.platform.cce_conf.get_soc_spec(te.platform.cce_conf.CORE_NUM)

        # get size of UB and compute the number of elements can be stored in a block
        self.ub_size_bytes = te.platform.cce_conf.get_soc_spec(te.platform.cce_conf.UB_SIZE)
        self.dtype_bytes_size = te.platform.cce_intrin.get_bit_len(self.dtype_x) // 8
    ...
    def pdist_compute(self):
        ...
        last_nums_blocks = math.ceil(last_nums / self.data_each_block)
            ...
            with self.tik_instance.for_range(0, self.ai_core_num, block_num=self.ai_core_num) as core_id:
                ...
                with self.tik_instance.for_range(0, num_block_each_core) as block_num_id:
                    ...
                    with self.tik_instance.for_range(0, self.data_each_block) as k:
                        ...
                        self.tik_instance.scalar_sqrt(self.scalar_i3, self.scalar_i3)
                        expr_i4 = i2 - self.scalar_i3
    ...
    def init_ub_tensor_and_scalar(self):
        ...
        self.scalar_i = self.tik_instance.Scalar(dtype="int32", name="scalar_i")
