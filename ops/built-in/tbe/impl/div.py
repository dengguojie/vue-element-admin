...
def op_select_format(x, y, output, kernel_name="div"):
    ...
    # 5HD+scalar,ND+ND,FZ+scalar,6D+scalar,NZ+ND
        ...
        param_list = _gen_para(dtype_total, format_list0, format_list1, format_list0, unknownshape_format_list,
                               shape_x, shape_y)
    ...
    # ND+ND,scalar+5HD,scalar+FZ,scalar+6D,ND+NZ
        ...
        format_list1 = format_nd * len(format_list)
        unknownshape_format_list = ["ND"] * len(dtype_total)
        param_list = _gen_para(dtype_total, format_list1, format_list0, format_list0, unknownshape_format_list,
                               shape_x, shape_y)
    # ND+ND,5HD+5HD
    else:
