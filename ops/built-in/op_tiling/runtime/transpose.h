...
struct RuntimeInfoV2 {
  ...
  RuntimeInfoV2(): coreNum(MAX_CORE_NUM), scenarioSize(0) {
...
void ReduceAxisV2(const char* opType,
                  ...
                  ShapeInfo& shapeInfo, RuntimeInfoV2& ci);

void RemoveAxisV2(ShapeInfo& shapeInfo);

void MergeAxisV2(ShapeInfo& shapeInfo);

bool TransposeCalcTilingData(const std::string& opType, const TransposeCompilerInfo& compilerInfo, ShapeInfo& shapeInfo,
