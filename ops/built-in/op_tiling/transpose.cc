...
static map<uint64_t, PermInfo> InitPerm() {
  ...
  ADD_T_ITEM(0, 3, 3, 0x012, 0x210, 0x345210,
             PTA({{0, 1, 2, 3, 4, 5}, {1, 2, 0, 3, 4, 5}, {2, 1, 0, 3, 4, 5}, {3, 4, 5, 2, 1, 0}}))
  ...
  ADD_T_ITEM(0, 3, 3, 0x021, 0x210, 0x354210,
             PTA({{0, 1, 2, 3, 4, 5}, {1, 2, 0, 3, 4, 5}, {2, 1, 0, 3, 4, 5}, {3, 4, 5, 2, 1, 0}}))
  ...
  ADD_T_ITEM(0, 3, 3, 0x102, 0x210, 0x435210,
             PTA({{0, 1, 2, 3, 4, 5}, {1, 2, 0, 3, 4, 5}, {2, 1, 0, 3, 4, 5}, {3, 4, 5, 2, 1, 0}}))
  ...
  ADD_T_ITEM(0, 3, 3, 0x120, 0x210, 0x453210,
             PTA({{0, 1, 2, 3, 4, 5}, {1, 2, 0, 3, 4, 5}, {2, 1, 0, 3, 4, 5}, {3, 4, 5, 2, 1, 0}}))
  ...
  ADD_T_ITEM(0, 3, 3, 0x201, 0x210, 0x534210,
             PTA({{0, 1, 2, 3, 4, 5}, {1, 2, 0, 3, 4, 5}, {2, 1, 0, 3, 4, 5}, {3, 4, 5, 2, 1, 0}}))
  ...
  ADD_T_ITEM(0, 3, 3, 0x210, 0x210, 0x543210,
             PTA({{0, 1, 2, 3, 4, 5}, {1, 2, 0, 3, 4, 5}, {2, 1, 0, 3, 4, 5}, {3, 4, 5, 2, 1, 0}}))
  ...
  ADD_T_ITEM(2, 2, 3, 0x10, 0x201, 0x201,
             PTA({
                 {0, 1, 2},
                 {2, 0, 1},
             }))
  ...
  ADD_T_ITEM(3, 3, 3, 0x120, 0x120, 0x120,
             PTA({
                 {0, 1, 2},
                 {1, 2, 0},
             }))
  ADD_T_ITEM(3, 3, 3, 0x201, 0x201, 0x201,
             PTA({
                 {0, 1, 2},
                 {2, 0, 1},
             }))
