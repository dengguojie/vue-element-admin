...
namespace optiling {
    ...
    static void SetIsFiniteTiling(const int64_t& core_num, int64_t& ub_max_size, int64_t& need_core_num,
                                  const int64_t& total_element_size, std::vector<int64_t>& core_parm_vector) {
    ...
    static void ComputeIsFiniteTiling(const int64_t& core_num, int64_t& ub_x_size, int64_t& need_core_num,
                                      const int64_t& total_element_size, std::vector<int64_t>& core_parm_vector) {
