...
namespace {
  ...
  constexpr int64_t NO_REDUCE = 400;
  constexpr int64_t ALL_DYNAMIC_NO_SPLIT = 200;
  constexpr int64_t ALL_DYNAMIC_SPLIT_NORMAL = 201;
  constexpr int64_t ALL_DYNAMIC_SPLIT_REDUCE = 202;
  constexpr int64_t ALL_DYNAMIC_SPLIT_REDUCE_SPLIT_NORMAL = 203;
  constexpr int64_t ALL_DYNAMIC_SPLIT_REDUCE_I = 204;
  constexpr int64_t DYNAMIC_REDUCE_NO_SPLIT = 100;
  constexpr int64_t DYNAMIC_REDUCE_SPLIT_REDUCE = 101;
  constexpr int64_t DYNAMIC_REDUCE_SPLIT_REDUCE_I = 102;
  constexpr int64_t DYNAMIC_NORMAL_NO_SPLIT = 300;
  constexpr int64_t DYNAMIC_NORMAL_SPLIT_NORMAL = 301;
  constexpr int64_t DYNAMIC_NORMAL_SPLIT_REDUCE = 302;
  constexpr int64_t DYNAMIC_NORMAL_SPLIT_REDUCE_SPLIT_NORMAL = 303;
  constexpr int64_t DYNAMIC_NORMAL_SPLIT_REDUCE_I = 304;
}
