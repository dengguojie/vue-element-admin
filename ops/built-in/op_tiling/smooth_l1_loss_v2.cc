...
bool SmoothL1LossV2IsInAxis(std::vector<int32_t>& input, int32_t value) {
...
static bool ParseJsonCompileInfo(const std::string& op_type, const nlohmann::json& compile_info,
                                 SmoothL1LossV2CompileInfo& parsed_info) {
...
REGISTER_OP_TILING_V3_CUSTOM(SmoothL1LossV2, SmoothL1LossV2Tiling, ParseJsonCompileInfo, SmoothL1LossV2CompileInfo);
}  // namespace optiling
