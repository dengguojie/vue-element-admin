...
void PrintTilingParams(const std::string& opType, const ScatterMinTilingParams& params) {
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : tilingMode=%ld.", params.tilingMode);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : indiceStep=%ld.", params.indiceStep);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : coreNum=%ld.", params.coreNum);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : updatesDataNum=%ld.", params.updatesDataNum);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : indicesLoopNum=%ld.", params.indicesLoopNum);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : indicesLastNum=%ld.", params.indicesLastNum);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : updatesNum=%ld.", params.updatesNum);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : updatesLoopNum=%ld.", params.updatesLoopNum);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : updatesLastNum=%ld.", params.updatesLastNum);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : varNum=%ld.", params.varNum);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : varLoopNum=%ld.", params.varLoopNum);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : varLastNum=%ld.", params.varLastNum);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : varEachCoreBurstLen=%ld.", params.varEachCoreBurstLen);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : varLastCoreBurstLen=%ld.", params.varLastCoreBurstLen);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : maxIndice=%ld.", params.maxIndice);
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : varEachCoreData=%ld.", params.varEachCoreData);
}
...
bool ScatterMinTiling(const std::string& opType, const TeOpParas& opParas, const nlohmann::json& opCompileInfo,
  ...
  OP_LOGI(opType.c_str(), "ScatterMinTiling running.");
  ...
  if (!is_valid_shape) {
    OP_LOGE(opType.c_str(), "CheckScatterMinShape is failed.");
    return false;
  }
  ...
  if (!can_get_params) {
    OP_LOGE(opType.c_str(), "GetScatterMinCompileParams error.");
    return false;
  }
  ...
  OP_LOGD(opType.c_str(), "op [ScatterMinTiling] : indicesNum=%ld.", indicesNum);
  ...
  OP_LOGI(opType.c_str(), "ScatterMinTiling run success.");
