...
bool SigmoidCrossEntropyWithLogitsGradV2Tiling(const std::string& op_type, const TeOpParas& op_paras,
...
REGISTER_OP_TILING_FUNC_BUFFERED(SigmoidCrossEntropyWithLogitsGradV2, SigmoidCrossEntropyWithLogitsGradV2Tiling);
}  // namespace optiling
