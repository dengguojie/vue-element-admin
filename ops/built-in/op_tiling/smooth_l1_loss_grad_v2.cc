...
bool SmoothL1LossGradV2Tiling(const std::string& op_type, const ge::Operator& op_paras,
                                  const SmoothL1LossGradV2CompileInfo& parsed_info, utils::OpRunInfo& run_info) {
...
static bool ParseJsonCompileInfo(const std::string& op_type, const nlohmann::json& compile_info,
                                 SmoothL1LossGradV2CompileInfo& parsed_info) {
...
REGISTER_OP_TILING_V3_CUSTOM(SmoothL1LossGradV2, SmoothL1LossGradV2Tiling, ParseJsonCompileInfo,
                             SmoothL1LossGradV2CompileInfo);
}  // namespace optiling
