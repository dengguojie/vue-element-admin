...
vector<BufferFusionPattern *> TbeAippConvSingleInFusionPass::DefinePatterns() {
  ...
  string passName1 = "TbeAippConvSingleInFusion1";
  ...
  pattern1
      ...
      .AddOpDesc(PATTERN_ELTWISE1, {OP_PATTERN_ELEMWISE}, TBE_PATTERN_NUM_DEFAULT, 3)
  ...
  string passName2 = "TbeAippConvSingleInFusion2";
 ...
 */
Status TbeAippConvSingleInFusionPass::GetFusionNodes(
  ...
  OP_LOGD(FUSED_OP_TYPE.c_str(), "End to do TbeAippConvReluFusionPass!");
  return SUCCESS;
}
REGISTER_BUFFER_FUSION_PASS("TbeAippConvSingleInFusion",
