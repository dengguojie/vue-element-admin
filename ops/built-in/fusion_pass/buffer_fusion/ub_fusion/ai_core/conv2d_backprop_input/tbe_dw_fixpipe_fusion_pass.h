...
#ifndef OPS_BUILT_IN_FUSION_PASS_BUFFER_FUSION_UB_FUSION_AI_CORE_CONV2DBACKPROPINPUT_TBE_DW_FIXPIPE_FUSION_PASS_H_
#define OPS_BUILT_IN_FUSION_PASS_BUFFER_FUSION_UB_FUSION_AI_CORE_CONV2DBACKPROPINPUT_TBE_DW_FIXPIPE_FUSION_PASS_H_
...
class TbeDwFixpipeFusionPass : public BufferFusionPassBase {
 public:
  explicit TbeDwFixpipeFusionPass() {}

  ~TbeDwFixpipeFusionPass() override {}
...
#endif //OPS_BUILT_IN_FUSION_PASS_BUFFER_FUSION_UB_FUSION_AI_CORE_CONV2DBACKPROPINPUT_TBE_DW_FIXPIPE_FUSION_PASS_H_
