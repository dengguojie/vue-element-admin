...
#include "tbe_conv2d_backprop_requant_pass.h"
#include <string>
#include <vector>
#include "op_log.h"
 ...
 */
vector<BufferFusionPattern *> TbeConv2DBackpropRequantFusionPass::DefinePatterns() {
  ...
  pattern
      ->AddOpDesc(kPatternConv, {OP_PATTERN_CONV_BACKPROP_INPUT},
...
REGISTER_BUFFER_FUSION_PASS("TbeConv2DBackpropRequantFusionPass", BUILT_IN_AI_CORE_BUFFER_FUSION_PASS,
