...
#ifndef OPS_BUILT_IN_FUSION_PASS_BUFFER_FUSION_UB_FUSION_AI_CORE_CONV_TBE_CONV_BNREDUCE_FUSION_PASS_H_
...
namespace fe {
class ConvBnreduceFusionPass : public BufferFusionPassBase {
 public:
  explicit ConvBnreduceFusionPass() {}
...
#endif  // OPS_BUILT_IN_FUSION_PASS_BUFFER_FUSION_UB_FUSION_AI_CORE_CONV_TBE_CONV_BNREDUCE_FUSION_PASS_H_
