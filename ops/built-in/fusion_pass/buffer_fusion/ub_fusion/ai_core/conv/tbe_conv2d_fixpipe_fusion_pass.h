...
#ifndef OPS_BUILT_IN_FUSION_PASS_BUFFER_FUSION_UB_FUSION_AI_CORE_CONV_TBE_CONV2D_FIXPIPE_FUSION_PASS_H_
#define OPS_BUILT_IN_FUSION_PASS_BUFFER_FUSION_UB_FUSION_AI_CORE_CONV_TBE_CONV2D_FIXPIPE_FUSION_PASS_H_
...
class TbeConv2DFixpipeFusionPass : public BufferFusionPassBase {
 public:
  explicit TbeConv2DFixpipeFusionPass() {}
...
#endif //OPS_BUILT_IN_FUSION_PASS_BUFFER_FUSION_UB_FUSION_AI_CORE_CONV_TBE_CONV2D_FIXPIPE_FUSION_PASS_H_
