...
/*!
 * \file copy_fusion_pass.h
 * \brief LayerNormGrad fusion pass
 *   (LayerNormGrad --> LayerNormXBackprop \brief LayerNormBetaGammaBackprop)
 */
#ifndef OPS_BUILT_IN_FUSION_PASS_GRAPH_FUSION_AI_CORE_COPY_FUSION_PASS_H_
#define OPS_BUILT_IN_FUSION_PASS_GRAPH_FUSION_AI_CORE_COPY_FUSION_PASS_H_
...
#endif  // OPS_BUILT_IN_FUSION_PASS_GRAPH_FUSION_AI_CORE_COPY_FUSION_PASS_H_
