 ...
 */
#ifndef OPS_BUILT_IN_FUSION_PASS_GRAPH_FUSION_AI_CORE_TRANSDATA_RESHAPE_TRANSDATA_TRANSPOSE_FUSION_PASS_H_
#define OPS_BUILT_IN_FUSION_PASS_GRAPH_FUSION_AI_CORE_TRANSDATA_RESHAPE_TRANSDATA_TRANSPOSE_FUSION_PASS_H_
...
namespace fe {
class TransdataTransposeFusionPass : public PatternFusionBasePass {
    protected:
