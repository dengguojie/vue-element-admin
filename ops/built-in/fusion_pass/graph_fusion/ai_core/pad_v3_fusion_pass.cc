...
Status PadV3FusionPass::PadMoveConsttoAttr(ge::ComputeGraph& graph, ge::NodePtr& pad_node, const string& attr_name,
                                           int32_t index) {
  ...
  FUSION_PASS_CHECK(pad_desc == nullptr, OP_LOGE(FUSED_OP_TYPE.c_str(), "pad_v3_node's OpDesc is null, fusion failed."),
