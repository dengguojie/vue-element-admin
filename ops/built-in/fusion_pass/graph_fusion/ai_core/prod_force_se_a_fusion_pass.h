...
namespace fe {
class ProdForceSeAFusionPass : public PatternFusionBasePass {
 protected:
  vector<FusionPattern*> DefinePatterns() override;
  Status Fusion(ge::ComputeGraph& graph, Mapping& mapping, vector<ge::NodePtr>& fusionNodes) override;
 private:
  bool CheckUsePattern(vector<int64_t>& dimInfo);
  const string FUSED_OP_TYPE = "TransposeD_ProdForceSeA";
};
