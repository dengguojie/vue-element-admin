...
/*!
 * \file square_sum_v2_fusion_pass.h
 * \brief square_sum(square+square+sum)
 */
#ifndef OPS_BUILT_IN_FUSION_PASS_GRAPH_FUSION_AI_CORE_SQUARE_SUM_V2_FUSION_PASS_H_
#define OPS_BUILT_IN_FUSION_PASS_GRAPH_FUSION_AI_CORE_SQUARE_SUM_V2_FUSION_PASS_H_
