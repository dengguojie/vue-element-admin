...
private:
    ...
    void AddHiddenGradNodeEdge(map<std::string, ge::NodePtr>& inputNodes, ge::NodePtr hiddenGradNode,
                               ge::NodePtr matmulGradNode, ge::NodePtr lastHiddenGradNode,
                               ge::NodePtr lastMatmulNode, ge::NodePtr dynamicGRUGradNode, int64_t curT);
    void AddSplitTInputNodeDesc(ge::OpDescPtr hiddenGradDesc, ge::OpDescPtr dynamicGRUGradDesc,
    ...
    ge::NodePtr AddWxBroadcastNode(ge::NodePtr dynamicGRUGradNode, ge::ComputeGraph &graph,
        vector<ge::NodePtr> &newNodes, bool &failStatus);
