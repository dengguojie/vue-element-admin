...
Status SplitFusionPass::Fusion(ge::ComputeGraph &graph,
                              Mapping &mapping,
  ...
  Status ret = PatternFusionUtil::ConstToAttrWithNode(graph, fused_node1,
                 fusionOpType, splitAttrInfo, fused_node);
  if (ret != SUCCESS) {
