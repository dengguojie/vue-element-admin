...
#ifndef FE_DYNAMIC_GRU_V2_GRAD_ALIGN_FUSION_PASS_H
#define FE_DYNAMIC_GRU_V2_GRAD_ALIGN_FUSION_PASS_H

#include "graph_optimizer/fusion_common/pattern_fusion_base_pass.h"

namespace fe {
class DynamicGRUV2GradAlignFusionPass : public PatternFusionBasePass {
 protected:
 ...
 private:
  ...
  ge::NodePtr AddReduceSumNode(ge::NodePtr dynamicGRUGradNode, ge::NodePtr inputNode, int anchorIndex,
                               ...
                               ge::ComputeGraph& graph, vector<ge::NodePtr>& newNodes, bool& failStatus);
  ge::NodePtr GetConstNodeOne(ge::NodePtr dynamicGRUGradNode, ge::NodePtr inputNode,
  ...
  ge::NodePtr AddDbReduceSumTransNode(ge::NodePtr dynamicGRUGradNode, ge::NodePtr inputNode, int anchorIndex,
                                      const vector<int64_t>& axis, const string& nodeName, const string& indexName,
                                      ge::ComputeGraph& graph, vector<ge::NodePtr>& newNodes,
                                      const vector<int64_t>& transDims, bool& failStatus);
  ge::NodePtr AddDwReduceSumTransNode(ge::NodePtr dynamicGRUGradNode, ge::NodePtr inputNode, int anchorIndex,
                                      const vector<int64_t>& axis, const string& nodeName, const string& indexName,
                                      ge::ComputeGraph& graph, vector<ge::NodePtr>& newNodes,
                                      const vector<int64_t>& transDims, const string& weightName, bool& failStatus);
  ge::NodePtr AddTransposeNode(ge::NodePtr dynamicGRUGradNode, ge::NodePtr dwMatmulNode, const string& nodeName,
                               const string& weightName, const string& outputName, ge::ComputeGraph& graph,
                               vector<ge::NodePtr>& newNodes);
  const string FUSED_OP_TYPE = "DynamicGRUV2GradAlign";
  int64_t t_size = 0;
  int64_t batch = 0;
  int64_t nzBatch = 0;
  int64_t input_dim = 0;
...
#endif  // FE_DYNAMIC_GRU_V2_GRAD_ALIGN_FUSION_PASS_H
