 ...
 *
 * @brief TensorScatterAdd fusion pass(TensorScatterAdd --> TensorMove & ScatterNdAdd)
 *
 */
...
Status TensorScatterAddFusionPass::Fusion(ge::ComputeGraph &graph,
  ...
  scatterNdAdddesc =
      std::make_shared<ge::OpDesc>(fusedNode->GetName(), SCATTERNDADD);
  FUSION_PASS_CHECK(scatterNdAdddesc == nullptr, OP_LOGE(FUSED_OP_TYPE.c_str(), "scatterNdAdddesc is null, fusion failed."),
           return PARAM_INVALID);
  ...
  FUSION_PASS_CHECK(scatterNdAddNode == nullptr,
           OP_LOGE(FUSED_OP_TYPE.c_str(), "scatterNdAddNode fusionNode:%s is null, fusion failed.",
  ...
  FUSION_PASS_CHECK(ge::GraphUtils::AddEdge(
               ...
               scatterNdAddNode->GetInDataAnchor(0)) != SUCCESS,
  ...
  for (auto inDataAnchor :
    ...
    FUSION_PASS_CHECK(ge::GraphUtils::AddEdge(scatterNdAddNode->GetOutDataAnchor(0),
                                     inDataAnchor) != SUCCESS,
