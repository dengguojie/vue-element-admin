...
Status TensorScatterSubFusionPass::Fusion(ge::ComputeGraph &graph,
  ...
  scatterNdSubdesc =
      std::make_shared<ge::OpDesc>(fusedNode->GetName(), SCATTERNDSUB);
  FUSION_PASS_CHECK(scatterNdSubdesc == nullptr, OP_LOGE(FUSED_OP_TYPE.c_str(), "scatterNdSubdesc is null, fusion failed."),
           return PARAM_INVALID);
  ...
  FUSION_PASS_CHECK(scatterNdSubNode == nullptr,
           OP_LOGE(FUSED_OP_TYPE.c_str(), "scatterNdSubNode fusionNode:%s is null, fusion failed.",
  ...
  FUSION_PASS_CHECK(ge::GraphUtils::AddEdge(
               ...
               scatterNdSubNode->GetInDataAnchor(0)) != SUCCESS,
  ...
  for (auto inDataAnchor :
    ...
    FUSION_PASS_CHECK(ge::GraphUtils::AddEdge(scatterNdSubNode->GetOutDataAnchor(0),
                                     inDataAnchor) != SUCCESS,
