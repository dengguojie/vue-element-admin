...
#ifndef OPS_BUILT_IN_FUSION_PASS_GRAPH_FUSION_AI_CORE_MIN_FUSION_PASS_H_
#define OPS_BUILT_IN_FUSION_PASS_GRAPH_FUSION_AI_CORE_MIN_FUSION_PASS_H_
#include <string>
#include <vector>
...
namespace fe {
class MinToMinimumPass : public PatternFusionBasePass {
 protected:
