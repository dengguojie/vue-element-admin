    ...
    ge::ComputeGraph &graph, vector<ge::NodePtr> &newNodes, bool &failStatus)
{
    ...
    */
    ...
    AddOutputNodeDesc(concatDesc, "concat_h", outputNzDim, ge::FORMAT_FRACTAL_NZ,
                      outputDim, ge::FORMAT_FRACTAL_NZ, inputHType);
...
ge::NodePtr DynamicGRUV2GradFusionPass::AddDwhMatmulNode(ge::NodePtr dynamicGRUGradNode,
    ge::NodePtr gruHiddenGradNode, ge::ComputeGraph &graph, vector<ge::NodePtr> &newNodes, bool &failStatus)
{
    // create matmul desc
    ge::OpDescPtr matmulDesc =
...
ge::NodePtr DynamicGRUV2GradFusionPass::AddDgateXConcatNode(ge::NodePtr dynamicGRUGradNode,
...
ge::NodePtr DynamicGRUV2GradFusionPass::AddDwxMatmulNode(ge::NodePtr dynamicGRUGradNode,
...
ge::NodePtr DynamicGRUV2GradFusionPass::AddNzTransDataNode(ge::NodePtr dynamicGRUGradNode, ge::NodePtr inputNode,
    int anchorIndex, const string &nodeName, ge::ComputeGraph &graph, vector<ge::NodePtr> &newNodes, bool &failStatus)
{
    // create desc
...
Status DynamicGRUV2GradFusionPass::Fusion(ge::ComputeGraph &graph, Mapping &mapping, vector<ge::NodePtr> &newNodes)
{
    ...
    FUSION_PASS_CHECK(isFailure, OP_LOGE(FUSED_OP_TYPE.c_str(), "AddNzTransDataNode:check failed, fusion failed."),
                      return FAILED);
    isFailure = AddReduceSumNode(gruV2GradNode, dbhTransNode, 0, reduceDbAxis, "dbh",
