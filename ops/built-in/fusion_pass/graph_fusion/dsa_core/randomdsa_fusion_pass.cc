...
Status RandomDsaFusionPass::Fusion(ge::ComputeGraph& graph, Mapping& mapping, vector<ge::NodePtr>& fusionNodes) {
  ...
  if (platformInfo.str_info.short_soc_version != "Ascend910B") {
  ...
  if (fusedNode_Drop == nullptr && fusedNode_Uniform == nullptr && fusedNode_normal == nullptr &&
      fusedNode_Truncate == nullptr) {
