...
def special_pipe_transformation(_, e_search_result, __, instr, extra_info, group=2):
    ...
    if waiting_pipe == "L2":
        ...
        waiting_pipe = "MTE1"
    return DavinciV100PipelineType["PID_PIPELINE_" + waiting_pipe]


class Ascend910_CA_ModelParser(common.BaseModelParser):
    # ICACHE
    ...
    special_rules = ((re.compile(r"scalar_ld|scalar_st.*"),
                     ...
                     (re.compile(r"barrier"),
                      bar_pattern,
                      lambda search_result, e_search_result, pipeline, instr, extra_info:
                      DavinciV100PipelineType.PID_PIPELINE_SCALAR if extra_info == "(pipe_type: ALL) " else
    ...
    def handle_instr_log(self, raw_instr_logs, raw_instr_popped_logs):
        pipelines = (DavinciV100PipelineType.PID_PIPELINE_MTE3,
                     DavinciV100PipelineType.PID_PIPELINE_MTE2,
                     DavinciV100PipelineType.PID_PIPELINE_MTE1,
                     DavinciV100PipelineType.PID_PIPELINE_VEC,
                     DavinciV100PipelineType.PID_PIPELINE_CUBE,
                     DavinciV100PipelineType.PID_PIPELINE_SCALAR,
                     DavinciV100PipelineType.PID_PIPELINE_SCALARLDST)
    ...
    def get_color_by_instr_name(instr: str, pipeline_type: common.Enum):
        if "wait_flag" == instr or "barrier" == instr:
            return common.INSTR_COLOR_MAP[DavinciV100PipelineType.PID_PIPELINE_FLOWCTRL]
    ...
    def __init__(self, container):
        super().__init__(container, DavinciV100PipelineType)
