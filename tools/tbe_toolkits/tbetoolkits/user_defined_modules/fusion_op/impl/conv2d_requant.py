...
def conv2d_requant(inputs, weights, bias,deq_scale, offset_w, outputs, strides, pads, dilations=[1, 1, 1, 1],
           groups=1, data_format='NHWC', offset_x=0, kernel_name="conv2d_requant"):
