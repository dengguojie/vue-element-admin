...
def conv2d_dequant_relu_add_quant(inputs, weights, bias, deq_scale,fm2_place,offset_w, outputs, strides, pads, dilations=[1, 1, 1, 1],
           groups=1, data_format='NHWC', offset_x=0, kernel_name="conv2d_dequant_relu_add_quant"):
    ...
    with tvm.target.cce():
        ...
        add_res = add_compute(fm2,relu_res,None)
        ...
        tensor_list = [fm, filter_w, deq_reg, fm2,out]
        
        if bias:
            tensor_list = [fm, filter_w, bias_tensor, deq_reg, fm2,out]
