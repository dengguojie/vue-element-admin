...
def conv2d_mul(inputs, weights, bias, offset_w, outputs, strides, pads, dilations=[1, 1, 1, 1],
           groups=1, data_format='NHWC', offset_x=0, kernel_name="conv2d_mul"):
...
#            Co1, block_size_n, block_size_k)
    with tvm.target.cce():
        ...
        out = mul_compute(conv_res,conv_res, None) #, negative_slope=0.1
