...
def conv2d_add_relu(inputs, weights, bias, fm2_place,offset_w, outputs, strides, pads, dilations=[1, 1, 1, 1],
           groups=1, data_format='NHWC', offset_x=0, kernel_name="conv2d_add_relu"):
...
#            Co1, block_size_n, block_size_k)
    with tvm.target.cce():
        ...
        out = leaky_relu_compute(add_res, None) #, negative_slope=0.1
