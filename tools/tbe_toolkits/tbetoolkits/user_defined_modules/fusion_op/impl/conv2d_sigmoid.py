...
def conv2d_sigmoid(inputs, weights, bias, offset_w, outputs, strides, pads, dilations=[1, 1, 1, 1],
                groups=1, data_format='NHWC', offset_x=0, kernel_name="conv2d_sigmoid"):
    ...
    with tvm.target.cce():
        ...
        out = sigmoid_compute(conv_res, None)  # , negative_slope=0.1
