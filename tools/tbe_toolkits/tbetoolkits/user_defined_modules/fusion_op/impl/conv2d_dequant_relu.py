...
def conv2d_dequant_relu(inputs, weights, bias,deq_scale, offset_w, outputs, strides, pads, dilations=[1, 1, 1, 1],
           groups=1, data_format='NHWC', offset_x=0, kernel_name="conv2d_dequant_relu"):
    ...
    with tvm.target.cce():
        ...
        out = leaky_relu_compute(dequant_res,None) 
