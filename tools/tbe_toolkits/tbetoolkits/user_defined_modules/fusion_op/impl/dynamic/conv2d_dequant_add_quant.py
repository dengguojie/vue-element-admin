...
def conv2d_dequant_add_quant(inputs,weights,bias,deq_scale,fm2_place,offset_w,outputs,strides,pads,dilations,groups, data_format, offset_x,kernel_name='conv2d_dequant_add_quant_dynamic'):

    soc_version = get_soc_spec("SOC_VERSION")
    relu_outputs={"dtype": "float16"}
    #hape_deq_scale = (1, weights["shape"][0], 1, 1, 16)
