...
def conv2d_add_relu_quant_doubleout(inputs,weights,bias,fm2_place,offset_w,outputs,output,strides,pads,dilations,groups, data_format, offset_x,kernel_name='conv2d_add_relu_quant_doubleout_dynamic'):
