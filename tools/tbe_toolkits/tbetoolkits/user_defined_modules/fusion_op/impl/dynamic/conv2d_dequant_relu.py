...
def conv2d_dequant_relu(inputs,weights,bias,deq_scale,offset_w,outputs,strides,pads,dilations,groups, data_format, offset_x,kernel_name='conv2d_dequant_relu_dynamic'):
    ...
    with tbe.dsl.base.operation.compute():
            ...
            out = relu(dequant_res,relu_outputs,None)
