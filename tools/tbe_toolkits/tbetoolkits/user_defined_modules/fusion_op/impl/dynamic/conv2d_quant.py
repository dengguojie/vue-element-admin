...
def conv2d_quant(inputs,weights,bias,offset_w,outputs,strides,pads,dilations,groups, data_format, offset_x,kernel_name='conv2d_quant_dynamic'):
...
#ascend_quant_compute(x, y, scale, offset, sqrt_mode=False, round_mode="Round", kernel_name="ascend_quant"):
...
#        tensor_list = [input_tensor,weight_tensor,out]
