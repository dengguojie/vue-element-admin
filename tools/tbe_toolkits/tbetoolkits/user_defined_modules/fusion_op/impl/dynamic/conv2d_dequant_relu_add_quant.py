...
def conv2d_dequant_relu_add_quant(inputs,weights,bias,deq_scale,fm2_place,offset_w,outputs,strides,pads,dilations,groups, data_format, offset_x,kernel_name='conv2d_dequant_relu_add_quant_dynamic'):
