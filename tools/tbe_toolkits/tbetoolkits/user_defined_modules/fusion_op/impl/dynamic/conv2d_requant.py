...
def conv2d_requant(inputs,weights,bias,deq_scale,offset_w,outputs,strides,pads,dilations,groups, data_format, offset_x,kernel_name='conv2d_requant_dynamic'):
    ...
    with tbe.dsl.base.operation.compute():
            ...
            out = ascend_requant_compute(conv_res, deq_reg, None, 0)
