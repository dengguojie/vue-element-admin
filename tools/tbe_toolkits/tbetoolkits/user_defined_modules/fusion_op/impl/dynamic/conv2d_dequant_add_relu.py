...
def conv2d_dequant_add_relu(inputs,weights,bias,deq_scale,fm2_place,offset_w,outputs,strides,pads,dilations,groups, data_format, offset_x,kernel_name='conv2d_dequant_add_relu_dynamic'):
...
#            weights_fraz = (Cin*filter_h*filter_w, Cout, block_size_n, block_size_k)
            ...
            add_res = add(fm2,dequant_res,None)
            out = relu(add_res, relu_outputs, "relu")
