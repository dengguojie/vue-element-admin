...
def conv2d_relu_quant_doubleout(inputs,weights,bias,offset_w,outputs,output,strides,pads,dilations,groups, data_format, offset_x,kernel_name='conv2d_relu_quant_doubleout_dynamic'):
...
#        weights_fraz = (Cin*filter_h*filter_w, Cout, block_size_n, block_size_k)
        ...
        conv_res = conv(input_tensor,
                        ...
                        offset_x=offset_x,
                        kernel_name="conv2d")
        relu_res = relu(conv_res,relu_outputs,None)
