...
def conv2d_add_relu(inputs,weights,bias,fm2_place,offset_w,outputs,strides,pads,dilations,groups, data_format, offset_x,kernel_name='conv2d_add_relu_dynamic'):
    ...
    with tbe.dsl.base.operation.compute():
        ...
        tensor_list = [input_tensor, weight_tensor, fm2,relu_res]
        if bias:
            tensor_list = [input_tensor, weight_tensor, bias_tensor, fm2,relu_res]
