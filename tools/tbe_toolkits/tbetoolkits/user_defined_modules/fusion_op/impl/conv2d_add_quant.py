...
def conv2d_add_quant(inputs, weights, bias, fm2_place,offset_w, outputs, strides, pads, dilations=[1, 1, 1, 1],
           groups=1, data_format='NHWC', offset_x=0, kernel_name="conv2d_add_quant"):
    ...
    with tvm.target.cce():
        ...
        if bias:
            tensor_list = [fm, filter_w, bias_tensor, fm2,out]
