...
def conv2d_relu_quant_doubleout(inputs, weights, bias, offset_w, outputs, output,strides, pads, dilations=[1, 1, 1, 1],
           groups=1, data_format='NHWC', offset_x=0, kernel_name="conv2d_relu_quant_doubleout"):
    ...
    with tvm.target.cce():
        ...
        relu_res = leaky_relu_compute(conv_res,None)
