...
def conv2d_add_relu_quant(inputs, weights, bias, fm2_place,offset_w, outputs, strides, pads, dilations=[1, 1, 1, 1],
           groups=1, data_format='NHWC', offset_x=0, kernel_name="conv2d_add_relu_quant"):
    ...
    with tvm.target.cce():
        ...
        add_res = add_compute(conv_res,conv_res,None)
