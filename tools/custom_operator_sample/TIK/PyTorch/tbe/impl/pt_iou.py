...
class Iou():
    ...
    def __init__(self, bboxes, gtboxes, mode):
        ...
        self.product = tbe_platform.cce_conf.api_check_support("tik.vdiv", "float32")
...
@fusion_manager.register("pt_iou")
...
def iou(bboxes, gtboxes, overlap, mode="iou", kernel_name="pt_iou"):
    ...
    op_utils.check_shape(bboxes_shape, param_name="bboxes")
    op_utils.check_shape(gtboxes_shape, param_name="gtboxes")
