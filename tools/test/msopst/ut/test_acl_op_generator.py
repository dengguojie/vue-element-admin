...
class TestUtilsMethods(unittest.TestCase):
    ...
    def test_create_acl_op_json_content_error(self):
        with mock.patch('json.dumps', side_effect=TypeError):
            acl_op_generator._create_acl_op_json_content("")

    def test_append_content_to_file_error(self):
        with pytest.raises(utils.OpTestGenException) as error:
