...
DSL_CHECK_SUPPORT_MAP = {
    "broadcast": {
        ...
        ASCEND_310: ("int8", "uint8",
                     "float16", "int16", "uint16",
                     "float32", "int32", "uint32"),
        ASCEND_310B: ("int8", "uint8",
                     "float16", "int16", "uint16",
                     "float32", "int32", "uint32"),
        ASCEND_910: ("int8", "uint8",
                     "float16", "int16", "uint16",
                     "float32", "int32", "uint32",
                     "int64", "uint64"),
        ASCEND_910B: ("int8", "uint8",
                      "float16", "int16", "uint16",
                      "float32", "int32", "uint32"),
        ASCEND_310P: ("int8", "uint8",
                     "float16", "int16", "uint16",
                     "float32", "int32", "uint32",
                     "int64", "uint64"),
        ASCEND_610: ("int8", "uint8",
                     "float16", "int16", "uint16",
                     "float32", "int32", "uint32",
                     "int64", "uint64"),
        ASCEND_615: ("int8", "uint8",
                     "float16", "int16", "uint16",
                     "float32", "int32", "uint32"),
    ...
    "ceil": {
        ...
        ASCEND_310B: ("float16", "float32", "f162s32", "f322s32",
                     "f322s64", "s642f32", "f322bf16", "bf162s32"),
        ASCEND_910: ("float16", "float32", "f162s32", "f322s32"),
        ASCEND_910B: ("float16", "float32", "f162s32", "f322s32",
                      "f322s64", "s642f32", "f322bf16", "bf162s32"),
        ASCEND_310P: ("float16", "float32", "f162s32", "f322s32"),
    ...
    "reduce_sum": {
        ...
        ASCEND_910: ("float16", "float32", "int32"),
        ASCEND_910B: ("float16", "float32", "int32"),
        ASCEND_310P: ("float16", "float32", "int32"),  # int32: nlst support, last not
        ASCEND_610: ("float16", "float32", "int32"),
        ASCEND_615: ("float16", "float32", "int32"),
    ...
    "vadd": {
        ...
        ASCEND_910B: ("float16", "float32", "int32", "int64", "uint64"),
        ASCEND_310P: ("float16", "float32", "int32", "int64", "uint64"),
        ASCEND_610: ("float16", "float32", "int32", "int64", "uint64"),
        ASCEND_615: ("float16", "float32", "int32", "int64", "uint64"),
    ...
    "vnot": {
        ...
        ASCEND_310B: ("int16", "uint16", "int32", "uint32"),
        ASCEND_910: ("int16", "uint16", "int32", "uint32"),
        ASCEND_910B: ("int16", "uint16", "int32", "uint32"),
        ASCEND_310P: ("int16", "uint16", "int32", "uint32"),
        ASCEND_610: ("int16", "uint16", "int32", "uint32"),
        ASCEND_615: ("int16", "uint16", "int32", "uint32"),
    ...
    "vcmp": {
        ...
        ASCEND_910B: ("float16", "float32", "int64", "uint64"),
        ASCEND_310P: ("float16", "float32", "int64", "uint64"),
        ASCEND_610: ("float16", "float32", "int64", "uint64"),
        ASCEND_615: ("float16", "float32", "int64", "uint64"),
        ASCEND_SHISI: ("float16",),
    },
    "vlogic": {
        "AllSoc": ("bool",),
    ...
    "gather_nd": {
        "AllSoc": ("float16",),
        ASCEND_310: (),
        ASCEND_310B: ("float16", "float32", "int8", "uint8", "int32", "bool"),
        ASCEND_910: ("float16", "float32", "int8", "uint8", "int32", "bool"),
        ASCEND_910B: ("float16", "float32", "int8", "uint8", "int32", "bool"),
        ASCEND_310P: ("float16", "float32", "int8", "uint8", "int32", "bool"),
    ...
    "clip": {
        ...
        ASCEND_910: ("float16", "float32", "int32"),
        ASCEND_910B: ("float16", "float32", "int32"),
        ASCEND_310P: ("float16", "float32"),  # int32: schedule not support
    ...
    "cast_to": {
        ...
        ASCEND_310: ("s82f16", "s82u8", "u82f16", "u82s8",
                     ...
                     "s322f16", "s322s8", "s322u8", "s322f32"),
        ASCEND_310B: ("s82f16", "s82u8", "u82f16", "u82s8",
        ...
        ASCEND_910: ("s82f16", "s82u8", "u82f16", "u82s8",
                     ...
                     "s322f16", "s322s8", "s322u8", "s322f32", "s322s64",
                     "s642s32"),
        ASCEND_910B: ("s82f16", "s82u8", "u82f16", "u82s8",
                      "f162f32", "f162s8", "f162u8", "f162s32", "bf162f32",
                      "f322f16", "f322s8", "f322u8", "f322s32",
                      "s322f16", "s322s8", "s322u8", "s322f32", "s322s64",
                      "s642s32"),
        ASCEND_310P: ("s82f16", "s82u8", "u82f16", "u82s8",
                     "f162f32", "f162s8", "f162u8", "f162s32",
                     "f322f16", "f322s8", "f322u8", "f322s32",
                     "s322f16", "s322s8", "s322u8", "s322f32", "s322s64",
                     "s642s32"),
