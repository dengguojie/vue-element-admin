...
def dsl_vmla(x, y, z, _, kernel_name='dsl_vmla'):
    ...
    res = tbe.vmla(data1, data2, data3)
...
ut_case = OpUT("vmla", "vmla.test_vmla_impl", "dsl_vmla")
...
def calc_expect_func(x, y, z, _):
    ...
    z_value = z.get("value")
    z_dtype = z.get("dtype")
    res = np.add(np.multiply(x_value, y_value),  z_value).astype(z_dtype)
    return (res, )
...
ut_case.add_precision_case(
    "all", {
        ...
        "case_name": "test_vmla_precision_1",
...
ut_case.add_precision_case(
    "all", {
        ...
        "case_name": "test_vmla_precision_2",
        "calc_expect_func": calc_expect_func,
        "precision_standard": precision_info.PrecisionStandard(0.001, 0.001)
    })
