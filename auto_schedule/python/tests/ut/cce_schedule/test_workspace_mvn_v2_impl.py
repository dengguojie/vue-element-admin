...
def dsl_workspace_mvn_v2(input_x, output_y, eps, axis, kernel_name="test_dsl_reduce_multi_mvn_v2"):
    mvn_v2(input_x, output_y, eps, axis, kernel_name)

ut_case = OpUT("cce_schedule", "cce_schedule.test_workspace_mvn_v2_impl", "dsl_workspace_mvn_v2")
