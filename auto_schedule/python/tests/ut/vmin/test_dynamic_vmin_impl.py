...
@register_operator("vmin")
def dsl_dynamic_vmin(x, y, z, kernel_name="dsl_dynamic_vmin"):
...
ut_case = OpUT("vmin", "vmin.test_dynamic_vmin_impl", "dsl_dynamic_vmin")
...
def calc_expect_func(x, y, z):
    x_value = x.get("value")
    y_value = y.get("value")
    res = np.minimum(x_value, y_value)
    return (res, )
...
ut_case.add_precision_case(
    "all", {
        ...
        "case_name": "test_dync_vmin_prec_01"
    })
...
ut_case.add_precision_case(
    "all", {
        ...
        "case_name": "test_dync_vmin_prec_02"
    })
...
ut_case.add_precision_case(
    "all", {
        ...
        "calc_expect_func": calc_expect_func,
        "precision_standard": precision_info.PrecisionStandard(0.001, 0.001),
        "case_name": "test_dync_vmin_prec_03"
    })
