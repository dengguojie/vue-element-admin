...
ut_case = OpUT("trunc", "trunc.test_dynamic_trunc_impl", "dsl_dynamic_trunc")
...
def calc_expect_func(x, y):
    x_value = x.get("value")
    res = np.trunc(x_value).astype(np.int32)
    return (res, )
...
ut_case.add_precision_case(
    ["Ascend910A"], {
        ...
        "case_name": "test_dync_trunc_prec_01"
    })
...
ut_case.add_precision_case(
    ["Ascend910A"], {
        ...
        "case_name": "test_dync_trunc_prec_02"
    })
