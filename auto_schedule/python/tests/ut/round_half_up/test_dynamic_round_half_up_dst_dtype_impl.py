...
def dsl_dynamic_round_half_up(x, y, kernel_name="dsl_dynamic_round_half_up"):
    ...
    for (x,) in ins:
        with tbe.dsl.compute():
            ...
            res = tbe.dsl.round_half_up(data1, output_dtype)
...
ut_case = OpUT("round_half_up", "round_half_up.test_dynamic_round_half_up_dst_dtype_impl", "dsl_dynamic_round_half_up")
...
case1 = {
    ...
    "case_name":
        "test_dync_round_half_up_dst_f12_bf16",
    "expect":
        "success",
    "support_expect":
        True
...
case2 = {
    ...
    "case_name":
        "test_dync_round_half_up_dst_s64_f32",
    "expect":
        "success",
    "support_expect":
        True
...
case3 = {
    ...
    "case_name":
        "test_dync_round_half_up_dst_f32_s64",
    "expect":
        "success",
    "support_expect":
        True
...
case4 = {
    ...
    "case_name":
        "test_dync_round_half_up_dst_bf16_s32",
    "expect":
        "success",
    "support_expect":
        True
