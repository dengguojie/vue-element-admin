...
ut_case = OpUT("vrsqrt", "vrsqrt.test_vrsqrt_impl", "dsl_vrsqrt")
...
ut_case.add_precision_case(
    "Ascend310", {
        ...
        "case_name": "test_vrsqrt_precision_1",
...
ut_case.add_precision_case(
    "Ascend910A", {
        ...
        "case_name": "test_vrsqrt_precision_2",
        "calc_expect_func": calc_expect_func,
        "precision_standard": precision_info.PrecisionStandard(0.004, 0.004)
    })
