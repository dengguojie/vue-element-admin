...
def dsl_dynamic_floor(x, y, kernel_name="dsl_dynamic_floor"):
    ...
    for (x,) in ins:
        with tbe.dsl.compute():
            ...
            res = tbe.dsl.floor(data1, output_dtype)
...
ut_case = OpUT("floor", "floor.test_dynamic_floor_dst_dtype_impl", "dsl_dynamic_floor")
