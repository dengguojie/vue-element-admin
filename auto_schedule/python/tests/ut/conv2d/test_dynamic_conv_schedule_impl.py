...
def test_bias_not_support_preload(test_arg):
    try:
...
print("adding test_bias_not_support_preload")
ut_case.add_cust_test_func(test_func=test_bias_not_support_preload)
