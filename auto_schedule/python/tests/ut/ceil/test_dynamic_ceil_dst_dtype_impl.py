...
def dsl_dynamic_ceil(x, y, kernel_name="dsl_dynamic_ceil"):
    ...
    for (x,) in ins:
        with tbe.dsl.compute():
            ...
            res = tbe.dsl.ceil(data1, output_dtype)
...
ut_case = OpUT("ceil", "ceil.test_dynamic_ceil_dst_dtype_impl", "dsl_dynamic_ceil")
