...
ut_case = OpUT("SoftmaxCrossEntropyWithLogits", "impl.dynamic.softmax_cross_entropy_with_logits",
...
case2 = {"params": [{"shape": (-1, -1), "dtype": "float16", "format": "ND", "ori_shape": (-1, -1), "ori_format": "ND",
         ...
         "support_expect": True}
case3 = {
    "params": [{"shape": (-1, 2, 3), "dtype": "float32", "format": "ND", "ori_shape": (-1, 2, 3), "ori_format": "ND",
...
case6 = {"params": [{"shape": (2, 24), "dtype": "float16", "format": "ND", "ori_shape": (2, 24), "ori_format": "ND",
         ...
         "expect": "success",
         "support_expect": True}
case7 = {"params": [{"shape": (8, -1), "dtype": "float16", "format": "ND", "ori_shape": (8, -1), "ori_format": "ND",
                     "range": ((8, 8), (1, 24))},
                    {"shape": (8, -1), "dtype": "float16", "format": "ND", "ori_shape": (8, -1), "ori_format": "ND",
                     "range": ((8, 8), (1, 24))},
