...
def dsl_vmax(x, y, _, kernel_name='dsl_vmax'):
...
ut_case = OpUT("vmax", "vmax.test_vmax_impl", "dsl_vmax")
...
case1 = {"params": [{"shape": (5, 9, 16, 16), "dtype": "float16", "format": "ND"},
                    {"shape": (5, 9, 16, 16), "dtype": "float16", "format": "ND"},
                    {"shape": (5, 9, 16, 16), "dtype": "float16", "format": "ND"}
                    ],
         "case_name": "test_vmax_1",
         "expect": "success",
         "support_expect": True
         }
...
def calc_expect_func(x, y, _):
    x_value = x.get("value")
    y_value = y.get("value")
    output = np.maximum(x_value, y_value)
    return output


ut_case.add_precision_case(
    "all", {
        "params": [{"shape": (1, 1, 38, 38), "dtype": "float16", "param_type": "input"},
                   {"shape": (1, 1, 38, 38), "dtype": "float16", "param_type": "input"},
                   {"shape": (1, 1, 38, 38), "dtype": "float16", "param_type": "output"},
                   ],
        "case_name": "test_vmax_precision_text_detection",
...
ut_case.add_precision_case(
    "all", {
        "params": [{"shape": (1, 13, 13, 256), "dtype": "float16", "param_type": "input"},
                   {"shape": (1, 13, 13, 256), "dtype": "float16", "param_type": "input"},
                   {"shape": (1, 13, 13, 256), "dtype": "float16", "param_type": "output"}
                   ],
        "case_name": "test_vmax_precision_yolov3",
        "calc_expect_func": calc_expect_func,
        "precision_standard": precision_info.PrecisionStandard(0.001, 0.001)
    })
...
ut_case.add_precision_case(
    "all", {
        "params": [{"shape": (1, 13, 4), "dtype": "float16", "param_type": "input"},
                   {"shape": (1, 13, 4), "dtype": "float16", "param_type": "input"},
                   {"shape": (1, 13, 4), "dtype": "float16", "param_type": "output"}
                   ],
        "case_name": "test_vmax_precision_maskrcnn_mobilenet_v2",
        "calc_expect_func": calc_expect_func,
        "precision_standard": precision_info.PrecisionStandard(0.001, 0.001)
    })
...
ut_case.add_precision_case(
    "all", {
        "params": [{"shape": (1, 4, 135, 512), "dtype": "float16", "param_type": "input"},
                   {"shape": (1, 4, 135, 512), "dtype": "float16", "param_type": "input"},
                   {"shape": (1, 4, 135, 512), "dtype": "float16", "param_type": "output"}
                   ],
        "case_name": "test_vmax_precision_8concat",
        "calc_expect_func": calc_expect_func,
        "precision_standard": precision_info.PrecisionStandard(0.001, 0.001)
    })
