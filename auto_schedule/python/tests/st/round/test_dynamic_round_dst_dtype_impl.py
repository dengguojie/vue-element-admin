...
def dsl_dynamic_round(x, y, kernel_name="dsl_dynamic_round"):
    ...
    for (x,) in ins:
        with tbe.dsl.compute():
            ...
            res = tbe.dsl.round(data1, output_dtype)
...
ut_case = OpUT("round", "round.test_dynamic_round_dst_dtype_impl", "dsl_dynamic_round")
