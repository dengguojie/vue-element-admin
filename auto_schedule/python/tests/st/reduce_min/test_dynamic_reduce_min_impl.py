...
def dsl_dync_reduce_min(x, y, axis, keepdims=False, kernel_name="dsl_dync_reduce_min"):
...
ut_case = OpUT("reduce_min", "reduce_min.test_dynamic_reduce_min_impl", "dsl_dync_reduce_min")
...
ut_case.add_case(["Ascend910", "Ascend310P3"], case1)
