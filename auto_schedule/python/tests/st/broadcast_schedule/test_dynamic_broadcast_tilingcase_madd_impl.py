...
def dsl_dync_vmadd(x, y, z, kernel_name="dsl_dync_vmadd"):
    dtype = x.get("dtype")
    ...
    for (x, y) in ins:
        with tbe.dsl.compute():
            ...
            madd = tbe.dsl.vmadd(input_x_fp32, input_y_fp32, input_z)
            res = tbe.dsl.vmla(madd, madd, input_z)
...
ut_case = OpUT("vmadd", "broadcast_schedule.test_dynamic_broadcast_tilingcase_madd_impl", "dsl_dync_vmadd")
case1 = {
    "params": [{
        "shape": (1, -1),
        "dtype": "float16",
    ...
    "case_name":
        "test_dynamic_broadcast_tilingcase_madd_impl_1",
    "expect":
        "success",
    "support_expect":
        True
