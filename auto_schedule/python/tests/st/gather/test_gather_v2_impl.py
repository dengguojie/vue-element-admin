...
def dsl_dync_gather_v2(params, indices, axis, output, batch_dims=0, kernel_name="dsl_dync_vadd"):
...
ut_case = OpUT("gather", "gather.test_gather_v2_impl", "dsl_dync_gather_v2")
