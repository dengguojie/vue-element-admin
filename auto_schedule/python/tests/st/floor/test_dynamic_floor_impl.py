...
ut_case = OpUT("floor", "floor.test_dynamic_floor_impl", "dsl_dynamic_floor")
...
def calc_expect_func(x, y):
    x_value = x.get("value")
    res = np.floor(x_value).astype(np.int32)
    return (res, )
...
ut_case.add_precision_case(
    ["Ascend910A"], {
        ...
        "case_name": "test_dync_floor_prec_01"
    })
...
ut_case.add_precision_case(
    ["Ascend910A"], {
        ...
        "case_name": "test_dync_floor_prec_02"
    })
