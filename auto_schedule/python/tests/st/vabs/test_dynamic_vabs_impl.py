...
@register_operator("vabs")
def dsl_dynamic_vabs(x, y, kernel_name="dsl_dynamic_vabs"):
...
ut_case = OpUT("vabs", "vabs.test_dynamic_vabs_impl", "dsl_dynamic_vabs")
...
ut_case.add_precision_case(
    ["Ascend910A", "Ascend710"], {
        ...
        "case_name": "test_dync_vabs_prec_01"
    })
...
ut_case.add_precision_case(
    ["Ascend910A", "Ascend710"], {
        ...
        "case_name": "test_dync_vabs_prec_02"
    })
