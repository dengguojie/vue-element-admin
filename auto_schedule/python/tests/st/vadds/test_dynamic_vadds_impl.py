...
@register_operator("vadds")
def dsl_dync_vadds(x, y, value, kernel_name="dsl_dync_vadds"):
...
ut_case = OpUT("vadds", "vadds.test_dynamic_vadds_impl", "dsl_dync_vadds")
