...
from sch_test_frame.config import llt_config
from sch_test_frame.common import logger
from sch_test_frame.common import op_status
from sch_test_frame.common import precision_info
from sch_test_frame.common import data_generator
from sch_test_frame.utils import shape_utils
from sch_test_frame.utils import precision_compare_util
from sch_test_frame.utils import op_param_util
from sch_test_frame.utils import file_util
from sch_test_frame.ut import op_ut_case_info
from sch_test_frame.ut import ut_report
from sch_test_frame.common.ascend_tbe_op import AscendOpKernel
from sch_test_frame.common.ascend_tbe_op import AscendOpKernelRunner
...
class OpUT:  # pylint: disable=too-many-instance-attributes
    """
        OpUT
        example:
        from sch_test_frame import OpUT
    ...
    def _build_op_ut_case_info(self, support_soc, case,
        ...
        if precision_standard and not isinstance(precision_standard, precision_info.PrecisionStandard):
            raise RuntimeError("precision_standard is not sch_test_frame.common.precision.PrecisionStandard type")
    ...
    def _do_tiling(self, run_soc_version: str, case_info: op_ut_case_info.OpUTCase,
        ...
        return tiling_info.get("block_dim"), tiling_info.get("tiling_data"), tiling_info.get("tiling_key")
    ...
    def _run_kernel(self, run_soc_version: str, case_info: op_ut_case_info.OpUTCase, run_cfg: Dict[str, Any] = None):
        ...
        with AscendOpKernelRunner(simulator_mode=simulator_mode,
            ...
            if self.imply_type == OpImplyType.DYNAMIC_SHAPE:
                ...
                block_dim, tiling_data, tiling_key = self._do_tiling(run_soc_version=run_soc_version,
                                                         case_info=case_info,
