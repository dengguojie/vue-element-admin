...
def get_op_info(outs):
    ...
    """
    warnings.warn(
        "te.lang.cce.get_op_info is expired, please replace it with tbe.dsl.static_schedule.get_op_info", 
        DeprecationWarning)
...
def verify_compute_tensor(tensors):
    ...
    """
    warnings.warn(
        "te.lang.cce.verify_compute_tensor is expired, please replace it with tbe.dsl.static_schedule.verify_compute_tensor", 
        DeprecationWarning)
...
def schedule_cce(outs, option=None):
    ...
    """
    warnings.warn(
        "te.lang.cce.schedule_cce is expired, please replace it with tbe.dsl.static_schedule.schedule_cce", 
        DeprecationWarning)
...
def check_is_need_cast(out):
    ...
    """
    warnings.warn(
        "te.lang.cce.check_is_need_cast is expired, please replace it with tbe.dsl.static_schedule.check_is_need_cast", 
        DeprecationWarning)
