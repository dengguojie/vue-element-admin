...
BROADCAST_COMPUTE = {
    "broadcast_for_tensor", "broadcast", "unknown_broadcast"
}
...
def _parse_pattern(outs):
    ...
    if ComputeType.CONV2D_BP_INPUT_D in compute_type_size_map:
...
def _get_compute_type(tensor: tvm.tensor.Tensor) -> ComputeType:
    ...
    insn_compute_type_mapping = [
        ...
        (CONV2D_BP_INPUT_D_COMPUTE, ComputeType.CONV2D_BP_INPUT_D)
    ]
