...
class Conv2dParamsEncoder(BaseClassParamsEncoder):
    ...
    def check_info_dict(self, params_in):
        ...
        params_in['pooling_shape'] = [0, 0] if \
            pooling_shape is None else pooling_shape
        pooling_stride = params_in.get('pooling_stride', None)
        params_in['pooling_stride'] = [0, 0] if \
            pooling_stride is None else pooling_stride
        ...
        self.check_param_length(params_in.get('fused_channel_wise'), \
            [SHAPE_LENGTH3])
        self.check_param_length(params_in.get('pooling_shape'), \
            [SHAPE_LENGTH2])
        self.check_param_length(params_in.get('pooling_stride'), \
            [SHAPE_LENGTH2])
        ...
        if _ca0 != C04:
            self.check_support_value(pooling_shape, \
                [CONST_VALUE0, CONST_VALUE0])
            self.check_support_value(pooling_stride, \
                [CONST_VALUE0, CONST_VALUE0])
