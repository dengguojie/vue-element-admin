...
class OperatorContext:
    ...
    def begin_compute(self, _compute):
        ...
        if self.current_compute is not None:
            raise RuntimeError("Exist not finished compute context.")
    ...
    def end_compute(self, _compute):
        ...
        if self.current_compute != _compute:
            raise RuntimeError("Compute context not match.")
        self.current_compute = None
...
def register_build(pattern, break_: bool = False):
    """
    :param pattern:
    :param break_:
    :return:
    ...
    def decorator(func):
        ...
        builds[pattern] = {"func": wrapper, "break": break_}
        return wrapper

    return decorator


def get_build(pattern):
    """
    :param pattern:
    :return:
    """
