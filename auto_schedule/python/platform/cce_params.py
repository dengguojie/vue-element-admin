...
ASCEND_615 = "Ascend615"
ASCEND_710P = "Ascend710Pro"
_AIC_ENGINE = "AiCore"
...
AIC_615 = ASCEND_615 + _AIC_ENGINE
VEC_615 = ASCEND_615 + _VEC_ENGINE
...
ONLY_TIK_API_MAP = {
    ...
    "vector_dup_v1": {
        ...
        AIC_615: ["uint16", "int16", "float16", "uint32", "int32", "float32"]
    },
    "vector_dup": {
        ASCEND_310AIC: ["uint16", "int16", "float16", "uint32", "int32", "float32"],
        ASCEND_910AIC: ["uint16", "int16", "float16", "uint32", "int32", "float32"],
    ...
    "vec_trans_scatter": {
        ...
        HI3796CV300CSAIC: ["int8", "uint8", "uint16", "int16", "float16",
                           "uint32", "int32", "float32"],
        AIC_710: ["int8", "uint8", "uint16", "int16", "float16", "uint32",
                  "int32", "float32"],
        AIC_610: ["int8", "uint8", "uint16", "int16", "float16", "uint32",
                  "int32", "float32"],
        VEC_710: ["int8", "uint8", "uint16", "int16", "float16", "uint32",
                  "int32", "float32"],
        VEC_610: ["int8", "uint8", "uint16", "int16", "float16", "uint32",
                  "int32", "float32"],
        AIC_615: ["int8", "uint8", "uint16", "int16", "float16", "uint32",
                  "int32", "float32"]
    },
    "data_move_v1": {
        ASCEND_310AIC: [],
    ...
    "load2dv1": {
        ...
        HI3796CV300CSAIC: ["uint4", "int4", "int8", "uint8", "uint16",
                           "int16", "float16"],
        AIC_710: ["uint4", "int4", "int8", "uint8", "uint16", "int16",
                  "float16"],
        AIC_610: ["uint4", "int4", "int8", "uint8", "uint16", "int16",
                  "float16"],
        VEC_710: ["uint4", "int4", "int8", "uint8", "uint16", "int16",
                  "float16"],
        VEC_610: ["uint4", "int4", "int8", "uint8", "uint16", "int16",
                  "float16"],
        AIC_615: ["uint4", "int4", "int8", "uint8", "uint16", "int16",
                  "float16"]
    },
    "load2dv2": {
        HI3796CV300ESAIC: ["uint4", "int4", "int8", "uint8", "uint16",
    ...
    "mmad_broadcast": {
        ...
        AIC_615: ['f16f16', 'f32f32', 's32s32', 'f32f16']
    },
    ...
    "fixpipe": {
        ...
        AIC_615: ["f32f16", "f32f32", "s32s32", "s32f16"]
    },
    "matmul": {
        ASCEND_310AIC: ["s8s8s32", "u8s8s32", "f16f16f32"],
        ASCEND_910AIC: ["s8s8s32", "u8s8s32", "f16f16f32"],
